...
<?php
/**
 * Classe de mapeamento da tabela ppa.controle_acao
...
class TPPAControleAcao extends Persistente
{
    /**
     * Método construtor
     * @access private
    ...
    public function __construct()
    {
        ...
        $this->setTabela('ppa.controle_acao');

        $this->setCampoCod('cod_acao,timestamp');
        ...
        $this->addCampo('cod_nova_acao', 'integer', true, '', false, false);
    }
}
