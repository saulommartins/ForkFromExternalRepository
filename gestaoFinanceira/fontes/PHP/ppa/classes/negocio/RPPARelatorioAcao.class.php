...
<?php
/**
    * Classe de Regra de Negócio de Relatório de Acao
...
*/
require_once '../../../../../../gestaoFinanceira/fontes/PHP/ppa/classes/mapeamento/TPPAAcao.class.php';
require_once '../../../../../../gestaoFinanceira/fontes/PHP/ppa/classes/mapeamento/TPPAAcaoRecurso.class.php';
...
require_once '../../../../../../gestaoFinanceira/fontes/PHP/ppa/classes/mapeamento/TPPARegiao.class.php';
require_once(CAM_GRH_PES_MAPEAMENTO."TPessoalContrato.class.php");

class RPPARelatorioAcao
{
    /**
    ...
    */
    ...
    {
        $this->pgForm = "FMRelatorioAcao.php";
    }
    ...
    */
    ...
    /**
        ...
        * @return object
    */
    public function pesquisar($stMap, $stMetodo, $stParam, $stOrdem, $boCriterio)
    {
        return $this->callMapeamento($stMap, $stMetodo, $stParam, $stOrdem, $boCriterio);
    }
