...
<?php
/**
* Página de Filtro de Procura de Conta Receita
...
$stPrograma = "ProcurarContaReceita";
...
$obHdnCodContaReceita->setName ( 'hdnCodContaReceita' );
$obHdnCodContaReceita->setId   ( 'hdnCodContaReceita' );
