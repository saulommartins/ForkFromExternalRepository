...
<?php
/**
* Página de Lista de Procura de Conta Receita
...
$stFncJavaScript .= " function insereClassReceita(num,nom,codConta) {  \n";
...
$stFncJavaScript .= " window.opener.parent.frames['telaPrincipal'].document.getElementById('inCodContaReceita').value = codConta; \n";
...
$obLista->ultimaAcao->addCampo( '&inCodContaReceita', 'cod_conta' );
$obLista->commitAcao();
$obLista->show();
