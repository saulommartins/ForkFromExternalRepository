...
<?php
/**
* Página de Listagem de Procura de Orgão
...
if ($_REQUEST['stNome']) {
    $stFiltro.= " orgao.nom_orgao ilike '%".$_REQUEST['stNome']."%' and ";
...
$stOrder = " order by orgao.nom_orgao";

$obTOrgao->recuperaOrgao($rsLista, $stFiltro, $stOrder);
...
$obLista->ultimaAcao->setLink("JavaScript:insereOrgao()");
$obLista->ultimaAcao->addCampo("1",	"cod_orgao"   );
$obLista->ultimaAcao->addCampo("2",	"nom_orgao"   );
$obLista->commitAcao();
$obLista->show();
