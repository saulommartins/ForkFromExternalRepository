...
$obHdnCtrl->setValue('buscaSubFuncao');
...
$obTxtCod->setTitle('Informe o Código da SubFunção.');

$obTxtNome = new TextBox;
$obTxtNome->setName('stNome');
$obTxtNome->setRotulo('Nome da SubFunção');
$obTxtNome->setSize(80);
$obTxtNome->setMaxLength(80);
$obTxtNome->setNull(true);
$obTxtNome->setTitle('Informe o Nome da SubFunção.');
