...
$obHdnCtrl->setValue('buscaFuncao');
...
$obTxtCod->setTitle('Informe o Código da Função.');

$obTxtNome = new TextBox;
$obTxtNome->setName('stNome');
$obTxtNome->setRotulo('Nome da Função');
$obTxtNome->setSize(80);
$obTxtNome->setMaxLength(80);
$obTxtNome->setNull(true);
$obTxtNome->setTitle('Informe o Nome da Função.');
