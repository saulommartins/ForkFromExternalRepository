...
<?php
/**
 * Página de Listagem para seleção de dados a serem consultar
...
$stPrograma = 'ConsultarReceita';
$pgForm     = 'FM' . $stPrograma . '.php';
$pgProc     = 'PR' . $stPrograma . '.php';
$pgExcl     = 'FM' . $stPrograma . '.php';
$pgCons     = 'FM' . $stPrograma . '.php';

$inCodPPA  = (int) $_REQUEST['inCodPPA'];
$inCodConta = 0;
if (isset($_REQUEST['inCodConta'])) {
    $inCodConta = (int) $_REQUEST['inCodConta'];
}
...
$stCaminho  = CAM_GF_PPA_INSTANCIAS . 'consultas/' . $pgAcao;
