 ...
 * Casos de uso: uc-02.09.04
 ...
 $Id: PRManterAcao.php 35607 2008-11-14 13:12:13Z pedro.medeiros $
...
//echo"#<br>codOrgao:   ".$_REQUEST['inMontaCodOrgaoM']."<br>";
//echo"#<br>codUnidade: ".$_REQUEST['inMontaCodUnidadeM']."<br>";
