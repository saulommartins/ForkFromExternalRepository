...
<?php
/**
    * Página do oculto filtra de Relatórios de Ações Não Orçamentárias
...
$preview->setTitulo('Ações Não Orçamentárias');
$preview->setVersaoBirt('2.5.0');
$preview->setExportaExcel(true);
$preview->addParametro('cod_ppa', $_POST['inCodPPA']);
$preview->addParametro('ano_inicio', $rsPPA->getCampo('ano_inicio'));
$preview->addParametro('cod_tipo_acao', $_POST['inCodTipoAcao']);
if ($_POST['inCodPrograma'] == '') {
    $preview->addParametro('cod_programa', '');
} else {
    $preview->addParametro('cod_programa', $_POST['inCodPrograma']);
}
$preview->preview();
