...
<?php
/**
    * Página Processamento de Relatório Regiões
...
require_once '../../../../../../gestaoFinanceira/fontes/PHP/ppa/classes/visao/VPPARelatorioRegioes.class.php';

//Instanciando a Classe de Controle e de Visao
$obController = new RPPAHomologarPPA;
$obVisao = new VPPARelatorioRegioes($obController);
