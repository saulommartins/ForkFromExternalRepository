...
<?php
/**
    * Página Processamento de Relatório Metas
...
$obHdnAcao->setValue("encaminhaRelatorioMetas");

$obHdnCtrl = new Hidden;
$obHdnCtrl->setName("stCtrl");
$obHdnCtrl->setValue("encaminhaRelatorioMetas");
...
$obFormulario->addTitulo('Filtro Metas Físicas / Fiscais Alteradas');
