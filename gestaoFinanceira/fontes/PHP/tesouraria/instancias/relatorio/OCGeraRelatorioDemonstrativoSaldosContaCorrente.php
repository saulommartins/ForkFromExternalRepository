...
$obPDF->setAcao( "Demonstrativo de Saldos Por Conta Corrente" );
...
while ( !$arDados->eof() ) {
    ...
    $arDemostrativo[$inContadorRecurso]["des_conta" ]   = $arDados->getCampo("des_conta");    
    $arDemostrativo[$inContadorRecurso]["nom_conta" ]   = $arDados->getCampo("nom_conta"     );
...
$obPDF->addCabecalho( "Dados da Conta Corrente" , 21 );
$obPDF->addCabecalho( "Descrição" , 30 );
...
$obPDF->setAlinhamento ( "L" );
$obPDF->addCampoComLargura( "des_conta" , 17,8 );
$obPDF->addCampoComLargura( "nom_conta" , 33,8 );
