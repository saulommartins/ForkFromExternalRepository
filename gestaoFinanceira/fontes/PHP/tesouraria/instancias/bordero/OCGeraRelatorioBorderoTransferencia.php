...
/*
$Log$
Revision 1.7  2006/07/05 20:39:07  cleisson
...
if ($arFiltro['inCodBordero']) {
    $arFiltro['inNumBordero'] = $arFiltro['inCodBordero'];
}

$obRRelatorio->setExercicio  ( Sessao::getExercicio() );
$obRRelatorio->recuperaCabecalho( $arConfiguracao );
$arConfiguracao[ "nom_acao" ] = "Borderô de Transferência";
$obPDF->setModulo            ( "Relatorio" );
$obPDF->setTitulo            ( "Dados para Extrato Bancário" );
$obPDF->setSubTitulo         ( "Borderô Nr. ".str_pad($arFiltro['inNumBordero'], 3,"0",STR_PAD_LEFT)." Exercicio - ".Sessao::getExercicio() );
$obPDF->setUsuario           ( Sessao::getUsername() );
$obPDF->setEnderecoPrefeitura( $arConfiguracao );

$obPDF->addRecordSet( $arFiltroRelatorio[0] );
$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho("",100,10);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCampo("DadosBordero",8, '', '', 'LTRB','205,206,205');

$obPDF->addRecordSet( $arFiltroRelatorio[1] );
...
$obPDF->addRecordSet( $arFiltroRelatorio[2] );
$obPDF->setQuebraPaginaLista( false );
...
$obPDF->addRecordSet( $arFiltroRelatorio[3] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho("", 22, 10);
...
$obPDF->addRecordSet( $arFiltroRelatorio[4] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho("", 100, 10);
...
$obPDF->addRecordSet( $arFiltroRelatorio[5] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
...
$obPDF->addRecordSet( $arFiltroRelatorio[6] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
...
$obPDF->addRecordSet( $arFiltroRelatorio[7] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
...
$obPDF->addRecordSet( $arFiltroRelatorio[8] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho("", 40, 10);
...
$obPDF->setAlinhamento ( "L" );
$obPDF->addCampo("BancoAgenciaCC", 8 , '', '', 'LTRB','205,206,205');
$obPDF->setAlinhamento ( "C" );
$obPDF->addCampo("Observacoes", 8 , '', '', 'LTRB','205,206,205');
$obPDF->setAlinhamento ( "C" );
$obPDF->addCampo("Valor", 8 , '', '', 'LTRB','205,206,205');

$obPDF->addRecordSet( $arFiltroRelatorio[9] );
$obPDF->setQuebraPaginaLista( false );
//$obPDF->setAlturaCabecalho(-6);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho("", 40, 10);
...
$obPDF->addCabecalho("", 20, 10);
$obPDF->setAlinhamento ( "L" );
$obPDF->addCampo("BancoAgenciaCC", 8 , '', '', 'LTRB','255,255,255');
$obPDF->setAlinhamento ( "C" );
$obPDF->addCampo("Observacoes", 8 , '', '', 'LTRB','255,255,255');
$obPDF->setAlinhamento ( "C" );
$obPDF->addCampo("Valor", 8 , '', '', 'LTRB','255,255,255');

$obPDF->addRecordSet( $arFiltroRelatorio[10] );
$obPDF->setQuebraPaginaLista( false );
...
$obPDF->addRecordSet( $arFiltroRelatorio[11] );
$obPDF->setQuebraPaginaLista( false );
$obPDF->setAlinhamento ( "L" );
