...
/*
$Log$
Revision 1.8  2007/09/17 15:07:40  luciano
Ticket#10187#
...
switch ($_REQUEST['stCtrl']) {
    ...
    case 'montaSpanContas':
                ...
                // Define Objeto BuscaInner da conta para resgate
                $obBscContaDebito = new IPopUpContaAnalitica( $obCmbEntidades->obSelect);
                $obBscContaDebito->setRotulo                      ( "Conta Resgate" );
                ...
                $obBscContaDebito->setTipoBusca                   ( "tes_resgate_entrada" );
                ...
                $obBscContaCredito->setTipoBusca                   ( "tes_resgate_contrapartida"    );
    ...
    case 'verificaContas':
            ...
            if ( $_GET['inCodPlanoCredito']  && ( $_GET['inCodPlanoCredito'] == $_GET['inCodPlanoDebito']) ) {
                $stJs .= "alertaAviso('A conta de contrapartida não pode ser a mesma de resgate! (".$_GET['inCodPlanoCredito'].")', '', 'erro','".Sessao::getId()."' );";
                $_erro++;
            }
