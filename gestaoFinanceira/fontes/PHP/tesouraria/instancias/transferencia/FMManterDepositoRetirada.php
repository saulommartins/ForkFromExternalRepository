...
/*
$Log$
Revision 1.12  2007/09/17 15:05:39  luciano
Ticket#10187#

Revision 1.11  2007/07/17 14:50:31  rodrigo_sr
Bug#9583#

Revision 1.10  2007/07/06 18:32:37  rodrigo_sr
Bug#9583#

Revision 1.9  2007/04/05 15:54:36  cako
Bug #8910#

Revision 1.8  2007/01/03 11:08:28  cako
Bug #7792#
...
$stPrograma = "ManterDepositoRetirada";
...
$stHdnValor = "
    ...
    if (document.frm.inCodPlanoCredito.value == '') {
         erro = true;
         mensagem += '@Deve ser informada uma conta de saída!';
    }
    if (document.frm.inCodPlanoDebito.value == '') {
         erro = true;
         mensagem += '@Deve ser informada uma conta de entrada!';
    }
    var stValor;
...
$obIEntidade->setTitle ( "Selecione a entidade das contas para Depósito." );
...
// Define objeto para o valor do depósito
...
$obTxtValor->setTitle    ( "Informe o Valor do depósito." );
...
$obTxtObs->setTitle  ( "Informe as observações do depósito." );
...
$obFormulario->addTitulo        ( "Dados para Depósito/Retiradas"     );
...
$obOk  = new Ok;
$obOk->setId ("Ok");
$obOk->obEvento->setOnClick("if(Valida()){ Salvar(); } document.frm.Ok.disabled = false;");
