...
/*
$Log$
Revision 1.5  2007/04/30 19:21:27  cako
implementação uc-02.03.28

Revision 1.4  2007/03/30 21:58:02  cako
Bug #7884#
...
if ( !Sessao::read('paginando') ) {
    ...
    $_REQUEST['inNumCredor'           ] = $arFiltro['inNumCredor'           ];
...
$obRTesourariaBoletim->roUltimoBordero->obROrcamentoEntidade->obRCGM->setNumCGM($_REQUEST['inNumCredor']);

//$obRTesourariaBoletim->roUltimoBordero->listaConsultaBorderos( $rsLista );
...
$obLista->commitDado();
$obLista->addDado();
$obLista->ultimoDado->setCampo( "[dt_bordero]" );
$obLista->ultimoDado->setAlinhamento( 'CENTRO' );
$obLista->commitDado();
$obLista->addDado();
...
$pgProx = $pgForm;
$obLista->ultimaAcao->setLink( $pgProx."?".Sessao::getId() );
$obLista->commitAcao();
