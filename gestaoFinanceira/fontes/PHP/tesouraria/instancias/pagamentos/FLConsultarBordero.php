...
/*
$Log$
Revision 1.7  2006/07/05 20:39:28  cleisson
...
$obBscCGM->setTitle                ( "Informe o credor a pesquisar"                         );
$obBscCGM->setId                   ( "stNomCredor"                                          );
$obBscCGM->setValue                ( $stNomCredor                                           );
$obBscCGM->setNull                 ( true                                                   );
$obBscCGM->obCampoCod->setName     ( "inNumCredor"                                          );
$obBscCGM->obCampoCod->setSize     ( 10                                                     );
$obBscCGM->obCampoCod->setMaxLength( 8                                                      );
$obBscCGM->obCampoCod->setValue    ( $inNumCredor                                           );
$obBscCGM->obCampoCod->setAlign    ( "left"                                                 );
$obBscCGM->setFuncaoBusca          ("abrePopUp('".CAM_GA_CGM_POPUPS."cgm/FLProcurarCgm.php','frm','inNumCredor','stNomCredor','geral','".Sessao::getId()."','800','550');");
