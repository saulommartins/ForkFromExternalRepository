...
<?php
/**
    * Classe de mapeamento da tabela TESOURARIA_TRANSFERENCIA_RECURSO
...
class TTesourariaTransferenciaRecurso extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TTesourariaTransferenciaRecurso()
{
    parent::Persistente();
    $this->setTabela("tesouraria.transferencia_recurso");
