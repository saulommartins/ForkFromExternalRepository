...
<?php
/**
    * Classe de mapeamento da tabela TESOURARIA_BOLETIM_FECHADO
...
/*
$Log$
Revision 1.8  2006/07/05 20:38:37  cleisson
...
/**
  * Efetua conexão com a tabela  TESOURARIA_BOLETIM_FECHADO
  ...
  * @subpackage Mapeamento
*/
class TTesourariaBoletimFechado extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TTesourariaBoletimFechado()
{
    parent::Persistente();
    $this->setTabela("tesouraria.boletim_fechado");
    ...
    $this->AddCampo('timestamp_fechamento' , 'timestamp', false,''  , false , true  );
