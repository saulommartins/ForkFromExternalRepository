...
<?php
/**
    * Classe de mapeamento da tabela RECIBO_EXTRA_CREDOR
...
class TTesourariaReciboExtraCredor extends Persistente
{
   public function TTesourariaReciboExtraCredor()
   {
        parent::Persistente();

        $this->setTabela( 'tesouraria.recibo_extra_credor' );
        $this->setCampoCod ( '' );
