...
class TTesourariaBoletimLoteTransferenciaEstornada extends Persistente
{
    public function TTesourariaBoletimLoteTransferenciaEstornada()
    {
        parent::Persistente();
        $this->setTabela("tesouraria.boletim_lote_transferencia_estornada");
        ...
        $this->AddCampo('timestamp_estorno'     , 'timestamp'   , true, ''  , true  , true );
