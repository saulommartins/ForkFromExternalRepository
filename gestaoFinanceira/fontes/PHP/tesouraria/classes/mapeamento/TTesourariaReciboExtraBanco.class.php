...
<?php
/**
    * Classe de mapeamento da tabela RECIBO_EXTRA_BANCO
...
class TTesourariaReciboExtraBanco extends Persistente
{
   public function TTesourariaReciboExtraBanco()
   {
        parent::Persistente();

        $this->setTabela( 'tesouraria.recibo_extra_banco' );
        $this->setCampoCod ( '' );
