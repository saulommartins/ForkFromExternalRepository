...
<?php
/**
    * Classe de mapeamento da função EstornoRealizacaoReceitaVariavel
...
class FTesourariaEstornoRealizacaoReceitaVariavel extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FTesourariaEstornoRealizacaoReceitaVariavel()
{
    parent::Persistente();
    $this->setTabela('EstornoRealizacaoReceitaVariavel');
...
{
    $stSql  = " SELECT                                                              \n";
    $stSql .= "       EstornoRealizacaoReceitaVariavel(                             \n";
