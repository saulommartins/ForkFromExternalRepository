...
/*
$Log$
Revision 1.4  2007/09/14 20:56:57  cako
Ticket#9496#
...
class TTesourariaConciliacaoLancamentoArrecadacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TTesourariaConciliacaoLancamentoArrecadacao()
{
    parent::Persistente();
    $this->setTabela("tesouraria.conciliacao_lancamento_arrecadacao");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_plano,exercicio,mes,cod_arrecadacao,timestamp_arrecadacao,tipo');
