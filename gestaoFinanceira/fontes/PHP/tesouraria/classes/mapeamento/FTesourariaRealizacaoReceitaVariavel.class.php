...
<?php
/**
    * Classe de mapeamento da função RealizacaoReceitaVariavel
...
class FTesourariaRealizacaoReceitaVariavel extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FTesourariaRealizacaoReceitaVariavel()
{
    parent::Persistente();
    $this->setTabela('RealizacaoReceitaVariavel');
    ...
    $this->AddCampo('cod_plano_conta_recebimento'  ,'integer',false,''    ,false,false);
    $this->AddCampo('cod_plano_clas_receita'       ,'integer',false,''    ,false,false);
}
...
{
    $stSql  = " SELECT                                                              \n";
    $stSql .= "       RealizacaoReceitaVariavel(                                    \n";
    $stSql .= "                        '".$this->getDado("conta_recebimento")  ."', \n";
...
{
    $stSql  = " SELECT                                                              \n";
    $stSql .= "       RealizacaoReceitaVariavelTribunal(                                    \n";
    $stSql .= "                        '".$this->getDado("conta_recebimento")  ."', \n";
    $stSql .= "                        '".$this->getDado("clas_receita")       ."', \n";
    $stSql .= "                        '".$this->getDado('exercicio')          ."', \n";
    $stSql .= "                         ".$this->getDado("valor")              ." , \n";
    ...
    $stSql .= "                         ".$this->getDado("cod_plano_conta_recebimento")." , \n";
    $stSql .= "                         ".$this->getDado("cod_plano_clas_receita")." ) \n";
    $stSql .= "                         as sequencia                                \n";
