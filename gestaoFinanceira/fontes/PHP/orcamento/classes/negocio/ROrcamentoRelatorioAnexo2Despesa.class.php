...
class ROrcamentoRelatorioAnexo2Despesa
{
/**
    * @var Object
    * @access Private
...
/**
     ...
     * @param Object $valor
*/
function getFOrcamentoSomatorioDespesa() { return $this->obFOrcamentoSomatorioDespesa; }
...
/**
    ...
    * @access Private
*/
function ROrcamentoRelatorioAnexo2Despesa()
{
...
function geraRecordSet(&$rsRecordSet, &$rsCabecalho, &$rsResumo , $stOrder = "")
{
    ...
    $stEntidade = substr($this->stFiltro,0,strpos($this->stFiltro,")")+1);
    $stFiltro = "WHERE valor <> 0";

    $obErro = $this->obFOrcamentoSomatorioDespesa->recuperaTodos( $rsRecordSet, $stFiltro, "" );
//    $this->obFOrcamentoSomatorioDespesa->Debug();
