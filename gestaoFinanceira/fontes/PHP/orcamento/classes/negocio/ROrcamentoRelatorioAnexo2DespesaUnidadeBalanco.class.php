...
include_once( CAM_GF_ORC_MAPEAMENTO."FOrcamentoSomatorioDespesaUnidadeBalanco.class.php"                );
...
class ROrcamentoRelatorioAnexo2DespesaUnidadeBalanco
{
/**
    * @var Object
    * @access Private
*/
var $obFOrcamentoSomatorioDespesaUnidadeBalanco;
var $stFiltro;
var $inExercicio;
var $inOrgao;
var $inUnidade;
...
/**
     ...
     * @param Object $valor
*/
function setFOrcamentoSomatorioDespesaUnidadeBalanco($valor) { $this->obFOrcamentoSomatorioDespesaUnidadeBalanco = $valor; }
...
/**
     ...
     * @param Object $valor
*/
function getFOrcamentoSomatorioDespesaUnidadeBalanco() { return $this->obFOrcamentoSomatorioDespesaUnidadeBalanco; }
...
/**
    ...
    * @access Private
*/
function ROrcamentoRelatorioAnexo2DespesaUnidadeBalanco()
{
    $this->setFOrcamentoSomatorioDespesaUnidadeBalanco ( new FOrcamentoSomatorioDespesaUnidadeBalanco );
...
function geraRecordSet(&$arTodos, &$rsTotal, $stOrder = "")
{
    ...
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("stDataInicial",$this->stDataInicial);
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("stDataFinal",  $this->stDataFinal  );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("stSituacao",   $this->stSituacao   );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("stEntidades",  $this->stEntidades  );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("exercicio",    $this->inExercicio  );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("stFiltro",     $this->stFiltro     );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("inOrgao",      $this->inOrgao      );
    $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->setDado ("inUnidade",    $this->inUnidade    );
    ...
    $obErro = $this->obFOrcamentoSomatorioDespesaUnidadeBalanco->recuperaTodos( $rsRecordSet, $stFiltro, "" );
