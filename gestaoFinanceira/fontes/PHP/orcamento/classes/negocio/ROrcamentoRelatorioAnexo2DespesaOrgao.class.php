...
<?php
/**
    * Classe de regra para Anexo2DespesaOrgao
...
include_once( CAM_GF_ORC_MAPEAMENTO."FOrcamentoSomatorioDespesaOrgao.class.php" );
...
class ROrcamentoRelatorioAnexo2DespesaOrgao
{
/**
    * @var Object
    * @access Private
*/
var $obFOrcamentoSomatorioDespesaOrgao;
var $stFiltro;
var $inExercicio;
var $inOrgao;
var $inUnidade;
...
/**
     ...
     * @param Object $valor
*/
function setFOrcamentoSomatorioDespesaOrgao($valor) { $this->obFOrcamentoSomatorioDespesaOrgao = $valor; }
...
/**
     ...
     * @param Object $valor
*/
function getFOrcamentoSomatorioDespesaOrgao() { return $this->obFOrcamentoSomatorioDespesaOrgao; }
...
/**
    ...
    * @access Private
*/
function ROrcamentoRelatorioAnexo2DespesaOrgao()
{
    $this->setFOrcamentoSomatorioDespesaOrgao ( new FOrcamentoSomatorioDespesaOrgao );
}
...
function geraRecordSet(&$arTodos, &$rsTotal, $stOrder = "")
{
    ...
    $this->obFOrcamentoSomatorioDespesaOrgao->setDado ("exercicio", $this->inExercicio);
    $this->obFOrcamentoSomatorioDespesaOrgao->setDado ("stFiltro",  $this->stFiltro);
    ...
    $obErro = $this->obFOrcamentoSomatorioDespesaOrgao->recuperaTodos( $rsRecordSet, $stFiltro, "" );
