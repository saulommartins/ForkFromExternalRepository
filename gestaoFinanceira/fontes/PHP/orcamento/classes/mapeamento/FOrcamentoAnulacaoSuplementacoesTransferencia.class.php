...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_ANULACAO_SUPLEMENTACOES_TRANSFERENCIA
    * Data de Criação: 215/043/2005
...
class FOrcamentoAnulacaoSuplementacoesTransferencia extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoAnulacaoSuplementacoesTransferencia()
{
    parent::Persistente();
    $this->setTabela('OrcamentoAnulacaoSuplementacoesTransferencia');
