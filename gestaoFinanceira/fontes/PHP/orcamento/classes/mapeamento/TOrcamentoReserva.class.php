...
<?php
/**
    * Classe de mapeamento da tabela ORCAMENTO.RESERVA
...
class TOrcamentoReserva extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TOrcamentoReserva()
{
    parent::Persistente();
    $this->setTabela('orcamento.reserva');

    $this->setCampoCod('cod_reserva');
    $this->setComplementoChave('exercicio,cod_despesa');
    ...
    $this->AddCampo('anulada','boolean',true,'',false,false);
