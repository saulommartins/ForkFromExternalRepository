...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_ANULACAO_SUPLEMENTACOES_CREDITO_SUPLEMENTAR
...
class FOrcamentoAnulacaoSuplementacoesCreditoSuplementar extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoAnulacaoSuplementacoesCreditoSuplementar()
{
    parent::Persistente();
    $this->setTabela('OrcamentoAnulacaoSuplementacoesCreditoSuplementar');
