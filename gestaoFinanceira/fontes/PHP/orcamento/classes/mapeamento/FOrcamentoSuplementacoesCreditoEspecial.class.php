...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SUPLEMENTACOES_CREDITO_ESPECIAL
...
class FOrcamentoSuplementacoesCreditoEspecial extends Persistente
{
/**
    * Método Construtor
    * @access Private
...
{
    parent::Persistente();
    $this->setTabela('OrcamentoSuplementacoesCreditoEspecial');
