...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SOMATORIO_DESPESA_ORGAO
...
class FOrcamentoSomatorioDespesaOrgao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDespesaOrgao()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_despesa_orgao');
...
function montaRecuperaTodos()
{
    ...
    $stSql .= "     as retorno(cod_conta integer, num_orgao integer, nivel integer, descricao varchar,                  \n";
