...
class FOrcamentoSomatorioDespesaBalanco extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDespesaBalanco()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_despesa_balanco');
...
function montaRecuperaTodos()
{
    ...
    $stSql .= " FROM                                                                                 \n";
    $stSql .= "               ".$this->getTabela()."('".$this->getDado("exercicio")."','".$this->getDado("stFiltro")."','".$this->getDado("stDataInicial")."','".$this->getDado("stDataFinal")."','".$this->getDado("stEntidades")."','".$this->getDado("stSituacao")."') \n";
