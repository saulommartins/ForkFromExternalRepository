...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SUPLEMENTACOES_TRANSFERENCIA
...
class FOrcamentoSuplementacoesTransferencia extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSuplementacoesTransferencia()
{
    parent::Persistente();
    $this->setTabela('OrcamentoSuplementacoesTransferencia');
