...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_ANULACAO_SUPLEMENTACOES_CREDITO_EXTRAORDINARIO
...
class FOrcamentoAnulacaoSuplementacoesCreditoExtraordinario extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoAnulacaoSuplementacoesCreditoExtraordinario()
{
    parent::Persistente();
    $this->setTabela("orcamentoanulacaosuplementacoescreditoextraordinario");
    ...
    $this->AddCampo('tipo_anulacao'  ,'varchar',false,''    ,false,false);
}
...
function montaExecutaFuncao()
{
    ...
    $stSql .= "                        '".$this->getDado("tipo_anulacao") ."')  \n";
    $stSql .= "                         as sequencia                            \n";
