...
class FOrcamentoSomatorioDespesaUnidadeCategoriaEconomica extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDespesaUnidadeCategoriaEconomica()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_despesa_unidade_categoria_economica');
