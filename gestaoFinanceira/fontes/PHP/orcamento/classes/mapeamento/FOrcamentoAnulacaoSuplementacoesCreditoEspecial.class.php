...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_ANULACAO_SUPLEMENTACOES_CREDITO_ESPECIAL
...
class FOrcamentoAnulacaoSuplementacoesCreditoEspecial extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoAnulacaoSuplementacoesCreditoEspecial()
{
    parent::Persistente();
    $this->setTabela('OrcamentoAnulacaoSuplementacoesCreditoEspecial');
