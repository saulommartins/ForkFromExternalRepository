...
<?php
/**
    * Classe de mapeamento da tabela ORCAMENTO.SUPLEMENTACAO_REDUCAO
...
/**
  * Efetua conexão com a tabela  ORCAMENTO.SUPLEMENTACAO_REDUCAO
  * Data de Criação: 10/02/2005
...
*/
class TOrcamentoSuplementacaoReducao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TOrcamentoSuplementacaoReducao()
{
    parent::Persistente();
    $this->setTabela('orcamento.suplementacao_reducao');
