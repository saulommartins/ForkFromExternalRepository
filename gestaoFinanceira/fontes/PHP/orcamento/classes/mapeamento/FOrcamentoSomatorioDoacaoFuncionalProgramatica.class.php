...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SOMATORIO_DOTACAO_FUNCIONAL_PROGRAMATICA
...
class FOrcamentoSomatorioDoacaoFuncionalProgramatica extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDoacaoFuncionalProgramatica()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_dotacao_funcional_programatica');
