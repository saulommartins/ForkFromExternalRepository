...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SUPLEMENTACOES_CREDITO_EXTRAORDINARIO
...
class FOrcamentoSuplementacoesCreditoExtraordinario extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSuplementacoesCreditoExtraordinario()
{
    parent::Persistente();
    $this->setTabela('OrcamentoSuplementacoesCreditoExtraordinario');
