...
<?php
/**
    * Classe de mapeamento para a função orcamento.fn_somatorio_dotacao_pao
...
class FOrcamentoSomatorioDotacaoPao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioReceita()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_dotacao_pao');
...
function montaRecuperaTodos()
{
    ...
    $stSql .= " FROM orcamento.fn_somatorio_dotacao_pao ('".$this->getDado("exercicio")."','".$this->getDado("stFiltro")."')  \n";
