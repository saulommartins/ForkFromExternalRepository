...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SOMATORIO_PROGRAMA_TRABALHO
...
class FOrcamentoSomatorioProgramaTrabalho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioProgramaTrabalho()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_programa_trabalho');
