...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SOMATORIO_RECEITA_BALANCO
...
class FOrcamentoSomatorioReceitaBalanco extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioReceitaBalanco()
{
    parent::Persistente();

    $this->setTabela('orcamento.fn_somatorio_receita_balanco');
...
function montaRecuperaTodos()
{
    ...
    $stSql .= " FROM                                                                                \n";
    $stSql .= "               ".$this->getTabela()."('".$this->getDado("exercicio")."','".$this->getDado("stEntidades")."','".$this->getDado("dtDataInicial")."','".$this->getDado("dtDataFinal")."')                \n";
