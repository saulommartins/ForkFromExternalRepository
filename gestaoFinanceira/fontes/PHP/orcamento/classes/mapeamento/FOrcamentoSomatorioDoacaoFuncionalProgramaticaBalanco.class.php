...
<?php
/**
    * Classe de mapeamento da tabela FN_ORCAMENTO_SOMATORIO_DOTACAO_FUNCIONAL_PROGRAMATICA_BALANCO
...
class FOrcamentoSomatorioDoacaoFuncionalProgramaticaBalanco extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDoacaoFuncionalProgramaticaBalanco()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_dotacao_funcional_programatica_balanco');

    $this->AddCampo('dotacao'      ,'integer',false,''    ,false,false);
