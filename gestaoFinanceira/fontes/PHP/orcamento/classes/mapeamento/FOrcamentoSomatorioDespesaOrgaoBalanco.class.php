...
class FOrcamentoSomatorioDespesaOrgaoBalanco extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDespesaOrgaoBalanco()
{
    parent::Persistente();
    $this->setTabela('orcamento.fn_somatorio_despesa_orgao_balanco');
...
function montaRecuperaTodos()
{
    ...
    $stSql .= "               num_orgao integer, valor numeric)                                      \n";
