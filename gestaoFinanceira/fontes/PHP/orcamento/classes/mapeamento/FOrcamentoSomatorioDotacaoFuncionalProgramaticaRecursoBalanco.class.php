...
class FOrcamentoSomatorioDotacaoFuncionalProgramaticaRecursoBalanco extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FOrcamentoSomatorioDotacaoFuncionalProgramaticaRecursoBalanco()
{
    parent::Persistente();
...
function montaRecuperaTodos()
{
    $stSql  = " SELECT                                                                                         \n";
    $stSql .= "     *                                                                                          \n";
    $stSql .= " FROM  orcamento.fn_somatorio_dotacao_funcional_programatica_recurso_balanco        \n";
    $stSql .= "     ('".$this->getDado("exercicio")."','".$this->getDado("stFiltro")."',\n";
