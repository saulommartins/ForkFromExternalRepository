...
<?php
/**
    * Página de Formulario de Inclusao/Alteracao de Identificador de Uso
    * Data de Criação   : 30/10/2007

    * @author Desenvolvedor: Anderson cAko Konze

    $Id: FLIdentificadorUso.php 59612 2014-09-02 12:00:51Z gelson $
...
$obHdnAcao->setValue( $stAcao );
    ...
    $obTxtCod->setName     ( "inCodIdUso"  );
    $obTxtCod->setRotulo   ( "IDUSO"           );
    $obTxtCod->setSize     ( 1 );
    $obTxtCod->setMaxLength( 1 );
    $obTxtCod->setInteiro  ( true               );
    $obTxtCod->setTitle    ( "Informe o Identificador de Uso."    );

    $obTxtDesc = new TextBox;
    $obTxtDesc->setName     ( "stDescricao"           );
    $obTxtDesc->setValue    ( $stDescricao            );
    $obTxtDesc->setRotulo   ( "Descrição"        );
    $obTxtDesc->setTitle    ( "Informe a descrição do Identificador de Uso." );
