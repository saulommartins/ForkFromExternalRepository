...
$obPDF->setComplementoAcao   ( "- Natureza da Despesa por Orgao e Unidade " );
...
//total
$rsRecordTotais = Sessao::read('rsTotal');
$obPDF->addRecordSet( $rsRecordTotais );
