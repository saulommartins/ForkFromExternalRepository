...
<?php
/**
    * Página de Relatório da Evolução da Despesa
...
$preview->addParametro( 'sinteticas', 1 );

// Intervalo de Codigos Estruturais

$stCodEstruturalInicial = (string) $_REQUEST['stCodEstruturalInicial'];
$stCodEstruturalFinal   = (string) $_REQUEST['stCodEstruturalFinal'];

if (strlen($stCodEstruturalInicial) > 0) {
    $preview->addParametro( 'cod_estrutural_ini', $stCodEstruturalInicial );
} else {
    $preview->addParametro( 'cod_estrutural_ini', "" );
}

if (strlen($stCodEstruturalFinal) > 0) {
    $preview->addParametro( 'cod_estrutural_fim', $stCodEstruturalFinal );
} else {
    $preview->addParametro( 'cod_estrutural_fim', "" );
}
