...
$obPDF->setComplementoAcao   ( "- Demonstrativo das Fontes de Receita" );
$obPDF->setSubTitulo         ( "Anexo 3 - Exercício: ".Sessao::getExercicio() );
$obPDF->setUsuario           ( Sessao::getUsername() );
$obPDF->setEnderecoPrefeitura( $arConfiguracao );

$obPDF->addRecordSet( Sessao::read('rsClassificacaoReceita') );
