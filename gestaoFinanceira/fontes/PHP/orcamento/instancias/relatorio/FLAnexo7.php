...
/**
    ...
    * @ignore
    ...
    $Name$
    $Autor: $
    $Date: 2007-08-14 12:41:32 -0300 (Ter, 14 Ago 2007) $
...
/*
$Log$
Revision 1.9  2007/08/14 15:41:32  bruce
Bug#9899#

Revision 1.8  2006/07/14 20:32:56  leandro.zis
Bug #6391#
...
$obHdnCaminho->setValue( CAM_GF_ORC_INSTANCIAS."relatorio/OCAnexo7.php" );
...
$obCmbSituacao->setTitle               ( "Informe demonstrar valores."   );
...
$obCmbTipoRelatorio->setTitle   ( "Informe o tipo de relatório." );
...
$obFormulario->setAjuda ( 'UC-02.01.14' );
