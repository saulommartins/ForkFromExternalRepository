...
/**
* Instância o OBJETO da regra de negócios RSubFuncaoOrçamento
*/
...
if ($_REQUEST['inCodigoSubFuncao']) {
    $obROrcamentoSubfuncao->setCodigoSubFuncao( $_REQUEST['inCodigoSubFuncao'] );
}
if ($_REQUEST['stDescricao']) {
    $obROrcamentoSubfuncao->setDescricao( $_REQUEST['stDescricao'] );
}

$stLink .= "&stAcao=".$stAcao;
$obROrcamentoSubfuncao->obRConfiguracaoOrcamento->setExercicio(Sessao::getExercicio());
$obROrcamentoSubfuncao->listar( $rsLista );
...
$obLista->ultimaAcao->addCampo("&inCodigoSubFuncao","cod_subfuncao");
