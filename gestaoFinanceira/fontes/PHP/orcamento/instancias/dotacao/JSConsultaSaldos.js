...
<?php
/**
    * Arquivo JS utilizado na Consulta Saldos da Dotação
...
/*
$Log$
Revision 1.4  2006/07/05 20:42:50  cleisson
...
function buscaValor(variavel){
    ...
    document.frm.action = 'OCConsultaSaldos.php?stCtrl='+variavel+'&<?=Sessao::getId();?>';
    document.frm.submit();
