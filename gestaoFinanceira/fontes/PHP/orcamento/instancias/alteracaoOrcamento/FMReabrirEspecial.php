...
<?php
/**
    * Página de Formulário de Reabertura de Cred Especial
...
/*
$Log$
Revision 1.6  2007/05/21 18:55:15  melo
Bug #9229#
...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual AND $boUtilizarEncerramentoMes == 'true') {
    ...
    if ($stAcao == 'Suplementa') {
        $obFormulario->addTitulo            ( "Dados para crédito suplementar por superavit" );
    } else {
        $obFormulario->addTitulo            ( "Dados para Reabertura de Crédito Especial" );
    }
