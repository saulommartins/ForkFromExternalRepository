...
<?php
/**
    * Página de Processamento de Credito especial/suplementar por auxilios e convenios
    ...
    * @ignore
    ...
    $Id: PRManterAuxConvenio.php 59612 2014-09-02 12:00:51Z gelson $
...
switch ($stAcao) {
    ...
    case "Especial":
        ...
        $obROrcamentoSuplementacao->setDecreto( $_POST['stDecreto'] );
        ...
        $obROrcamentoSuplementacao->setCredSuplementar( 'Auxilios' );
