...
<?php
 /**
    * Paginae Oculta de Credito extraordinario
...
$stPrograma = "ManterExtraordinario";
...
switch ($stCtrl) {
    ...
    case 'buscaDespesa':
    if ($_POST["inCodDespesaSuplementar"] != "" and $_POST["inCodEntidade"] != "") {
        ...
        // $obROrcamentoSuplementacao->roUltimoDespesaReducao->listarDespesaCredEspecial( $rsDespesa );
        ...
        if (!$stNomDespesa) {
            ...
            $js .= "alertaAviso('@Despesa inválida. (".$_POST["inCodDespesaSuplementar"].")','form','erro','".Sessao::getId()."');";
        } else {
            $js .= 'd.getElementById("stNomDespesaSuplementar").innerHTML = "'.$stNomDespesa.'";';
        }
    } else {
        $js .= 'd.getElementById("stNomDespesaSuplementar").innerHTML = "&nbsp;";';
        $js .= 'd.getElementById("inCodDespesaSuplementar").value = "";';
    }
    SistemaLegado::executaFrameOculto($js);
    break;
