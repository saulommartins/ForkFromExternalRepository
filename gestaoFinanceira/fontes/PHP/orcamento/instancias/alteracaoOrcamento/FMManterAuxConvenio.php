...
<?php
/**
    * Página de Formulário de Cred Especial/Suplementar por Auxilios e convenios
    ...
    * @ignore
    ...
    $Id: FMManterAuxConvenio.php 59612 2014-09-02 12:00:51Z gelson $
...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual AND $boUtilizarEncerramentoMes == 'true') {
    ...
    if ($stAcao == 'Suplementa') {
        $obFormulario->addTitulo            ( "Dados para Crédito Suplementar por Auxílios e Convênios" );
    } else {
        $obFormulario->addTitulo            ( "Dados para Crédito Especial por Auxílios e Convênios" );
    }
