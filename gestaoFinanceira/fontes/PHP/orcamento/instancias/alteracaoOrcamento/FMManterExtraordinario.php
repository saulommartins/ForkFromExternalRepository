...
<?php
/**
    * Página de Formulário de Credito Extraordinario
...
/*
$Log$
Revision 1.9  2007/05/21 18:54:54  melo
Bug #9229#

Revision 1.8  2006/07/28 17:38:29  leandro.zis
Bug #6688#
...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual AND $boUtilizarEncerramentoMes == 'true') {
    ...
    $obFormulario->addTitulo            ( "Dados para Crédito Extraordinário" );
