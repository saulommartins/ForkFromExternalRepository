...
<?php
/**
    * Página de Formulário de Cred Especial/Suplementar por Excesso de arrecadação
...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual && $boUtilizarEncerramentoMes == 'true') {
    ...
    $obTxtVlTotal->setNegativo  (false        );
    ...
    $obTxtVlSuplementar->setNegativo  (true             );
    ...
    if ($stAcao == 'Suplementa') {
        $obFormulario->addTitulo            ( "Dados para Crédito Suplementar por Excesso de Arrecadação" );
    } else {
