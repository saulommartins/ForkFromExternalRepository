...
function limparListaReducao() {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    limparRedutora();
    document.getElementById( "spnReducoes" ).innerHTML = "";
    document.frm.target = 'oculto';
    document.frm.stCtrl.value = 'limparListaReducao';
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>';
    document.frm.submit();
    document.frm.action = stAction;
    document.frm.target = stTarget;
...
function limparListaSuplementacao() {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    limparSuplementada();
    document.getElementById( "spnSuplementada" ).innerHTML = "";
    document.frm.target = 'oculto';
    document.frm.stCtrl.value = 'limparListaSuplementacao';
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>';
    document.frm.submit();
    document.frm.action = stAction;
    document.frm.target = stTarget;
