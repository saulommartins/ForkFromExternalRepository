...
if ($_REQUEST['inCodRecursoInicial'] != '') {
    $obROrcamentoRecurso->setCodRecursoInicial($_REQUEST['inCodRecursoInicial'] );
}

if ($_REQUEST['inCodRecursoFinal'] != '') {
    $obROrcamentoRecurso->setCodRecursoFinal($_REQUEST['inCodRecursoFinal'] );
}
...
$obROrcamentoRecurso->listarRecursoSemConta($rsLista);
$obLista = new Lista;
...
$obChkCriarConta->setName ('boCriarConta_[cod_recurso]_');
