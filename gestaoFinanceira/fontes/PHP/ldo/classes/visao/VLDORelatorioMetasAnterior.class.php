...
<?php
/**
 * Classe Visao do 02.10.08 - Emitir Metas Anteriores
 ...
 * @subpackage LDO
 * @uc 02.10.08 - Emitir Metas Anterior
 */

include_once CAM_GF_LDO_VISAO . 'VLDORelatorio.class.php';

class VLDORelatorioMetasAnterior extends VLDORelatorio implements IVLDORelatorio
{
    ...
    public function emitir(array $arParametros)
    {
        ...
        $pgProg = "PRRelatorioMetasAnterior.php?stAcao=gerar";
