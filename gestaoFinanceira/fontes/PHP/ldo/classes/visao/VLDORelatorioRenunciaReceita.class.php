...
<?php
/**
 * Classe Visao do Relatório Estimativa e Compensação da Renúncia de Receita
 ...
 * @subpackage LDO
 * @uc 02.10.17 - Estimativa e Compensação da Renúncia de Receita
 */
include_once CAM_GF_LDO_VISAO . 'VLDORelatorio.class.php';

class VLDORelatorioRenunciaReceita extends VLDORelatorio implements IVLDORelatorio
{
    ...
    public function emitir(array $arParametros)
    {
        ...
        $pgProc  = 'PRRelatorioRenunciaReceita.php?stAcao=gerar';
    ...
    {
        $obPreview = new PreviewBirt(2, 44, 6);
