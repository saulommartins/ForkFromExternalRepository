...
class TLDORiscoFiscal extends Persistente
{
    /**
     * Método construtor
     * @access private
    ...
    {
        parent::Persistente();
        $this->setTabela('ldo.risco_fiscal');
        $this->setCampoCod('cod_risco_fiscal');
        $this->addCampo('cod_risco_fiscal', 'integer',   true,  '',    true,  false);
