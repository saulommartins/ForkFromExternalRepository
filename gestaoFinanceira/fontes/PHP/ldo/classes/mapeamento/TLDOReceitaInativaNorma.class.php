...
<?php
/**
 * Pagina de MAPEAMENTO Receita_inativo_norma tipo do uc-02.10.04
...
class TLDOReceitaInativaNorma extends Persistente
{
    ...
    {
        parent::Persistente();
        $this->setTabela('ldo.receita_inativa_norma');
