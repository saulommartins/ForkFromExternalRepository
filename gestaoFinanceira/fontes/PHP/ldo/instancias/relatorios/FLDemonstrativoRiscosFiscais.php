...
<?php
/**
 * Página de filtro Demonstrativo de Riscos Fiscais e Providências
 ...
 * @package GF
 * @subpackage LDO
 * @uc uc-02.10.15 - Demonstrativo de Riscos Fiscais e Providências
 */
...
$pgProc = 'PRRelatorioRiscosFiscais.php';
