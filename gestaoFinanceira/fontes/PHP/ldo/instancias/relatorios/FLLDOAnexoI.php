...
$obForm = new Form;
$obForm->setAction('OCGeraRelatorioLDOAnexoI.php');
...
$obITextBoxSelectPPA->obSelect->obEvento->setOnChange("montaParametrosGET('preencheLDOHomologado');");
$obITextBoxSelectPPA->obTextBox->obEvento->setOnChange("montaParametrosGET('preencheLDOHomologado');");
...
//Instancia um radio para a exibicao de nao orcamentarias
$obRdExibeSim = new Radio();
$obRdExibeSim->setId     ('boExibeNaoOrcamentariaSim');
$obRdExibeSim->setName   ('boExibeNaoOrcamentaria');
$obRdExibeSim->setLabel  ('Sim');
$obRdExibeSim->setRotulo ('Demonstrar Não Orçamentárias');
$obRdExibeSim->setValue  (1);

$obRdExibeNao = new Radio();
$obRdExibeNao->setId     ('boExibeNaoOrcamentariaNao');
$obRdExibeNao->setName   ('boExibeNaoOrcamentaria');
$obRdExibeNao->setLabel  ('Não');
$obRdExibeNao->setRotulo ('Demonstrar Não Orçamentárias');
$obRdExibeNao->setValue  (0);
$obRdExibeNao->setChecked(true);
...
$obFormulario->agrupaComponentes(array($obRdExibeSim,$obRdExibeNao));
