...
include CAM_GF_LDO_NEGOCIO.'RLDOManterConfiguracao.class.php';
include CAM_GF_LDO_VISAO.'VLDOManterConfiguracao.class.php';

$obVisao = VLDOManterConfiguracao::recuperarInstancia();
