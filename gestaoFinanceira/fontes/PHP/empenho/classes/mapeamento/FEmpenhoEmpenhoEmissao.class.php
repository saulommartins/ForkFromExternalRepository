...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_EMISSAO
...
/*
$Log$
Revision 1.8  2006/09/26 17:58:23  tonismar
...
class FEmpenhoEmpenhoEmissao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoEmissao()
{
    parent::Persistente();
    $this->setTabela('EmpenhoEmissao');
