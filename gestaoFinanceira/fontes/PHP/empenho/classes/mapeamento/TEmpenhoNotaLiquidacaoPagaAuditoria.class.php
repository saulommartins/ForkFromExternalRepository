...
<?php
/**
    * Classe de mapeamento da tabela EMPENHO.NOTA_LIQUIDACAO_PAGA_AUDITORIA
...
class TEmpenhoNotaLiquidacaoPagaAuditoria extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TEmpenhoNotaLiquidacaoPagaAuditoria()
{
    parent::Persistente();
    $this->setTabela('empenho.nota_liquidacao_paga_auditoria');
