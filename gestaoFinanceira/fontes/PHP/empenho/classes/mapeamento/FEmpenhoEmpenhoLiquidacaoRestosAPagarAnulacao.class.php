...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_LIQUIDACAO_RESTOAS_A_PAGAR_ANULACAO
...
class FEmpenhoEmpenhoLiquidacaoRestosAPagarAnulacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoLiquidacaoRestosAPagarAnulacao()
{
    parent::Persistente();
    $this->setTabela('EmpenhoAnulacaoLiquidacaoRestosAPagar');
    ...
    $this->AddCampo('exerc_liquidacao'       ,'varchar',false,''    ,false,false);
}
...
function montaExecutaFuncao()
{
    ...
    $stSql .= "                        '".$this->getDado("exerc_liquidacao")        ."') \n";
    $stSql .= "                         as sequencia                                     \n";
...
{
    $stSql  = " SELECT  \n";
    $stSql .= " EmpenhoAnulacaoLiquidacaoRestosAPagarTCEMS('".$this->getDado("exercicio")   ."', \n";
    $stSql .= "                         ".$this->getDado("valor")                           ." , \n";
    $stSql .= "                        '".$this->getDado("complemento")                     ."', \n";
    $stSql .= "                         ".$this->getDado('cod_lote')                        ." , \n";
    $stSql .= "                        '".$this->getDado("tipo_lote")                       ."', \n";
