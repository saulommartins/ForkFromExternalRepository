...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_PAGAMENTO_RESTOS_A_PAGAR_ANULACAO
...
class FEmpenhoEmpenhoPagamentoRestosAPagarAnulacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoPagamentoRestosAPagarAnulacao()
{
    parent::Persistente();
    $this->setTabela('EmpenhoAnulacaoPagamentoRPLiquidado');
    ...
    $this->AddCampo('conta_pg'               ,'varchar',false,''    ,false,false);
...
{
    $stSql  = " SELECT  \n";
    $stSql .= " EmpenhoAnulacaoPagamentoRPLiquidadoTCEMS('".$this->getDado("exercicio") ."', \n";
    $stSql .= "                         ".$this->getDado("valor")                       ." , \n";
    $stSql .= "                        '".$this->getDado("complemento")                 ."', \n";
    $stSql .= "                         ".$this->getDado('cod_lote')                    ." , \n";
    $stSql .= "                        '".$this->getDado("tipo_lote")                   ."', \n";
