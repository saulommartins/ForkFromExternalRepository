...
<?php
/**
    * Classe de mapeamento da tabela EMPENHO.HISTORICO_EMPENHO
...
/**
  * Efetua conexão com a tabela  EMPENHO.HISTORICO_EMPENHO
  * Data de Criação: 30/11/2004
  ...
  * @subpackage Mapeamento
*/
class TEmpenhoHistoricoEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TEmpenhoHistoricoEmpenho()
{
    parent::Persistente();
    $this->setTabela('empenho.historico');
