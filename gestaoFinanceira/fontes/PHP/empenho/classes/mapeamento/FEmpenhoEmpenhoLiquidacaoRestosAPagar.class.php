...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_LIQUIDACAO_RESTOS_A_PAGAR
...
class FEmpenhoEmpenhoLiquidacaoRestosAPagar extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoLiquidacaoRestosAPagar()
{
    parent::Persistente();
    $this->setTabela('EmpenhoLiquidacaoRestosAPagar');
...
{
    $stSql  = " SELECT  \n";
    $stSql .= " EmpenhoLiquidacaoRestosAPagarTCEMS('".$this->getDado("exercicio")   ."', \n";
    $stSql .= "                         ".$this->getDado("valor")                   ." , \n";
    $stSql .= "                        '".$this->getDado("complemento")             ."', \n";
    $stSql .= "                         ".$this->getDado('cod_lote')                ." , \n";
    $stSql .= "                        '".$this->getDado("tipo_lote")               ."', \n";
