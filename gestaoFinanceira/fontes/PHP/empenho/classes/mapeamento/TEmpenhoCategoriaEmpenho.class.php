...
<?php
/**
  * Classe de mapeamento da tabela EMPENHO.CATEGORAI_EMPENHO
...
class TEmpenhoCategoriaEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TEmpenhoCategoriaEmpenho()
{
    parent::Persistente();
    $this->setTabela('empenho.categoria_empenho');
