...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_LIQUIDACAO_ANULACAO
...
class FEmpenhoEmpenhoLiquidacaoAnulacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoLiquidacaoAnulacao()
{
    parent::Persistente();
    $this->setTabela('EmpenhoAnulacaoLiquidacao');
    ...
    $this->AddCampo('conta_debito', 'integer', false, '', false, false);
    $this->AddCampo('conta_credito', 'integer', false, '', false, false);
}
