...
/**
  ...
  * @subpackage Mapeamento
*/
class TEmpenhoNotaLiquidacaoItem extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TEmpenhoNotaLiquidacaoItem()
{
    parent::Persistente();
    $this->setTabela('empenho.nota_liquidacao_item');
