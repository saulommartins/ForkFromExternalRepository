...
<?php
/**
    * Classe de mapeamento da tabela FN_EMPENHO_EMPENHO_PAGAMENTO
...
class FEmpenhoEmpenhoPagamento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FEmpenhoEmpenhoPagamento()
{
    parent::Persistente();
    $this->setTabela('EmpenhoPagamento');
    ...
    $this->AddCampo('cod_plano_debito'       ,'integer',false,''    ,false,false);
    $this->AddCampo('cod_plano_credito'      ,'integer',false,''    ,false,false);
...
/**
    * Executa funcao EmpenhoPagamento no banco de dados a partir do comando SQL montado no método montaExecutaFuncao.
    * @access Public
