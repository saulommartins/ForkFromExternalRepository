...
/**
$Log$
Revision 1.1  2007/08/10 13:35:36  luciano
movido de lugar
...
$stPrograma = "AnularAdiantamentosSubvencoes";

$pgFilt = "FLManterAdiantamentosSubvencoes.php";
$pgList = "LSManterAdiantamentosSubvencoes.php";
...
$stNomRecurso = $obRAutorizacao->obREmpenhoEmpenho->obROrcamentoDespesa->obROrcamentoRecurso->getNome();
if ($stNomRecurso != '') {
...
$obHdnDataPrestacaoContas = new hidden;
$obHdnDataPrestacaoContas->setName ( "stDtPrestacaoContas" );
$obHdnDataPrestacaoContas->setId   ( "stDtPrestacaoContas" );
...
$obLblDtPrestacaoContas->setName   ( "stDataPrestacaoContas"          );
$obLblDtPrestacaoContas->setId     ( "stDataPrestacaoContas"          );
...
/*
$obLblTotalPrestacaoContasAnular = new Label;
$obLblTotalPrestacaoContasAnular->setRotulo( "Total a Anular"         );
$obLblTotalPrestacaoContasAnular->setId    ( "flTotalPrestacaoContasAnular" );
$obLblTotalPrestacaoContasAnular->setValue ( "&nbsp;"                 );
*/
...
$obFormulario->addHidden    ( $obHdnDataPrestacaoContas                                                );
...
//$obFormulario->addComponente( $obLblTotalPrestacaoContasAnular                                         );
