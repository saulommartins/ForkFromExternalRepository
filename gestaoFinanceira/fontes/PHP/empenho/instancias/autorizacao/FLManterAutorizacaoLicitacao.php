...
<?php
/**
    * Página de Filtro de Autorizacao por licitação
    ...
    * @ignore
    ...
    $Name$
    $Author: bruce $
    $Date: 2007-07-24 16:24:28 -0300 (Ter, 24 Jul 2007) $
...
/*
$Log$
Revision 1.9  2007/07/24 19:24:28  bruce
Bug#9423#
...
Revision 1.7  2006/07/19 18:55:39  leandro.zis
Bug #6184#

Revision 1.6  2006/07/17 13:27:57  leandro.zis
Bug #6183#
...
if ($rsUltimoMesEncerrado->getCampo('mes') >= $mesAtual AND $boUtilizarEncerramentoMes == 'true') {
    ...
    include '../../../../../../gestaoPatrimonial/fontes/PHP/licitacao/instancias/autorizacao/FLManterAutorizacao.php';
}
