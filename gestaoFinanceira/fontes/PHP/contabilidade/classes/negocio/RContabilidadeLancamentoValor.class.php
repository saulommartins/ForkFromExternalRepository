...
<?php
    ...
    */
    ...
    class RContabilidadeLancamentoValor {
         ...
         * @access private
         */
        public $obRContabilidadeBoletin;
         ...
         * @param Object $valor
         */
        public function setRContabilidadeLancamento($valor) {
            $this->obRContabilidadeLancamento = $valor;
        }
         ...
         * @param Object $valor
         */
        public function setRContabilidadeBoletin($valor) {
            $this->obRContabilidadeBoletin = $valor;
        }
         ...
         * @param Integer $valor
         */
        public function setRContabilidadePlanoContaAnalitica($valor) {
            $this->obRContabilidadePlanoContaAnalitica = $valor;
        }
         ...
         * @param Integer $valor
         */
        public function setContaCredito($valor) {
            $this->inContaCredito = $valor;
        }
         ...
         * @param Integer $valor
         */
        public function setContaDebito($valor) {
            $this->inContaDebito = $valor;
        }
         ...
         * @param Integer $valor
         */
        public function setTipoValor($valor) {
            $this->stTipoValor = $valor;
        }
         ...
         * @param Array $valor
         */
        public function setImplantaSaldo($valor) {
            $this->arImplantaSaldo = $valor;
        }
         ...
         * @param Array $valor
         */
        public function setAberturaOrcamento($valor) {
            $this->arAberturaOrcamento = $valor;
        }
         ...
         * @param String $valor
         */
        public function setNomLogErros($valor) {
            $this->stNomLogErros = $valor;
        }
         ...
         * @param Object $valor
         */
        public function getRContabilidadeLancamento() {
            return $this->obRContabilidadeLancamento;
        }
         ...
         * @param Object $valor
         */
        public function getRContabilidadeBoletin() {
            return $this->obRContabilidadeBoletin;
        }
         ...
         * @param Object $valor
         */
        public function getRcontabilidadePlanoContaAnalitica() {
            return $this->obRContabilidadePlanoContaAnalitica;
        }
         ...
         * @param Array $valor
         */
        public function getImplantaSaldo() {
            return $this->arImplantaSaldo;
        }
         ...
         * @param Array $valor
         */
        public function getAberturaOrcamento() {
            return $this->arAberturaOrcamento;
        }
         ...
         * @return String
         */
        public function getNomLogErros() {
            return $this->stNomLogErros;
        }
        ...
        */
        public function RContabilidadeLancamentoValor()
        {
            ...
            $this->setRContabilidadeBoletin(false);
        }
        ...
        */
        ...
        public function incluirLancamentoValorRecurso($sequencia, $inCodRecurso, $vlRetencao)
        {
            ...
            $obTContabilidadeValorLancamentoRecurso->setDado('cod_lote'    , $this->obRContabilidadeLancamento->obRContabilidadeLote->getCodLote() );
            $obTContabilidadeValorLancamentoRecurso->setDado('tipo'        , $this->obRContabilidadeLancamento->obRContabilidadeLote->getTipo() );
            $obTContabilidadeValorLancamentoRecurso->setDado('sequencia'   , $sequencia );
            $obTContabilidadeValorLancamentoRecurso->setDado('exercicio'   , $this->obRContabilidadeLancamento->obRContabilidadeLote->getExercicio() );
            // $obTContabilidadeValorLancamentoRecurso->setDado('tipo_valor'  , 'T' );
            $obTContabilidadeValorLancamentoRecurso->setDado('cod_entidade', $this->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->getCodigoEntidade() );
            $obTContabilidadeValorLancamentoRecurso->setDado('cod_recurso' , $inCodRecurso );
            $obTContabilidadeValorLancamentoRecurso->setDado('vl_recurso'  , $vlRetencao );

            $obTContabilidadeValorLancamentoRecurso->inclusao( $boTransacao );
        }
            ...
            if ( !$obErro->ocorreu() ) {
                if ( $stAno[2] ==  $this->obRContabilidadeLancamento->obRContabilidadeLote->getExercicio() ) {
                    ...
                    if ( !$obErro->ocorreu() ) {
                        ...
                        $obTContabilidadeLancamentoValor->setDado(
                            "cod_entidade",
                            $this->obRContabilidadeLancamento->obRContabilidadeLote->obROrcamentoEntidade->getCodigoEntidade()
                        );
