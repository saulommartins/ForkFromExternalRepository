...
<?php
/**
    * Classe de mapeamento da tabela CONTABILIDADE.POSICAO_PLANO
...
class TContabilidadePosicaoPlano extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadePosicaoPlano()
{
    parent::Persistente();
    $this->setTabela('contabilidade.posicao_plano');

    $this->setCampoCod('');
    $this->setComplementoChave('exercicio,cod_posicao');
