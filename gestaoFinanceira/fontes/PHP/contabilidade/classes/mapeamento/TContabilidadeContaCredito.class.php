...
<?php
/**
    * Classe de mapeamento da tabela CONTABILIDADE.CONTA_CREDITO
...
/**
  * Efetua conexão com a tabela  CONTABILIDADE.CONTA_CREDITO
  * Data de Criação: 01/11/2004
  ...
  * @subpackage Mapeamento
*/
class TContabilidadeContaCredito extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadeContaCredito()
{
    parent::Persistente();
    $this->setTabela('contabilidade.conta_credito');
