...
class TContabilidadePlanoContaTCEMS extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadePlanoContaTCEMS()
{
    parent::Persistente();
...
function montaRecuperaDadosExportacaoBalVerificacao()
{
    ...
    $stSQL  .= "                    replace(vl_saldo_anterior,'-','')                                                                                                                                    \n";
    $stSQL  .= "                 ELSE                                                                                                                                                    \n";
    $stSQL  .= "                    '0'                                                                                                                                                  \n";
    ...
    $stSQL  .= "             escrituracao        VARCHAR,                                                                                                                                \n";
    $stSQL  .= "             indicador_superavit VARCHAR)                                                                                                                                \n";
...
$stSQL .="         WHERE                                                                                                \n";
$stSQL .="                 pc.cod_estrutural like '".$this->getDado('stCodEstrutural')."%'                              \n";
