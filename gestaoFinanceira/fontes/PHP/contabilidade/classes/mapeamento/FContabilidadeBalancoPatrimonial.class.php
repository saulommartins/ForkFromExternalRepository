...
class FContabilidadeBalancoPatrimonial extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FContabilidadeBalancoPatrimonial()
{
    parent::Persistente();
    $this->setTabela('contabilidade.fn_rl_balanco_patrimonial');
    ...
    $this->AddCampo('nom_sistema'       ,'varchar',false,''    ,false,false);
