...
<?php
/**
    * Classe de mapeamento da tabela CONTABILIDADE.CONTA_DEBITO
...
/**
  * Efetua conexão com a tabela  CONTABILIDADE.CONTA_DEBITO
  * Data de Criação: 01/11/2004
  ...
  * @subpackage Mapeamento
*/
class TContabilidadeContaDebito extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadeContaDebito()
{
    parent::Persistente();
    $this->setTabela('contabilidade.conta_debito');
