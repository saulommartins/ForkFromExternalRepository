...
<?php
/**
    * Classe de mapeamento da tabela CONTABILIDADE.EMPENHAMENTO
...
class TContabilidadeEmpenhamento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadeEmpenhamento()
{
    parent::Persistente();
    $this->setTabela('contabilidade.empenhamento');
    ...
    $this->AddCampo('cod_empenho','integer',true,'',false,false);
    $this->AddCampo('exercicio_empenho','char',true,'04',false,false);
