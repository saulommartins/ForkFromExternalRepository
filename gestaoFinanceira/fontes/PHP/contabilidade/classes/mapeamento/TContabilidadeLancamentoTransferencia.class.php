...
<?php
/**
    * Classe de mapeamento da tabela CONTABILIDADE.LANCAMENTO_TRANSFERENCIA
...
class TContabilidadeLancamentoTransferencia extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TContabilidadeLancamentoTransferencia()
{
    parent::Persistente();
    $this->setTabela('contabilidade.lancamento_transferencia');
