...
/**
    ...
    * utilizada no relatorio de Demonstração Receita e Despesa Extra-Orçamentária
...
class FContabilidadeDemoRecDespExtraOrcamento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FContabilidadeDemoRecDespExtraOrcamento()
{
    parent::Persistente();
...
function montaRecuperaTodos()
{
    ...
    $stSql .= "                )                                                                            \n";
    $stSql .= " WHERE   retorno.nivel <= 5                                                                  \n";
    $stSql .= "     AND ( substr(cod_estrutural,1,5)='1.1.2' or substr(cod_estrutural,1,3)='2.1')           \n";
