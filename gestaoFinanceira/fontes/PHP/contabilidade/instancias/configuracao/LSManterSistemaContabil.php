...
<?php
/**
    * Página de Listagem Sistema Contábil
...
if ($_REQUEST['inCodSistema'] or $_REQUEST['stNomSistema']) {
...
$stLink .= '&inCodSistema='.$_REQUEST['inCodSistema'];
...
$obLista->ultimoDado->setCampo( "cod_sistema" );
$obLista->commitDado();
$obLista->addDado();
$obLista->ultimoDado->setCampo( "nom_sistema" );
$obLista->commitDado();
$obLista->addAcao();
$obLista->ultimaAcao->setAcao( $stAcao );

$obLista->ultimaAcao->addCampo("&inCodSistema"  ,"cod_sistema");
$obLista->ultimaAcao->addCampo("&stNomSistema"  ,"nom_sistema");
$obLista->ultimaAcao->addCampo("&stExercicio"   ,"exercicio");
$obLista->ultimaAcao->addCampo("&stDescQuestao" ,"[cod_sistema] - [nom_sistema]");
