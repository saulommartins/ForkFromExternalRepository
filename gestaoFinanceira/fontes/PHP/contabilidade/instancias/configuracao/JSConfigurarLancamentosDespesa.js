...
function selecionaDespesa( inputCheck ) {
    ...
    executaFuncaoAjax("montaLancamentoDespesa", "&cod_conta_despesa=" + inputCheck.value );
}

function carregaContasLancamento( tipoLancamento, valorRadio ) {
    executaFuncaoAjax( tipoLancamento, "&cod_despesa=" + jQuery('#codDespesaLista').val() + "&valor_radio=" + valorRadio );
}
</script>