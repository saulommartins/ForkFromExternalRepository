...
/**
    ...
    * @ignore
    ...
    $Id: OCGeraRelatorioAnexo16.php 59612 2014-09-02 12:00:51Z gelson $
...
$obPDF->setAcao             ( "Anexo 16 - Demonstrativo Dívida Fundada Interna" );
...
$obPDF->addCabecalho   ( "SALDO DO EXERCÍCIO ANTERIOR"   ,12, 10);
$obPDF->addCabecalho   ( "DÉBITOS"          ,12, 10);
$obPDF->addCabecalho   ( "CRÉDITOS"         ,12, 10);
$obPDF->addCabecalho   ( "SALDO PARA O EXERCÍCIO SEGUINTE"      ,12, 10);
