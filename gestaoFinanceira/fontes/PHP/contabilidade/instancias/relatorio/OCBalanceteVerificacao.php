...
/**
    ...
    * $Id: OCBalanceteVerificacao.php 59612 2014-09-02 12:00:51Z gelson $
...
$obRContabilidadeRelatorioBalanceteVerificacao                             = new RContabilidadeRelatorioBalanceteVerificacao;
...
$obRContabilidadeRelatorioBalanceteVerificacao->setFiltro     ( $stFiltro );
$obRContabilidadeRelatorioBalanceteVerificacao->setExercicio  ( Sessao::getExercicio() );
$obRContabilidadeRelatorioBalanceteVerificacao->setDtInicial  ( $arFiltro['stDataInicial'] );
$obRContabilidadeRelatorioBalanceteVerificacao->setDtFinal    ( $arFiltro['stDataFinal']   );
$obRContabilidadeRelatorioBalanceteVerificacao->setEstilo     ( $arFiltro['stEstiloConta'] );
$obRContabilidadeRelatorioBalanceteVerificacao->geraRecordSet( $rsRecordSet );
