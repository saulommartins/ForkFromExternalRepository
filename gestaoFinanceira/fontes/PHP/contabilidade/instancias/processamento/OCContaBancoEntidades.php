...
* $Id: OCContaBancoEntidades.php 59612 2014-09-02 12:00:51Z gelson $
...
function buscaPopup()
{
   ...
   if ($_GET[$_GET['stNomCampoCod']]) {
        ...
        if ($codAgencia <> "") {
           if($_GET[$_GET['stNomSelectMultiplo']] AND (array_search ($obRContabilidadePlanoContaBanco->obROrcamentoEntidade->getCodigoEntidade(), $_GET[$_GET['stNomSelectMultiplo']]) === false))
