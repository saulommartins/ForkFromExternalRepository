...
class TLRFTCERSContaDespesaModeloLRF extends Persistente
{
    public function TLRFTCERSContaDespesaModeloLRF()
    {
        parent::Persistente();
        $this->setTabela(LRFTCERS_CONTA_DESPESA_MODELO_LRF);
