...
class TLRFTCERSAjusteContaReceitaModeloLRF extends Persistente
{
    public function TLRFTCERSAjusteContaReceitaModeloLRF()
    {
        parent::Persistente();
        $this->setTabela(LRFTCERS_AJUSTE_CONTA_RECEITA_MODELO_LRF);
