...
class TLRFTCERSAjusteContaDespesaModeloLRF extends Persistente
{
    public function TLRFTCERSAjusteContaDespesaModeloLRF()
    {
        parent::Persistente();
        $this->setTabela(LRFTCERS_AJUSTE_CONTA_DESPESA_MODELO_LRF);
