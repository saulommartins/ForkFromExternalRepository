...
<?php
/**
* Oculto para modelo 11 do modulo LRF
...
* Casos de uso: uc-02.05.13, uc-02.01.35
*/
...
$obRegra      = new RLRFRelatorioModelos7;
...
$obPDF->addCabecalho("Modelo 11 - Demonstrativo dos Restos a Pagar", 100, 12 );
$obPDF->addCampo( '', 8 );
...
$obPDF->setAlturaCabecalho( 8 );
$obPDF->setAlinhamento ( "C" );
$obPDF->addCabecalho('LC Federal nº 101/2000, art. 54 e alínea "b" do inciso 55', 100, 12 );
$obPDF->addCampo( '', 8 );
