...
include_once ( CAM_GF_EXP_NEGOCIO."RExportacaoTCERSUniOrcam.class.php"  	    );

class RExportacaoTCERSArqUniOrcam
{
var $arUniOrcam;
var $roUltimaUniOrcam;
var $obRExportacaoTCERSUniOrcam;
var $obTransacao;

//SETTERS
function setUniOrcam($valor) { $this->arUniOrcam = $valor;         }
function setUltimaUniOrcam($valor) { $this->roUltimaUniOrcam = $valor;   }
function setExportacaoTCERSUniOrcam($valor) { $this->obRExportacaoTCERSUniOrcam = $valor;   }
...
/**
     ...
     * @access Private
*/
function RExportacaoTCERSArqUniOrcam()
{
