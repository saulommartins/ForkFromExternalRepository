...
<?php
/**
    * Classe de mapeamento da tabela FN_EXPORTACAO_UNIDADE_ORCAMENTARIA
...
class FExportacaoUnidadeOrcamentaria extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FExportacaoUnidadeOrcamentaria()
{
    parent::Persistente();
    $this->setTabela('tcerj.fn_exportacao_unidorca');
    $this->AddCampo('exercicio'            ,'character(4)'           ,false,'',false,false);
    $this->AddCampo('num_unidade'          ,'integer'                ,false,'',false,false);
    $this->AddCampo('nom_unidade'          ,'character varying(60)'  ,false,'',false,false);
...
function montaRecuperaDadosExportacao()
{
    ...
    $stSql .= "          nom_unidade          character varying(60),            \n";
