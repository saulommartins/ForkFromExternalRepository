...
<?php
/**
    * Classe de mapeamento da tabela FN_EXPORTACAO_PROGRAMA
...
class FExportacaoPrograma extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FExportacaoPrograma()
{
    parent::Persistente();
    $this->setTabela('tcerj.fn_exportacao_programa');
    $this->AddCampo('cod_programa'         ,'integer'                ,false,'',false,false);
    $this->AddCampo('descricao'            ,'character varying(80)'  ,false,'',false,false);
...
function montaRecuperaDadosExportacao()
{
    ...
    $stSql .= "          descricao            character varying(80),            \n";
