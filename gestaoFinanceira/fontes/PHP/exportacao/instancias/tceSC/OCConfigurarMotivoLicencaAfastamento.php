...
function configuracoesIniciais()
{
    ...
    foreach ($rsMotivosLicencas->arElementos as $item) {
            $sessao->transf['configuracoesMotivosLicencas'][$inId]['inId'] = $inId;
            $sessao->transf['configuracoesMotivosLicencas'][$inId]['inMotivoLicensaEsfinge'] = $item['cod_motivo_licenca_esfinge'];
            $sessao->transf['configuracoesMotivosLicencas'][$inId]['stMotivoLicensaEsfinge'] = $item['descricao_motivo_esfinge'];
            $sessao->transf['configuracoesMotivosLicencas'][$inId]['inMotivoLicensaUrbem'] = $item['cod_assentamento'];
            $sessao->transf['configuracoesMotivosLicencas'][$inId]['stMotivoLicensaUrbem'] = $item['descricao_motivo_urbem'];
            $inId++;
        }
    }
}
...
function montaSpnListaMotivosLicencas()
{
    ...
    $rsConfiguracoesMotivosLicencas->preenche( $sessao->transf['configuracoesMotivosLicencas'] );
...
function incluirConfiguracaoMotivosLicencas()
{
    ...
    if ($boValida) {
        ...
        $inId = count( $sessao->transf['configuracoesMotivosLicencas'] );

        $sessao->transf['configuracoesMotivosLicencas'][$inId]['inId']                   = $inId;
        $sessao->transf['configuracoesMotivosLicencas'][$inId]['inMotivoLicensaEsfinge'] = $_GET['inMotivoLicensaEsfinge'];
        $sessao->transf['configuracoesMotivosLicencas'][$inId]['stMotivoLicensaEsfinge'] = trim($stMotivoLicencaEsfinge);
        $sessao->transf['configuracoesMotivosLicencas'][$inId]['inMotivoLicensaUrbem'] = $_GET['inMotivoLicensaUrbem'];
        $sessao->transf['configuracoesMotivosLicencas'][$inId]['stMotivoLicensaUrbem'] = trim($stMotivoLicencaoUrbem);
...
function excluirConfiguracaoMotivosLicencas($inIdExcluir)
{
    ...
    unset( $sessao->transf['configuracoesMotivosLicencas'] );
    $sessao->transf['configuracoesMotivosLicencas'] = $arNovoMotivoLicenca;
    unset( $arNovoMotivoLicenca );
