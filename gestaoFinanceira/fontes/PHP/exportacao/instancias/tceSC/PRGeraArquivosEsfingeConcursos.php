...
function geraArquivosConcursos(&$obExportador , $stDataInicial, $stDataFinal)
{
    ...
    include_once( CAM_GRH_CON_MAPEAMENTO."TConcursoConcurso.class.php"  );

    $obTConcursoConcurso = new TConcursoConcurso;
    $obTConcursoConcurso->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTConcursoConcurso->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
