...
/**
    ...
    * @ignore
    ...
    $Date: 2007-04-26 12:26:49 -0300 (Qui, 26 Abr 2007) $
...
function geraArquivosLicitacoes(&$obExportador, $stDataInicial, $stDataFinal)
{
    ...
    $obTLicitacaoLicitacao->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTLicitacaoLicitacao->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== CONVIDADO LICITACÃO ========
    ...
    $obTLicitacaoParticipante->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTLicitacaoParticipante->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== CERTIDÃO PARTICIPANTE ========
    ...
    $obTLicitacaoParticipanteDocumentos->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTLicitacaoParticipanteDocumentos->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== COTACAO ========
    ...
    $obTComprasCotacaoFornecedorItem->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTComprasCotacaoFornecedorItem->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== COMISSÃO LICITACÃO ========
    ...
    $obTLicitacaoComissaoLicitacao->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTLicitacaoComissaoLicitacao->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== MEMBRO COMISSAO LICITACAO ========
    ...
    $obTLicitacaoComissaoMembros->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTLicitacaoComissaoMembros->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
...
//======== BLOQUEIO ORÇAMENTÁRIO ========
    ...
    $obTOrcamentoReservaSaldos->setDado( "exercicio", $sessao->filtro['stExercicio'] );
    $obTOrcamentoReservaSaldos->setDado( "cod_entidade", implode(",", $sessao->filtro['inCodEntidade'] ) );
