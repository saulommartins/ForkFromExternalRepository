...
/**
    ...
    * @ignore
    ...
    $Date: 2007-01-24 16:41:34 -0200 (Qua, 24 Jan 2007) $
...
function geraArquivosLoa(&$obExportador, $stDataInicial, $stDataFinal)
{
...
//======== PREVISAO RECEITA ========
    ...
    $obTOrcamentoReceita->recuperaPrevisaoReceita( $rsPrevisaoReceita );
    unset( $obTOrcamentoReceita );

    $obExportador->addArquivo("PrevisaoReceita.txt");
    $obExportador->roUltimoArquivo->addBloco($rsPrevisaoReceita);
...
//======== PROJETO ATIVIDADE ========
    ...
    $obTOrcamentoDespesa->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTOrcamentoDespesa->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    $obTOrcamentoDespesa->recuperaProjetoAtividade( $rsProjetoAtividade );
    $rsProjetoAtividade->addFormatacao( 'nom_pao', 'SEM_ASPAS' );
    unset($obTOrcamentoDespesa);

    $obExportador->addArquivo("ProjetoAtividade.txt");
    $obExportador->roUltimoArquivo->addBloco( $rsProjetoAtividade );
...
//======== UNIDADE ORCAMENTARIA ========
    ...
    $obTOrcamentoUnidade->setDado( 'exercicio', $sessao->filtro['stExercicio'] );
    $obTOrcamentoUnidade->recuperaUnidadeOrcamentaria( $rsUnidadeOrcamentaria );
    $rsUnidadeOrcamentaria->addFormatacao( 'nom_unidade', 'SEM_ASPAS' );
    unset($obTOrcamentoUnidade);

    $obExportador->addArquivo("UnidadeOrcamentaria.txt");
    $obExportador->roUltimoArquivo->addBloco( $rsUnidadeOrcamentaria );
...
//======== FONTE RECURSOS DE DOTACAO ========
    $obTOrcamentoDespesa = new TOrcamentoDespesa;
    $obTOrcamentoDespesa->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTOrcamentoDespesa->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    $obTOrcamentoDespesa->recuperaFonteRecursosDotacao( $rsFonteRecursosDotacao );
    $rsProjetoAtividade->addFormatacao( 'nom_pao', 'SEM_ASPAS' );
    unset($obTOrcamentoDespesa);

    $obExportador->addArquivo("FonteRecurso.txt");
    $obExportador->roUltimoArquivo->addBloco( $rsFonteRecursosDotacao );

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna('exercicio');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado('NUMERICO_ZEROS_ESQ');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(4);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna('tipo_dotacao');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado('NUMERICO_ZEROS_ESQ');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
...
//======== ALTERAÇÃO ORÇAMENTÁRIA ========
    ...
    $obTOrcamentoSuplementacao->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTOrcamentoSuplementacao->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );;
    $obTOrcamentoSuplementacao->setDado( 'dt_inicial'  , $stDataInicial );
    $obTOrcamentoSuplementacao->setDado( 'dt_final'    , $stDataFinal );
    $obTOrcamentoSuplementacao->recuperaAlteracaoOrcamentaria( $rsAlteracaoOrcamentaria );

    $obExportador->addArquivo("AlteracaoOrcamentaria.txt");
    $obExportador->roUltimoArquivo->addBloco( $rsAlteracaoOrcamentaria );
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna('tipo_texto_juridico');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado('NUMERICO_ZEROS_ESQ');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna('modalidade_da_aplicacao');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado('NUMERICO_ZEROS_ESQ');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
...
//======== FONTE DE RECURSOS DE CRÉDITO ADICIONAL ========
    $obTOrcamentoSuplementacao->recuperaAlteracaoOrcamentaria( $rsFonteRecursosCreditoAdicional );
    unset( $obTOrcamentoSuplementacao );

    $obExportador->addArquivo("FonteRecursosCreditoAdicional.txt");
    $obExportador->roUltimoArquivo->addBloco( $rsFonteRecursosCreditoAdicional );
