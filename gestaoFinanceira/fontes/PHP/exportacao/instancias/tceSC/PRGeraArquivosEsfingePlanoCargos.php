...
function geraArquivosPlanoCargos(&$obExportador , $stDataInicial, $stDataFinal)
{
    ...
    $obTPessoalCargo->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTPessoalCargo->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    $obTPessoalCargo->setDado( 'dt_inicial'  , $stDataInicial );
    $obTPessoalCargo->setDado( 'dt_final'  , $stDataFinal );
    $obTPessoalCargo->recuperaAtualizacaoCargoEsfinge( $rsAtualizacaoCargo );
    for ($i=0;$i<count($rsAtualizacaoCargo->arElementos);$i++) {
       if ($rsAtualizacaoCargo->arElementos[$i]['diff_vagas'] > 0) {
          $rsAtualizacaoCargo->arElementos[$i]['aumento_vagas'] = $rsAtualizacaoCargo->arElementos[$i]['diff_vagas'];
          $rsAtualizacaoCargo->arElementos[$i]['reducao_vagas'] = 0;
       } else {
          $rsAtualizacaoCargo->arElementos[$i]['aumento_vagas'] = 0;
          $rsAtualizacaoCargo->arElementos[$i]['reducao_vagas'] = -$rsAtualizacaoCargo->arElementos[$i]['diff_vagas'];
       }
       if ($rsAtualizacaoCargo->arElementos[$i]['diff_vagas_ocupadas'] > 0) {
          $rsAtualizacaoCargo->arElementos[$i]['aumento_vagas_ocupadas'] = $rsAtualizacaoCargo->arElementos[$i]['diff_vagas_ocupadas'];
          $rsAtualizacaoCargo->arElementos[$i]['reducao_vagas_ocupadas'] = 0;
       } else {
          $rsAtualizacaoCargo->arElementos[$i]['aumento_vagas_ocupadas'] = 0;
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nro_vaga_criada");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("aumento_vagas");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("reducao_vagas");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nro_vagas_ocupadas");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("aumento_vagas_ocupadas");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("reducao_vagas_ocupadas");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);
    ...
    $obTFlolhaPagamentoPadrao = new TFolhaPagamentoPadrao;
    $obTFlolhaPagamentoPadrao->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTFlolhaPagamentoPadrao->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    ...
    $obTFlolhaPagamentoPadrao->setDado( 'dt_inicial'  , $stDataInicial );
    $obTFlolhaPagamentoPadrao->setDado( 'dt_final'  , $stDataFinal );
    $obTFlolhaPagamentoPadrao->recuperaVencimentoCargoEsfinge( $rsVencimentoCargo);

    $obExportador->addArquivo("vencimentocargo.txt");
    $obExportador->roUltimoArquivo->addBloco($rsVencimentoCargo);
