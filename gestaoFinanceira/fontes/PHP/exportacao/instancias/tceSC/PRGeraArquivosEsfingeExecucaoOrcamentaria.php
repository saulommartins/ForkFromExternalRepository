...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: leandro.zis $
    $Date: 2007-10-05 10:52:21 -0300 (Sex, 05 Out 2007) $
...
function geraArquivosExecOrcamentaria(&$obExportador , $stDataInicial, $stDataFinal)
{
    ...
    $obTEmpenhoEmpenho->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTEmpenhoEmpenho->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    ...
    $obTEmpenhoEmpenhoAnulado->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTEmpenhoEmpenhoAnulado->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
    ...
    $obTEmpenhoNotaLiquidacao->setDado( 'exercicio'   , $sessao->filtro['stExercicio'] );
    $obTEmpenhoNotaLiquidacao->setDado( 'cod_entidade', implode(",", $sessao->filtro['inCodEntidade'] ) );
