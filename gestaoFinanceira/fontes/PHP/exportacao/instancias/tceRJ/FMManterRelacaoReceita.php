...
<?php
/**
    * Página de Formulario dos Parâmetros do Arquivo de Relacionamento das Receitas
...
SistemaLegado::executaFramePrincipal( "buscaDado('MontaListaRelacionamentoReceitas');" );
...
$obSpnRelacionamentoReceitas = new Span;
$obSpnRelacionamentoReceitas->setId ( "spnRelacionamentoReceitas" );
...
$obFormulario->addSpan  ( $obSpnRelacionamentoReceitas        );
