...
$sessao->prefeitura["cnpj"]         = substr($_REQUEST["stCnpjSetor"],0,14);
$sessao->prefeitura["prefeitura"]   = substr($_REQUEST["stCnpjSetor"],15,strlen($_REQUEST["stCnpjSetor"])-1);
