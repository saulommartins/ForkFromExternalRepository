...
IF Restos = \\''\\''Executivo\\''\\'' THEN
    ...
    IF     ExercRP  =  2011 THEN
        Sequencia := FazerLancamento( \\''\\''212160202021800\\''\\'' , \\''\\''212110200021700\\''\\'' , 916 , Exercicio , Valor , Complemento , CodLote , TipoLote , CodEntidade ); 
    END IF;
END IF;
IF Restos = \\''\\''Legislativo\\''\\'' THEN
    ...
    END IF;
    IF   ExercRP  =  2011 THEN
        Sequencia := FazerLancamento( \\''\\''212160202031800\\''\\'' , \\''\\''212110200031700\\''\\'' , 916 , Exercicio , Valor , Complemento , CodLote , TipoLote , CodEntidade ); 
    END IF;
END IF;
IF Restos = \\''\\''RPPS\\''\\'' THEN
    IF ExercRP = 1994 THEN
    ...
    END IF;
    IF   ExercRP  =  2011 THEN
        Sequencia := FazerLancamento( \\''\\''212160202041800\\''\\'' , \\''\\''212110200041700\\''\\'' , 916 , Exercicio , Valor , Complemento , CodLote , TipoLote , CodEntidade ); 
    END IF;
END IF;
RETURN Sequencia;
END;
