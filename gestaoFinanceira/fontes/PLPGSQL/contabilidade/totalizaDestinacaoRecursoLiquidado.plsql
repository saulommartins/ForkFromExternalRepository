...
*/
/*
 * PL para totalizar os valores liquidados por destinacao de recurso 
...
CREATE OR REPLACE FUNCTION contabilidade.totaliza_destinacao_recurso_liquidado(varchar,varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS '
DECLARE
