...
CREATE OR REPLACE FUNCTION "contabilidade"."fn_rl_balanco_patrimonial" (varchar, varchar, varchar, varchar, bpchar) RETURNS SETOF RECORD AS
'
DECLARE
...
BEGIN
    ...
    --Verifica estilo de relatorio (Analico ou Sintetico)
    IF chEstilo = ''S'' THEN
        stSql := '' SELECT
                         pc.cod_estrutural
