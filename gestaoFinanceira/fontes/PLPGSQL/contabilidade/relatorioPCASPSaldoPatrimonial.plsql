...
CREATE OR REPLACE FUNCTION contabilidade.pcasp_saldo_patrimonial(VARCHAR, VARCHAR, VARCHAR, VARCHAR, CHAR) RETURNS SETOF RECORD AS $$ 
DECLARE
...
BEGIN
    ...
    CREATE TEMPORARY TABLE tmp_patrimonial_1 AS
        SELECT * FROM tmp_lancamento WHERE cod_estrutural LIKE '1.0.0.0.0.00.00.%' OR
                                           cod_estrutural LIKE '3.0.0.0.0.00.00.%';
                                           
    CREATE TEMPORARY TABLE tmp_patrimonial_2 AS
        SELECT * FROM tmp_lancamento WHERE cod_estrutural LIKE '2.0.0.0.0.00.00.%' OR
                                           cod_estrutural LIKE '4.0.0.0.0.00.00.%';
                                           
    stSql := 'SELECT tmp_patrimonial_1.cod_estrutural AS estrutural_debito,
                     tmp_patrimonial_1.vl_saldo_atual AS saldo_debito,
                     tmp_patrimonial_2.cod_estrutural AS estrutural_credito,
                     tmp_patrimonial_2.vl_saldo_atual AS saldo_credito
                FROM tmp_patrimonial_1
                JOIN tmp_patrimonial_2
                  ON tmp_patrimonial_1.nivel = tmp_patrimonial_2.nivel
                 AND tmp_patrimonial_1.cod_sistema = tmp_patrimonial_2.cod_sistema
               WHERE substr(tmp_patrimonial_1.cod_estrutural,1,1) = ''1''
                 AND substr(tmp_patrimonial_2.cod_estrutural,1,1) = ''2''
                 
              UNION
              
              SELECT tmp_patrimonial_1.cod_estrutural AS estrutural_debito,
                     tmp_patrimonial_1.vl_saldo_atual AS saldo_debito,
                     tmp_patrimonial_2.cod_estrutural AS estrutural_credito,
                     tmp_patrimonial_2.vl_saldo_atual AS saldo_credito
                FROM tmp_patrimonial_1
                JOIN tmp_patrimonial_2
                  ON tmp_patrimonial_1.nivel = tmp_patrimonial_2.nivel
                 AND tmp_patrimonial_1.cod_sistema = tmp_patrimonial_2.cod_sistema
               WHERE substr(tmp_patrimonial_1.cod_estrutural,1,1) = ''3''
                 AND substr(tmp_patrimonial_2.cod_estrutural,1,1) = ''4''';
                 
    CREATE TEMPORARY TABLE tmp_patrimonial (
    ...
    FOR reRegistro IN EXECUTE stSql
    LOOP
            INSERT INTO tmp_patrimonial (cod_estrutural_d, saldo_d, cod_estrutural_c, saldo_c)
                            VALUES (reRegistro.estrutural_debito, reRegistro.saldo_debito, reRegistro.estrutural_credito, reRegistro.saldo_credito);
    END LOOP;
    
    stSql := 'SELECT * FROM tmp_patrimonial';
    ...
    DROP TABLE tmp_patrimonial_1;
    DROP TABLE tmp_patrimonial_2;
   DROP TABLE tmp_patrimonial;
