...
CREATE OR REPLACE FUNCTION empenho.fn_exclui_lancamentos_liquidacao(varchar, varchar,varchar, varchar,varchar, varchar) RETURNS BOOLEAN AS $$
DECLARE
...
BEGIN
    ...
    stSql := '
        DELETE From contabilidade.liquidacao
         where contabilidade.lote.exercicio                   = '|| quote_literal(stExercicio)      ||'
           ...
           And contabilidade.lancamento_empenho.exercicio   = contabilidade.liquidacao.exercicio
           And contabilidade.lancamento_empenho.cod_lote    = contabilidade.liquidacao.cod_lote
           And contabilidade.lancamento_empenho.tipo        = contabilidade.liquidacao.tipo
           And contabilidade.lancamento_empenho.cod_entidade= contabilidade.liquidacao.cod_entidade
           And contabilidade.lancamento_empenho.sequencia   = contabilidade.liquidacao.sequencia

           And contabilidade.liquidacao.exercicio_liquidacao= empenho.nota_liquidacao.exercicio
           And contabilidade.liquidacao.cod_nota            = empenho.nota_liquidacao.cod_nota
           And contabilidade.liquidacao.cod_entidade        = empenho.nota_liquidacao.cod_entidade
           And contabilidade.liquidacao.cod_entidade        IN  ('|| stCodEntidades ||')
