...
* $Name$
* $Author: cako $
* $Date: 2006-12-06 09:30:05 -0200 (Qua, 06 Dez 2006) $
*
...
/*
$Log$
Revision 1.7  2006/12/06 11:30:05  cako
Bug #7730#
...
CREATE OR REPLACE FUNCTION empenho.fn_consultar_valor_pagamento_anulado_nota(VARCHAR,INTEGER,INTEGER) RETURNS NUMERIC AS '
