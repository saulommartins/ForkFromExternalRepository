...
CREATE OR REPLACE FUNCTION empenho.fn_exclui_lancamentos_pagamento(varchar, varchar,varchar, varchar,varchar, varchar) RETURNS BOOLEAN AS $$
DECLARE
    ...
    stSql := '
        DELETE From contabilidade.pagamento
         where contabilidade.lote.exercicio                   = '|| quote_literal(stExercicio)      ||'
           ...
           And contabilidade.lancamento_empenho.exercicio   = contabilidade.pagamento.exercicio
           And contabilidade.lancamento_empenho.cod_lote    = contabilidade.pagamento.cod_lote
           And contabilidade.lancamento_empenho.tipo        = contabilidade.pagamento.tipo
           And contabilidade.lancamento_empenho.cod_entidade= contabilidade.pagamento.cod_entidade
           And contabilidade.lancamento_empenho.sequencia   = contabilidade.pagamento.sequencia

           And contabilidade.pagamento.exercicio_liquidacao= empenho.nota_liquidacao_paga.exercicio
           And contabilidade.pagamento.cod_nota            = empenho.nota_liquidacao_paga.cod_nota
           And contabilidade.pagamento.cod_entidade        = empenho.nota_liquidacao_paga.cod_entidade
           And contabilidade.pagamento.timestamp           = empenho.nota_liquidacao_paga.timestamp
           And contabilidade.pagamento.cod_entidade        IN  ('|| stCodEntidades ||')

           And empenho.nota_liquidacao_paga.exercicio      = empenho.nota_liquidacao.exercicio
           And empenho.nota_liquidacao_paga.cod_nota       = empenho.nota_liquidacao.cod_nota
           And empenho.nota_liquidacao_paga.cod_entidade   = empenho.nota_liquidacao.cod_entidade

           And empenho.nota_liquidacao.exercicio_empenho    = empenho.empenho.exercicio
           And empenho.nota_liquidacao.cod_empenho          = empenho.empenho.cod_empenho
           And empenho.nota_liquidacao.cod_entidade         = empenho.empenho.cod_entidade
