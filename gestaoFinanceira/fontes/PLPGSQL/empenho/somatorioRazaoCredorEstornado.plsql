...
*
* Casos de uso: uc-02.03.26,uc-02.03.11,uc-02.03.07,uc-02.03.13
*/
...
CREATE OR REPLACE FUNCTION empenho.fn_somatorio_razao_credor_estornado(INTEGER, INTEGER, VARCHAR)  RETURNS numeric AS $$
DECLARE
