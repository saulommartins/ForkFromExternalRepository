...
CREATE OR REPLACE FUNCTION empenho.fn_empenho_restos_pagar_pagamento_estorno_credor(varchar,varchar,varchar,varchar,varchar,varchar, varchar, varchar, varchar, varchar,varchar,varchar,varchar,varchar,varchar,VARCHAR,VARCHAR)
