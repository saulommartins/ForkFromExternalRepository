...
*
* $Id: RelatorioSituacaoRestosPagar.plsql 64417 2016-02-18 18:03:51Z michel $
*/
...
CREATE OR REPLACE FUNCTION empenho.fn_relatorio_situacao_restos_pagar(varchar,varchar,varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
