/*
    ...
    **********************************************************************************
*/
CREATE OR REPLACE FUNCTION EmpenhoEmissaoAnulacao (character varying, numeric, character varying, integer, character varying, integer, integer, integer, character varying) RETURNS INTEGER AS $$
DECLARE
...
BEGIN
        ...
        LOOP
                ...
                IF STCODESTRUTURALVINCULOCREDITO <> '' AND STCODESTRUTURALVINCULODEBITO <> '' THEN
                        SEQUENCIA := FAZERLANCAMENTO( STCODESTRUTURALVINCULODEBITO, STCODESTRUTURALVINCULOCREDITO, 904, EXERCICIO , VALOR , COMPLEMENTO , CODLOTE , TIPOLOTE , CODENTIDADE, INCODCONTAVINCULODEBITO, INCODCONTAVINCULOCREDITO );
        ...
        IF EXERCICIO::integer > 2012 THEN
            ...
            FOR REREGISTROSCONTAFIXA IN EXECUTE SQLCONTAFIXA
            LOOP
                    SEQUENCIA := FAZERLANCAMENTO(  REREGISTROSCONTAFIXA.estrutural_debito , REREGISTROSCONTAFIXA.estrutural_credito , 904 , EXERCICIO , VALOR , COMPLEMENTO , CODLOTE , TIPOLOTE , CODENTIDADE , REREGISTROSCONTAFIXA.plano_debito, REREGISTROSCONTAFIXA.plano_credito );
            END LOOP;
            
            IF EXERCICIO::INTEGER = 2013 THEN
                SEQUENCIA := EMPENHOMODALIDADESLICITACAO(  EXERCICIO , VALOR , COMPLEMENTO , CODLOTE , TIPOLOTE , CODENTIDADE , CODPREEMPENHO  );
