...
CREATE OR REPLACE FUNCTION tesouraria.fn_relatorio_extrato_conta_corrente(integer, varchar, varchar, varchar,varchar, boolean, boolean) RETURNS SETOF RECORD AS '
DECLARE
