...
*/
CREATE OR REPLACE FUNCTION tesouraria.fn_relatorio_demostrativo_saldos(varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar) RETURNS SETOF RECORD AS $$
DECLARE
