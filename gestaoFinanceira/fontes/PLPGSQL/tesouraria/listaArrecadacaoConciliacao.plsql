...
*
	$Id: listaArrecadacaoConciliacao.plsql 66474 2016-08-31 20:45:40Z michel $
*
    ...
    stSql := ''
        CREATE TEMPORARY TABLE tmp_arrecadacao AS
            SELECT TB.cod_boletim
                  ...
                  ,CAST(NULL as timestamp) as timestamp_estornada
            ...
            SELECT TD.cod_boletim
                  ...
                  ,CAST ('''''''' as VARCHAR ) as numeracao
                  ,TD.timestamp
                  ,cast(TD.timestamp_estornada as timestamp) as timestamp_estornada
                  ,TD.valor AS valor
                  ,CAST( 0.00 AS NUMERIC ) as vl_desconto
                  ,CAST( 0.00 AS NUMERIC ) as vl_multa
                  ,CAST( 0.00 AS NUMERIC ) as vl_juros
