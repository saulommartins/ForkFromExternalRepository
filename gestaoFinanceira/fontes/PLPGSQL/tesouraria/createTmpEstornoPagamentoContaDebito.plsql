...
CREATE OR REPLACE FUNCTION tesouraria.fn_estorno_pagamento_conta_debito(VARCHAR,VARCHAR,VARCHAR,VARCHAR,VARCHAR,BIGINT,BIGINT,BIGINT,BIGINT,BIGINT) RETURNS BOOLEAN AS '
...
stSql := '' CREATE TEMPORARY TABLE tmp_estorno_pagamento_conta_debito AS
    SELECT
