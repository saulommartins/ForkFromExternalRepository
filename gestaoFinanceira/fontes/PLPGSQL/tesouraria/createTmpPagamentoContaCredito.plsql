...
CREATE OR REPLACE FUNCTION tesouraria.fn_pagamento_conta_credito(VARCHAR,VARCHAR,VARCHAR,VARCHAR,VARCHAR,BIGINT,BIGINT,BIGINT,BIGINT,BIGINT) RETURNS BOOLEAN AS '
...
stSql := '' CREATE TEMPORARY TABLE tmp_pagamento_conta_credito AS
    SELECT
