...
* $Date: 2008-04-01 16:45:54 -0300 (Ter, 01 Abr 2008) $
*
* Casos de uso: uc-02.01.09, uc-02.01.11, uc-02.01.18
*/
...
CREATE OR REPLACE FUNCTION orcamento.fn_consulta_class_despesa(INTEGER,VARCHAR,VARCHAR)
   RETURNS VARCHAR AS $$
