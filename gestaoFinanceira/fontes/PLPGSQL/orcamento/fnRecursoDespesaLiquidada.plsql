...
*/
/**
    * Script de função PLPGSQL - Relatório Despesas Municipais com Saúde - Despesas Liquidadas.
...
CREATE OR REPLACE FUNCTION orcamento.fn_recurso_despesa_liquidada(inCodRecurso INTEGER, stExercicio VARCHAR, stEntidades VARCHAR, stDtIni VARCHAR, stDtFim VARCHAR, stCodOrgao VARCHAR) RETURNS NUMERIC(14,2) AS 
$$
...
BEGIN 
	...
	WHERE 
		...
		pedcd.cod_recurso = ' || inCodRecurso || ' ';
