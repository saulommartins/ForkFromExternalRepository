...
CREATE OR REPLACE FUNCTION orcamento.fn_receita_realizada_periodo(varchar,varchar,integer,varchar,varchar) RETURNS NUMERIC(14,2) AS $$
DECLARE
    inExercicio         ALIAS FOR $1        ;
    stCodEntidade       ALIAS FOR $2        ;
    inCodReceita        ALIAS FOR $3        ;
...
stSql1 := '
    SELECT
        ...
        WHERE ore.cod_receita   = '||inCodReceita||'
