...
CREATE OR REPLACE FUNCTION orcamento.fn_despesa_liquidada(stMascRed VARCHAR, stExercicio VARCHAR, stEntidades VARCHAR, stDtIni VARCHAR, stDtFim VARCHAR, stCodOrgao VARCHAR, boIntra BOOLEAN) RETURNS NUMERIC(14,2) AS 
$$
