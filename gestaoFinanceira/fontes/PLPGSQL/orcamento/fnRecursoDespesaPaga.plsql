...
CREATE OR REPLACE FUNCTION orcamento.fn_recurso_despesa_paga(inCodRecurso INTEGER, stExercicio VARCHAR, stEntidades VARCHAR, stDtIni VARCHAR, stDtFim VARCHAR, stCodOrgao VARCHAR) RETURNS NUMERIC(14,2) AS 
$$
