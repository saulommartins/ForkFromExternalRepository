...
* $Date: 2014-06-02 09:10:51 -0300 (Seg, 02 Jun 2014) $
*
* Casos de uso: uc-02.08.01
* Casos de uso: uc-02.08.01
*/

CREATE OR REPLACE FUNCTION tceal.fn_exportacao_liquidacao(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) RETURNS SETOF
RECORD AS $$
...
BEGIN
    ...
    stSql := 'CREATE TEMPORARY TABLE tmp_total AS
                SELECT * FROM(                
                    SELECT
                        ...
                        tceal.fn_exportacao_liquidacao_total_liquidado(nl.exercicio,nl.cod_nota,nl.cod_entidade) as valor_liquidacao,
                        tceal.fn_exportacao_liquidacao_total_pago(nl.exercicio,nl.cod_nota,nl.cod_entidade,'''||stExercicio||''') as valor_pago,
    ...
    ORDER BY tabela.exercicio DESC,tabela.cod_entidade,tabela.cod_empenho,tabela.cod_nota,tabela.data_pagamento ASC,tabela.sinal_valor DESC,tabela.ordem ASC
            ';
