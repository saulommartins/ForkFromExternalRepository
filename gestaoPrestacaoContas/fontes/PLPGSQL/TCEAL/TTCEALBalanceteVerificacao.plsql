...
*
*/
CREATE OR REPLACE FUNCTION tceal.balancete_verificacao(VARCHAR, VARCHAR, VARCHAR, VARCHAR) RETURNS SETOF RECORD AS $$ 
DECLARE
...
BEGIN
    ...
    LOOP
        arRetorno := tceal.totaliza_balancete_verificacao( publico.fn_mascarareduzida(reRegistro.cod_estrutural) , stDtInicial, stDtFinal);
