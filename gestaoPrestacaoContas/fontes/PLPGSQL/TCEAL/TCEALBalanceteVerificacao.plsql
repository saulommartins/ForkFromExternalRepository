...
*
* $Id: TCEALBalanceteVerificacao.plsql 64655 2016-03-18 16:50:13Z michel $
*/


CREATE OR REPLACE FUNCTION tceal.fn_balancete_verificacao(VARCHAR, VARCHAR, VARCHAR, VARCHAR, CHAR) RETURNS SETOF RECORD AS $$ 
DECLARE
