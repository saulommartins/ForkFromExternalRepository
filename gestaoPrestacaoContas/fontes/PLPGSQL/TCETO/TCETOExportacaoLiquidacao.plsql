...
* $Revision: $
* $Name: $
* $Id: TCETOExportacaoLiquidacao.plsql 60726 2014-11-11 19:48:00Z evandro $
* $Date: $
*
*/

CREATE OR REPLACE FUNCTION tceto.fn_exportacao_liquidacao(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) RETURNS SETOF
RECORD AS $$
