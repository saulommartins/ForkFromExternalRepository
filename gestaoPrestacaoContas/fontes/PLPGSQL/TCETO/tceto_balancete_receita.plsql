...
CREATE OR REPLACE FUNCTION tceto.fn_balancete_receita(varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
        ...
        stSql := '
            ...
            FROM (
                ...
                AND ocr.exercicio =  '|| quote_literal(stExercicio) ||'
                    ...
                    --     tbl.valor_previsto <> 0
                    --     OR tbl.arrecadado_periodo <> 0
                    --     OR tbl.arrecadado_ano <> 0
