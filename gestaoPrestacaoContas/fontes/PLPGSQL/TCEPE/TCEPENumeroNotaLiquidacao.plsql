...
*/
   ...
   --
   CREATE OR REPLACE FUNCTION tcepe.numero_nota_liquidacao( varExercicio         VARCHAR
   ...
   DECLARE
      ...
      intRetorno        INTEGER;
   BEGIN
      ALTER SEQUENCE tcepe.seqLiquidacao RESTART WITH 1;
      ...
      LOOP
         intRetorno := nextval('tcepe.seqLiquidacao');
