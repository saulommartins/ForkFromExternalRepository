 ...
 * 
 * $Id: FTCEPERestosInscritos.plsql 60337 2014-10-14 19:04:41Z michel $
 */
...
CREATE OR REPLACE FUNCTION tcepe.fn_restos_pagar(varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
