...
*
* Casos de uso: uc-02.01.21, uc-02.02.07
*/

CREATE OR REPLACE FUNCTION tcepe.somatorio_receita_orcamentaria(VARCHAR, VARCHAR, VARCHAR, VARCHAR)  RETURNS numeric(14,2) AS $$

DECLARE
    stCodEstrutural ALIAS FOR $1;
    dtInicial       ALIAS FOR $2;
    dtFinal         ALIAS FOR $3;
    stEstorno       ALIAS FOR $4;
    stSql           VARCHAR   := '';
    nuSoma          NUMERIC   := 0;
    crCursor        REFCURSOR;
