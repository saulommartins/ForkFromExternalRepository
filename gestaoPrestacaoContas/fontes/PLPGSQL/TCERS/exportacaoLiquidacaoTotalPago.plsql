...
CREATE OR REPLACE FUNCTION tcers.fn_exportacao_liquidacao_total_pago(varchar,integer,integer,varchar) RETURNS NUMERIC(14,2)  AS '
DECLARE
...
BEGIN
    ...
    WHERE   enl.exercicio            =   stExercicio
        ...
        AND	to_date(enlp.timestamp::varchar,''yyyy-mm-dd'') <= to_date(''31/12/''||(to_number(stExercicioAtual,''9999'')-1 ),''dd/mm/yyyy'')
