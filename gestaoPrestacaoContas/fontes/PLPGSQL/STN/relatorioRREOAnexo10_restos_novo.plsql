...
*/
/*
* Script de função PLPGSQL - Relatório STN - RREO - Anexo 10
* para trazer os valores de restos a pagar do até o final do exercício corrente.
* -> Cria também a tabela tmp_restos_cancelados para ser utilizada no relatório
*
...
CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo10_restos_novo( stExercicio VARCHAR, stDtFim VARCHAR, stEntidades VARCHAR ) RETURNS SETOF RECORD AS $$
DECLARE
