...
CREATE OR REPLACE FUNCTION stn.fn_rgf_anexo2_rpps_novo(varchar,varchar,integer,varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
BEGIN
  ...
  arFiltro[6] := '(( REPLACE(plano_conta.cod_estrutural,''''.'''','''''''') LIKE ''''1111150%'''' )) ';
  ...
  INSERT INTO tmp_valores SELECT arDescricao[4]
                               , 4
                               , ((SELECT SUM(valor_exercicio_anterior) FROM tmp_valores WHERE ordem IN(5,6,7)) - (SELECT SUM(valor_exercicio_anterior) FROM tmp_valores WHERE ordem IN(8)))
                               , ((SELECT SUM(valor_1) FROM tmp_valores WHERE ordem IN(5,6,7)) - (SELECT SUM(valor_1) FROM tmp_valores WHERE ordem IN(8)))
                               , ((SELECT SUM(valor_2) FROM tmp_valores WHERE ordem IN(5,6,7)) - (SELECT SUM(valor_2) FROM tmp_valores WHERE ordem IN(8)))
                               , ((SELECT SUM(valor_3) FROM tmp_valores WHERE ordem IN(5,6,7)) - (SELECT SUM(valor_3) FROM tmp_valores WHERE ordem IN(8)));
