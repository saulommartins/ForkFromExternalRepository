...
CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo4_receitas_intra_orcamentaria(varchar,varchar, varchar, varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
CREATE TEMPORARY TABLE tmp_receitas_intra_orcamentarias AS (
    ...
    FROM(
        ...
        WHERE 
             ...
             AND conta_receita.exercicio = ' || quote_literal(stExercicio) || '
        ) as tbl
)  
