...
CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo5_receitas(varchar,varchar, varchar, varchar, varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
ELSE 
    ...
    INSERT INTO tmp_receitas VALUES (6, 'militar1', 4, 'Pessoa Militar');
    INSERT INTO tmp_receitas VALUES (6, 'militar2', 5, 'Contribuição de Militar Ativo');
    INSERT INTO tmp_receitas VALUES (6, 'militar3', 5, 'Contribuição de Militar Inativo');
    INSERT INTO tmp_receitas VALUES (6, 'militar4', 5, 'Contribuição de Pensionista Militar');
    ...
    stSql := '
        ...
        WHERE (receitas.cod_estrutural NOT ILIKE ''4.9%''
          ...
          AND publico.fn_nivel(receitas.cod_estrutural) = 3
    ...
    UNION ALL
        ...
        SELECT
            ...
            CAST(''Contribuição de Servidores Ativo Civil'' as varchar) AS nom_conta,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_inicial,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_atualizada,
            SUM(coalesce(no_bimestre,0.00)) as no_bimestre,
            SUM(coalesce(ate_bimestre,0.00)) as ate_bimestre,
        ...
        WHERE   cod_estrutural IN (''4.1.2.1.0.01.01.01.00.00''
                                  ,''4.1.2.1.0.01.01.03.00.00''
                                  ,''4.1.2.1.0.29.01.00.00.00''
                                  ,''4.1.2.1.0.29.07.00.00.00''
                                  ,''4.1.2.1.0.99.00.10.00.00''
                                  )
    ...
    UNION ALL
        ...
        SELECT
            ...
            CAST('''' as varchar) AS cod_estrutural,
            cast(5 as integer) as nivel,
            CAST(''Contribuição de Servidores Inativo Civil'' as varchar) AS nom_conta,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_inicial,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_atualizada,
            SUM(coalesce(no_bimestre,0.00)) as no_bimestre,
            SUM(coalesce(ate_bimestre,0.00)) as ate_bimestre,
        ...
        WHERE   cod_estrutural IN (''4.1.2.1.0.01.01.02.00.00''
                                  ,''4.1.2.1.0.01.01.04.00.00''
                                  ,''4.1.2.1.0.29.09.00.00.00''
                                  ,''4.1.2.1.0.99.00.11.00.00''
                                  )
    ...
    UNION ALL
        ...
        SELECT
            ...
            CAST('''' as varchar) AS cod_estrutural,
            cast(5 as integer) as nivel,
            CAST(''Contribuição de Pensionista Civil'' as varchar) AS nom_conta,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_inicial,
            SUM(coalesce(previsao_inicial, 0.00)) as previsao_atualizada,
            SUM(coalesce(no_bimestre,0.00)) as no_bimestre,
            SUM(coalesce(ate_bimestre,0.00)) as ate_bimestre,
        ...
        WHERE   cod_estrutural IN (''4.1.2.1.0.01.01.05.00.00''
                                  ,''4.1.2.1.0.29.11.00.00.00''
                                  )
    ...
    UNION ALL
        ...
        WHERE   cod_estrutural ILIKE ''4.1.3.3.%''
          OR    cod_estrutural ILIKE ''4.1.3.4.%''
          OR    cod_estrutural ILIKE ''4.1.3.9.%''
    ...
    UNION ALL
        ...
        WHERE   cod_estrutural ILIKE ''4.1.6.%''
