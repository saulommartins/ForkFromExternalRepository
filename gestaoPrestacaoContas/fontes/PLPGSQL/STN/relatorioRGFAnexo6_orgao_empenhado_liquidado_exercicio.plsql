...
CREATE OR REPLACE FUNCTION stn.fn_rel_rgf6_emp_liq_exercicio_orgao(varchar,varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS '
DECLARE
    ...
    FROM (
        ...
        FROM
           ...
           , empenho.pre_empenho as pe
            ...
            LEFT JOIN orcamento.orgao AS erpe
                   ON erpe.exercicio = ''''||stExercicio||''''
                  AND erpe.num_orgao = ode.num_orgao
