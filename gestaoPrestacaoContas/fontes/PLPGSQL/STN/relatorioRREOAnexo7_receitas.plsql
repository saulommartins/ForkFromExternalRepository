...
BEGIN
    ...
    CREATE TEMPORARY TABLE tmp_valor AS (
        ...
        FROM
            ...
            contabilidade.lote                
        WHERE
               (receita.exercicio = ' || quote_literal(stExercicio)  || ' OR
               receita.exercicio = ' || quote_literal(stExercicioAnterior) || ' ) ';  
    ...
    SELECT
        ...
        0 as subgrupo,
        0 as item,
        cast(''4.1.0.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        1 as nivel,
    ...
    SELECT
        ...
        1 as subgrupo,
        0 as item,
        cast(''4.1.1.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.1.0.0.00.00.00.00.00''  
    ...
    SELECT
        ...
        2 as subgrupo,
        0 as item,
        cast(''4.1.2.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    SELECT
        ...
        2 as subgrupo,
        1 as item,
        cast(''4.1.2.1.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (   plano_conta.cod_estrutural = ''4.1.2.1.0.01.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.2.1.0.29.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 6        
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        2 as subgrupo,
        2 as item,
        cast(''4.1.2.2.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (   plano_conta.cod_estrutural = ''4.1.2.2.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.2.1.0.99.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.7.2.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) <= 6
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        3 as subgrupo,
        0 as item,
        cast(''4.1.3.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    SELECT
        ...
        3 as subgrupo,
        1 as item,
        cast(''4.1.3.1.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (   plano_conta.cod_estrutural = ''4.1.3.1.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.3.2.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.3.3.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.7.3.0.0.00.00.00.00.00''
            )
    ...
    SELECT
        ...
        3 as subgrupo,
        2 as item,
        cast(''4.1.3.2.5.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            AND plano_conta.cod_estrutural = ''4.1.3.2.5.00.00.00.00.00''
    ...
    SELECT
        ...
        4 as subgrupo,
        0 as item,
        cast(''4.1.4.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.4.0.0.00.00.00.00.00''  
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3  
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        5 as subgrupo,
        0 as item,
        cast(''4.1.5.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.5.0.0.00.00.00.00.00''  
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3  
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        6 as subgrupo,
        0 as item,
        cast(''4.1.6.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.6.0.0.00.00.00.00.00''  
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3  
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        7 as subgrupo,
        0 as item,
        cast(''4.1.7.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    SELECT
        ...
        7 as subgrupo,
        1 as item,
        cast (''4.1.7.1.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.7.6.0.00.00.00.00.00''
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 4
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    FROM(
        SELECT
            ...
            7 as subgrupo,
            2 as item,
            cast (''4.1.7.2.0.00.00.00.00.00'' as varchar) as cod_estrutural,
            3 as nivel,
        ...
        FROM(
            ...
            WHERE
                ...
                plano_conta.exercicio        = conta_receita.exercicio             
                -- Filtros
                AND (   plano_conta.cod_estrutural = ''4.1.7.2.0.00.00.00.00.00''
                    OR  plano_conta.cod_estrutural = ''4.1.7.3.0.00.00.00.00.00''
                    OR  plano_conta.cod_estrutural = ''4.1.7.4.0.00.00.00.00.00''
                    OR  plano_conta.cod_estrutural = ''4.1.7.5.0.00.00.00.00.00''
                    ) 
                AND publico.fn_nivel(plano_conta.cod_estrutural) = 4
                AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
        ...
        cast(sum(coalesce((
            ...
            WHERE 
              ...
              ELSE
                ...
                AND plano_conta.cod_estrutural   like ''9.1%'' 
              END
    ...
    FROM (
        ...
        WHERE 
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural like '|| quote_literal(stExAtualMascRedDedutora||'%')||'
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 2
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '*/
...
UNION
    ...
    SELECT
        ...
        8 as subgrupo,
        0 as item,
        cast(''4.1.8.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
...
UNION
    ...
    SELECT
        ...
        8 as subgrupo,
        1 as item,
        cast(''4.1.8.1.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio 
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.1.9.3.0.00.00.00.00.00'' 
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 4 
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || ' 
...
UNION
    ...
    SELECT
        ...
        8 as subgrupo,
        2 as item,
        cast(''4.1.8.2.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (   plano_conta.cod_estrutural = ''4.1.9.1.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.9.2.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.1.9.9.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.7.9.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) <= 4
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
...
UNION
    ...
    SELECT
        ...
        0 as subgrupo,
        0 as item,
        cast(''4.2.0.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        1 as nivel,
...
UNION
    ...
    SELECT
        ...
        1 as subgrupo,
        0 as item,
        cast(''4.2.1.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio
            -- Filtros
            AND (plano_conta.cod_estrutural = ''4.2.1.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
...
UNION
    ...
    SELECT
        ...
        2 as subgrupo,
        0 as item,
        cast(''4.2.3.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (  plano_conta.cod_estrutural = ''4.2.3.0.0.00.00.00.00.00''
                OR plano_conta.cod_estrutural = ''4.8.3.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
...
UNION
    ...
    SELECT
        ...
        3 as subgrupo,
        0 as item,
        cast(''4.2.2.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (  plano_conta.cod_estrutural = ''4.2.2.0.0.00.00.00.00.00''
                OR plano_conta.cod_estrutural = ''4.8.2.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3        
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
...
UNION
    ...
    SELECT
        ...
        4 as subgrupo,
        0 as item,
        cast(''4.2.4.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
...
UNION
    ...
    SELECT
        ...
        4 as subgrupo,
        1 as item,
        cast(''4.2.4.1.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
        cast(''Convênios'' as varchar) as nom_conta,
        cast(sum(coalesce(previsao_inicial,0.00)) as numeric(14,2)) as previsao_atualizada,
        cast(sum(coalesce(no_bimestre,0.00))*-1 as numeric(14,2)) as no_bimestre,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND plano_conta.cod_estrutural = ''4.2.4.7.0.00.00.00.00.00''
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 4
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        4 as subgrupo,
        2 as item,
        cast(''4.2.4.2.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM( 
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (   plano_conta.cod_estrutural = ''4.2.4.2.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.2.4.3.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.2.4.4.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.2.4.5.0.00.00.00.00.00''
                OR  plano_conta.cod_estrutural = ''4.2.4.6.0.00.00.00.00.00'' 
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 4
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        5 as subgrupo,
        0 as item,
        cast(''4.2.5.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        2 as nivel,
    ...
    FROM(
        ...
        WHERE
            ...
            plano_conta.exercicio        = conta_receita.exercicio             
            -- Filtros
            AND (  plano_conta.cod_estrutural = ''4.2.5.0.0.00.00.00.00.00''
                OR plano_conta.cod_estrutural = ''4.8.5.0.0.00.00.00.00.00''
            )
            AND publico.fn_nivel(plano_conta.cod_estrutural) = 3
            AND plano_conta.exercicio = ' || quote_literal(stExercicio) || '
    ...
    SELECT
        ...
        0 as subgrupo,
        0 as item,
        cast(''4.3.0.0.0.00.00.00.00.00'' as varchar) as cod_estrutural,
        1 as nivel,
