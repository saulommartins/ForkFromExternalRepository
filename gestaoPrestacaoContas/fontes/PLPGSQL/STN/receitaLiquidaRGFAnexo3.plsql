...
CREATE OR REPLACE FUNCTION stn.fn_rgf_receita_liquida_anexo3 (varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
stSql := '
    select 
        ...
        ,cast ( (SELECT
               sum(cast( ( total_mes_1 + total_mes_2 + total_mes_3 + total_mes_4  + total_mes_5  + total_mes_6
                         + total_mes_7 + total_mes_8 + total_mes_9 + total_mes_10 + total_mes_11 + total_mes_12 ) as numeric(14,2))) 
          FROM stn.pl_total_subcontas (''30/04/'||stExercicio||''') as retorno (
                                                                       ordem      integer
                                                                      ,cod_conta      varchar
                                                                      ,nom_conta      varchar
                                                                      ,cod_estrutural varchar
                                                                      ...
                                                                      ,total_mes_11 numeric
                                                                      ,total_mes_12 numeric)
         WHERE ordem = 1) as numeric ) as saldo_primeiro_quadrimestre
        ,cast ( (SELECT
               sum(cast( ( total_mes_1 + total_mes_2 + total_mes_3 + total_mes_4  + total_mes_5  + total_mes_6
                         + total_mes_7 + total_mes_8 + total_mes_9 + total_mes_10 + total_mes_11 + total_mes_12 ) as numeric(14,2))) 
          FROM stn.pl_total_subcontas (''31/08/'||stExercicio||''') as retorno (
                                                                       ordem      integer
                                                                      ,cod_conta      varchar
                                                                      ,nom_conta      varchar
                                                                      ,cod_estrutural varchar
                                                                      ...
                                                                      ,total_mes_11 numeric
                                                                      ,total_mes_12 numeric)
         WHERE ordem = 1) as numeric ) as saldo_segundo_quadrimestre
        ,cast ( (SELECT
               sum(cast( ( total_mes_1 + total_mes_2 + total_mes_3 + total_mes_4  + total_mes_5  + total_mes_6
                         + total_mes_7 + total_mes_8 + total_mes_9 + total_mes_10 + total_mes_11 + total_mes_12 ) as numeric(14,2))) 
          FROM stn.pl_total_subcontas (''31/12/'||stExercicio||''') as retorno (
                                                                      ...
                                                                      ,total_mes_11 numeric
                                                                      ,total_mes_12 numeric)
         WHERE ordem = 1) as numeric ) as saldo_terceiro_quadrimestre
