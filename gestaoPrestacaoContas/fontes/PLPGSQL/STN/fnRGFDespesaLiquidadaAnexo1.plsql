/*
    ...
    **********************************************************************************
*/
CREATE OR REPLACE FUNCTION stn.fn_rgf_despesa_liquidada_anexo1(stDtInicial VARCHAR, stDtFinal VARCHAR, stEntidades VARCHAR, stCondicao VARCHAR) RETURNS NUMERIC(14,2) AS 
$$
