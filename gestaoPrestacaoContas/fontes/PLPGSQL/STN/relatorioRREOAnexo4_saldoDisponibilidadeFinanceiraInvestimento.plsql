...
/**
    ...
    * Casos de uso : uc-06.01.04
    ...
    $Id: relatorioRREOAnexo4_saldoDisponibilidadeFinanceiraInvestimento.plsql 61129 2014-12-10 17:04:54Z evandro $
*/


CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo4_saldo_disponivel(varchar, varchar, varchar, varchar, varchar) RETURNS SETOF RECORD AS $$
DECLARE
