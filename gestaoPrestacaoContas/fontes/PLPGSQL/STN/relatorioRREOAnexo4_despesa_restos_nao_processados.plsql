 ...
 * 
 * $Id: relatorioRREOAnexo4_despesa_restos_nao_processados.plsql 61129 2014-12-10 17:04:54Z evandro $
 */
...
CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo4_despesas_restos_nao_processados(varchar,varchar,varchar,varchar,varchar) RETURNS NUMERIC AS $$
DECLARE
