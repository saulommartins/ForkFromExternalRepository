...
Revision 1.3  2006/08/04 17:53:28  jose.eduardo
Ajustes
...
CREATE OR REPLACE FUNCTION stn.fn_rgf_anexo3 (varchar, varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
stSql := '
    select
        ...
        ,cast(saldo_primeiro_quadrimestre as numeric)
        ,cast(saldo_segundo_quadrimestre as numeric)
        ,cast(saldo_terceiro_quadrimestre as numeric)
    ...
    from(
        select 
            ...
            ,null as saldo_primeiro_quadrimestre 
            ,null as saldo_segundo_quadrimestre 
            ,null as saldo_terceiro_quadrimestre 
            ,1   as sequencia
            ,''G'' as tipo
        ...
        select 
            ...
            ,coalesce(stn.fn_rgf_calcula_saldo_garantias_anexo3('|| quote_literal(stExercicio) ||','|| quote_literal(stEntidade) ||', '' AND (
                             ...
                             or pc.cod_estrutural  = ''1.9.9.5.2.01.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.1.02.02.00.00.00''
                             ) '','|| quote_literal('01/01/'|| stExercicio) ||','|| quote_literal('30/04/'|| stExercicio) ||'), 0.00) as saldo_primeiro_quadrimestre 
            ,coalesce(stn.fn_rgf_calcula_saldo_garantias_anexo3('|| quote_literal(stExercicio) ||','|| quote_literal(stEntidade) ||', '' AND (
                                pc.cod_estrutural  = ''1.9.9.5.1.01.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.2.02.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.2.01.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.1.02.02.00.00.00''
                             ) '','|| quote_literal('01/01/'|| stExercicio) ||','|| quote_literal('31/08/'|| stExercicio) ||'), 0.00) as saldo_segundo_quadrimestre 
            ,coalesce(stn.fn_rgf_calcula_saldo_garantias_anexo3('|| quote_literal(stExercicio) ||','|| quote_literal(stEntidade) ||', '' AND (
                                pc.cod_estrutural  = ''1.9.9.5.1.01.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.2.02.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.2.01.02.00.00.00''
                             or pc.cod_estrutural  = ''1.9.9.5.1.02.02.00.00.00''
                             ) '','|| quote_literal('01/01/'|| stExercicio) ||','|| quote_literal('31/12/'|| stExercicio) ||'), 0.00) as saldo_terceiro_quadrimestre 
            ,2   as sequencia
            ,''G'' as tipo
        ...
        select 
            ...
            ,null as saldo_exercicio_anterior
            ,null as saldo_primeiro_quadrimestre 
            ,null as saldo_segundo_quadrimeste 
            ,null as saldo_terceiro_quadrimestre 
            ,3   as sequencia
            ,''G'' as tipo
