...
*/
/**
    * Script de função PLPGSQL - Relatório STN - Anexo6 - Receitas
    *
    * URBEM Soluções de Gestão Pública Ltda
    * www.urbem.cnm.org.br
    *
    * $Id: relatorioRREOAnexo6_receitas.plsql 66505 2016-09-06 19:20:24Z michel $
    *
    * Casos de uso:
    * 
*/

CREATE OR REPLACE FUNCTION stn.fn_rreo_anexo6_receitas(varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
...
BEGIN
    ...
    SELECT
        ...
        1 as subgrupo,
        1 as item,
        cast(''1.1.1.2.02.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        FROM
            orcamento.conta_receita     
        WHERE   conta_receita.cod_estrutural = ''1.1.1.2.02.00.00.00.00''  
    ...
    SELECT
        ...
        1 as subgrupo,
        2 as item,
        cast(''1.1.1.3.05.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        FROM
            orcamento.conta_receita     
        WHERE   conta_receita.cod_estrutural = ''1.1.1.3.05.00.00.00.00''  
            AND publico.fn_nivel(conta_receita.cod_estrutural) = 5
            AND conta_receita.exercicio = ''' || stExercicio || '''
    ...
    SELECT
        ...
        1 as subgrupo,
        3 as item,
        cast(''1.1.1.2.08.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        FROM
            orcamento.conta_receita     
        WHERE   conta_receita.cod_estrutural = ''1.1.1.2.08.00.00.00.00''  
            AND publico.fn_nivel(conta_receita.cod_estrutural) = 5
            AND conta_receita.exercicio = ''' || stExercicio || '''
    ...
    SELECT
        ...
        1 as subgrupo,
        4 as item,
        cast(''1.1.1.2.04.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
    ...
    FROM(
        ...
        FROM
            orcamento.conta_receita     
        WHERE   conta_receita.cod_estrutural = ''1.1.1.2.04.00.00.00.00''  
            AND publico.fn_nivel(conta_receita.cod_estrutural) = 5
            AND conta_receita.exercicio = ''' || stExercicio || '''
    ...
    SELECT
        ...
        1 as subgrupo,
        5 as item,
        cast(''1.1.1.2.09.00.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
        cast(''Outras Receitas Tributárias'' as varchar) as nom_conta,
        coalesce(cast(sum(coalesce(previsao_inicial,0.00)) as numeric(14,2)), 0.00) as previsao_atualizada,
        coalesce(cast(sum(coalesce(no_bimestre,0.00))*-1 as numeric(14,2)), 0.00) as no_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre,0.00))*-1 as numeric(14,2)), 0.00) as ate_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre_exercicio_anterior,0.00))*-1 as numeric(14,2)), 0.00) as ate_bimestre_exercicio_anterior
    FROM(
        SELECT
            publico.fn_nivel(conta_receita.cod_estrutural) as nivel,
            conta_receita.cod_estrutural,
        ...
        FROM
            orcamento.conta_receita     
        WHERE   conta_receita.cod_estrutural SIMILAR TO ''4.1.1.1.2.09%|1.1.2.0%|1.1.3.0%''
            AND publico.fn_nivel(conta_receita.cod_estrutural) IN (3,4,6)
            AND conta_receita.exercicio = ''' || stExercicio || '''
    ...
    FROM(
        ...
        FROM 
            orcamento.conta_receita  
        WHERE   conta_receita.cod_estrutural SIMILAR TO ''1.3.2.5.00.00.00.00.00|1.3.2.8%''
    ...
    SELECT
        ...
        7 as subgrupo,
        1 as item,
        cast (''1.7.2.1.01.02.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
        cast(''Cota-parte do FPM'' as varchar) as nom_conta,
        coalesce(cast(sum(coalesce(previsao_inicial,0.00)) as numeric(14,2)),0.00) as previsao_atualizada,
        coalesce(cast(sum(coalesce(no_bimestre,0.00))*-1 as numeric(14,2)),0.00) as no_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre,0.00))*-1 as numeric(14,2)),0.00) as ate_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre_exercicio_anterior,0.00))*-1 as numeric(14,2)),0.00) as ate_bimestre_exercicio_anterior
    FROM(
        ...
        FROM
            orcamento.conta_receita  
        WHERE   conta_receita.cod_estrutural = ''1.7.2.1.01.02.00.00.00''
...
UNION
     ...
     SELECT
        ...
        7 as subgrupo,
        2 as item,
        cast (''1.7.2.2.01.01.00.00.00'' as varchar) as cod_estrutural,
        3 as nivel,
        cast(''Cota-parte do ICMS'' as varchar) as nom_conta,
        coalesce(cast(sum(coalesce(previsao_inicial,0.00)) as numeric(14,2)),0.00) as previsao_atualizada,
        coalesce(cast(sum(coalesce(no_bimestre,0.00))*-1 as numeric(14,2)),0.00) as no_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre,0.00))*-1 as numeric(14,2)),0.00) as ate_bimestre,
        coalesce(cast(sum(coalesce(ate_bimestre_exercicio_anterior,0.00))*-1 as numeric(14,2)),0.00) as ate_bimestre_exercicio_anterior
    FROM(
        ...
        FROM
            orcamento.conta_receita  
        WHERE   conta_receita.cod_estrutural = ''1.7.2.2.01.01.00.00.00''
            AND publico.fn_nivel(conta_receita.cod_estrutural) = 6
            AND conta_receita.exercicio = ''' || stExercicio || '''
...
UNION 
    ...
    FROM(
        ...
        FROM(
            ...
            WHERE   conta_receita.cod_estrutural LIKE  ''1.7.%''
                AND conta_receita.cod_estrutural NOT LIKE ''1.7.2.1.01.02%''
                AND conta_receita.cod_estrutural NOT LIKE ''1.7.2.2.01.01%''
                AND conta_receita.cod_estrutural NOT LIKE ''1.7.6.%''
                --Receita Analitica
                AND cast(orcamento.fn_tipo_conta_receita(conta_receita.exercicio, conta_receita.cod_estrutural) as varchar) = ''A''
                AND conta_receita.exercicio = ''' || stExercicio || '''
            ORDER BY
                conta_receita.cod_estrutural
        )  as tbl
...
UNION
    ...
    LOOP
        ...
        LOOP
            ...
            AND cod_estrutural != ''1.1.0.0.00.00.00.00.00''
            ';
    ...
    stSql := '    
    UPDATE tmp_valores_birt SET 
        previsao_atualizada = ((SELECT coalesce(sum(previsao_atualizada), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.0.0.0.00.00.00.00.00'') 
                  - (SELECT coalesce(sum(previsao_atualizada), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.1.0.0.00.00.00.00.00'') 
                  - (SELECT coalesce(sum(previsao_atualizada), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.3.0.0.00.00.00.00.00'') 
                  - (SELECT coalesce(sum(previsao_atualizada), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.2.0.0.00.00.00.00.00'')),
        no_bimestre = ((SELECT coalesce(sum(no_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.0.0.0.00.00.00.00.00'')
                     - (SELECT coalesce(sum(no_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.1.0.0.00.00.00.00.00'')
                     - (SELECT coalesce(sum(no_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.3.0.0.00.00.00.00.00'')
                     - (SELECT coalesce(sum(no_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.2.0.0.00.00.00.00.00'')),
        ate_bimestre = ((SELECT coalesce(sum(ate_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.0.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.1.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.3.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.2.0.0.00.00.00.00.00'')), 
        ate_bimestre_exercicio_anterior = ((SELECT coalesce(sum(ate_bimestre_exercicio_anterior), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.0.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre_exercicio_anterior), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.1.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre_exercicio_anterior), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.3.0.0.00.00.00.00.00'') 
                      - (SELECT coalesce(sum(ate_bimestre_exercicio_anterior), 0.00) FROM tmp_valores_birt where cod_estrutural = ''2.2.0.0.00.00.00.00.00'')  ) 
