...
* $Name$
* $Author: gris $
* $Date: 2007-04-23 17:42:06 -0300 (Seg, 23 Abr 2007) $
*
...
*/
   ...
   --
   CREATE OR REPLACE FUNCTION TCMGO.numero_nota_liquidacao( varExercicio         VARCHAR
   ...
   DECLARE
      ...
      intRetorno        INTEGER;
   BEGIN
      ALTER SEQUENCE tcmgo.seqLiquidacao RESTART WITH 1;
      ...
      LOOP
         intRetorno := nextval('tcmgo.seqLiquidacao');
