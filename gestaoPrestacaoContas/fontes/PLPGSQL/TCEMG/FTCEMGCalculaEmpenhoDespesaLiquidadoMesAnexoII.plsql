...
CREATE OR REPLACE  FUNCTION tcemg.fn_despesa_liquidado_mes_anexo_ii(character varying, character varying, character varying, integer, integer, integer, integer, integer, integer, integer, integer, integer, integer) RETURNS numeric
    AS '
DECLARE
...
BEGIN
    ...
    LOOP
       nuRetorno := reRegistro.liquidado_per;
    END LOOP;
