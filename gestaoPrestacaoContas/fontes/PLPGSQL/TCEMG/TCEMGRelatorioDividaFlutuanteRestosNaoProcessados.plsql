 ...
 *
 * $Id: TCEMGRelatorioDividaFlutuanteRestosNaoProcessados.plsql 59612 2014-09-02 12:00:51Z gelson $
 */


CREATE OR REPLACE FUNCTION tcemg.relatorio_divida_flutuante_restos_nao_processados(varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
