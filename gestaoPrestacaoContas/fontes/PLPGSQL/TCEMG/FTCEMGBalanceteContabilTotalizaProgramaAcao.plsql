...
* www.urbem.cnm.org.br
    ...
    $Id: FTCEMGBalanceteContabilTotalizaProgramaAcao.plsql 62872 2015-07-01 20:16:55Z franver $
...
*/
CREATE OR REPLACE FUNCTION tcemg.fn_balancete_contabil_totaliza_programa_acao(VARCHAR, INTEGER, INTEGER) RETURNS numeric[] AS $$
DECLARE
    stMascaraReduzida   ALIAS FOR $1;
    inNumPrograma       ALIAS FOR $2;
    inNumAcao           ALIAS FOR $3;
    stSql               VARCHAR   := '';
