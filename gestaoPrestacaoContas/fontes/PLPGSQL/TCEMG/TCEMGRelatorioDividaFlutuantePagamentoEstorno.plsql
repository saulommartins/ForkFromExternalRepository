...
/**
    ...
    * Casos de uso: uc-02.03.09 
    ...
    $Id: TCEMGRelatorioDividaFlutuantePagamentoEstorno.plsql 59612 2014-09-02 12:00:51Z gelson $

*/

CREATE OR REPLACE FUNCTION tcemg.relatorio_divida_flutuante_pagamento_estorno(varchar,varchar,varchar,varchar,varchar,varchar, varchar, varchar, varchar, varchar,varchar,varchar,varchar,varchar,varchar)
