...
* www.urbem.cnm.org.br
    ...
    $Id: FTCEMGBalanceteContabilTotalizaReceita.plsql 62872 2015-07-01 20:16:55Z franver $
...
*/
CREATE OR REPLACE FUNCTION tcemg.fn_balancete_contabil_totaliza_receita(VARCHAR, INTEGER, VARCHAR) RETURNS numeric[] AS $$
DECLARE
    stMascaraReduzida   ALIAS FOR $1;
    inCodRecurso        ALIAS FOR $2;
    stNaturezaReceita   ALIAS FOR $3;
    stSql               VARCHAR   := '';
