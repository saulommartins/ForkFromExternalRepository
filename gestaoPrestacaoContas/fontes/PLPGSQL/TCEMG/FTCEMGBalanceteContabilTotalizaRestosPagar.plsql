...
* www.urbem.cnm.org.br
    ...
    $Id: FTCEMGBalanceteContabilTotalizaRestosPagar.plsql 62872 2015-07-01 20:16:55Z franver $
...
*/
CREATE OR REPLACE FUNCTION tcemg.fn_balancete_contabil_totaliza_restos_pagar(VARCHAR, INTEGER, INTEGER, INTEGER, INTEGER,  INTEGER, INTEGER, INTEGER, VARCHAR, INTEGER, VARCHAR) RETURNS numeric[] AS $$
DECLARE
    ...
    inCodEmpenho        ALIAS FOR $10;
    stExercicioEmpenho  ALIAS FOR $11;
    stSql               VARCHAR   := '';
