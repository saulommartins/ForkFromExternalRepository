...
*
* $Id: TCEMGRelatorioDividaFlutuanteRestosPagar.plsql 64532 2016-03-10 13:48:36Z michel $
*/
...
CREATE OR REPLACE FUNCTION tcemg.relatorio_divida_flutuante_restos_pagar(varchar,varchar,varchar,varchar) RETURNS SETOF RECORD AS $$
DECLARE
