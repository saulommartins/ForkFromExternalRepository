...
* www.urbem.cnm.org.br
    ...
    $Id: FTCEMGBalanceteContabil13.plsql 62872 2015-07-01 20:16:55Z franver $
...
*/
CREATE OR REPLACE FUNCTION tcemg.fn_balancete_contabil_13(VARCHAR, VARCHAR, VARCHAR, VARCHAR) RETURNS SETOF balancete_contabil_registro_13 AS $$
DECLARE
...
BEGIN
   ...
   CREATE TEMPORARY TABLE tmp_credito AS
    ...
    LOOP
        arRetorno := tcemg.fn_balancete_contabil_totaliza_programa_acao( publico.fn_mascarareduzida(reRegistro.conta_contabil) , reRegistro.num_programa, reRegistro.num_acao);
