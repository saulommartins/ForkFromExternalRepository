...
* www.urbem.cnm.org.br
    ...
    $Id: FTCEMGBalanceteContabilTotalizaCodigoCTBRecurso.plsql 62872 2015-07-01 20:16:55Z franver $
...
*/
CREATE OR REPLACE FUNCTION tcemg.fn_balancete_contabil_totaliza_codigoCTB_recurso(VARCHAR, INTEGER, INTEGER) RETURNS numeric[] AS $$
DECLARE
    stMascaraReduzida   ALIAS FOR $1;
    inCodCtb            ALIAS FOR $2;
