...
<?php
/**
    * Classe rodapeFimArquivo - gerar rodapé arquivos de exportação
...
class rodapeFimArquivo extends GeracaoArquivoExportacao
{
    public function rodapeFimArquivo()
    {
    ...
    public function geraArquivo()
    {
        ...
        // tipo de registro - valor fixo '099'
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("[]099");
