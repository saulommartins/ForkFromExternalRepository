...
include_once ( CAM_GPC_TCEAL_NEGOCIO."RExportacaoTCEALArqUniOrcam.class.php"    );
...
$obRExportacaoTCEALArqUniOrcam->obRExportacaoTCEALUniOrcam->setExercicio(Sessao::getExercicio());
$obRExportacaoTCEALArqUniOrcam->obRExportacaoTCEALUniOrcam->listar($rsUnidadeOrcamento);
$obRExportacaoTCEALArqUniOrcam->obRExportacaoTCEALUniOrcam->listarDadosConversao($rsUnidadeOrcamentoConversao);
...
if ($rsUnidadeOrcamento->getNumLinhas() != 0) {
    ...
    $obRExportacaoTCEALArqUniOrcam->listarIdentificador($rsIdentificador);
