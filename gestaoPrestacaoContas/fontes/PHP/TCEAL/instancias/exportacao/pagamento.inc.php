...
/**
    ...
    *
    $Id: pagamento.inc.php 65507 2016-05-27 17:41:08Z lisiane $
    *
    * @ignore
    *
*/
...
while (!$rsRecordSet->eof()) {
    ...
    $arResult[$idCount]['DataPagamento']        = $rsRecordSet->getCampo('data_pagamento');
    ...
    $arResult[$idCount]['NumProcesso']          = $rsRecordSet->getCampo('numero_processo');
