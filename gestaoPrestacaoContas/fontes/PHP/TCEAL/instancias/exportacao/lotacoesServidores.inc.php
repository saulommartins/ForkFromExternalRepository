...
/*
    ...
    * Página de Include Oculta - Exportação Arquivos Relacionais - lotacoesServidores.xml
    *
    * Data de Criação: 27/05/2014
    *
    * @author: Carolina Schwaab Marçal
    *
    * $Id: lotacoesServidores.inc.php 65683 2016-06-09 12:56:23Z lisiane $
    *
    * @ignore
    *
*/
...
include_once CAM_GPC_TCEAL_MAPEAMENTO.'TTCEALLotacoesServidores.class.php';
...
$stNomeArquivo         = "LotacoesServidores";
$arEsquemasEntidades   = array();

$obTTCEALLotacoesServidores = new TTCEALLotacoesServidores();
