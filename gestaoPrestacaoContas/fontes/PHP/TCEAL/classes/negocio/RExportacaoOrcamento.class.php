...
include_once(CAM_GPC_TCEAL_MAPEAMENTO."TExportacaoOrcamento.class.php");
include_once(CLA_ARQUIVO_ZIP);

class RExportacaoOrcamento
{
    private $obXML;
    private $obTExportacaoOrcamento;
    ...
    public function __construct()
    {
        ...
        $this->obTExportacaoOrcamento = new TExportacaoOrcamento();
