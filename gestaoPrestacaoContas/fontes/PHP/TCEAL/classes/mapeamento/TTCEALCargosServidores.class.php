...
/*
    ...
    * Extensão da Classe de Mapeamento TTCEALCargosServidores
    *
    * Data de Criação: 28/05/2014
    *
    * @author: Carolina Schwaab Marçal
    *
    * $Id: TTCEALCargosServidores.class.php 59612 2014-09-02 12:00:51Z gelson $
    *
    * @ignore
    *
*/
class TTCEALCargosServidores extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCEALCargosServidores()
    {
        parent::Persistente();
   ...
   public function listarExportacaoCargosServidores(&$rsRecordSet,$stFiltro="",$stOrder=" ",$boTransacao="")
  {
         $stSql = "
