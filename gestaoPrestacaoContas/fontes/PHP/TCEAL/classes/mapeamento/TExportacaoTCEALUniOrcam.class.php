...
class TExportacaoTCEALUniOrcam extends Persistente
{
function TExportacaoTCEALUniOrcam()
{
    parent::Persistente();
    $this->setTabela('tceal.uniorcam');
    ...
    */
    ...
    public function MontaRecuperaDadosUniOrcam()
    {
        ...
        $stSql .= "LEFT JOIN tceal.uniorcam as tu                         \n";
