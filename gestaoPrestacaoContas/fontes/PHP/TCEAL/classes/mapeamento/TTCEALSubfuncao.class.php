...
<?php
/**
 * Classe de Mapeamento TTCEALSubfuncao
 *
...
class TTCEALSubfuncao extends Persistente
{
    /**
     * Método Construtor
     * @access Private
    */
    public function TTCEALSubfuncao()
    {
        parent::Persistente();
    ...
    public function montaRecuperaSubfuncao()
    {
        $stSql = "
            SELECT  exercicio
             ...
             WHERE  1=1
               AND  subfuncao.exercicio = '".$this->getDado('exercicio')."'";
