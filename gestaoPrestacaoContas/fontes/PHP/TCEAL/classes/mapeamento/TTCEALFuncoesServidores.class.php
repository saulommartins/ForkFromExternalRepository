...
/*
    ...
    * Extensão da Classe de Mapeamento TTCEALFuncoesServidores
    *
    * Data de Criação: 28/05/2014
    *
    * @author: Carolina Schwaab Marçal
    *
    * $Id: TTCEALFuncoesServidores.class.php 59612 2014-09-02 12:00:51Z gelson $
    *
    * @ignore
    *
*/
class TTCEALFuncoesServidores extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCEALFuncoesServidores()
    {
        parent::Persistente();
     ...
     public function listarExportacaoFuncoesServidores(&$rsRecordSet,$stFiltro="",$stOrder=" ",$boTransacao="")
    {
         $stSql = "
                        SELECT  (    SELECT PJ.cnpj
                                  ...
                                  , lpad(cod_funcao::VARCHAR,15,'0') AS cod_funcao
                                  , descricao
                          FROM  (
                                        SELECT  servidor_pensionista.*
                                          FROM pessoal".$this->getDado('stEntidade').".contrato
                                           ...
                                           FROM pessoal".$this->getDado('stEntidade').".contrato_pensionista
                                                 ...
                                                 INNER JOIN pessoal".$this->getDado('stEntidade').".cargo
                                                             ON cargo.cod_cargo = ultimo_contrato_pensionista_funcao.cod_cargo
