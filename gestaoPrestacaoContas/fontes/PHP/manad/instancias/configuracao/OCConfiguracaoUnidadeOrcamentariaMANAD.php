...
include_once( CAM_GF_EXP_NEGOCIO . "RExportacaoMANADArqUniOrcam.class.php"    );

$stCtrl = $_GET['stCtrl'] ?  $_GET['stCtrl'] : $_POST['stCtrl'];

$obRExportacaoMANADArqUniOrcam = new RExportacaoMANADArqUniOrcam();
$obRExportacaoMANADArqUniOrcam->obRExportacaoMANADUniOrcam->setExercicio(Sessao::getExercicio());
$obRExportacaoMANADArqUniOrcam->obRExportacaoMANADUniOrcam->listar($rsUnidadeOrcamento);
$obRExportacaoMANADArqUniOrcam->obRExportacaoMANADUniOrcam->listarDadosConversao($rsUnidadeOrcamentoConversao);
...
switch ($stCtrl) {
    ...
    case "MontaListaUniOrcam":
          ...
          if ($rsUnidadeOrcamento->getNumLinhas() != 0) {
              ...
              $obRExportacaoMANADArqUniOrcam->listarIdentificador($rsIdentificador);
