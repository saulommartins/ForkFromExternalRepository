...
function geraArquivosPessoal(&$obExportador , $stDataInicial, $stDataFinal)
{
    ...
    $obTPessoalContrato->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalContrato->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTPessoalAdidoCedido->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalAdidoCedido->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTPessoalAssentamento->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalAssentamento->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTPessoalCausaRecisao->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalCausaRecisao->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTPessoalCausaObito->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalCausaObito->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTFPEventoCalculado = new TFolhaPagamentoEventoCalculado;
    $obTFPEventoCalculado->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTFPEventoCalculado->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    $obTFPEventoCalculado->setDado( 'dt_inicial'  , $stDataInicial );
    $obTFPEventoCalculado->setDado( 'dt_final'  , $stDataFinal );
    ...
    $obTPessoalServidor->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTPessoalServidor->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
...
//======== BENEFICIARIO PENSAO ========
    ...
    if (!empty($arNovoBeneficiarPensao))
