...
function geraArquivosConvenios(&$obExportador , $stDataInicial, $stDataFinal)
{
    ...
    $obTLicitacaoConvenio->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTLicitacaoConvenio->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
    ...
    $obTParticipanteConvenio->setDado( 'exercicio'   , $arFiltroRelatorio['stExercicio'] );
    $obTParticipanteConvenio->setDado( 'cod_entidade', implode(",", $arFiltroRelatorio['inCodEntidade'] ) );
