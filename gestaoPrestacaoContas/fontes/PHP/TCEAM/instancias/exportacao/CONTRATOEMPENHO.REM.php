...
<?php
/**
    * Página de Include Oculta - Exportação Arquivos Econtas - CONTRATOEMPENHO.REM.txt
    *
    * Data de Criação: 24/04/2014
    *
    * @author: Michel Teixeira
    *
    $Id: CONTRATOEMPENHO.REM.php 59612 2014-09-02 12:00:51Z gelson $
    *
    * @ignore
    *
*/
...
$obTMapeamento->recuperaContratoEmpenho($rsRecordSet);
