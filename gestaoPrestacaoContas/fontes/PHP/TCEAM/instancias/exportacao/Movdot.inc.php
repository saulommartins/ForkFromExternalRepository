...
/**
    ...
    *
    $Id: Movdot.inc.php 59612 2014-09-02 12:00:51Z gelson $
    *
    * @ignore
    *
*/
...
if (array_search( 'Movdot.txt', $arFiltro['arArquivosSelecionados'] ) !== FALSE && $inMes == 12 && count($arFiltro['inCodEntidade']) > 1) {
...
$obTMapeamento->recuperaAtualizacaoOrcamentaria($rsRecordSet);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("uni_descentralizada");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);
