...
/**
    ...
    * @ignore
    ...
    $Id: FMConfigurarTipoCertidao.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
$obTTCEAMTipoCertidao->recuperaDocumentosCertidao($rsTipoCertidao, "", "ORDER BY cod_tipo_certidao", $boTransacao);

$obDocumentoTCEMGCredor = new Select;
$obDocumentoTCEMGCredor->setName       ('inCodDocumento_[cod_tipo_certidao]');
$obDocumentoTCEMGCredor->setId         ('inCodDocumento_[cod_tipo_certidao]');
$obDocumentoTCEMGCredor->setValue      ('[cod_tipo_certidao]');
$obDocumentoTCEMGCredor->addOption     ('', 'Selecione');
$obDocumentoTCEMGCredor->setCampoId    ('[cod_tipo_certidao]');
$obDocumentoTCEMGCredor->setCampoDesc  ('[descricao]');
$obDocumentoTCEMGCredor->preencheCombo ( $rsTipoCertidao );

$obLista->addCabecalho('Documentos TCEAM Certidão', 20);
...
$jsOnload = "executaFuncaoAjax('carregaComboTipoCertidao');";
