...
//Cria um campo data para a data de aprovacao do QDD
$obDtAprovacaoQDD = new Data();
$obDtAprovacaoQDD->setRotulo('Data de Aprovação do QDD');
$obDtAprovacaoQDD->setName('dtAprovacaoQDD');
$obDtAprovacaoQDD->setId('dtAprovacaoQDD');
$obDtAprovacaoQDD->setNull( false );

//Cria um campo para o numero do QDD
$obInNumeroQDD = new Inteiro();
$obInNumeroQDD->setRotulo('Número do QDD');
$obInNumeroQDD->setName('numQDD');
$obInNumeroQDD->setId('numQDD');
$obInNumeroQDD->setNull( false );
$obInNumeroQDD->setMaxLength( 8 );
...
$obFormulario->addComponente( $obDtAprovacaoQDD );
$obFormulario->addComponente( $obInNumeroQDD );
