...
switch ($_REQUEST['stAcao']) {
  default:
    ...
    $obMapeamento->setDado('parametro','numero_qdd');
    $obMapeamento->setDado('valor', $_REQUEST['numQDD']);
    $obMapeamento->recuperaPorChave( $rsConfiguracao );
    if ( $rsConfiguracao->getNumLinhas() > 0 ) {
        $obMapeamento->alteracao();
    } else {
    ...
    $obMapeamento->setDado('parametro','data_aprovacao_qdd');
    $obMapeamento->setDado('valor', $_REQUEST['dtAprovacaoQDD']);
    $obMapeamento->recuperaPorChave( $rsConfiguracao );
    if ( $rsConfiguracao->getNumLinhas() > 0 ) {
        $obMapeamento->alteracao();
    } else {
