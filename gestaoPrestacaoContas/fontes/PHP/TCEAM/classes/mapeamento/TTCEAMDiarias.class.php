...
<?php
/**
    * Extens�o da Classe de mapeamento
    * Data de Cria��o: 30/01/2007
...
*/
class TTCEAMDiarias extends Persistente
{
    /**
        * M�todo Construtor
        * @access Private
    */
    public function TTCEAMDiarias()
    {
        parent::Persistente();
        $this->setDado('exercicio', Sessao::getExercicio() );
    }

    public function recuperaDiarias(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
    {
        $obErro      = new Erro;
    ...
    public function montaRecuperaDiarias()
    {
        ...
        FROM (
                   SELECT despesa.exercicio
                        ...
                        , tipo_documento_diaria.matricula           AS matricula
                        , tipo_documento_diaria.funcionario         AS funcionario
                        , tipo_documento_diaria.destino             AS destino
                        , tipo_documento_diaria.quantidade          AS quantidade
                        , to_char(tipo_documento_diaria.dt_saida,'dd/mm/yyyy')     AS data_saida
                        , replace(tipo_documento_diaria.hora_saida::text,':','')   AS hora_saida
                        , to_char(tipo_documento_diaria.dt_retorno,'dd/mm/yyyy')         AS data_retorno
                        , tipo_documento_diaria.motivo             AS motivo
                        , replace(tipo_documento_diaria.hora_retorno::text,':','')   AS hora_retorno
                        , documento.vl_total                        AS valor_total_documento
                        , documento.vl_comprometido                 AS valor_comprometido_documento
               ...
               INNER JOIN tceam.tipo_documento_diaria
                       ON tipo_documento_diaria.cod_documento = documento.cod_documento
