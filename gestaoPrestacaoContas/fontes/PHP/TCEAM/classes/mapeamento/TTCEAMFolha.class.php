...
*/
class TTCEAMFolha extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCEAMFolha()
    {
        parent::Persistente();
        $this->setDado('exercicio', Sessao::getExercicio() );
    }

    public function recuperaFolha(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;

        $stSql = $this->montaRecuperaFolha().$stCondicao.$stOrdem;
        $this->setDebug( $stSql );
    ...
    public function montaRecuperaFolha()
    {
        ...
        FROM (
                   SELECT despesa.exercicio
                        ...
                        , tipo_documento_folha.exercicio            AS exercicio_folha
                        , tipo_documento_folha.mes                  AS mes
               ...
               INNER JOIN tceam.tipo_documento_folha
                       ON tipo_documento_folha.cod_documento = documento.cod_documento
