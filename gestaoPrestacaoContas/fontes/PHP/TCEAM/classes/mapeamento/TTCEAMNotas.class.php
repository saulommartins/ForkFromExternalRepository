...
*/
class TTCEAMNotas extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCEAMNotas()
    {
        parent::Persistente();
        $this->setDado('exercicio', Sessao::getExercicio() );
    }

    public function recuperaNotas(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;

        $stSql = $this->montaRecuperaNotas().$stCondicao.$stOrdem;
       $this->setDebug( $stSql );
    ...
    public function montaRecuperaNotas()
    {
        ...
        FROM (
                   SELECT despesa.exercicio
                        ...
                        , tipo_documento_nota.numero_nota_fiscal    AS numero_nota_fiscal
                        , documento.vl_total                        AS valor_total_documento
                        , documento.vl_comprometido                 AS valor_comprometido_documento
                        , tipo_documento_nota.numero_serie          AS numero_serie
                        , tipo_documento_nota.numero_subserie       AS numero_subserie
                        , to_char(tipo_documento_nota.data,'dd/mm/yyyy') AS data_documento
               ...
               INNER JOIN tceam.tipo_documento_nota
                       ON tipo_documento_nota.cod_documento = documento.cod_documento
