...
*/
class TTCEAMDiverso extends Persistente
{
    /**
        * M�todo Construtor
        * @access Private
    */
    public function TTCEAMDiverso()
    {
        parent::Persistente();
        $this->setDado('exercicio', Sessao::getExercicio() );
    }

    public function recuperaDiverso(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;

        $stSql = $this->montaRecuperaDiverso().$stCondicao.$stOrdem;
        $this->setDebug( $stSql );
    ...
    public function montaRecuperaDiverso()
    {
        $stSql = " SELECT exercicio                          --ano do empenho para a despesa
           ...
           , sum(valor_total_pago) as valor_total_documento
           , descricao_documento
           , nome_documento
           , data_documento
           , data_pagamento
        ...
        FROM (
                   SELECT despesa.exercicio
                        ...
                        , tipo_documento_diverso.numero             AS numero_documento
                        , documento.vl_total                        AS valor_total_documento
                        , nota_liquidacao_paga.vl_pago              AS valor_total_pago
                        , tipo_documento_diverso.descricao          AS descricao_documento
                        , tipo_documento_diverso.nome_documento
                        , to_char(tipo_documento_diverso.data,'dd/mm/yyyy') AS data_documento
               ...
               INNER JOIN tceam.tipo_documento_diverso
                       ON tipo_documento_diverso.cod_documento = documento.cod_documento
