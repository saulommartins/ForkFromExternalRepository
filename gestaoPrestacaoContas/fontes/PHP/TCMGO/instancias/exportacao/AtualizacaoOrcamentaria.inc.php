...
*/
    ...
    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBDotacao.class.php" );
    $obTMapeamento = new TTPBDotacao();
    $obTMapeamento->setDado('exercicio'  , Sessao::getExercicio() );
    $obTMapeamento->setDado('inMes'      , $inMes );
    $obTMapeamento->setDado('stEntidades', $stEntidades );
    $obTMapeamento->recuperaAtualizacaoOrcamentaria($arRecordSet[$stArquivo]);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_suplementacao");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
