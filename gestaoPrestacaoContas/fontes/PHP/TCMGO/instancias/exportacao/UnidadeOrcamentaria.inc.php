...
*/
    ...
    $obTMapeamento = new TOrcamentoUnidade();
    $obTMapeamento->setDado('inMes'      , $inMes );
    $obTMapeamento->setDado('stEntidades', $stEntidades );
    $obTMapeamento->recuperaRelacionamento($arRecordSet[$stArquivo], " AND UO.exercicio='Sessao::getExercicio()' ORDER BY UO.num_orgao, UO.num_unidade ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("[]XXX");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(60);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("[]123456789");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
