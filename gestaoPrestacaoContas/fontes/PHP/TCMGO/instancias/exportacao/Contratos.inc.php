...
*/
    ...
    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBContratos.class.php" );
    $obTMapeamento = new TTPBContratos();
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("prazo_vigencia");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(08);
