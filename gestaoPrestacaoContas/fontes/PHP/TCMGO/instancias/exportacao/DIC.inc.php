...
include_once( CAM_GPC_TGO_MAPEAMENTO."TTGODIC.class.php" );

$arFiltroRelatorio = Sessao::read('filtroRelatorio');

$obTMapeamento = new TTGODIC();
$obTMapeamento->setDado('dt_inicio', sistemaLegado::dataToSql($arFiltroRelatorio['stDataInicial']));
$obTMapeamento->setDado('dt_fim'   , sistemaLegado::dataToSql($arFiltroRelatorio['stDataFinal']));
$obTMapeamento->recuperaPorPeriodo($arRecordSet[$stArquivo]);
$i = 0;
$j = 0;
