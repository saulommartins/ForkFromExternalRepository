...
<?php
/**
    * Página de Filtro - Exportação Arquivos Orçamentários
...
$arNomeArquivos = array(
                       array('Arquivo' => 'AMP.txt'  ,'Nome'=>'AMP'),
                       array('Arquivo' => 'DSP.txt'  ,'Nome'=>'DSP'),
                       array('Arquivo' => 'IDE.txt'  ,'Nome'=>'IDE'),
                       array('Arquivo' => 'ISI.txt'  ,'Nome'=>'ISI'),
                       array('Arquivo' => 'LDO.txt'  ,'Nome'=>'LDO'),
                       array('Arquivo' => 'LOC.txt'  ,'Nome'=>'LOC'),
                       array('Arquivo' => 'LPP.txt'  ,'Nome'=>'LPP'),
                       array('Arquivo' => 'ORGAO.txt','Nome'=>'ORGAO'),
                       array('Arquivo' => 'PRO.txt'  ,'Nome'=>'PRO'),
                       array('Arquivo' => 'REC.txt'  ,'Nome'=>'REC'),
                       array('Arquivo' => 'UOC.txt'  ,'Nome'=>'UOC')
                       );
