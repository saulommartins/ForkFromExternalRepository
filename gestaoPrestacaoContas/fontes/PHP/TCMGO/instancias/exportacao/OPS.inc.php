...
*/
    ...
    include_once CAM_GPC_TGO_MAPEAMENTO."TTGOOPS.class.php";
    ...
    if (Sessao::getExercicio() > 2008) {
        ...
        $obTMapeamento->recuperaOrdemPagamentoMovimentacao($rsOrdemPagamentoMovimentacao);
    }
    ...
    foreach ($rsOrdemPagamento->arElementos as $arOrdemPagamento) {
        ...
        //VERIFICA SE É 2009 PARA LAYOUT NOVO
        if (Sessao::getExercicio() < 2009 ) {
            ...
            foreach ($rsOrdemPagamentoMovimentacao->arElementos as $arOPMovimentacao) {
				...
				$arOPMovimentacao['nroprojativ'].$arOPMovimentacao['elementodespesa'].$arOPMovimentacao['subelemento'].$arOPMovimentacao['dotorigp2001'].$arOPMovimentacao['nroempenho'].$arOPMovimentacao['nrdocumento'].$arOPMovimentacao['nroop'];
				
				if ($stChave === $stChaveMovimentacao) {
					...
					$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nrcheque");
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(15);

					$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vlcheque");
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(13);
					...
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
					$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(251);
				...
				foreach ($rsOrdemPagamentoLiquidacoes->arElementos as $arOPLiquidacoes) {
    				...
    				if ($stChaveSemDocumentoLiquidacao === $stChaveLiquidacoes) {
    					...
    					if (Sessao::getExercicio() > '2011') {
    						...
    						$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("brancos");
    						$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    						$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(263);
    					}
                ...
                if ($stChaveSemDocumentoLiquidacao === $stChaveMovimentacao) {
                    ...
                    if (Sessao::getExercicio() > '2011') {
                        ...
                        if (Sessao::getExercicio() > '2010' ) {
                            ...
                            $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(223);
                        }
                    }
            ...
            if (Sessao::getExercicio() == '2011') {
                ...
                foreach ($rsOrdemPagamentoFonteRecursos->arElementos as $arOPFonteRecursos) {
                    ...
                    if ($stChave2 === $stChaveFonteRecursos) {
                        $boEncontrado13 = true;
                        $arOPFonteRecursos['numero_sequencial'] = ++$inCount;
                        ...
                        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("brancos");
                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(241);
            ...
            foreach ($rsOrdemPagamentoRetencao->arElementos as $arOPRetencao) {
                ...
                if ($stChaveSemDocumento == $stChaveRetencao && $inCodOrdem == $arOPRetencao['nroop']) {
                    ...
                    if (Sessao::getExercicio() > '2011') {
                        ...
                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(230);
                    }
    ...
    if (Sessao::getExercicio() > '2011') {
		if (Sessao::getExercicio() >= '2014') {
			...
			$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("espacador");
			$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
			$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(414);			
		}
    } else {
		$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("espacador");
		$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
		$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(353);
    }
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("numero_sequencial");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(06);
