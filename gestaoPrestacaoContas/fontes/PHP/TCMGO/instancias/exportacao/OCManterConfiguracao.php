...
switch ($stCtrl) {
    case "BuscaCodigo":
          if ($_REQUEST['inCodEntidade'] != '') {
            ...
            $obTLicitacaoPreEmpenho->setDado('cod_entidade',$arFiltroRelatorio['cod_entidade']);
            ...
            if ($rsLicitacaoEmpenho->getCampo('cod_licitacao') != '') {
                ...
                $obTComprasOrdemCompra->setDado('cod_entidade',$arFiltroRelatorio['cod_entidade']);
                ...
                while (!$rsItens->eof()) {
                    ...
                    $arItens[$inCount]['vl_oc'] = bcmul($arItens[$inCount]['qtd_oc'],$arItens[$inCount]['vl_unitario'],2);
                    $arItens[$inCount]['qtd_saldo'] = bcsub($rsItens->getCampo('quantidade_emp'),$arItens[$inCount]['qtd_oc'],2);
