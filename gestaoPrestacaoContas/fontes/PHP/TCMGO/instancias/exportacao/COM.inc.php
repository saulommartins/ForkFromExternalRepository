...
/*
$Log$
Revision 1.3  2007/06/12 18:33:46  hboaventura
inclusão dos casos de uso uc-06.04.00

Revision 1.2  2007/05/23 19:39:24  bruce
ligando a unidade

Revision 1.1  2007/05/22 20:43:02  bruce
*** empty log message ***

*/
        include_once( CAM_GPC_TGO_MAPEAMENTO."TTCMGOAtivoPassivoConpensados.class.php" );

        $obTMapeamento = new TTCMGOPassivoFinanceiro ;
        ...
        foreach ($arRecordSet[$stArquivo]->arElementos as $stChave) {
            ...
            $arRecordSet[$stArquivo]->arElementos[$i]['tipo_registro']   = 10;
            $arRecordSet[$stArquivo]->arElementos[$i]['vl_reavaliacao']  = 0;
            $arRecordSet[$stArquivo]->arElementos[$i]['vl_baixa']        = 0;
            $arRecordSet[$stArquivo]->arElementos[$i]['vl_depreciacao']  = 0;
            $i++;
        }
        ...
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_inscricao");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(13);
        ...
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vl_baixa");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(13);

        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vl_depreciacao");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(13);
