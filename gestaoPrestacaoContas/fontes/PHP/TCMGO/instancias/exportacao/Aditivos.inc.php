...
*/
    ...
    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBAditivos.class.php" );
    $obTMapeamento = new TTPBAditivos();
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_aditivado");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
