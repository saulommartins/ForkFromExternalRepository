...
<?php
/**
  * Página de Include Oculta - Exportação Arquivos TCMGO - ORGAO
...
include_once( CAM_GPC_TGO_MAPEAMENTO."TTCMGOArquivoOrcamentoOrgao.class.php" );

    $arFiltroRelatorio = Sessao::read('filtroRelatorio');
    $obTMapeamento = new TTCMGOArquivoOrcamentoOrgao;
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cpf_gestor");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
