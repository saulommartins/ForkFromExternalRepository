...
<?php
/**
  * Página de Include Oculta - Exportação Arquivos TCMGO - DSP
...
*/
    ...
    include_once( CAM_GPC_TGO_MAPEAMENTO."TTCMGOArquivoOrcamentoDSP.class.php" );
    $arFiltroRelatorio = Sessao::read('filtroRelatorio');

    $obTMapeamento = new TTCMGOArquivoOrcamentoDSP();
    $obTMapeamento->setDado('exercicio'  , Sessao::getExercicio() );
    $obTMapeamento->setDado('cod_entidade',$stEntidades );
    $obTMapeamento->recuperaDSP10( $rsDSP10 );
    $obTMapeamento->recuperaDSP11( $rsDSP11 );
  
    $inCount = 0;
    //loop do tipo 10
    foreach ($rsDSP10->arElementos as $arDSP10) {

        $stChave =  $arDSP10['cod_programa']
                    .$arDSP10['num_orgao']
                    .$arDSP10['num_unidade']
                    .$arDSP10['cod_funcao']
                    .$arDSP10['cod_subfuncao']
                    .$arDSP10['natureza_acao']
                    .$arDSP10['num_proj_atividade']
                    .$arDSP10['elemento_despesa'];

        $arDSP10['numero_sequencial'] = ++$inCount;
        ...
        //loop do tipo 11
        foreach ($rsDSP11->arElementos as $arDSP11) {
            $stChaveElemento =  $arDSP11['cod_programa']
                                .$arDSP11['num_orgao']
                                .$arDSP11['num_unidade']
                                .$arDSP11['cod_funcao']
                                .$arDSP11['cod_subfuncao']
                                .$arDSP11['natureza_acao']
                                .$arDSP11['num_proj_atividade']
                                .$arDSP11['elemento_despesa'];

            if ($stChave === $stChaveElemento) {
                $arDSP11['numero_sequencial'] = ++$inCount;
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(41);
