...
<?php
/**
  * Página de Include Oculta - Exportação Arquivos TCMGO - IDE.txt
  ...
  *
*/
    include_once( CAM_GPC_TGO_MAPEAMENTO."TTCMGOArquivoOrcamentoIDE.class.php" );

    $arFiltroRelatorio = Sessao::read('filtroRelatorio');

    $obTTCMGOArquivoOrcamentoIDE = new TTCMGOArquivoOrcamentoIDE();
    $obTTCMGOArquivoOrcamentoIDE->setDado('stEntidades', $stEntidades );
    $obTTCMGOArquivoOrcamentoIDE->setDado('inCodModulo', 42 );
    $obTTCMGOArquivoOrcamentoIDE->recuperaTodos($arRecordSet[$stArquivo]);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ano_referencia_loa");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(04);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ano_inicial_ppa");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(04);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ano_final_ppa");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(04);
