...
/**
  ...
  *
  * @ignore
  * $Id: ISI.inc.php 65168 2016-04-29 16:36:09Z michel $
*/

include_once( CAM_GPC_TGO_MAPEAMENTO.Sessao::getExercicio()."/TTCMGOArquivoOrcamentoISI.class.php" );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nom_responsavel_tec");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(50);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("email_responsavel_tec");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(100);
