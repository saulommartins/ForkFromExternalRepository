...
<?php
/**
    * Página de Include Oculta - Exportação Arquivos Balanço TCMGO- Orgao.txt
...
*/
    ...
    include_once( CAM_GPC_TGO_MAPEAMENTO.Sessao::getExercicio()."/TTCMGOOrgao.class.php" );

    $arFiltroRelatorio = Sessao::read('filtroRelatorio');
    $obTMapeamento = new TTCMGOOrgao();
    $obTMapeamento->setDado('exercicio'  , Sessao::getExercicio() );
    $obTMapeamento->recuperaOrgao( $rsOrgao );

    $i = 0;

    foreach ($rsOrgao->arElementos as $stChave) {
        $rsOrgao->arElementos[$i]['numero_sequencial'] = $i+1;
        $i++;
    }

    $obExportador->roUltimoArquivo->addBloco($rsOrgao);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("desc_orgao");
