...
/**
    ...
    * $Id: FMManterPpdaaaa.php 59612 2014-09-02 12:00:51Z gelson $
...
$obCmbTipoLancamento->addOption ('1','Dívida Fundada Interna');
$obCmbTipoLancamento->addOption ('2','Dívida Fundada Externa');
...
$obBscConta->setFuncaoBusca("abrePopUp('".CAM_GF_CONT_POPUPS."planoConta/FLPlanoConta.php','frm','inCodConta','stConta','conta_analitica_estrutural','".Sessao::getId()."&inCodIniEstrutural=2&tipoBusca2=Ppdaaaa','800','550');");
