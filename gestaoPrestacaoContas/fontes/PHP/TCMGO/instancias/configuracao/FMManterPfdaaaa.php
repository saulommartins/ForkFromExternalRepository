...
/**
    ...
    * $Id: FMManterPfdaaaa.php 59612 2014-09-02 12:00:51Z gelson $
...
$obCmbTipoLancamento->addOption ('1','Depósitos');
$obCmbTipoLancamento->addOption ('2','Débitos Tesouraria');
$obCmbTipoLancamento->addOption ('3','Diversos');
$obCmbTipoLancamento->obEvento->setOnChange("montaParametrosGET('preencheDesdobramento','inTipoLancamento','true');");
...
$obBscConta->setFuncaoBusca("abrePopUp('".CAM_GF_CONT_POPUPS."planoConta/FLPlanoConta.php','frm','inCodConta','stConta','conta_analitica_estrutural','".Sessao::getId()."&inCodIniEstrutural=2&tipoBusca2=Pfdaaaa','800','550');");

$obBtnOk = new Button();
$obBtnOk->setValue('Incluir');
$obBtnOk->obEvento->setOnClick("montaParametrosGET('incluirConta','inTipoLancamento,inCodConta,inCodDesdobramento','true');");
