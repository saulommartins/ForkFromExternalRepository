...
Revision 1.1  2007/05/15 19:01:32  hboaventura
Arquivos para geração do TCMGO
...
<script type="text/javascript">
    ...
    function excluirListaItens( id,tipo_lancamento,desdobramento_tipo ){
        ajaxJavaScript('<?=$pgOcul."?".Sessao::getId()?>&id='+id+'&tipo_lancamento='+tipo_lancamento+'&desdobramento_tipo='+desdobramento_tipo,'excluirListaItens');
    }
