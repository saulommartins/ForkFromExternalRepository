...
/**
    ...
    * $Id: OCManterAfraaaa.php 59612 2014-09-02 12:00:51Z gelson $
...
switch ($stCtrl) {
    case 'buscaEstrutural' :
        ...
        $stFiltro.= " AND NOT EXISTS ( SELECT 	1
                                               ...
                                               WHERE    balanco_afraaaa.cod_plano = pa.cod_plano
                                                 AND    balanco_afraaaa.exercicio = pa.exercicio
                                            ) ";
    ...
    case 'preencheLista' :
        if ($_REQUEST['inTipoLancamento'] != '') {
            $obTTGOBalancoAfraaa = new TTGOBalancoAfraaaa();
            $obTTGOBalancoAfraaa->setDado( 'exercicio', Sessao::getExercicio() );
            $obTTGOBalancoAfraaa->setDado( 'tipo_lancamento', $_REQUEST['inTipoLancamento'] );
            $obTTGOBalancoAfraaa->recuperaRelacionamento( $rsContas );
            while ( !$rsContas->eof() ) {
                $boExiste = false;
