...
<?php
/**
 * Arquivo de processamento de cheques
 *
 * @category    Urbem
 * @package     Tesouraria
...
include CAM_GPC_TGO_CONTROLE . 'CTGOConfiguracao.class.php';
include CAM_GPC_TGO_NEGOCIO . 'RTGOConfiguracao.class.php';

$stAcao = $request->get('stAcao');
//Instancia o model
$obModel = new RTGOConfiguracao();
//instancia o controller
$obController = new CTGOConfiguracao($obModel);
