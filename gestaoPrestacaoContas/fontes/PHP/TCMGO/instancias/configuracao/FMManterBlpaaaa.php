...
/**
    ...
    * $Id: FMManterBlpaaaa.php 59612 2014-09-02 12:00:51Z gelson $
...
$obCmbTipoLancamento->addOption ('2','Passívo');
...
$obBscConta->setFuncaoBusca("abrePopUp('".CAM_GF_CONT_POPUPS."planoConta/FLContaSintetica.php','frm','inCodConta','stConta','ativoPassivo&tipoLancamento='+document.getElementById('inTipoLancamento').value+'&tipoBusca2=Blpaaaa','".Sessao::getId()."&inTipoLancamento='+document.getElementById('inTipoLancamento').value,'800','550');");
