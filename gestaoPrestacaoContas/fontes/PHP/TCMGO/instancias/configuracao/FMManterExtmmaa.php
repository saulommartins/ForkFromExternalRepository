...
/**
    ...
    *$Id: FMManterExtmmaa.php 59612 2014-09-02 12:00:51Z gelson $
...
$obCmbTipoLancamento->addOption ('1','Depósitos/Consignações');
...
if( Sessao::getExercicio() < '2011' )
    ...
    $obCmbTipoLancamento->addOption ('5', 'Diversos');
