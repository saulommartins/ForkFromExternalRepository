...
<?php
/**
  * Página de filtro da Configuração de Metas de Arrecadacao da Receita
...
$obIntExercicio->setRotulo("Exercício de configurações para Metas de Arrecadação de Receita.");
$obIntExercicio->setTitle("Informe o exercício de vigência das configurações para Metas de Arrecadação de Receita.");
