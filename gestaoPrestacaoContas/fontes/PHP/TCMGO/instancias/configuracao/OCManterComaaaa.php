 ...
 */
 ...
 switch ($stCtrl) {
     case 'buscaEstrutural' :
        ...
        $stFiltro.= " AND pc.cod_estrutural LIKE '".$_REQUEST['inTipoLancamento'].".%' ";
        $stFiltro.= " AND NOT EXISTS ( SELECT 	1
                                                FROM 	tcmgo.balanco_comaaaa
                                               WHERE    balanco_comaaaa.cod_plano = pa.cod_plano
                                                 AND    balanco_comaaaa.exercicio = pa.exercicio
                                            ) ";
    ...
    case 'preencheLista' :
        if ($_REQUEST['inTipoLancamento'] != '') {
            ...
            $obTTGOBalancoComaaaa->setDado( 'tipo_lancamento', $_REQUEST['inTipoLancamento'] );
