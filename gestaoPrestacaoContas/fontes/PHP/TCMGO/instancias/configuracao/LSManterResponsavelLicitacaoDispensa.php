 ...
 * $Id: LSManterResponsavelLicitacaoDispensa.php 61611 2015-02-13 16:38:34Z carlos.silva $
 * $Name: $
 * $Revision: $
 * $Author: $
 * $Date: $
...
$obTLicitacaoLicitacao->setDado('cod_modalidade', '8,9');
...
if ($_REQUEST['inPeriodicidade'] != "") {
    ...
    if ($_REQUEST['stDataInicial']) {
        ...
        $stFiltro .= "  AND TO_DATE(ll.timestamp,'yyyy-mm-dd') BETWEEN TO_DATE('".$dtDataInicial."','dd/mm/yyyy')   \n";
