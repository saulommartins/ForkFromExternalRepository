...
/**
    ...
    * $Id: FMManterAfraaaa.php 59612 2014-09-02 12:00:51Z gelson $
...
$obCmbTipoLancamento->addOption ('001','Duodécimo Câmara Municipal');
$obCmbTipoLancamento->addOption ('002','FUNDEF');
$obCmbTipoLancamento->addOption ('003','FMS');
$obCmbTipoLancamento->addOption ('999','Outros');
...
$obBscConta->setFuncaoBusca("abrePopUp('".CAM_GF_CONT_POPUPS."planoConta/FLPlanoConta.php','frm','inCodConta','stConta','conta_analitica_estrutural','".Sessao::getId()."&inCodIniEstrutural=1&tipoBusca2=Afraaaa','800','550');");
