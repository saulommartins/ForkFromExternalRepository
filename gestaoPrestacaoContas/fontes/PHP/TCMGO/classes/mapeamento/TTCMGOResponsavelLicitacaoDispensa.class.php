 ...
 * $Id: TTCMGOResponsavelLicitacaoDispensa.class.php 61611 2015-02-13 16:38:34Z carlos.silva $
 * $Name: $
 * $Revision: $
 * $Author: $
 * $Date: $
...
class TTCMGOResponsavelLicitacaoDispensa extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCMGOResponsavelLicitacaoDispensa()
    {
        parent::Persistente();
        $this->setTabela('tcmgo.responsavel_licitacao_dispensa');
        $this->setCampoCod('');
        ...
        $this->AddCampo('cgm_resp_abertura_disp'     , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_cotacao_precos'    , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_recurso'           , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_ratificacao'       , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_publicacao_orgao'  , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_parecer_juridico'  , 'integer',  false,    '',   false, false);
        $this->AddCampo('cgm_resp_parecer_outro'     , 'integer',  false,    '',   false, false);
    }
    ...
    function montaRecuperaResponsaveisLicitacao()
    {
        $stSql ="   SELECT 10 as tipo_registro
                    ...
                    FROM licitacao.licitacao    
                       ...
                       JOIN tcmgo.responsavel_licitacao_dispensa
                         ON tcmgo.responsavel_licitacao_dispensa.exercicio      = licitacao.exercicio
                        AND tcmgo.responsavel_licitacao_dispensa.cod_licitacao  = licitacao.cod_licitacao
                        AND tcmgo.responsavel_licitacao_dispensa.cod_modalidade = licitacao.cod_modalidade
                        AND tcmgo.responsavel_licitacao_dispensa.cod_entidade   = licitacao.cod_entidade
              
                    JOIN (
                            SELECT *
                                    , 1 AS tipo_responsabilidade
                                    
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_abertura_licitacao
                        ...
                        UNION ALL                        
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_edital
                        ...
                        UNION ALL
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_pesquisa
                        ...
                        UNION ALL
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_recurso_orcamentario
                        ...
                        UNION ALL
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_conducao_licitacao
                        ...
                        UNION ALL
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm = responsavel_licitacao_dispensa.cgm_resp_homologacao
                        ...
                        UNION ALL
                            ...
                            FROM tcmgo.responsavel_licitacao_dispensa
                            JOIN sw_cgm_pessoa_fisica
                             ON sw_cgm_pessoa_fisica.numcgm =  responsavel_licitacao_dispensa.cgm_resp_adjudicacao

                    ) AS dadosResponsaveis
                         ON tcmgo.responsavel_licitacao_dispensa.exercicio     = dadosResponsaveis.exercicio
                        AND tcmgo.responsavel_licitacao_dispensa.cod_licitacao  = dadosResponsaveis.cod_licitacao
                        AND tcmgo.responsavel_licitacao_dispensa.cod_modalidade = dadosResponsaveis.cod_modalidade
                        AND tcmgo.responsavel_licitacao_dispensa.cod_entidade   = dadosResponsaveis.cod_entidade
                    ...
                    JOIN tcmgo.orgao
                        ON orgao.numcgm_contador = dadosResponsaveis.numcgm
    ...
    function montaRecuperaComissaoLicitacao()
    {
        $stSql = "SELECT DISTINCT 20 as tipo_registro
            ...
            JOIN tcmgo.orgao
                    ON orgao.numcgm_contador = tipo_membro.numcgm
