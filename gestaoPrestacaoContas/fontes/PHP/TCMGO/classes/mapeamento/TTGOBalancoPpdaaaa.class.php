...
class TTGOBalancoPpdaaaa extends Persistente
{
    /**
    * Método Construtor
    * @access Private
*/
    public function TTGOBalancoPpdaaaa()
    {
        parent::Persistente();
        $this->setTabela("tcmgo.balanco_ppdaaaa");
    ...
    {
        $stSql = "
            SELECT  balanco_ppdaaaa.cod_plano
                 ,  tipo_lancamento
                 ,  cod_estrutural
                 ,  nom_conta
        ...
        INNER JOIN  contabilidade.plano_conta
             ...
             WHERE  balanco_ppdaaaa.tipo_lancamento = ".$this->getDado('tipo_lancamento')."
               AND  balanco_ppdaaaa.exercicio = '".$this->getDado('exercicio')."' ";
        if ( $this->getDado( 'cod_plano' ) ) {
            $stSql.= " AND balanco_ppdaaaa.cod_plano = ".$this->getDado('cod_plano')." ";
        }
