...
class TTGOTRB extends PERSISTENTE
{
    ...
    public function montaRecuperaTransferenciasCredito()
    {
        ...
        if ($this->getDado('exercicio') > '2012') {
            ...
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_credito.cod_estrutural,1,9) = '1.1.1.1.1')                   \n";
            $stSql .= "              THEN '999999999999'                                                                   \n";
            $stSql .= "              ELSE LTRIM(split_part(num_conta_corrente,'-',1),'0')                                  \n";
            $stSql .= "         END AS num_conta_corrente                                                                  \n";
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_credito.cod_estrutural,1,9) = '1.1.1.1.1')                   \n";
            ...
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_credito.cod_estrutural,1,9) = '1.1.1.1.1')                   \n";
            $stSql .= "              THEN '03'                                                                             \n";
            $stSql .= "              WHEN (SUBSTR(plano_conta_credito.cod_estrutural,1,9) = '1.1.1.1.2')                   \n";
            $stSql .= "              THEN '01'                                                                             \n";
            $stSql .= "              ELSE '02'                                                                             \n";
            $stSql .= "         END AS tipo_conta                                                                          \n";
        }
        ...
        /*$stSql .= "  GROUP BY orgao_plano_banco_credito.num_orgao,
                              plano_conta_credito.cod_estrutural,
                              conta_corrente_credito.num_conta_corrente,
                              banco_credito.num_banco,
                              agencia_credito.num_agencia,
...
//        $stSql .= "    AND LTRIM(split_part(num_conta_corrente,'-',1),'0') <> LTRIM(split_part(conta_corrente_debito.num_conta_corrente_debito,'-',1),'0') \n";
    ...
    public function montaRecuperaTransferenciasDebito()
    {
        ...
        if ($this->getDado('exercicio') > '2012') {
            ...
            $stSql .= "        ,orgao_plano_banco_debito.num_orgao                                                           \n";
            $stSql .= "        , '01' as num_unidade                                                                         \n";
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_debito.cod_estrutural,1,9) = '1.1.1.1.1')                      \n";
            $stSql .= "              THEN '999999999999'                                                                     \n";
            $stSql .= "              ELSE LTRIM(split_part(conta_corrente_debito.num_conta_corrente,'-',1),'0')              \n";
            $stSql .= "         END AS num_conta_corrente                                                                    \n";
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_debito.cod_estrutural,1,9) = '1.1.1.1.1')                      \n";
            ...
            $stSql .= "        ,CASE WHEN (SUBSTR(plano_conta_debito.cod_estrutural,1,9) = '1.1.1.1.1')                      \n";
            $stSql .= "              THEN '03'                                                                               \n";
            $stSql .= "              WHEN (SUBSTR(plano_conta_debito.cod_estrutural,1,9) = '1.1.1.1.2')                      \n";
            $stSql .= "              THEN '01'                                                                               \n";
            $stSql .= "              ELSE '02'                                                                               \n";
            $stSql .= "         END AS tipo_conta                                                                            \n";
        }
        ...
        /*$stSql .= "  GROUP BY plano_conta_credito.cod_estrutural,
                              conta_corrente_credito_1.num_conta_corrente,
                              banco_credito.num_banco,
                              agencia_credito.num_agencia,
                              orgao_plano_banco_debito.num_orgao,
                              plano_conta_debito.cod_estrutural,
                              conta_corrente_debito.num_conta_corrente,
                              banco_debito.num_banco,
                              agencia_debito.num_agencia,
                              transferencia.exercicio,
