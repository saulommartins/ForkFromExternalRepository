...
class TTGOSubtipoVeiculoTCM extends Persistente
{
/**
    * Método Construtor
    * @access Private
...
function TTGOSubtipoVeiculoTCM()
{
    parent::Persistente();
    $this->setTabela('tcmgo.subtipo_veiculo_tcm');
    $this->setCampoCod('cod_subtipo_tcm');
    $this->setComplementoChave('');
    $this->AddCampo('cod_tipo_tcm'   , 'integer', true, ''   , true, true);
    $this->AddCampo('cod_subtipo_tcm', 'integer', true, ''   , true, false);
    $this->AddCampo('nom_subtipo_tcm', 'varchar', true, '200', false, false);
}
