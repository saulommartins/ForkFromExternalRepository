...
/*
 * Classe de mapeamento da tabela tcmgo.responsavel_tecnico
...
class TTCMGOResponsavelTecnico extends Persistente
{
    /**
    ...
    */
    ...
    {
        parent::Persistente();
        $this->setTabela  ('tcmgo.responsavel_tecnico');
    ...
    public function montaRecuperaResponsavelTecnico()
    {
        $stSql = "  SELECT       
                            ...
                            ,sw_cgm.nom_cgm
                            ,tipo_responsavel_tecnico.cod_tipo
                            ,tipo_responsavel_tecnico.descricao
                    ...
                    FROM tcmgo.responsavel_tecnico 
                    JOIN sw_cgm
                    ...
                    JOIN tcmgo.tipo_responsavel_tecnico
                         ON tipo_responsavel_tecnico.cod_tipo    = responsavel_tecnico.cod_tipo
    ...
    public function montaRecuperaArquivoTecnicoResponsavel()
    {
        $stSql = "  SELECT                      
                    ...
                    FROM sw_cgm 
                    JOIN tcmgo.responsavel_tecnico  
                         ON responsavel_tecnico.cgm_responsavel = sw_cgm.numcgm 
                    JOIN tcmgo.tipo_responsavel
