...
Revision 1.1  2007/05/07 20:55:03  hboaventura
...
class TTGOTipoLancamento extends Persistente
{
    /**
    * Método Construtor
    * @access Private
*/
    public function TTGOTipoLancamento()
    {
        parent::Persistente();
        $this->setTabela("tcmgo.tipo_lancamento");

        $this->setCampoCod('cod_tipo_lancamento');
        //his->setComplementoChave('cod_entidade,exercicio_entidade,cod_modalidade');

        $this->AddCampo( 'cod_tipo_lancamento' ,'integer' ,true, ''   ,true ,true  );
        $this->AddCampo( 'descricao','varchar' ,true, '10' ,false,false );
    }
}
