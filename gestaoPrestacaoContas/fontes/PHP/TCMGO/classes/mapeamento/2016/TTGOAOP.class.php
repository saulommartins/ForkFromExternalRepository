...
/**
    ...
    * @subpackage Mapeamento
    ...
    $Id: TTGOAOP.class.php 66337 2016-08-11 17:40:35Z lisiane $
...
*/
    ...
    public function montaRecuperaFinanceiraOrdemPagamento()
    {
        ...
        INNER JOIN empenho.pagamento_liquidacao_nota_liquidacao_paga
                ON nlpa.cod_entidade = pagamento_liquidacao_nota_liquidacao_paga.cod_entidade
               AND nlpa.cod_nota     = pagamento_liquidacao_nota_liquidacao_paga.cod_nota
               AND nlpa.exercicio    = pagamento_liquidacao_nota_liquidacao_paga.exercicio
               AND nlpa.timestamp    = pagamento_liquidacao_nota_liquidacao_paga.timestamp
