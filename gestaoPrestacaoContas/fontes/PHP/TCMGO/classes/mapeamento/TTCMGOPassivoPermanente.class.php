...
/**
    ...
    * @subpackage Mapeamento
    ...
    $Id: TTCMGOPassivoPermanente.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TTCMGOPassivoPermanente extends TContabilidadeBalancoFinanceiro
{
    public function TTCMGOPassivoPermanente()
    {
        ...
        $stSql = " select consulta.*
                     ...
                     from (
                           select plano_conta.cod_estrutural
                                ...
                                , balanco_ppdaaaa.tipo_lancamento
                                , orgao_plano_banco.num_orgao
                                , unidade.num_unidade
                                , grupo_plano_analitica_lei.nro_lei
                                , grupo_plano_analitica_lei.data_lei
                                ---- soma dos debitos
                                ...
                                ,coalesce ( ( select sum ( vl_lancamento  )
                                              ...
                                              where conta_credito.exercicio = plano_analitica.exercicio
                                                ...
                                                and valor_lancamento.tipo <> 'I'
                                                and conta_credito.cod_entidade in ( $stExercicio ) )
                                           , 0 ) as total_creditos
                           ...
                           join tcmgo.balanco_ppdaaaa
                             on ( plano_analitica.cod_plano = balanco_ppdaaaa.cod_plano
                            and   plano_analitica.exercicio = balanco_ppdaaaa.exercicio )
                           ...
                           join tcmgo.grupo_plano_analitica_lei
                             on ( balanco_ppdaaaa.cod_plano = grupo_plano_analitica_lei.cod_plano
                            and   balanco_ppdaaaa.exercicio = grupo_plano_analitica_lei.exercicio )
