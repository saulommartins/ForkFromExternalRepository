...
$obTMapeamento->recuperaEntidades($rsEntidade);

$obExportador->roUltimoArquivo->addBloco($rsEntidade);
...
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(160);
