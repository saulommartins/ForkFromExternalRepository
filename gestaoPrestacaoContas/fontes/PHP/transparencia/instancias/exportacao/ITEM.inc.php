 ...
 * Data de Criação: 13/05/2013

 * @author Desenvolvedor: Diogo
...
include_once CAM_GPC_TRANSPARENCIA_MAPEAMENTO."TTransparenciaItem.class.php";

$obTMapeamento = new TTransparenciaItem;
...
foreach ($arEntidades as $key) {
    ...
    $obTMapeamento->setDado('stCodEntidades' , $key);
    $obTMapeamento->recuperaTransparenciaItem($$rsRecordSet);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("data");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("numero_item");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);
