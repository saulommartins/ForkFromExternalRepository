...
$obTMapeamento = new TOrcamentoContaDespesa();
$obTMapeamento->setDado('exercicio', Sessao::getExercicio());
$obTMapeamento->recuperaDadosExportacao($rsRubrica);

$obExportador->roUltimoArquivo->addBloco($rsRubrica);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tnc");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nnc");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
