...
include_once CAM_GPC_TRANSPARENCIA_MAPEAMENTO."TTransparenciaLiquidacao.class.php";

$obTMapeamento = new TTransparenciaLiquidacao;
$obTMapeamento->setDado('stExercicio'    , Sessao::getExercicio());
...
$obTMapeamento->recuperaDadosExportacao($rsLiquidacao);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_nota"); //num liquidacao
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
