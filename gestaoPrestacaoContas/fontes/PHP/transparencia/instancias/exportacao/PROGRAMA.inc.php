...
$obTMapeamento = new TOrcamentoPrograma;
$obTMapeamento->setDado('exercicio', $stExercicio);
$obTMapeamento->recuperaDadosExportacao($rsPrograma, $stCondicao, $stOrdem, $boTransacao);

$obExportador->roUltimoArquivo->addBloco($rsPrograma);
