...
$obTMapeamento = new TEmpenhoEmpenho();

foreach ($arEntidades as $key) {
    $rsRecordSet = "rsEmpenho";
    $rsRecordSet .= $key;
    ...
    $obTMapeamento->recuperaTransparenciaExportacao($$rsRecordSet);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_estrutural"); //RUBRICA
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cgm"); //COD_CREDOR
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nom_modalidades");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
