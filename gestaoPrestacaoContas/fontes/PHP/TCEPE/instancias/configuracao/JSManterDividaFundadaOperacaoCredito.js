...
function limparDivida(){
    ...
    jQuery( '#vlSaldoAnteriorTitulo' ).val('')
    jQuery( '#vlInscricaoExercicioTitulo' ).val('')
    jQuery( '#vlBaixaExercicioTitulo' ).val('')
    jQuery( '#vlSaldoAnteriorContrato' ).val('')
    jQuery( '#vlInscricaoExercicioContrato' ).val('')
    jQuery( '#vlBaixaExercicioContrato' ).val('')
}
