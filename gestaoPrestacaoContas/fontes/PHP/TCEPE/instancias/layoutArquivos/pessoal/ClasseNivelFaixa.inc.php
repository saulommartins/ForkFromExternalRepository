...
/**
  ...
  * $Date: 2015-01-15 17:32:48 -0200 (Thu, 15 Jan 2015) $
  * $Author: jean $
  * $Rev: 61426 $
  *
*/

include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEClasseNivelFaixa.class.php";
include_once CAM_GRH_FOL_MAPEAMENTO.'TFolhaPagamentoPeriodoMovimentacao.class.php';

$boTransacao = new Transacao();
$obTTCEPEClasseNivelFaixa = new TTCEPEClasseNivelFaixa();

if ($inCodEntidade == SistemaLegado::pegaConfiguracao('cod_entidade_prefeitura',8,Sessao::getExercicio())) {
    $inCodEntidade = '';
}

$obTTCEPEClasseNivelFaixa->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPEClasseNivelFaixa->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPEClasseNivelFaixa->setDado('competencia'          , $inCodCompetencia      );
$obTTCEPEClasseNivelFaixa->setDado('dt_inicial'           , $stDataInicial         );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nomenclatura");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
