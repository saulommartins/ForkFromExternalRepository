...
<?php
/**
  * Layout exportação TCE-PE arquivo : Retencao
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Retencao.inc.php 60527 2014-10-27 16:33:17Z jean $
  * $Date: 2014-10-27 14:33:17 -0200 (Mon, 27 Oct 2014) $
  * $Author: jean $
  * $Rev: 60527 $
  *
*/
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPERetencao.class.php";

$boTransacao = new Transacao();
$obTTCEPERetencao = new TTCEPERetencao();

$obTTCEPERetencao->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPERetencao->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPERetencao->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPERetencao->setDado('dt_final'             , $stDataFinal           );
$obTTCEPERetencao->setDado('unidade_gestora'      , $stUnidadeGestora      );
if ($inCodCompetencia < 10) {
  $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPERetencao->setDado('mes'                  , $inCodCompetencia       );

$obTTCEPERetencao->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
