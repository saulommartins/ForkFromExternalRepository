...
<?php
/**
  * Layout exportação TCE-PE arquivo : Acao
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Acao.inc.php 60151 2014-10-02 14:36:47Z evandro $
  * $Date: 2014-10-02 11:36:47 -0300 (Thu, 02 Oct 2014) $
  * $Author: evandro $
  * $Rev: 60151 $
  *
*/
...
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEAcao.class.php";

$boTransacao = new Transacao();
$obTTCEPEAcao = new TTCEPEAcao();

$obTTCEPEAcao->setDado('exercicio'   , Sessao::getExercicio()  );
$obTTCEPEAcao->setDado('cod_entidade', $inCodEntidade          );
$obTTCEPEAcao->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
