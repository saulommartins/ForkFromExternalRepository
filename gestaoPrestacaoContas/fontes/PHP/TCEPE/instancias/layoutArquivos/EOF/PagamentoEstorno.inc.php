...
/**
  ...
  *
  * @ignore
  * $Id: PagamentoEstorno.inc.php 60342 2014-10-14 21:14:33Z jean $
  * $Date: 2014-10-14 18:14:33 -0300 (Tue, 14 Oct 2014) $
  * $Author: jean $
  * $Rev: 60342 $
  *
*/

include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEPagamentoEstorno.class.php";

$boTransacao = new Transacao();
$obTTCEPEPagamentoEstorno = new TTCEPEPagamentoEstorno();

$obTTCEPEPagamentoEstorno->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPEPagamentoEstorno->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPEPagamentoEstorno->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPEPagamentoEstorno->setDado('dt_final'             , $stDataFinal           );
$obTTCEPEPagamentoEstorno->setDado('unidade_gestora'      , $stUnidadeGestora      );

$obTTCEPEPagamentoEstorno->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
