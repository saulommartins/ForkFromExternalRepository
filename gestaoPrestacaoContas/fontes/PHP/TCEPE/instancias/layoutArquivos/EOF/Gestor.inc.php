...
<?php
/**
  * Layout exportação TCE-PE arquivo :  Gestor.txt
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Gestor.inc.php 60270 2014-10-09 18:48:46Z arthur $
  * $Date:$
  * $Author:$
  * $Rev:$
  *
...
$obTTCEPEConfiguracaoGestor->setDado('cod_entidade', $inCodEntidade          );
$obTTCEPEConfiguracaoGestor->setDado('data_inicial', $stDataInicial          );
$obTTCEPEConfiguracaoGestor->setDado('data_final'  , $stDataFinal            );
$obTTCEPEConfiguracaoGestor->recuperaExportacaoGestor($rsRecordSet, "" ,"" , $boTransacao );
