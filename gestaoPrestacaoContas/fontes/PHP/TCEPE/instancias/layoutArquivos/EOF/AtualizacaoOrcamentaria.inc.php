...
/*
  ...
  * Layout exportação TCE-PE arquivo : Atualizacao Orcamentaria
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: AtualizacaoOrcamentaria.inc.php 60515 2014-10-24 19:20:23Z carolina $
  * $Date: 2014-10-24 17:20:23 -0200 (Fri, 24 Oct 2014) $
  * $Author: carolina $
  * $Rev: 60515 $
  *
*/
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEAtualizacaoOrcamentaria.class.php";

$boTransacao = new Transacao();
$obTTCEPEAtualizacaoOrcamentaria = new TTCEPEAtualizacaoOrcamentaria();

$obTTCEPEAtualizacaoOrcamentaria->setDado('exercicio'      , Sessao::getExercicio() );
$obTTCEPEAtualizacaoOrcamentaria->setDado('cod_entidade'   , $inCodEntidade         );
$obTTCEPEAtualizacaoOrcamentaria->setDado('dt_inicial'     , $stDataInicial         );
$obTTCEPEAtualizacaoOrcamentaria->setDado('dt_final'       , $stDataFinal           );
$obTTCEPEAtualizacaoOrcamentaria->setDado('unidade_gestora', $stUnidadeGestora      );
$obTTCEPEAtualizacaoOrcamentaria->recuperaTodos($rsRecordSet, "","" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_norma");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_alteracao_orcamentaria");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
