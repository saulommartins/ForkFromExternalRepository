...
<?php
/**
  * Layout exportação TCE-PE arquivo : Programas
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Programas.inc.php 60291 2014-10-10 18:07:42Z carlos.silva $
  * $Date: 2014-10-10 15:07:42 -0300 (Fri, 10 Oct 2014) $
  * $Author: carlos.silva $
  * $Rev: 60291 $
  *
*/
...
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEProgramas.class.php";

$boTransacao = new Transacao();
$obTTCEPEProgramas = new TTCEPEProgramas();

$obTTCEPEProgramas->setDado('exercicio'   , Sessao::getExercicio() );
$obTTCEPEProgramas->setDado('cod_entidade', $inCodEntidade         );
$obTTCEPEProgramas->recuperaArquivoTCEPEProgramas($rsRecordSet, "" ,"" , $boTransacao );
