...
/**
  ...
  *
  * @ignore
  * $Id: RemuneracaoAgentesEletivos.inc.php 60556 2014-10-29 13:33:29Z jean $
  * $Date: 2014-10-29 11:33:29 -0200 (Wed, 29 Oct 2014) $
  * $Author: jean $
  * $Rev: 60556 $
  *
*/

include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPERemuneracaoAgentesEletivos.class.php";
include_once CAM_GRH_FOL_MAPEAMENTO.'TFolhaPagamentoPeriodoMovimentacao.class.php';

$boTransacao = new Transacao();
$obTTCEPERemuneracaoAgentesEletivos = new TTCEPERemuneracaoAgentesEletivos();
...
$obTTCEPERemuneracaoAgentesEletivos->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPERemuneracaoAgentesEletivos->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPERemuneracaoAgentesEletivos->setDado('competencia'          , $inCodCompetencia      );
$obTTCEPERemuneracaoAgentesEletivos->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPERemuneracaoAgentesEletivos->setDado('dt_final'             , $stDataFinal           );

$obTTCEPERemuneracaoAgentesEletivos->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ano_norma");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nom_agente");
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("remuneracao_permitida");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("remuneracao_percebida");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
