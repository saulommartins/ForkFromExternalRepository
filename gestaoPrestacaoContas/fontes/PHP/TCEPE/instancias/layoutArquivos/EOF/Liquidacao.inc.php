...
<?php
/**
  * Layout exportação TCE-PE arquivo : Liquidacao
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Liquidacao.inc.php 60426 2014-10-21 11:54:26Z gelson $
  * $Date: 2014-10-21 09:54:26 -0200 (Tue, 21 Oct 2014) $
  * $Author: gelson $
  * $Rev: 60426 $
  *
*/
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPELiquidacao.class.php";

$boTransacao = new Transacao();
$obTTCEPELiquidacao = new TTCEPELiquidacao();

$obTTCEPELiquidacao->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPELiquidacao->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPELiquidacao->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPELiquidacao->setDado('dt_final'             , $stDataFinal           );
if ( $inCodCompetencia < 10 ) {
    $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPELiquidacao->setDado('mes'                  , $inCodCompetencia       );

$obTTCEPELiquidacao->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_uf");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
