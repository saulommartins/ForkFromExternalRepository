...
<?php
/**
  * Layout exportação TCE-PE arquivo : Ordenador.txt
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Ordenador.inc.php 60270 2014-10-09 18:48:46Z arthur $
  * $Date: 2014-10-09 15:48:46 -0300 (Thu, 09 Oct 2014) $
  * $Author: arthur $
  * $Rev: 60270 $
  *
*/
...
$obTTCEPEConfiguracaoOrdenador->setDado('cod_entidade', $inCodEntidade          );
$obTTCEPEConfiguracaoOrdenador->setDado('data_inicial', $stDataInicial          );
$obTTCEPEConfiguracaoOrdenador->setDado('data_final'  , $stDataFinal            );
$obTTCEPEConfiguracaoOrdenador->recuperaExportacaoOrdenador($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_data");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
