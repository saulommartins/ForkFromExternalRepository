...
$obTTCEPESaldosContasContabeis = new TTCEPESaldosContasContabeis();
$obTTCEPESaldosContasContabeis->setDado('exercicio'   , $stExercicio      );
$obTTCEPESaldosContasContabeis->setDado('dt_inicial'  , $stDataInicial    );
$obTTCEPESaldosContasContabeis->setDado('dt_final'    , $stDataFinal      );
$obTTCEPESaldosContasContabeis->setDado('cod_entidade', $inCodEntidade    );
