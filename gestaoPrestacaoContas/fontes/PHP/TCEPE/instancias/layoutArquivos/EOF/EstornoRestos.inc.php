...
<?php
/**
  * Layout exportação TCE-PE arquivo : Estorno restos
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: EstornoRestos.inc.php 60426 2014-10-21 11:54:26Z gelson $
  * $Date: 2014-10-21 09:54:26 -0200 (Tue, 21 Oct 2014) $
  * $Author: gelson $
  * $Rev: 60426 $
  *
*/
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEEstornoRestos.class.php";

$boTransacao = new Transacao();
$obTTCEPEEstornoRestos = new TTCEPEEstornoRestos();

$obTTCEPEEstornoRestos->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPEEstornoRestos->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPEEstornoRestos->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPEEstornoRestos->setDado('dt_final'             , $stDataFinal           );
if ( $inCodCompetencia < 10 ) {
    $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPEEstornoRestos->setDado('mes'                  , $inCodCompetencia       );

$obTTCEPEEstornoRestos->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_estorno");
