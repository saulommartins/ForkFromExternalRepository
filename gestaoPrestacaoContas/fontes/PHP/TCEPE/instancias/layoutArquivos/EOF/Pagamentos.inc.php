...
<?php
/**
  * Layout exportação TCE-PE arquivo : Pagamentos 
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: Pagamentos.inc.php 60218 2014-10-07 16:28:42Z michel $
  * $Date: 2014-10-07 13:28:42 -0300 (Tue, 07 Oct 2014) $
  * $Author: michel $
  * $Rev: 60218 $
  *
*/
...
include_once(CAM_GPC_TCEPE_MAPEAMENTO.'TTCEPEPagamentos.class.php');

$boTransacao = new Transacao();

$obTTCEPEPagamentos = new TTCEPEPagamentos();
$obTTCEPEPagamentos->setDado('stEntidades', $inCodEntidade          );
$obTTCEPEPagamentos->setDado('dtInicial', $stDataInicial            );
$obTTCEPEPagamentos->setDado('dtFinal', $stDataFinal                );
$obTTCEPEPagamentos->setDado('stExercicio', Sessao::getExercicio()  );
$obTTCEPEPagamentos->recuperaPagamento($rsRecordSet);
