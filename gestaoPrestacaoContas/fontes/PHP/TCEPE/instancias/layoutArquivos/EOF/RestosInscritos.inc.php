...
<?php
/**
  * Layout exportação TCE-PE arquivo : Restos Inscritos
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: RestosInscritos.inc.php 60250 2014-10-08 18:07:08Z evandro $
  * $Date: 2014-10-08 15:07:08 -0300 (Wed, 08 Oct 2014) $
  * $Author: evandro $
  * $Rev: 60250 $
  *
*/
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPERestosInscritos.class.php";

$boTransacao = new Transacao();
$obTTCEPERestosInscritos = new TTCEPERestosInscritos();

$obTTCEPERestosInscritos->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPERestosInscritos->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPERestosInscritos->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPERestosInscritos->setDado('dt_final'             , $stDataFinal           );

$obTTCEPERestosInscritos->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("modalidade_licitacao");//modalidade licitacao
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("numero_licitacao");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(9);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_elemento_despesa");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
