...
<?php
/**
  * Layout exportação TCE-PE arquivo : LiquidacaoRestosEstorno
  ...
  *
  * @ignore
  * $Id: LiquidacaoRestosEstorno.inc.php 60426 2014-10-21 11:54:26Z gelson $
...
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPELiquidacaoRestosEstorno.class.php";

$boTransacao = new Transacao();
$obTTCEPELiquidacaoRestosEstorno = new TTCEPELiquidacaoRestosEstorno();

$obTTCEPELiquidacaoRestosEstorno->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPELiquidacaoRestosEstorno->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPELiquidacaoRestosEstorno->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPELiquidacaoRestosEstorno->setDado('dt_final'             , $stDataFinal           );
if ( $inCodCompetencia < 10 ) {
    $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPELiquidacaoRestosEstorno->setDado('mes'                  , $inCodCompetencia       );

$obTTCEPELiquidacaoRestosEstorno->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
