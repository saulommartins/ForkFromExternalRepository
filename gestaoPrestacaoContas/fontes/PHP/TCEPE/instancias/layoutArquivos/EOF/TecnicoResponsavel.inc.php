...
<?php
/**
  * Layout exportação TCE-PE arquivo : Tecnico Responsavel
  * Data de Criação
  ...
  *
  * @ignore
  * $Id: TecnicoResponsavel.inc.php 60477 2014-10-23 17:51:04Z jean $
  * $Date: 2014-10-23 15:51:04 -0200 (Thu, 23 Oct 2014) $
  * $Author: jean $
  * $Rev: 60477 $
  *
*/
...
$obTTCEPEResponsavelTecnico->setDado('stDataInicial' , $stDataInicial  );
$obTTCEPEResponsavelTecnico->setDado('stDataFinal'   , $stDataFinal  );
$obTTCEPEResponsavelTecnico->setDado('stEntidade'    , $inCodEntidade  );
if ($inCodCompetencia < 10) {
  $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPEResponsavelTecnico->setDado('mes'           , $inCodCompetencia       );
$obTTCEPEResponsavelTecnico->recuperaArquivoTecnicoResponsavel($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nom_tecnico");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(60);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("razao_social");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(70);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("provedor_sistema");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(70);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ddd_telefone");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("telefone_fixo");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("celular");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_tecnico");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
