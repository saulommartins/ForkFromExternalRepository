...
<?php
/**
  * Layout exportação TCE-PE arquivo : PagamentoRestoEstorno
  ...
  *
  * @ignore
  * $Id: PagamentoRestoEstorno.inc.php 60426 2014-10-21 11:54:26Z gelson $
...
include_once CAM_GPC_TCEPE_MAPEAMENTO."TTCEPEPagamentoRestoEstorno.class.php";

$boTransacao = new Transacao();
$obTTCEPEPagamentoRestoEstorno = new TTCEPEPagamentoRestoEstorno();

$obTTCEPEPagamentoRestoEstorno->setDado('exercicio'            , Sessao::getExercicio() );
$obTTCEPEPagamentoRestoEstorno->setDado('cod_entidade'         , $inCodEntidade         );
$obTTCEPEPagamentoRestoEstorno->setDado('dt_inicial'           , $stDataInicial         );
$obTTCEPEPagamentoRestoEstorno->setDado('dt_final'             , $stDataFinal           );

if ( $inCodCompetencia < 10 ) {
    $inCodCompetencia = '0'.$inCodCompetencia;
}
$obTTCEPEPagamentoRestoEstorno->setDado('mes'                  , $inCodCompetencia       );

$obTTCEPEPagamentoRestoEstorno->recuperaTodos($rsRecordSet, "" ,"" , $boTransacao );
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vl_estorno");
