...
class TTCEPELiquidacaoRestosEstorno extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
    function TTCEPELiquidacaoRestosEstorno()
    {
        parent::Persistente();
    }
        ...
        $stSql = " SELECT *
                    ...
                    FROM (
                            ...
                            SELECT
                                    ...
                                    , 'Estorno do Resto da Liquidação '||nota_liquidacao.cod_nota||'/'||nota_liquidacao.exercicio||' do Empenho '||empenho.cod_empenho||'/'||empenho.exercicio AS historico
