...
class TTPEPlanoAnaliticaRelacionamento extends Persistente
{
    /**
    * Método Construtor
    * @access Private
*/
    public function TTPEPlanoAnaliticaRelacionamento()
    {
        parent::Persistente();
        $this->setTabela("tcepe.plano_analitica_relacionamento");
    ...
    public function montaRecuperaContaAnalitica()
    {
        ...
        $stSQL  =" SELECT                                                   
             ...
             LEFT JOIN
                        tcepe.plano_analitica_tipo_retencao
                    ON  tcepe.plano_analitica_tipo_retencao.cod_plano = plano_analitica.cod_plano
                   AND  tcepe.plano_analitica_tipo_retencao.exercicio = plano_analitica.exercicio
