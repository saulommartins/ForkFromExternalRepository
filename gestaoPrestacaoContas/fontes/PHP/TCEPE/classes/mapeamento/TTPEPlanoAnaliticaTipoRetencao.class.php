...
/**
    ...
    * @subpackage Mapeamento
    ...
    $Id: TTPEPlanoAnaliticaTipoRetencao.class.php 60094 2014-09-29 20:36:00Z carlos.silva $
...
class TTPEPlanoAnaliticaTipoRetencao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
    public function TTPEPlanoAnaliticaTipoRetencao()
    {
        parent::Persistente();
        $this->setTabela("tcepe.plano_analitica_tipo_retencao");
