...
class TTCEPETipoTransferenciaRecebida extends Persistente
{
    ...
    public function TTCEPETipoTransferenciaRecebida()
    {
        parent::Persistente();
        $this->setTabela('tcepe.tipo_transferencia_recebida');
        ...
        $this->AddCampo('cod_entidade_transferidora' , 'integer' , true , ''  , false , true );
