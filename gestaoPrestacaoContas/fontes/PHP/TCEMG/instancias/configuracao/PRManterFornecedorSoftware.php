...
*/
/*
 * Processamento de Fornecedor De Software
 * Data de Criação: 06/01/2015
...
$stPrograma = "ManterFornecedorSoftware";
...
$obTAdministracaoConfiguracao->setDado('cod_modulo' , 55                        );
$obTAdministracaoConfiguracao->setDado('parametro'  , 'fornecedor_software'        );
