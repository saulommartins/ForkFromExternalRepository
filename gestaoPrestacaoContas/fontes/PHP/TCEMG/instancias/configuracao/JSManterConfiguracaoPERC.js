...
<?php
/**
  * Página de JavaScript da Configuração de PERC
...
function habilitaPercentual(){
    jQuery('#flPercentualEstabelecido').attr('disabled',false);
    jQuery('#flPercentualEstabelecido').css('background-color', '#ffffff');
}
