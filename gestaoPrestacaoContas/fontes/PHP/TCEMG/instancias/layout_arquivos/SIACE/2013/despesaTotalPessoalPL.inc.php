...
<?php
    ...
    */
    ...
    $obFTCEMGDespesaTotalPessoalPL->setDado('dt_inicial', $obBimestre->getDataInicial($arFiltros['inPeriodo'],Sessao::read('exercicio')) );
    $obFTCEMGDespesaTotalPessoalPL->setDado('dt_final'  , $obBimestre->getDataFinal($arFiltros['inPeriodo'],Sessao::read('exercicio')) );

    //1 MES
    $arTemp[0]["bimestre"] = $arFiltros['inPeriodo'];
