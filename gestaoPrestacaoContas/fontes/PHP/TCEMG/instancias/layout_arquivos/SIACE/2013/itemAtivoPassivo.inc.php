...
/*
    ...
    */
    ...
    $obTTCEMGItemAtivoPassivo->setDado('periodo'      , "12" );
    $obTTCEMGItemAtivoPassivo->setDado('dataInicial'  , "01/01/".Sessao::getExercicio() );
    $obTTCEMGItemAtivoPassivo->setDado('dataFinal'    , "31/12/".Sessao::getExercicio() );
