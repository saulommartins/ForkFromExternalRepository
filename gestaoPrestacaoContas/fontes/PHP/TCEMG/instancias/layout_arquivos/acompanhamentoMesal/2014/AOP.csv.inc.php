...
/**
  ...
  *
  * @ignore
  * $Id: AOP.csv.inc.php 62269 2015-04-15 18:28:39Z franver $
...
*/
include_once CAM_GPC_TCEMG_MAPEAMENTO.Sessao::getExercicio()."/TTCEMGAOP.class.php";
...
if (count($rsRecordSetAOP10->getElementos()) > 0) {
    ...
    foreach ($rsRecordSetAOP10->getElementos() as $arAOP10) {
        ...
        if ($stChave10 != $arAOP10['tiporegistro'].$arAOP10['codreduzido'].$arAOP10['nroop'].$arAOP10['nroanulacaoop']) {
              
            $inCount++;
            $stChave10 = $arAOP10['tiporegistro'].$arAOP10['codreduzido'].$arAOP10['nroop'].$arAOP10['nroanulacaoop'];
            ...
            if (count($rsRecordSetAOP11->getElementos()) > 0) {
                ...
                foreach ($rsRecordSetAOP11->getElementos() as $arAOP11) {
                    ...
                    if ($stChave10 == '10'.$arAOP11['codreduzido'].$arAOP11['nroop'].$arAOP11['nroanulacaoop']) {
                        //Chave única do registro 11
                        if ($stChave11 != $arAOP11['tiporegistro'].$arAOP11['codreduzido'].$arAOP11['nroop'].$arAOP11['nroanulacaoop']) {
                            $stChave11 = $arAOP11['tiporegistro'].$arAOP11['codreduzido'].$arAOP11['nroop'].$arAOP11['nroanulacaoop'];
