...
/**
  ...
  *
  * @ignore
  * $Id: LAO.csv.inc.php 62269 2015-04-15 18:28:39Z franver $
...
foreach ($entidades as $i) {
    if ($i == '2') {
        ...
        //NECESSARIO ALTERAR CONSULTA PARA TRAZER AS NORMAS DE ALTERACAO DAS LEIS ORCAMENTRIAS. .. FAZER NUM FUTURO PROXIMO... 
        //Tipo Registro 20
        //$obTTCEMGLeiAlteracaoOrcamentaria->recuperaExportacao20($rsRecordSetLAO20);$obTTCEMGLeiAlteracaoOrcamentaria->debug();

        //Tipo Registro 21
        //$obTTCEMGLeiAlteracaoOrcamentaria->recuperaExportacao21($rsRecordSetLAO21);$obTTCEMGLeiAlteracaoOrcamentaria->debug();
    }
}
