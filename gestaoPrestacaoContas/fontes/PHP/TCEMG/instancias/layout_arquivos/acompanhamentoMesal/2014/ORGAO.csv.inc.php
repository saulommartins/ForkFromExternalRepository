...
include_once CAM_GPC_TCEMG_MAPEAMENTO.Sessao::getExercicio()."/TTCEMGORGAO2014.class.php";

$rsRecordSetORGAO10 = new RecordSet();
$rsRecordSetORGAO11 = new RecordSet();
$stVersao = 'Versão: '.Sessao::getVersao();

$obTTCEMGORGAO2014               = new TTCEMGORGAO2014;
$obTTCEMGORGAO2014->setDado('exercicio',Sessao::getExercicio());
$obTTCEMGORGAO2014->setDado('entidade',$stEntidades);
$obTTCEMGORGAO2014->recuperaOrgao($rsRecordSetORGAO10);

$obTTCEMGORGAO2014->setDado('dt_inicial', $stDataInicial);
$obTTCEMGORGAO2014->setDado('dt_final'  , $stDataFinal);
$obTTCEMGORGAO2014->setDado('exercicio' , Sessao::getExercicio());
$obTTCEMGORGAO2014->setDado('entidade'  , $stEntidades);
$obTTCEMGORGAO2014->recuperaOrgaoResponsavel($rsRecordSetORGAO11);
