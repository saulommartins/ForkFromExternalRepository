    ...
    if ($stChave10 <> $arCAIXA10['tipo_registro'].$arCAIXA10['cod_orgao']) {
        ...
        if (count($rsRecordSetCAIXA11->getElementos()) > 0) {
            ...
            foreach ($rsRecordSetCAIXA11->getElementos() as $arCAIXA11) {
                    if ($stChave11 <> $arCAIXA11['tipo_registro'].$arCAIXA11['cod_fonte_caixa']) {

                        $inCount++;

                        $stChave11 = $arCAIXA11['tipo_registro'].$arCAIXA11['cod_fonte_caixa'];
                        ...
                        if (count($rsRecordSetCAIXA12->getElementos()) > 0) {
                            ...
                            foreach ($rsRecordSetCAIXA12->getElementos() as $arCAIXA12) {
                                $stChaveComp12 = trim($arCAIXA12['cod_reduzido']);
                                    ...
                                    if ($arCAIXA11['cod_fonte_caixa'] == $arCAIXA12['cod_fonte_caixa'] && $stChave12 <> $arCAIXA12['tipo_registro'].$arCAIXA12['tipo_movimentacao'].$arCAIXA12['tipo_entrada_saida'].$arCAIXA12['cod_ctb_transfe'].$arCAIXA12['cod_fonte_ctb_transfe']) {

                                        $inCount++;

                                        $stChave12 = $arCAIXA12['tipo_registro'].$arCAIXA12['tipo_movimentacao'].$arCAIXA12['tipo_entrada_saida'].$arCAIXA12['cod_ctb_transfe'].$arCAIXA12['cod_fonte_ctb_transfe'];
                                        ...
                                        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_entrada_saida");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);

                                        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("descricao_movimentacao");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                                        ...
                                        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_ctb_transfe");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                                        ...
                                        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_fonte_ctb_transfe");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CHARACTER_ESPACOS_DIR");
                                        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(3);
