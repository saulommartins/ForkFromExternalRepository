...
<?php
/**
  * Página de Include Oculta - Exportação Arquivos TCEMG - RESPLIC.csv
  ...
  *
  * @ignore
  * $Id: RESPLIC.csv.inc.php 63520 2015-09-08 19:13:32Z carlos.silva $
  * $Date: 2015-09-08 16:13:32 -0300 (Ter, 08 Set 2015) $
  * $Author: carlos.silva $
  * $Rev: 63520 $
  *
*/
...
*/
include_once CAM_GPC_TCEMG_MAPEAMENTO.Sessao::getExercicio()."/TTCEMGRespLic.class.php";

$rsRecordSetRESPLIC10 = new RecordSet();
$rsRecordSetRESPLIC20 = new RecordSet();

$obTTCEMGRespLic = new TTCEMGRespLic();
$obTTCEMGRespLic->setDado('exercicio' , Sessao::getExercicio());
$obTTCEMGRespLic->setDado('entidades'  , $stEntidades);
$obTTCEMGRespLic->setDado('dt_inicial', $stDataInicial);
$obTTCEMGRespLic->setDado('dt_final'  , $stDataFinal);
$obTTCEMGRespLic->setDado('mes', $stMes);

//Tipo Registro 10
$obTTCEMGRespLic->recuperaResponsaveisLicitacao($rsRecordSetRESPLIC10);

//Tipo Registro 20
$obTTCEMGRespLic->recuperaComissaoLicitacao($rsRecordSetRESPLIC20);
...
if ( count($rsRecordSetRESPLIC20->getElementos()) > 0 ) {
    ...
    foreach ( $rsRecordSetRESPLIC20->getElementos() as $arRESPLIC20 ) {
        ...
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_tipo_comissao");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);
        ...
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ini_vigencia");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);
        
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("fim_vigencia");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);
        
        $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cpf_membro");
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
        $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
        $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(11);
...
if ((count($rsRecordSetRESPLIC10->getElementos()) < 1)  && (count($rsRecordSetRESPLIC20->getElementos()) < 1)){
