...
/**
  ...
  * $Date: 2015-09-18 15:27:07 -0300 (Sex, 18 Set 2015) $
  * $Author: franver $
  * $Rev: 63622 $
  *
*/
...
$rsRecordSetEMP20 = new RecordSet();
...
$obTTCEMGEMP->recuperaDadosEMP20($rsRecordSetEMP20);
...
if (count($rsRecordSetEMP10->getElementos()) > 0) {
    ...
    foreach ($rsRecordSetEMP10->getElementos() as $arEMP10) {
        ...
        if (count($rsRecordSetEMP20->getElementos()) > 0) {
            foreach ($rsRecordSetEMP20->getElementos() as $arEMP20) {
                $stChave3 = $arEMP20['nroempenho'];

                if ($stChave === $stChave3) {
                    $rsBloco = 'rsBloco_' . $inCount;
                    unset($$rsBloco);
                    $$rsBloco = new RecordSet();
                    $$rsBloco->preenche(array($arEMP20));
                    ...
                    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nroreforco");
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                    $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoMaximo(22);

                    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dtreforco");
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                    $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoMaximo(8);
                    ...
                    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vlreforco");
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
                    $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
                    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoMaximo(14);
