...
/**
  ...
  *
  * @ignore
  * $Id: ANL.csv.inc.php 66138 2016-07-21 14:19:44Z franver $
  * $Date: 2016-07-21 11:19:44 -0300 (Thu, 21 Jul 2016) $
  * $Author: franver $
  * $Rev: 66138 $
  *
*/
...
*/
require_once CAM_GPC_TCEMG_MAPEAMENTO.Sessao::getExercicio()."/TTCEMGAnulacaoEmpenho.class.php";
...
if (count($rsRecordSetANL10->getElementos()) > 0) {
    ...
    foreach ($rsRecordSetANL10->getElementos() as $arANL10) {
        ...
        if (strcmp($stChave10, $arANL10['tipo_registro'].$arANL10['cod_orgao'].$arANL10['cod_unidade'].$arANL10['num_empenho'].$arANL10['num_anulacao'])) {
            ...
            if (count($rsRecordSetANL11->getElementos()) > 0) {
                ...
                foreach ($rsRecordSetANL11->getElementos() as $arANL11) {
                    ...
                    if (strcmp($stChave11,$arANL11['tipo_registro'].$arANL11['cod_unidade'].$arANL11['num_empenho'].$arANL11['num_anulacao'].$arANL11['cod_fonte_recurso'])) {
