...
<?php
/**
  * Página de Include Oculta - Exportação Arquivos TCEMG - PARELIC.csv
  ...
  *
  * @ignore
  * $Id: PARELIC.csv.inc.php 62269 2015-04-15 18:28:39Z franver $
...
$rsRecordSetPARELIC10 = new RecordSet();

$obTLicitacaoLicitacao = new TLicitacaoLicitacao();        
$obTLicitacaoLicitacao->setDado('exercicio',Sessao::getExercicio());
$obTLicitacaoLicitacao->setDado('entidades',$stEntidades);
$obTLicitacaoLicitacao->setDado('dt_inicial', $stDataInicial);
$obTLicitacaoLicitacao->setDado('dt_final'  , $stDataFinal);

$obTLicitacaoLicitacao->recuperaParecerLicTcemg($rsRecordSetPARELIC10);

//Tipo Registro 99 – Declaração de inexistência de informações
$arRecordSetPARELIC99 = array(
    '0' => array(
        'tipo_registro' => '99',
    )
);

$rsRecordSetPARELIC99 = new RecordSet();
$rsRecordSetPARELIC99->preenche($arRecordSetPARELIC99);

if (count($rsRecordSetPARELIC10->getElementos()) > 0) {
    $obExportador->roUltimoArquivo->setTipoDocumento('TCE_MG');
    $obExportador->roUltimoArquivo->addBloco($rsRecordSetPARELIC10);
    ...
    $obExportador->roUltimoArquivo->addBloco($rsRecordSetPARELIC99);
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_registro");
    $obExportador->roUltimoArquivo->roUltimoBloco->setDelimitador(';');
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(2);
...
$rsRecordSetPARELIC10  = null;
$obTLicitacaoLicitacao = null;
$rsRecordSetPARELIC99  = null;
?>