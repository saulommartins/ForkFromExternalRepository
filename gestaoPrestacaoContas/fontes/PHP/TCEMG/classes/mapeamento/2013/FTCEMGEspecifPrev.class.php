...
/**
    ...
    * @subpackage
    ...
    $Id: FTCEMGEspecifPrev.class.php 62626 2015-05-25 20:11:16Z jean $
*/
...
function montaRecuperaTodos()
{
    $stSql  = "
        ...
        SELECT REPLACE((CASE WHEN aplicacoes_financeiras < 0.00 THEN aplicacoes_financeiras*-1 ELSE aplicacoes_financeiras END)::VARCHAR,'.','') AS aplicacoes_financeiras,
               REPLACE((CASE WHEN caixa < 0.00 THEN caixa*-1 ELSE caixa END)::VARCHAR,'.','') AS caixa,
               REPLACE((CASE WHEN banco < 0.00 THEN banco*-1 ELSE banco END)::VARCHAR,'.','') AS banco
