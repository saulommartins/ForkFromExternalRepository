...
class TTCEMGConfiguracaoArquivoDCLRF extends Persistente {
    ...
    */
    function TTCEMGConfiguracaoArquivoDCLRF()
    {
        ...
        $this->AddCampo('valor_passivos_reconhecidos', 'numeric', false, '14,2', false, false);
        $this->AddCampo('valor_trans_obrig_uniao_relativ_emen_indiv', 'numeric', false, '14,2', false, false);
        $this->AddCampo('valor_dotacao_incentivo_contribuinte', 'numeric', false, '14,2', false, false);
        $this->AddCampo('valor_empenhado_incentivo_contribuinte', 'numeric', false, '14,2', false, false);
        $this->AddCampo('valor_dotacao_incentivo_inst_financeira', 'numeric', false, '14,2', false, false);
        $this->AddCampo('valor_empenhado_incentivo_inst_financeira', 'numeric', false, '14,2', false, false);
        ...
        $this->AddCampo('local_publicacao_lrf', 'text', false, '', false, false);
    ...
    function montaRecuperaValoresArquivoDCLRF() {
        ...
        $stSql.= "mes_referencia,
                  ...
                  REPLACE(valor_passivos_reconhecidos::VARCHAR, '.', ',') AS valor_passivos_reconhecidos,
                  REPLACE(valor_trans_obrig_uniao_relativ_emen_indiv::VARCHAR, '.', ',') AS valor_trans_obrig_uniao_relativ_emen_indiv,
                  REPLACE(valor_dotacao_incentivo_contribuinte::VARCHAR, '.', ',') AS valor_dotacao_incentivo_contribuinte,
                  REPLACE(valor_empenhado_incentivo_contribuinte::VARCHAR, '.', ',') AS valor_empenhado_incentivo_contribuinte,
                  REPLACE(valor_dotacao_incentivo_inst_financeira::VARCHAR, '.', ',') AS valor_dotacao_incentivo_inst_financeira,
                  REPLACE(valor_empenhado_incentivo_inst_financeira::VARCHAR, '.', ',') AS valor_empenhado_incentivo_inst_financeira,
                  publicacao_relatorio_lrf,
                  local_publicacao_lrf,
