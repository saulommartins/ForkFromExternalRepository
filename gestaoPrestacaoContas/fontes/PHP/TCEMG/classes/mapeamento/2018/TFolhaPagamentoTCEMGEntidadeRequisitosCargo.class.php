...
<?php
/**
* Classe de mapeamento para folhapagamento.tcemg_entidade_requisitos_cargo
...
class TFolhaPagamentoTCEMGEntidadeRequisitosCargo extends Persistente
{
    public function __construct()
    {
        parent::Persistente();
        $this->setTabela('folhapagamento.tcemg_entidade_requisitos_cargo');
        $this->setCampoCod('');
        $this->setComplementoChave('exercicio, cod_tipo, cod_cargo');
