                                  ...
                                  FROM sw_cgm_pessoa_fisica
                                     WHERE sw_cgm_pessoa_fisica.numcgm = (SELECT numcgm
                                                       ...
                                                       WHERE auditoria.objeto = (SELECT objeto
                                                                   FROM administracao.auditoria
                                                                  WHERE objeto = (SELECT '\"cod_ordem\" => \"'||op2.cod_ordem||'\",\"cod_entidade\" => \"'||op2.cod_entidade||'\",\"exercicio\" => \"'||op2.exercicio||'\"'
                                                                                    FROM empenho.ordem_pagamento AS op2
                                                                                   WHERE op2.exercicio = op2.exercicio
                                                                                     AND op2.cod_entidade   = op2.cod_entidade
                                                                                     AND op2.cod_ordem      = op2.cod_ordem limit 1))
