...
/*
    ...
    * @ignore
    ...
    $Id: TTCEMGNotaFiscal.class.php 62356 2015-04-28 18:25:11Z carlos.silva $
*/
...
function montaRecuperaNTF10()
{
    ...
    public function recuperaNTF20(&$rsRecordSet, $stFiltro="", $stOrdem="", $boTransacao="")
    {
        $obErro      = new Erro;
        $obConexao   = new Conexao;
        $rsRecordSet = new RecordSet;
