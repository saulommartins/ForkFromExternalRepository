...
class TTCEMGConfiguracaoLeisPPA extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TTCEMGConfiguracaoLeisPPA()
    {
        parent::Persistente();
        $this->setTabela('tcemg.configuracao_leis_ppa');
    ...
    public function montaRecuperaRelacionamento()
    {
        ...
        $stSql .= "  FROM tcemg.configuracao_leis_ppa       \n";
        $stSql .= "     , normas.norma                                                      \n";
