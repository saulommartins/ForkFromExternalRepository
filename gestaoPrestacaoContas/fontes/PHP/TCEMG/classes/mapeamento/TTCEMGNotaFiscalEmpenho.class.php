...
/*
    * Classe de mapeamento da tabela tcemg.nota_fiscal_empenho
    ...
    * @ignore
    ...
    $Id: TTCEMGNotaFiscalEmpenho.class.php 59719 2014-09-08 15:00:53Z franver $
*/

include_once '../../../../../../gestaoAdministrativa/fontes/PHP/framework/include/valida.inc.php';
include_once ( CLA_PERSISTENTE );

class TTCEMGNotaFiscalEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TTCEMGNotaFiscalEmpenho()
{
    parent::Persistente();
    $this->setTabela("tcemg.nota_fiscal_empenho");
    ...
    $this->AddCampo( 'exercicio_empenho'  , 'char'    , true  , '4'    , false , false  );
