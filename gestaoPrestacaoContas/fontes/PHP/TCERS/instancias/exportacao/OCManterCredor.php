...
/**
    ...
    * @ignore
    ...
    $Id: OCManterCredor.php 59612 2014-09-02 12:00:51Z gelson $
...
include_once ( CAM_GPC_TCERS_NEGOCIO."RExportacaoTCERSArqCredor.class.php" );
...
if ($stAno) {
    $obRegra->obRExportacaoTCERSCredor->setAno       ( $stAno );
}
...
// $obRegra->obRExportacaoTCERSCredor->listarConversao   ( $rsCredorConversao );
                ...
                */
                ...
                $obSelect->obEvento->setOnChange  ( "muda_selects('inTipo');");
