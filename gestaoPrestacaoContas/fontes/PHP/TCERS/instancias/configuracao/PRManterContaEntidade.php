...
switch ($stAcao) {
    ...
    default:
        if (is_array($arValores)) {
            $obErro = $obTContaEntidade->exclusao();
            foreach ($arValores as $k => $v) {
                $obTContaEntidade->setDado('exercicio'    , $arValores[$k]['exercicio']   );
                $obTContaEntidade->setDado('cod_conta'    , $arValores[$k]['cod_conta']   );
                $obTContaEntidade->setDado('cod_entidade' , $arValores[$k]['cod_entidade']);
                $obErro = $obTContaEntidade->inclusao( $boTransacao );
            }
        }
