...
<?php
/**
    * Classe de mapeamento da tabela FN_EXPORTACAO_LIQUIDACAO_EMPENHO
...
class FExportacaoLiquidacaoEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FExportacaoLiquidacaoEmpenho()
{
    parent::Persistente();
    $this->setTabela('tcerj.fn_exportacao_liqemp');
