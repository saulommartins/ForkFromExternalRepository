...
<?php
/**
    * Classe de mapeamento da tabela FN_EXPORTACAO_FONTE
...
class FExportacaoFonte extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FExportacaoFonte()
{
    parent::Persistente();
    $this->setTabela('tcerj.fn_exportacao_fonte');
...
function montaRecuperaDadosExportacao()
{
    ...
    $stSql .= "        *                                                                \n";
    $stSql .= "FROM                                                                     \n";
    $stSql .= "        ".$this->getTabela()."('".$this->getDado("stExercicio")."','".$this->getDado("stCodEntidades")."')      \n";
    $stSql .= "AS tabela              (   cod_fonte            integer,                 \n";
    $stSql .= "                           cod_recurso          integer,                 \n";
    $stSql .= "                           nom_recurso          character varying(160),  \n";
