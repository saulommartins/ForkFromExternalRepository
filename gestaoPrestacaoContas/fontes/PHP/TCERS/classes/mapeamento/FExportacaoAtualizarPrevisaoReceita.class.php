...
<?php
/**
    * Classe de mapeamento da tabela FN_EXPORTACAO_ATUALIZAR_PREVISAO_RECEITA
...
class FExportacaoAtualizarPrevisaoReceita extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FExportacaoAtualizarPrevisaoReceita()
{
    parent::Persistente();
    $this->setTabela('tcerj.fn_exportacao_aprevrec');
