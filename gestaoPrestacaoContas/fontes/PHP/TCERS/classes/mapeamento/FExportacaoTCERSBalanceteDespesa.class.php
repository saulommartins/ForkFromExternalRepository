...
function montaRecuperaDadosMANAD()
{
    ...
    $stSql  .= "    cod_despesa as cod_cta_desp,                                                           \n";
    $stSql  .= "    num_orgao    as cod_org,                                                                    \n";
    $stSql  .= "    num_unidade  as cod_un_orc,                                                             \n";
    $stSql  .= "    cod_funcao as cod_fun,                                                                      \n";
    $stSql  .= "    cod_subfuncao as cod_subfun,                                                          \n";
    $stSql  .= "    cod_programa as cod_prog,                                                               \n";
    $stSql  .= "    cod_subprograma as cod_subprog,                                                        \n";
    $stSql  .= "    num_pao as proj_ativ_oe,                                            \n";
    $stSql  .= "    cod_subelemento,                                            \n";
    $stSql  .= "    cod_recurso as cod_rec_vinc,                                            \n";
    $stSql  .= "    saldo_inicial as vl_dotacao_inicial,                                            \n";
    $stSql  .= "    atualizacao as vl_at_monetaria,                                            \n";
    $stSql  .= "    credito_suplementar as vl_cred_sup,                                            \n";
    $stSql  .= "    credito_especial as vl_cred_esp,                                            \n";
    $stSql  .= "    credito_extraordinario as vl_cred_ext,                                            \n";
    $stSql  .= "    reducoes as vl_red_dotacao,                                            \n";
    $stSql  .= "    suplementacao as vl_sup_rec_vinc,                                          \n";
    $stSql  .= "    reducao  as vl_red_rec_vinc                    ,                                            \n";
    $stSql  .= "    (empenho_per - anulado_per) as vl_empenhado                  ,                                            \n";
    $stSql  .= "    liquidado_per                ,                                            \n";
    $stSql  .= "    pago_per  as vl_pago                   ,                                            \n";
    $stSql  .= "    valor_liquidado as vl_liquidado           ,                                            \n";
    $stSql  .= "    recomposicao as vl_lmtdo_lrf                ,                                            \n";
    $stSql  .= "    previsao                                                                  \n";
    $stSql  .= "FROM                                                                             \n";
    $stSql  .= " ".$this->getTabela()."( '".$this->getDado("stExercicio")."',
                                        'AND OD.cod_entidade IN (".$this->getDado("stCodEntidades")  .")',
