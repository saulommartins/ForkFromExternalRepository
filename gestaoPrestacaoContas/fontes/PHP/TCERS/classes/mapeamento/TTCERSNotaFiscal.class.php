...
<?php
/*
 * Classe de mapeamento da tabela tcers.nota_fiscal
 *
 * @package SW2
 * @subpackage Mapeamento
 * @version $Id$
 * @analista Ane Caroline Fiegenbaum Pereira
 * @author Jean Felipe da Silva
 */

include_once '../../../../../../gestaoAdministrativa/fontes/PHP/framework/include/valida.inc.php';
include_once CLA_PERSISTENTE;

class TTCERSNotaFiscal extends Persistente
{
     ...
     * @author
     */
    public function TTCERSNotaFiscal()
    {
        parent::Persistente();
        $this->setTabela('tcers.nota_fiscal');

        $this->setCampoCod('cod_nota, cod_entidade, exercicio');
        ...
        $this->AddCampo('nro_nota'     , 'varchar', true  , '20'  , false, false);
        $this->AddCampo('nro_serie'    , 'varchar', true  , '8'  , false, false);
