...
<?php
/**
    * Classe de mapeamento da tabela TCERS_CREDOR
...
Revision 1.16  2006/07/05 20:45:58  cleisson
...
class TExportacaoTCERSCredor extends Persistente
{
function TExportacaoTCERSCredor()
{
    parent::Persistente();
    $this->setTabela('tcers.credor');
