...
function montaRecuperaDadosExportacao()
{
    ...
    $stSql .= " AS ( cod_conta varchar, cod_entidade varchar, mov_deb_1 numeric,      		\n";
    $stSql .= " mov_cre_1 numeric, mov_deb_2 numeric, mov_cre_2 numeric,  					\n";
    $stSql .= " mov_deb_3 numeric, mov_cre_3 numeric, mov_deb_4 numeric,  					\n";
    $stSql .= " mov_cre_4 numeric, mov_deb_5 numeric, mov_cre_5 numeric,  					\n";
    $stSql .= " mov_deb_6 numeric, mov_cre_6 numeric)     									\n";
