...
function buscaFornecedor(){
    ...
    document.frm.action = 'OCDemonstrativoEmpenhosPagar.php?<?=Sessao::getId();?>&stCtrl=buscaFornecedor';
    document.frm.submit();
...
function buscaValor(variavel){
    ...
    document.frm.target = "oculto";
    var stAction = document.frm.action;
    document.frm.action = 'OCDemonstrativoEmpenhosPagar.php?stCtrl='+variavel+'&<?=Sessao::getId();?>';
    document.frm.submit();
    document.frm.action = stAction;
