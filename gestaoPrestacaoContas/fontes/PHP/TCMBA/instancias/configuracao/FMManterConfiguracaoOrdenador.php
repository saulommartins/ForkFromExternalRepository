...
$obTTCMBAConfiguracaoOrdenador->setDado('cod_entidade',$arEntidade[0]);
$obTTCMBAConfiguracaoOrdenador->setDado('exercicio',Sessao::getExercicio());
$obTTCMBAConfiguracaoOrdenador->setDado("num_orgao",$arUnidadeOrcamentaria[0]);
$obTTCMBAConfiguracaoOrdenador->setDado("num_unidade",$arUnidadeOrcamentaria[1]);
$obTTCMBAConfiguracaoOrdenador->recuperaPorChave($rsRecordOrdenador, $boTransacao);
