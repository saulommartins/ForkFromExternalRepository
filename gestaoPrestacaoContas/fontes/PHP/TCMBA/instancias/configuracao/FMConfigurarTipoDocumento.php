...
include_once (CAM_GPC_TCMBA_MAPEAMENTO."TTCMBATipoDocumentoTCM.class.php");
...
// Lista os Tipos de Documentos cadastrados no Sistema do TCMBA
$obTTCMBATipoDocumentoTCM = new TTCMBATipoDocumentoTCM();
$obTTCMBATipoDocumentoTCM->recuperaTodos($rsTipoDocumentoTCM, "", " ORDER BY cod_documento_tcm", $boTransacao);

$obDocumentoTTCMBA = new Select;
$obDocumentoTTCMBA->setName       ('inCodDocumento_[cod_documento_tcm]');
$obDocumentoTTCMBA->setId         ('inCodDocumento_[cod_documento_tcm]');
$obDocumentoTTCMBA->setValue      ('[cod_documento_tcm]');
$obDocumentoTTCMBA->addOption     ('', 'Selecione');
$obDocumentoTTCMBA->setCampoId    ('[cod_documento_tcm]');
$obDocumentoTTCMBA->setCampoDesc  ('[descricao]');
$obDocumentoTTCMBA->preencheCombo ( $rsTipoDocumentoTCM );

$obLista->addCabecalho('Lista de Documentos do TCMBA', 20);
$obLista->addDadoComponente($obDocumentoTTCMBA);
