...
switch ($stCtrl) {
    case "carregaComboTipoDocumentoTCM":
        ...
        foreach ($rsDocumentos->getElementos() as $valor) {
            $stJs .= "jQuery(\"select[name~='inCodDocumento_".$valor['cod_documento']."']\").val(".$valor['cod_documento_tcm'].");";
        }
    break;
}
