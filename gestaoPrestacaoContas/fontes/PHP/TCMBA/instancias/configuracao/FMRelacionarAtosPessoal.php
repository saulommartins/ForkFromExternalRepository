...
include_once CAM_GPC_TCMBA_MAPEAMENTO.'TTCMBATipoAtoPessoal.class.php';
...
$obTTCMBATipoAtoPessoal = new TTCMBATipoAtoPessoal;
$obTTCMBATipoAtoPessoal->recuperaTodos($rsTipoAtoPessoal);

$obCmbTTCMBATipoAtoPessoal = new Select();
$obCmbTTCMBATipoAtoPessoal->setRotulo ("*Tipo de Ato Pessoal");
$obCmbTTCMBATipoAtoPessoal->setTitle ("Selecione o tipo de Ato Pessoal");
$obCmbTTCMBATipoAtoPessoal->setName ('inCodTipoAto');
$obCmbTTCMBATipoAtoPessoal->setId ('inCodTipoAto');
$obCmbTTCMBATipoAtoPessoal->setCampoId ("cod_tipo");
$obCmbTTCMBATipoAtoPessoal->setCampoDesc ("descricao");
$obCmbTTCMBATipoAtoPessoal->addOption ("","Selecione");
$obCmbTTCMBATipoAtoPessoal->preencheCombo($rsTipoAtoPessoal);
...
$obBtOk->obEvento->setOnCLick("montaParametrosGET('incluiLista', 'inCodEntidade,inCodTipoAto,inCodAssentamento');");
...
$obFormulario->addComponente($obCmbTTCMBATipoAtoPessoal);
