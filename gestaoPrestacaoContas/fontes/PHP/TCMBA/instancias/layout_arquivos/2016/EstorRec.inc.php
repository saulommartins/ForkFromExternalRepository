...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAEstorRec.class.php" );
    
    // Não possui subEmpenho então será gerado em branco
    $obTTCMBAEstorRec = new TTCMBAEstorRec();
    $obTTCMBAEstorRec->setDado('mes'       , $inMes );
    $obTTCMBAEstorRec->setDado('entidades' , $stEntidades );
    $obTTCMBAEstorRec->setDado('unidade_gestora', $inCodUnidadeGestora );
    $obTTCMBAEstorRec->setDado('dt_inicial', $stDataInicial );
    $obTTCMBAEstorRec->setDado('dt_final', $stDataFinal );
    $obTTCMBAEstorRec->recuperaDadosTribunal($rsArquivo);
