...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAIndProg.class.php" );
    $obTMapeamento = new TTCMBAIndProg();
    $obTMapeamento->setDado('exercicio', Sessao::getExercicio() );
    $obTMapeamento->setDado('entidades', $stEntidades );
    $obTMapeamento->setDado('unidade_gestora', $inCodUnidadeGestora );
    $obTMapeamento->recuperaIndicadores($rsRecordSet);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("descricao_indicador");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(120);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("situacao_inicial");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("situacao_modificada");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("ano_inicial");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ESPACOS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(4);
