...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTBABolsa.class.php" );

    $obTMapeamento = new TTBABolsa();
    $obTMapeamento->setDado('entidade',$stEntidades);
    $obTMapeamento->setDado('entidade_rh',$stEntidadeRH);
    $obTMapeamento->setDado('dt_inicial',$stDataInicial);
    $obTMapeamento->setDado('dt_final',$stDataFinal);
    $obTMapeamento->setDado('periodo',$arFiltro['stAnoMes'].$arFiltro['stMes']);
    $obTMapeamento->recuperaBolsa($rsBolsa);

    $obExportador->roUltimoArquivo->addBloco($rsBolsa);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_bolsa"); //PK
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_final_previsto");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("objetivos");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_doe");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_bilhete");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_final_efetivo");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("area_formacao");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(50);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("instituicao_ensino");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(50);
