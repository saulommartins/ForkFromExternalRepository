...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTBADotTermoParc.class.php" );
    
    $obTTBADotTermoParc = new TTBADotTermoParc();
    $obTTBADotTermoParc->setDado('mes'       , $inMes);
