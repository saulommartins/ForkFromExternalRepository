...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTBAConcurso.class.php" );

    $obTMapeamento = new TTBAConcurso();
    ...
    $obTMapeamento->recuperaConcurso($rsConcurso);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_concurso"); 
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("edital_contratacao");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ESPACOS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("de_edital");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_preedital");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("CARACTER_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);