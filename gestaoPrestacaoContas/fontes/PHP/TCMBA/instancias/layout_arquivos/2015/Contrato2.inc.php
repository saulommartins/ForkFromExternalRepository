...
*/
include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAContrato2.class.php" );
$obTTCMBAContrato2 = new TTCMBAContrato2();
$obTTCMBAContrato2->setDado('unidade_gestora',$inCodUnidadeGestora);
$obTTCMBAContrato2->setDado('entidades',$stEntidades);
$obTTCMBAContrato2->setDado('dt_inicial',$stDataInicial);
$obTTCMBAContrato2->setDado('dt_final',$stDataFinal);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("pessoa_contratado");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cic_contratado");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("custo_pessoal");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(30);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_inicio_execucao");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_processo_dispensa");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
...
$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("indicador_licitacao");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);

$obExportador->roUltimoArquivo->roUltimoBloco->addColuna("indicador_dispensa");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
$obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);


unset($rsArquivo);
unset($obTTCMBAContrato2);