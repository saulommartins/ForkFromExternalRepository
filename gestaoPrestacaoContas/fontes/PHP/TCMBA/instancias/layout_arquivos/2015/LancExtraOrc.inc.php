...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBALancExtraOrc.class.php" );
    
    $obTTCMBALancExtraOrc = new TTCMBALancExtraOrc();
    
    $obTTCMBALancExtraOrc->setDado('stExercicio'  , Sessao::getExercicio() );
    $obTTCMBALancExtraOrc->setDado('inMes'        , $inMes );
    $obTTCMBALancExtraOrc->setDado('dtInicio'     , $stDataInicial );
    $obTTCMBALancExtraOrc->setDado('dtFim'        , $stDataFinal );
    $obTTCMBALancExtraOrc->setDado('stEntidades'  , $stEntidades );
    $obTTCMBALancExtraOrc->setDado('inCodGestora' , $inCodUnidadeGestora );
    
    $obTTCMBALancExtraOrc->recuperaLancamentoExtraOrcamentario($rsLancExtras);
    
    $obExportador->roUltimoArquivo->addBloco($rsLancExtras);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_lancamento");
