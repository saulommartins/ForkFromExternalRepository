...
include_once CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAPessoal.class.php" ;
include_once CAM_GRH_FOL_MAPEAMENTO."TFolhaPagamentoPeriodoMovimentacao.class.php" ;

$obTFolhaPagamentoPeriodoMovimentacao = new TFolhaPagamentoPeriodoMovimentacao();
$stFiltroPeriodo = " AND dt_final BETWEEN TO_DATE('".$stDataInicial."', 'dd/mm/yyyy') AND TO_DATE('".$stDataFinal."', 'dd/mm/yyyy')";
$obTFolhaPagamentoPeriodoMovimentacao->recuperaPeriodoMovimentacao($rsPeriodoMovimentacao,$stFiltroPeriodo,"",$boTransacao,"folhapagamento");
