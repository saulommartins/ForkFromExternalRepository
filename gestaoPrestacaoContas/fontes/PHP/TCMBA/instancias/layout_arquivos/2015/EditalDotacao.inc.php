...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAEditalDotacao.class.php" );
    
    $obTTCMBAEditalDotacao = new TTCMBAEditalDotacao();
    $obTTCMBAEditalDotacao->setDado('exercicio'      , Sessao::getExercicio() );
