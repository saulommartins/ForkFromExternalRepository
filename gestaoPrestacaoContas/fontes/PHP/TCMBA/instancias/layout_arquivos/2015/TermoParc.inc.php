...
/*
    ...
    **********************************************************************************
/**
    * Página de Include Oculta - Exportação Arquivos TCM-BA ContrataMdo
    * Data de Criação   : 02/10/2015
    * @author Analista: Valtair Santos
    * @author Desenvolvedor: Jean da Silva
*/

    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBATermoParc.class.php" );
    $obTTCMBATermoParc = new TTCMBATermoParc();
    $obTTCMBATermoParc->setDado('unidade_gestora' , $inCodUnidadeGestora);    
    $obTTCMBATermoParc->setDado('competencia'     , Sessao::getExercicio().$inMes );
    $obTTCMBATermoParc->setDado('data_inicial'    , $stDataInicial );
    $obTTCMBATermoParc->setDado('data_final'      , $stDataFinal );
    $obTTCMBATermoParc->setDado('entidades'       , $stEntidades );
    $obTTCMBATermoParc->setDado('exercicio'       , Sessao::getExercicio() );
    
    $obTTCMBATermoParc->recuperaTribunal( $rsArquivo );
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vl_recurso_parceiro");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
                        
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("vl_recurso_oscip");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("VALOR_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nro_processo_mj");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(36);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_processo_mj");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);
                        
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_publicacao_mj");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("DATA_DDMMYYYY");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(8);                        

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cnpj_oscip");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(20);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("nome_pessoa");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(50);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("processo_dispensa");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("ALFANUMERICO_ESPACOS_DIR");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_proj_ativ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ESPACOS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("proj_ativ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ESPACOS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(4);
