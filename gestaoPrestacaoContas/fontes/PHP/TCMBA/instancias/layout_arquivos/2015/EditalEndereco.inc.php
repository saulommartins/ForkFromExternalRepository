...
*/
    ...
    include_once( CAM_GPC_TCMBA_MAPEAMENTO.Sessao::getExercicio()."/TTCMBAEditalEndereco.class.php" );
    $obTTCMBAEditalEndereco = new TTCMBAEditalEndereco();
    $obTTCMBAEditalEndereco->setDado('unidade_gestora',$inCodUnidadeGestora);
    $obTTCMBAEditalEndereco->setDado('entidades',$stEntidades);
    $obTTCMBAEditalEndereco->setDado('dt_inicial',$stDataInicial);
    $obTTCMBAEditalEndereco->setDado('dt_final',$stDataFinal);
    $obTTCMBAEditalEndereco->recuperaDadosTribunal($rsArquivo);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("municipio_ibge");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ESPACOS_ESQ");
