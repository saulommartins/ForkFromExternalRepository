...
/**
  * Efetua conexão com a tabela tcmba.documento_de_para
...
*/
class TTCMBADocumentoDePara extends Persistente
{
/**
    * Método Construtor
    * @access Private
...
{
    parent::Persistente();
    $this->setTabela("tcmba.documento_de_para");

    $this->setCampoCod('cod_documento_tcm');
    $this->setComplementoChave('');

    $this->AddCampo('cod_documento_tcm','integer',true ,'',true,true);
...
{
    $stSql = " SELECT documento_de_para.cod_documento,
