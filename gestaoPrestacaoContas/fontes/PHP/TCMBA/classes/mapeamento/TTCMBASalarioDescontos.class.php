...
<?php
/**
  * Mapeamento folhapagamento.tcmba_salario_descontos
...
class TTCMBASalarioDescontos extends Persistente {
    ...
    {
        parent::Persistente();
        $this->setTabela('folhapagamento.tcmba_salario_descontos');
