...
<?php
/**
  * Mapeamento folhapagamento.tcmba_vantagens_salariais
...
class TTCMBAVantagensSalariais extends Persistente {
    ...
    {
        parent::Persistente();
        $this->setTabela('folhapagamento.tcmba_vantagens_salariais');
