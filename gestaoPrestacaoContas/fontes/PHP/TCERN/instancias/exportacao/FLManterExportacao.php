...
$obHdnAcao->setValue( "../../../TCERN/instancias/exportacao/".$pgOcul );
...
/*
$obTxtCodOrgao    = new TextBox();
$obTxtCodOrgao->setName        ( "stCodOrgao"   );
$obTxtCodOrgao->setRotulo      ( "Codigo do Orgao"          );
$obTxtCodOrgao->setTitle       ( "");
$obTxtCodOrgao->setSize        ( 6 );
$obTxtCodOrgao->setMaxLength   ( "4" );
$obTxtCodOrgao->setNull        ( false                          );
*/
...
//$obFormulario->addComponente        ( $obTxtCodOrgao );
