...
switch ($stCtrl) {
    ...
    case 'preencheDados' :
        ...
        $obTUnidade = new TTCERNUnidadeGestora();
        $obTUnidade->recuperaRelacionamento($rsUnidade);

        if ($rsUnidade->getCampo('cod_institucional') != '') {
            $obTResponsavel = new TTCERNUnidadeGestoraResponsavel();
            $stFiltro = " AND unidade_gestora.cod_institucional = ".$rsUnidade->getCampo('cod_institucional')."";
...
$arResponsavel = Sessao::read('arResponsavel');
    ...
    case 'montaAlteracaoLista':
        ...
        $obResponsavel = new TTCERNUnidadeGestoraResponsavel();
        $obResponsavel->recuperaRelacionamento($rsResponsavel, " AND unidade_gestora_responsavel.id = ".$inId."");
