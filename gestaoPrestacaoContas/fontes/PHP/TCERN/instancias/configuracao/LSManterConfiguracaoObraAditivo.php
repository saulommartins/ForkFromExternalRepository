...
$obTTCERNObraAditivo->recuperaListaAditivo($rsRecordSet, $stFiltro);
...
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo('Data do aditivo');
$obLista->ultimoCabecalho->setWidth( 5 );
$obLista->commitCabecalho();
...
$obLista->addDado();
$obLista->ultimoDado->setAlinhamento("CENTRO");
$obLista->ultimoDado->setCampo( "num_aditivo" );
$obLista->commitDado();

$obLista->addDado();
$obLista->ultimoDado->setAlinhamento("CENTRO");
$obLista->ultimoDado->setCampo( "dt_aditivo" );
$obLista->commitDado();
