 ...
 * $Id: FMManterConfiguracaoReceita.php 59612 2014-09-02 12:00:51Z gelson $
...
$obForm->obEvento->setOnSubmit('alert("oi");');
...
$obHdnCtrl->setValue ('preencheDados');

$obPersistente = new TTRNReceitaTC();
$obPersistente->setDado('exercicio', Sessao::getExercicio());
$obPersistente->recuperaListagemReceita($rsRecordSetLista);

$obLista = new Lista;
$obLista->setTitulo ( "Relacionamento das Receitas");
...
$obLista->commitCabecalho();
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo( "Código da Receita - TCE" );
...
$obTextBox->setName   ("stCodigoTc_[cod_receita]_[cod_estrutural]_"  );
$obTextBox->setMascara("999999999"        );
$obTextBox->setNull   (false              );
$obTextBox->setValue  ("[cod_tc]"         );
