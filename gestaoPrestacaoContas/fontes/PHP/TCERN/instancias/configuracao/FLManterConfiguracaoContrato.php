...
$obTxtNumContratoInicial = new TextBox;
$obTxtNumContratoInicial->setName     ( "inCodContratoInicial" );
$obTxtNumContratoInicial->setValue    ( $inCodContratoInicial  );
$obTxtNumContratoInicial->setRotulo   ( "Número do Contrato"   );
$obTxtNumContratoInicial->setTitle    ( "Informe o número do contrato." );
$obTxtNumContratoInicial->setInteiro  ( true                  );
$obTxtNumContratoInicial->setNull     ( true                  );
...
$obTxtNumContratoFinal = new TextBox;
$obTxtNumContratoFinal->setName    ( "inCodContratoFinal" );
$obTxtNumContratoFinal->setValue   ( $inCodContratoFinal  );
$obTxtNumContratoFinal->setRotulo  ( "Número do Contrato" );
$obTxtNumContratoFinal->setTitle   ( "Informe o número do contrato." );
$obTxtNumContratoFinal->setInteiro ( true  );
$obTxtNumContratoFinal->setNull    ( true  );
...
$obFormulario->agrupaComponentes( array($obTxtNumContratoInicial, $obLblContrato, $obTxtNumContratoFinal) );
