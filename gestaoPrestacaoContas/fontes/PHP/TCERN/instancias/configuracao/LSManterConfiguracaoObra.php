...
if ($_REQUEST['inCodObraInicial'] != '' && $_REQUEST['inCodObraFinal'] != '') {
    $arFiltro[] = " num_obra >= ".$_REQUEST['inCodObraInicial']." and num_obra <= ".$_REQUEST['inCodObraFinal'];

} elseif ($_REQUEST['inCodObraInicial'] != '') {
    $arFiltro[] = " num_obra  = ".$_REQUEST['inCodObraInicial'];

} elseif ($_REQUEST['inCodObraFinal'] != '') {
    $arFiltro[] = " num_obra  = ".$_REQUEST['inCodObraFinal'];
}
...
$obTTCERNObra->recuperaTodos($rsRecordSet, $stFiltro);
...
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo('Cód. Cidade');
$obLista->ultimoCabecalho->setWidth( 5 );
$obLista->commitCabecalho();
...
$obLista->addDado();
$obLista->ultimoDado->setAlinhamento("CENTRO");
$obLista->ultimoDado->setCampo( "cod_cidade" );
$obLista->commitDado();
