...
class TTCERNUnidadeOrcamentariaResponsavel extends Persistente
{
/**
* Método Construtor
* * @access Private
*/
    ...
    public function TTCERNUnidadeOrcamentariaResponsavel()
    {
        parent::Persistente();
        $this->setTabela('tcern.unidade_orcamentaria_responsavel');
        $this->setCampoCod('id');
    ...
    public function montaRecuperaRelacionamento()
    {
        $stSql.= "SELECT  sw_cgm.nom_cgm AS nom_cgm
                        ...
                        , to_char(unidade_orcamentaria_responsavel.dt_inicio,'dd/mm/yyyy') AS dt_inicio
                        , to_char(unidade_orcamentaria_responsavel.dt_fim,'dd/mm/yyyy') AS dt_fim
                        , unidade_orcamentaria_responsavel.id AS id
                    ...
                    WHERE unidade_orcamentaria.exercicio = '".Sessao::getExercicio()."'";

        return $stSql;
    }

    public function excluir($stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaExcluir",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function montaExcluir()
    {
        $stSql .= "DELETE FROM tcern.unidade_orcamentaria_responsavel WHERE id_unidade = ".$this->getDado('id_unidade')."";
