...
<?php
/**
    * Pacote de configuração do TCETO - Mapeamento tceto.credor
    * Data de Criação   : 06/11/2014

    * @author Analista: Silvia Martins Silva
    * @author Desenvolvedor: Michel Teixeira
    * $Id: TExportacaoTCETOCredor.class.php 60660 2014-11-06 16:28:53Z michel $
*/

include_once '../../../../../../gestaoAdministrativa/fontes/PHP/framework/include/valida.inc.php';
include_once ( CLA_PERSISTENTE );

class TExportacaoTCETOCredor extends Persistente
{
    function TExportacaoTCETOCredor()
    {
        parent::Persistente();
        $this->setTabela('tceto.credor');
    ...
    function montaRecuperaDadosCredor()
    {
        ...
        $stSQL .= " sw_cgm AS cgm                                           \n";
        $stSQL .= " LEFT JOIN tceto.credor AS cr ON                         \n";
