...
class TTCETOConfiguracaoUnidadeGestora extends TAdministracaoConfiguracaoEntidade
{
/**
    * Método Construtor
    * @access Private
*/
function TTCETOConfiguracaoUnidadeGestora()
{
    ...
    $stSql = "SELECT   entidade.cod_entidade
         ...
         INNER JOIN  orcamento.entidade
          ...
          LEFT JOIN  administracao.configuracao_entidade
                ...
                AND  configuracao_entidade.cod_modulo   = 64
