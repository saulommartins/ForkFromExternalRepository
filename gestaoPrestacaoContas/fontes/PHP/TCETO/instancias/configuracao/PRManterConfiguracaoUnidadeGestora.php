...
include_once(CAM_GPC_TCETO_MAPEAMENTO.'TTCETOConfiguracaoUnidadeGestora.class.php');
    ...
    case 'manter' :
        ...
        foreach ($_REQUEST as $key => $value) {
            if (strstr($key, 'inCodigo_')) {
                $obTExportacaoConfiguracao = new TTCETOConfiguracaoUnidadeGestora;
                $obTExportacaoConfiguracao->setDado("cod_modulo", 64);
                $obTExportacaoConfiguracao->setDado("parametro",  "tceto_configuracao_unidade_gestora_".substr($key, 9)."");
