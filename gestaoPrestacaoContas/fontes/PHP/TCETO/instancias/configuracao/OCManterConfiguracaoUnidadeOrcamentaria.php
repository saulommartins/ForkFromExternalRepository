...
<?php
/**
    * Pacote de configuração do TCETO - Oculto Configurar Unidade Orçamentária
    * Data de Criação   : 05/11/2014

    * @author Analista: Silvia Martins Silva
    * @author Desenvolvedor: Michel Teixeira
    * $Id: OCManterConfiguracaoUnidadeOrcamentaria.php 60654 2014-11-06 13:18:49Z michel $
*/
