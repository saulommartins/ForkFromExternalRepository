...
<?php
/**
 * JS para inclusao dos dados do Relatorio RREO Anexo 13
 *
 * @category    Urbem
 * @package     STN
...
<script type="text/javascript">
    function limpaFormularioAux(){
        jq('#stAno').selectOptions('');
        jq('#flReceitaPrevidenciaria').val('');
        jq('#flDespesaPrevidenciaria').val('');
        jq('#flSaldoFinanceiro').val('');
    }
