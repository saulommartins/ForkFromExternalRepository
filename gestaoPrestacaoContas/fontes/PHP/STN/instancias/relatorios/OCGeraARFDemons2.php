...
<?php
/**
    * Arquivo de geração de relatório BIRT do Demonstrativo 2
...
$preview = new PreviewBirt(6,36,36);
$preview->setTitulo('Dem. Riscos Fiscais e Providências');
$preview->setVersaoBirt('2.5.0');
$preview->setExportaExcel(true);
$preview->addParametro('exercicio_risco', $_POST['stExercicio']);
$preview->preview();
