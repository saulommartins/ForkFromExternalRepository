...
include_once CAM_GPC_TPB_MAPEAMENTO.'TTCEPBTipoCargoTCE.class.php';
...
$obTTCEPBTipoCargoTCE = new TTCEPBTipoCargoTCE();
$stOrder = ' ORDER BY cod_tipo_cargo_tce';
$obTTCEPBTipoCargoTCE->recuperaTodos($rsTipoCargo, '', $stOrder);
...
$obTPessoalSubDivisao->recuperaDeParaTipoCargo($rsSubDivisao, '', $stOrder);
