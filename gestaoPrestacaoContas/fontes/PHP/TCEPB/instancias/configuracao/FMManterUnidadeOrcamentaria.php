...
$obTOrganogramaOrgao->recuperaOrgaosServidores($rsOrgao);
...
$obCmbUnidade->setId        ('cmbUnidade_[cod_orgao]');
$obCmbUnidade->setName      ('cmbUnidade_[cod_orgao]');
$obCmbUnidade->addOption    ('','Selecione');

$stJs = "jq.post('".$pgOcul."', {'stCtrl':'carregaUnidades', 'inNumOrgao':this.value, 'cbmId':this.id}, '', 'script')";
...
$obCmbOrgao->obEvento->setOnChange($stJs);
...
$obTable->Head->addCabecalho('Unidade Orçamentária', 15);

$obTable->Body->addCampo('[estrutural] - [descricao]', 'E');
$obTable->Body->addCampo($obCmbOrgao, 'E');
$obTable->Body->addCampo($obCmbUnidade, 'E');
