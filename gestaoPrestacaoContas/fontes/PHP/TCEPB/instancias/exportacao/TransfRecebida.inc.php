...
include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBTransfRecebida.class.php" );
    $obTMapeamento = new TTPBTransfRecebida();
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("tipo_transf");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(01);

    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_transferencia");
