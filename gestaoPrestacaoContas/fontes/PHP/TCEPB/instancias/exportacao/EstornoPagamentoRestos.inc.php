...
<?php
/*
 * Arquivo de geração do arquivo EstornoPagamentoRestos
 ...
 */
    ...
    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBEstornoPagamentoRestos.class.php" );
    $obTMapeamento = new TTPBEstornoPagamentoRestos();
