...
/*
$Log$
Revision 1.3  2007/04/26 20:21:39  bruce
*** empty log message ***

Revision 1.2  2007/04/23 15:41:52  rodrigo_sr
uc-06.03.00
...
*/
    ...
    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBPropostas.class.php" );
    $obTMapeamento = new TTPBPropostas();
...
$obTMapeamento->debug();
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("num_licitacao");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("valor_ofertado");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(16);
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("situacao_proposta");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
