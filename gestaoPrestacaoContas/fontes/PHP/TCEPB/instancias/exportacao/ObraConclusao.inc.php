...
*/
    ...
    $obTMapeamento->recuperaTodos($arRecordSet[$stArquivo], " WHERE TO_CHAR(dt_conclusao,'mmyyyy') = '".$inMes.Sessao::getExercicio()."' ORDER BY exercicio, num_obra ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_conclusao");
