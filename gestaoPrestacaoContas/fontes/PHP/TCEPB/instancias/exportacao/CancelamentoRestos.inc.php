...
/*
$Log$
Revision 1.10  2007/05/29 14:20:03  domluc
*** empty log message ***

Revision 1.9  2007/05/29 14:19:13  domluc
*** empty log message ***
...
*/
    ...
    $obTTPBCancelamentoRestos = new TTPBCancelamentoRestos();
    $obTTPBCancelamentoRestos->setDado('exercicio'  , Sessao::getExercicio() );
    $obTTPBCancelamentoRestos->setDado('inMes'      , $inMes );
    $obTTPBCancelamentoRestos->setDado('stEntidades', $stEntidades );
    
    $obTTPBCancelamentoRestos->recuperaTodos($arRecordSet[$stArquivo]);
