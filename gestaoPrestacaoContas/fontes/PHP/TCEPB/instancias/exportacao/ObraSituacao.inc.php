...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: luiz $
    $Date: 2008-04-11 11:59:39 -0300 (Sex, 11 Abr 2008) $
...
*/
    ...
    $obTMapeamento->recuperaTodos($arRecordSet[$stArquivo], " WHERE to_char(dt_cadastro,'yyyy') <= '".Sessao::getExercicio()."'  AND dt_conclusao IS NULL ORDER BY exercicio, num_obra ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_tipo_situacao");
