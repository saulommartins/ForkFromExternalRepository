...
/**
    ...
    * @ignore
    ...
    $Id: ReceitaOrcamentaria.inc.php 59612 2014-09-02 12:00:51Z gelson $
...
*/
    ...
    $obTMapeamento->recuperaReceitaOrcamentaria($arRecordSet[$stArquivo]);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("competencia_receita");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("reservado_tse");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
