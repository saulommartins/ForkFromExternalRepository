...
/*
$Log$
Revision 1.2  2007/04/23 15:37:59  rodrigo_sr
uc-06.03.00

Revision 1.1  2007/04/20 16:01:44  vitor
Inclusão  uc-06.04.00

*/

    include_once( CAM_GPC_TPB_MAPEAMENTO."TCEPBLancamentoContabil.class.php" );
    $obTMapeamento = new TCEPBLancamentoContabil();
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("cod_lancamento");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("pagam_receb_extra");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(1);
    
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("reservado_tce2");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTipoDado("NUMERICO_ZEROS_ESQ");
    $obExportador->roUltimoArquivo->roUltimoBloco->roUltimaColuna->setTamanhoFixo(6);
