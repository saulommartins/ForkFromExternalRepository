...
/**
    ...
    * @ignore
    ...
    $Id: AtualizacaoOrcamentaria.inc.php 59612 2014-09-02 12:00:51Z gelson $
...
*/
    ...
    $obTTPBDotacao = new TTPBDotacao();
    
    $obTTPBDotacao->setDado('exercicio'  , Sessao::getExercicio() );
    $obTTPBDotacao->setDado('inMes'      , $inMes );
    $obTTPBDotacao->setDado('stEntidades', $stEntidades );
    
    $obTTPBDotacao->recuperaAtualizacaoOrcamentaria($arRecordSet[$stArquivo]);
