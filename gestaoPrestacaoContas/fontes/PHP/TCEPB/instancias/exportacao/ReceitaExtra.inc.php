...
/*
$Log$
Revision 1.4  2007/04/23 15:42:12  rodrigo_sr
uc-06.03.00
...
*/
    ...
    $obTTPBReceitaExtra = new TTPBReceitaExtra();
    $obTTPBReceitaExtra->setDado('exercicio',Sessao::getExercicio());
    $obTTPBReceitaExtra->setDado('inMes'      , $inMes );
    $obTTPBReceitaExtra->setDado('stEntidades', $stEntidades );

    $obTTPBReceitaExtra->recuperaTodos($arRecordSet[$stArquivo]);
    ...
    $obExportador->roUltimoArquivo->roUltimoBloco->addColuna("dt_transferencia");
