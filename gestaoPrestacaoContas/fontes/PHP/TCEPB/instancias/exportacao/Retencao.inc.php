...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: evandro $
    $Date: 2014-09-24 11:28:00 -0300 (Wed, 24 Sep 2014) $

    * Casos de uso: uc-06.03.00
*/

    include_once( CAM_GPC_TPB_MAPEAMENTO."TTPBRetencoes.class.php" );
    
    $obTTPBRetencoes = new TTPBRetencoes();
    
    $obTTPBRetencoes->setDado('exercicio'  , Sessao::getExercicio() );
    $obTTPBRetencoes->setDado('inMes'      , $inMes );
    $obTTPBRetencoes->setDado('stEntidades', $stEntidades );
    
    $obTTPBRetencoes->recuperaRelatorioRetencoes($arRecordSet[$stArquivo]);
