...
*/
class TTCEPBOrcamentoModalidadeDespesa extends Persistente {
    /**
        * Método Construtor
        * @access Private
    */
    function TTCEPBOrcamentoModalidadeDespesa()
    {
        parent::Persistente();
        $this->setTabela('tcepb.orcamento_modalidade_despesa');
    
        $this->setCampoCod('');
        $this->setComplementoChave('exercicio,cod_modalidade,cod_despesa');
