...
class TTPBTransfRecebida extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TTPBTransfRecebida()
{
    parent::Persistente();
                 ...
                 FROM
                      ...
                      JOIN( SELECT pa.cod_plano
                             ...
                             WHERE      pa.exercicio = pc.exercicio
                                   ...
                                   AND (    pc.cod_estrutural ilike '4.5.1.2.2.01%'
                                         OR pc.cod_estrutural ilike '4.5.1.3.2.%'
                                       )
                          ) debito
                        ON(     debito.cod_plano = t.cod_plano_credito
