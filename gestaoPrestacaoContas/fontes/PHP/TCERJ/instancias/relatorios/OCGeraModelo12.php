...
$obAgata = new RRelatorioAgata( "../../../../../../gestaoPrestacaoContas/fontes/AGT/TCRJ/RLModelo12.agt" );
...
$obAgata->setParameter( '$stFiltro' , '01/01/'.Sessao::getExercicio().' a 31/12/'.Sessao::getExercicio() );
$obAgata->setParameter( '$stAnoAnterior' , '31/12/'.(Sessao::getExercicio()-1));
$obAgata->setParameter( '$stAnoCorrente' , '31/12/'.Sessao::getExercicio());
