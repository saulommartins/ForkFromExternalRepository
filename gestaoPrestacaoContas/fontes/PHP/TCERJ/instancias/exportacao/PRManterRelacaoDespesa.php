...
include_once ( CAM_GPC_TCERJ_NEGOCIO."RExportacaoTCERJRelDespesa.class.php" );
...
//Percorre os resultados do formulario adicionando as contas que possuem o campo "Despesa ExportacaoTCE" informado
