...
<div id="totais_contas_devedoras">
    <table>
        ...
        <tbody>
            ...
            <?php
                    // //Processo para gerar os calculos
                    // foreach ($totais_contas_devedoras->getElementos() as $key => $contasDevedoras) {

                    //     $contasDevedoras['saldo_anterior']   = number_format($contasDevedoras['saldo_anterior'],2,',','.');
                    //     $contasDevedoras['inscricao']        = number_format($contasDevedoras['inscricao'],2,',','.');
                    //     $contasDevedoras['restabelecimento'] = number_format($contasDevedoras['restabelecimento'],2,',','.');
                    //     $contasDevedoras['baixa']            = number_format($contasDevedoras['baixa'],2,',','.');
                    //     $contasDevedoras['cancelamentos']    = number_format($contasDevedoras['cancelamentos'],2,',','.');
                    //     $contasDevedoras['saldo_atual']      = number_format($contasDevedoras['saldo_atual'],2,',','.');
