...
function Exportador()
{
    ...
    include_once ( "TAdministracaoConfiguracao.class.php");
...
error_log("Nome do Arquivo Gerado - ".$stCaminho.$stNomeArquivo);
...
//    SistemaLegado::alertaAviso($this->getRetorno(),"Arquivo(s) Gerados com Sucesso",
    //"incluir","aviso", Sessao::getId(), "../");
