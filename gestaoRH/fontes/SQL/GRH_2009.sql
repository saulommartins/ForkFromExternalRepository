...
*/
   ...
   BEGIN
    ...
    --Inclusão de função interna arrecadacao/fn_acrescimo_indice.plsql
      ...
      intCodFuncao   := public.manutencao_funcao   (  27, 1, 'pega1QuantDiasAfastadosNaCompetencia', 4);
                                                 --( intCodmodulo , intCodBiblioteca , varNomeFunc , intCodTiporetorno )

      intCodVariavel := public.manutencao_variavel (  27, 1, intCodFuncao, 'stCodMotivoParametro', 2 );
