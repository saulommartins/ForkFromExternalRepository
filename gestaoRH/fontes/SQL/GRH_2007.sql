...
ALTER TABLE folhapagamento.previdencia_regime_rat ADD COLUMN aliquota_fap NUMERIC(5,4);

UPDATE folhapagamento.previdencia_regime_rat SET aliquota_fap = 1.0000;

ALTER TABLE folhapagamento.previdencia_regime_rat ALTER COLUMN aliquota_fap SET NOT NULL;
...
CREATE OR REPLACE FUNCTION EmpenhoLiquidacaoModalidadesLicitacao(varchar, numeric, varchar, integer, varchar, integer, integer) RETURNS INTEGER AS $$
DECLARE
