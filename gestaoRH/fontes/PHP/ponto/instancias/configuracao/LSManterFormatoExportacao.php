...
<?php
/*
 * Lista para Configuração Formato de Exportação
...
if ($_REQUEST["inCodigo"] != "") {
    $stFiltro = " AND formato_exportacao.cod_formato = ".$_REQUEST["inCodigo"];
}
...
$obTPontoFormatoExportacao->recuperaTodos($rsConfiguracoes,$stFiltro," descricao");
...
$obLista->ultimoDado->setCampo( "cod_formato" );
$obLista->commitDado();
...
$obLista->ultimaAcao->addCampo( "&inCodFormato", "cod_formato" );
