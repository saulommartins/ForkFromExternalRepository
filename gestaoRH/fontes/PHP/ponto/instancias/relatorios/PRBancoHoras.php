...
<?php
/*
 * Arquivo de processamento para Relatório Banco de Horas
...
$preview = new PreviewBirt(4,51,9);
$preview->setVersaoBirt( '2.5.0' );
$preview->setReturnURL( CAM_GRH_PON_INSTANCIAS."relatorios/FLBancoHoras.php");
$preview->setTitulo('Banco de Horas');
$preview->setNomeArquivo('bancoHoras');
...
$preview->addParametro("dtInicioPeriodo", $_REQUEST['stDataInicial']);
$preview->addParametro("dtFimPeriodo", $_REQUEST['stDataFinal']);
$preview->addParametro("dtSaldoBanco", $_REQUEST['dtSaldoBanco']);
