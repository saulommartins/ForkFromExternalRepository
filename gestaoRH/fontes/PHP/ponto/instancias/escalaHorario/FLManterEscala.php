...
<?php
/**
    * Página de Filtro para Manter Escalas
...
$obTxtCodigo->setId("inCodEscala");
$obTxtCodigo->setTitle("Informe o código da escala.");

$obTxtDescricao = new TextBox;
$obTxtDescricao->setRotulo   ( "Descrição"   );
$obTxtDescricao->setTitle    ( "Informe a descrição da escala" );
$obTxtDescricao->setName     ( "stDescricaoEscala" );
$obTxtDescricao->setId       ( "stDescricaoEscala" );
