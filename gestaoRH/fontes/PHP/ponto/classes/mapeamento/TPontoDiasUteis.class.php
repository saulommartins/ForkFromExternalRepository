...
<?php
/**
    * Classe de mapeamento da tabela ponto.dias_uteis
...
class TPontoDiasUteis extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoDiasUteis()
{
    parent::Persistente();
    $this->setTabela("ponto.dias_uteis");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_configuracao,timestamp,cod_dia');
