...
<?php
/**
    * Classe de mapeamento da tabela ponto.horas_desconto_dsr
...
class TPontoHorasDescontoDsr extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoHorasDescontoDsr()
{
    parent::Persistente();
    $this->setTabela("ponto.horas_desconto_dsr");
