...
<?php
/**
    * Classe de mapeamento da tabela ponto.horas_posterior
...
class TPontoHorasPosterior extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoHorasPosterior()
{
    parent::Persistente();
    $this->setTabela("ponto.horas_posterior");
