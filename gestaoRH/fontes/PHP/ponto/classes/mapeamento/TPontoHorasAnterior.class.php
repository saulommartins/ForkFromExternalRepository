...
<?php
/**
    * Classe de mapeamento da tabela ponto.horas_anterior
...
class TPontoHorasAnterior extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoHorasAnterior()
{
    parent::Persistente();
    $this->setTabela("ponto.horas_anterior");
