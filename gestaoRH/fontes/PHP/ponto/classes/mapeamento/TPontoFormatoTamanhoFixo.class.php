...
<?php
/**
    * Classe de mapeamento da tabela ponto.formato_tamanho_fixo
...
class TPontoFormatoTamanhoFixo extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoFormatoTamanhoFixo()
{
    parent::Persistente();
    $this->setTabela("ponto.formato_tamanho_fixo");
    ...
    $this->AddCampo('posicao_final'  ,'integer',true  ,'',false,false);
