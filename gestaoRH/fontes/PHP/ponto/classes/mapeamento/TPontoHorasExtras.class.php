...
<?php
/**
    * Classe de mapeamento da tabela ponto.horas_extras
...
class TPontoHorasExtras extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoHorasExtras()
{
    parent::Persistente();
    $this->setTabela("ponto.horas_extras");
    ...
    $this->AddCampo('periodo'         ,'char'     ,true  ,'1'  ,false,false);
