...
<?php
/**
    * Classe de mapeamento da tabela ponto.fator_multiplicacao
...
class TPontoFatorMultiplicacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPontoFatorMultiplicacao()
{
    parent::Persistente();
    $this->setTabela("ponto.fator_multiplicacao");
    ...
    $this->AddCampo('fator'           ,'numeric'  ,true  ,'14,2'  ,false,false);
