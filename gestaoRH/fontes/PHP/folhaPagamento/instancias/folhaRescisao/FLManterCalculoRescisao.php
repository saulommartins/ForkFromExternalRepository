...
<?php
/**
    * Página de Filtro do Calculo de Rescisao
    ...
    * Casos de uso: uc-04.05.18
    ...
    $Id: FLManterCalculoRescisao.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
$obBntOk = new ok();
$stJs  = "var url = '".CAM_GRH_FOL_INSTANCIAS."folhaRescisao/OCManterCalculoRescisao.php?".Sessao::getId()."' \n";
