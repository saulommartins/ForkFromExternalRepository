...
<?php
/**
    * Listagem de Vigências do IPERS
    ...
    * Casos de uso: uc-04.05.66
    ...
    $Id: LSConfiguracaoIpers.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
# Monta parametros default do link
...
$obTFolhaPagamentoConfiguracaoIpe->recuperaVigencia($rsVigencias);

$obLista = new Lista;
$obLista->setRecordSet( $rsVigencias );
...
if ($stAcao == "excluir") {
    $obLista->ultimaAcao->addCampo( "&stDescQuestao", "Vigência de [vigencia]");
    $obLista->ultimaAcao->setLink( $stCaminho.$pgProc."?".Sessao::read("id").$stLink );
} else {
    $obLista->ultimaAcao->setLink( $pgForm."?".Sessao::read("id").$stLink );
}
$obLista->commitAcao();
