...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: souzadl $
    $Date: 2006-10-20 15:16:57 -0300 (Sex, 20 Out 2006) $
...
/*
$Log$
Revision 1.2  2006/10/20 18:16:41  souzadl
alterado

Revision 1.1  2006/10/20 12:58:04  souzadl
construção
...
function processarPopUp(inCodContrato,inRegistro,stNumCgm,stNomCgm){
	var width  = 800;
    var height = 550;
    var sFiltros     = "&inCodContrato="+inCodContrato+"&inRegistro="+inRegistro+"&inCodConfiguracao=2&nom_cgm="+stNomCgm+"&numcgm="+stNumCgm;
