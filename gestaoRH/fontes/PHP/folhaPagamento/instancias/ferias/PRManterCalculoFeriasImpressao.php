...
/**
    ...
    * Casos de uso: uc-04.05.19
    ...
    $Id: PRManterCalculoFeriasImpressao.php 66258 2016-08-03 14:25:21Z evandro $
*/
...
if ($_REQUEST["stAcao"] == "imprimirErro") {
    ...
    $preview->addParametro("inCodConfiguracao", "2");
    $preview->preview();
} else {
    $arMeses["01"] = "Janeiro";
    ...
    $preview->setVersaoBirt("2.5.0");
    $preview->setReturnURL( CAM_GRH_FOL_INSTANCIAS."ferias/FLManterCalculoFerias.php");
    $preview->addParametro("stEntidade", Sessao::getEntidade());
    $preview->addParametro("entidade", Sessao::getCodEntidade($boTransacao));
