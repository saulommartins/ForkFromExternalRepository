...
<?php
/**
    * Página de Filtro do Calculo de Férias
    ...
    * Casos de uso: uc-04.05.19
    ...
    $Id: FLManterCalculoFerias.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
if ( $obRFolhaPagamentoPeriodoMovimentacao->roRFolhaPagamentoFolhaComplementar->getSituacao() == 'a' ) {
    $jsOnload   = "executaFuncaoAjax('processarFiltro2');";
}
...
$obBntOk = new ok();
$stJs  = "var url = '".CAM_GRH_FOL_INSTANCIAS."ferias/OCManterCalculoFerias.php?".Sessao::getId()."' \n";
