...
<?php
/**
    * Página de Lista do Registro de Evento de Férias
    ...
    * @ignore
    ...
    $Name$
    $Author: souzadl $
    $Date: 2006-11-21 09:50:28 -0200 (Ter, 21 Nov 2006) $
...
$stCaminho = CAM_GRH_FOL_INSTANCIAS."ferias/";
...
$arAnoMesCompetencia = explode("/",$rsUltimaMovimentacao->getCampo("dt_final"));
$inAnoMesCompetencia = $arAnoMesCompetencia[2].$arAnoMesCompetencia[1];

$obTFolhaPagamentoRegistroEventoFerias = new TFolhaPagamentoRegistroEventoFerias;
$obTFolhaPagamentoRegistroEventoFerias->setDado("ano_mes_competencia",$inAnoMesCompetencia);
$obTFolhaPagamentoRegistroEventoFerias->recuperaContratosDoFiltro($rsLista,$stFiltro);
