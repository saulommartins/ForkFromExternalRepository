...
$stCaminho = CAM_GRH_FOL_INSTANCIAS."IRRF/";
...
$obTFolhaPagamentoDescontoExternoIRRF->setDado("vigencia",$rsPeriodoMovimentacao->getCampo("dt_inicial"));
$obTFolhaPagamentoDescontoExternoIRRF->recuperaRelacionamento($rsDescontoExternoIRRF , $stFiltro , $stOrder , $boTransacao );

$obLista = new Lista;
$obLista->setRecordSet( $rsDescontoExternoIRRF );
...
$obLista->commitCabecalho();
$obLista->addCabecalho();
$obLista->ultimoCabecalho->addConteudo("Base IRRF");
...
$obLista->commitDado();
$obLista->addDado();
$obLista->ultimoDado->setCampo( "vl_base_irrf_formatado" );
$obLista->ultimoDado->setAlinhamento( 'DIREITA' );
$obLista->commitDado();
$obLista->addDado();
$obLista->ultimoDado->setCampo( "valor_irrf" );
$obLista->ultimoDado->setAlinhamento( 'DIREITA' );
$obLista->commitDado();
