...
<?php
/*
**** Página de filtro do relaório GPS
...
$obChkEmitirCopia = new CheckBox;
$obChkEmitirCopia->setRotulo('Emitir Cópia');
$obChkEmitirCopia->setName('boEmitirCopia');
$obChkEmitirCopia->setValue('true');
...
$obFormulario->addComponente                    ( $obChkEmitirCopia                                         		);
$obFormulario->Ok();
