...
function submeter()
{
    ...
    if (($_REQUEST["inAno"] == $_REQUEST["inAnoFinal"]) && ($_REQUEST["inCodMes"] == $_REQUEST["inCodMesFinal"])) {
        $stMensagem = "As competências devem ter valores diferentes.";
        $boErro = true;
    }
...
if ($stJs) {
    echo $stJs."LiberaFrames(true, false);\n";
}
