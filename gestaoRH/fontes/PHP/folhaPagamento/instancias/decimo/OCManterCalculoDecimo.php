...
/**
    ...
    * Casos de uso: uc-04.05.11
    ...
    $Id: OCManterCalculoDecimo.php 59612 2014-09-02 12:00:51Z gelson $
*/
...
function recalcular()
{
    ...
    $stJs .= "f.action ='PRManterCalculoDecimo.php?".Sessao::getId()."&stAcao=calcular&stTipoFiltro=recalcular';";
