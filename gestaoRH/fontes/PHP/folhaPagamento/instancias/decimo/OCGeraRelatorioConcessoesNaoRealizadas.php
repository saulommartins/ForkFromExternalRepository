...
$obPDF->setTitulo            ( "Concessão 13º Salário - Concessões Não Realizadas" );
...
$obPDF->addCabecalho("Concessão 13º Salário - Lista de Contratos não registrados", 100, 12);

$obPDF->addCampo( '', 1 );

$rsContratos = Sessao::read("rsContratosErro");
$obPDF->addRecordSet($rsContratos);
$obPDF->setQuebraPaginaLista( false );
$obPDF->setAlinhamento ( "C" );
$obPDF->addCabecalho   ( "Matrícula", 11, 10);

$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho   ( "CGM", 35, 10);

$obPDF->setAlinhamento ( "L" );
$obPDF->addCabecalho   ( "Motivo", 70, 10);
