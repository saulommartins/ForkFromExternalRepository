...
<?php
/**
    * Página de Oculto do Consultar Registro de Evento de Décimo Terceiro
...
function abrePopUpRegistrosEventos()
{
    ...
    if ($stErros === false) {
        ...
        $stJs .= "var sUrlFrames   = '".CAM_GRH_FOL_POPUPS."decimo/FMConsultarRegistroEventoDecimo.php?'+sSessao+sFiltros;\n";
...
function montaListaContratos()
{
    ...
    if ($stErros === false) {
        ...
        $obTFolhaPagamentoEventoDecimo = new TFolhaPagamentoRegistroEventoDecimo();
        ...
        $obTFolhaPagamentoEventoDecimo->recuperaRegistroContratoDecimoComPensionista( $rsLista, $stFiltro, $stOrdem);
