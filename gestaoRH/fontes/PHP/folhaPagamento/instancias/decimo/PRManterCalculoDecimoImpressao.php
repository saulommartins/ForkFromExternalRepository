...
/**
    ...
    * Casos de uso: uc-04.05.11
    ...
    $Id: PRManterCalculoDecimoImpressao.php 66258 2016-08-03 14:25:21Z evandro $
*/
...
if ($_REQUEST["stAcao"] == "imprimirErro") {
    ...
    $preview->setVersaoBirt("2.5.3");
    $preview->setReturnURL( CAM_GRH_FOL_INSTANCIAS."decimo/FLManterCalculoDecimo.php");
    $preview->addParametro("stEntidade", Sessao::getEntidade());
    $preview->addParametro("entidade", Sessao::getCodEntidade($boTransacao));
    $preview->addParametro("inCodConfiguracao", "3");
    $preview->preview();
} else {
    $arMeses["01"] = "Janeiro";
