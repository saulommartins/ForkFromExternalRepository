...
<?php
/**
    * Página de Filtro do Consultar Registro de Evento de Décimo Terceiro
...
$obRdoContrato->obEvento->setOnChange           ( "montaParametrosGET('montaSpanContrato', '', true)"                              );
...
$obRdoCGMContrato->obEvento->setOnChange        ( "montaParametrosGET('montaSpanCGMContrato', '', true)"                           );
...
$obRdoEvento->obEvento->setOnChange             ( "montaParametrosGET('montaSpanEvento', '', true)" );
...
//DEFINICAO DO FORM
$obForm = new Form;
$obForm->setAction                              ( "../../popups/decimo/".$pgForm                                        );
