...
<?php
/**
    * Página de Lista do Registro de Evento de Décimo Terceiro
    ...
    * @ignore
    ...
    $Name$
    $Author: souzadl $
    $Date: 2006-12-18 07:44:03 -0200 (Seg, 18 Dez 2006) $
...
switch ($_REQUEST['stTipoFiltro']) {
    ...
    case "cargo":
        ...
        $stFiltro = " AND servidor.cod_cargo = ".$_REQUEST['inCodCargo'] ;
        if ($_REQUEST['inCodEspecialidade'] != "") {
            $stFiltro .= " AND servidor.cod_especialidade_cargo = ".$_REQUEST['inCodEspecialidade'] ;
        }
    break;
    case "funcao":
        $stLink .= "&inCodRegime=".$_REQUEST['inCodRegime'];
        ...
        $stFiltro = " AND servidor.cod_funcao = ".$_REQUEST['inCodFuncao'] ;
        if ($_REQUEST['inCodEspecialidade'] != "") {
            $stFiltro .= " AND servidor.cod_especialidade_funcao = ".$_REQUEST['inCodEspecialidade'] ;
        }
    break;
    case "lotacao":
    ...
    case "local":
        ...
        $stFiltro = " AND servidor.cod_local = ".$_REQUEST['inCodLocal'];
    break;
    case "padrao":
        $stLink .= "&inCodPadrao=".$_REQUEST['inCodPadrao'];
        $stFiltro = " AND servidor.cod_padrao = ".$_REQUEST['inCodPadrao'];
    break;
}

$rsLista = new Recordset;
$obTFolhaPagamentoRegistroEventoDecimo = new TFolhaPagamentoRegistroEventoDecimo;
$obTFolhaPagamentoRegistroEventoDecimo->recuperaContratosDoFiltro($rsLista,$stFiltro);
