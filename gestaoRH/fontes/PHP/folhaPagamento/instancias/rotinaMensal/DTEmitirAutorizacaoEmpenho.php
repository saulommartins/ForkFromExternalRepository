...
$arDetalhes[0]["evento"]     = $_GET["evento"];
$arDetalhes[0]["num_pao"]    = $_GET["num_pao"];
$arDetalhes[0]["desc_pao"]   = $_GET["desc_pao"];
$arDetalhes[0]["lla"]        = $_GET["lla"];
...
$obTableTree->Head->addCabecalho( 'Evento' , 33  );
$obTableTree->Head->addCabecalho( 'PAO' , 33  );
$obTableTree->Head->addCabecalho( 'Lotação/Local/Atributo' , 33  );

$obTableTree->Body->addCampo( 'evento', 'E' );
$obTableTree->Body->addCampo( '[num_pao]-[desc_pao]', 'E' );
$obTableTree->Body->addCampo( 'lla', 'E' );
