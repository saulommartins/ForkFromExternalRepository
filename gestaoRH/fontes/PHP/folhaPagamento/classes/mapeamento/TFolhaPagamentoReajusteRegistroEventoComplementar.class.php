...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.reajuste_registro_evento_complementar
...
class TFolhaPagamentoReajusteRegistroEventoComplementar extends Persistente
{
    /**
    * Método Construtor
    * @access Private
    */
    public function TFolhaPagamentoReajusteRegistroEventoComplementar()
    {
        parent::Persistente();
        $this->setTabela("folhapagamento.reajuste_registro_evento_complementar");

        $this->setCampoCod('');
        $this->setComplementoChave('cod_reajuste,cod_registro,timestamp,cod_evento,cod_configuracao');
        ...
        $this->AddCampo('timestamp'       ,'timestamp',true  ,'',true,'TFolhaPagamentoRegistroEventoComplementar');
    ...
    public function recuperaReajusteComplementar(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajusteComplementar",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function recuperaReajustePensionistaComplementar(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajustePensionistaComplementar",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function montaRecuperaReajustePensionistaComplementar()
    {
        $stSql  = "     SELECT registro_evento_complementar.cod_contrato                                                                                                                                                            \n";
        $stSql .= "          , registro_evento_complementar.cod_evento                                                                                                                                                              \n";
        $stSql .= "          , registro_evento_complementar.timestamp                                                                                                                                                               \n";
        $stSql .= "          , to_real(registro_evento_complementar.valor) as valor                                                                                                                                                 \n";
        ...
        $stSql .= " INNER JOIN folhapagamento.reajuste_registro_evento_complementar                                                                                                                        \n";
        $stSql .= "         ON reajuste.cod_reajuste = reajuste_registro_evento_complementar.cod_reajuste                                                                                                                           \n";
        $stSql .= " INNER JOIN folhapagamento.registro_evento_complementar                                                                                                                                 \n";
        $stSql .= "         ON reajuste_registro_evento_complementar.cod_registro     = registro_evento_complementar.cod_registro                                                                                                   \n";
        $stSql .= "        AND reajuste_registro_evento_complementar.timestamp        = registro_evento_complementar.timestamp                                                                                                      \n";
        $stSql .= "        AND reajuste_registro_evento_complementar.cod_evento       = registro_evento_complementar.cod_evento                                                                                                     \n";
        $stSql .= "        AND reajuste_registro_evento_complementar.cod_configuracao = registro_evento_complementar.cod_configuracao                                                                                               \n";
        ...
        $stSql .= "           AND registro_evento_complementar.cod_periodo_movimentacao = ".$this->getDado("inCodPeriodoMovimentacao")."  \n";
        $stSql .= "           AND reajuste.cod_reajuste = ".$this->getDado("inCodReajuste")."                                             \n";

        return $stSql;
    }

    public function montaRecuperaReajusteComplementar()
    {
        $stSql  = "       SELECT registro_evento_complementar.cod_contrato                                                                                                                                                        \n";
        $stSql .= "             , registro_evento_complementar.cod_evento                                                                                                                                                         \n";
        $stSql .= "             , registro_evento_complementar.timestamp                                                                                                                                                          \n";
        ...
        $stSql .= "            ON registro_evento_complementar.cod_contrato = servidor_contrato_servidor.cod_contrato                                                                                                             \n";
