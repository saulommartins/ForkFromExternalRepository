...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.configuracao_empenho_evento_lotacao
...
/**
  * Efetua conexão com a tabela  folhapagamento.configuracao_empenho_evento_lotacao
  * Data de Criação: 10/07/2007
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoConfiguracaoEmpenhoLotacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoConfiguracaoEmpenhoLotacao()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.configuracao_empenho_lotacao");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_configuracao,exercicio,cod_orgao,sequencia,timestamp');
