...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.registro_evento_decimo_parcela
...
/**
  * Efetua conexão com a tabela  folhapagamento.registro_evento_decimo_parcela
  * Data de Criação: 06/09/2006
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoRegistroEventoDecimoParcela extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoRegistroEventoDecimoParcela()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.registro_evento_decimo_parcela");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_registro,timestamp,desdobramento,cod_evento');
