...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.reajuste_registro_evento_decimo
...
class TFolhaPagamentoReajusteRegistroEventoDecimo extends Persistente
{
    /**
    * Método Construtor
    * @access Private
    */
    public function TFolhaPagamentoReajusteRegistroEventoDecimo()
    {
        parent::Persistente();
        $this->setTabela("folhapagamento.reajuste_registro_evento_decimo");
        ...
        $this->AddCampo('timestamp'    ,'timestamp',true  ,''   ,true,'TFolhaPagamentoRegistroEventoDecimo');
    ...
    public function recuperaReajusteDecimo(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajusteDecimo",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function recuperaReajustePensionistaDecimo(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajustePensionistaDecimo",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function montaRecuperaReajustePensionistaDecimo()
    {
        ...
        $stSql .= "             , to_real(registro_evento_decimo.valor) as valor                                                                                                                              \n";
        ...
        $stSql .= " INNER JOIN folhapagamento.reajuste_registro_evento_decimo                                                                                                                              \n";
        $stSql .= "         ON reajuste.cod_reajuste = reajuste_registro_evento_decimo.cod_reajuste                                                                                                                                 \n";
        $stSql .= " INNER JOIN folhapagamento.registro_evento_decimo                                                                                                                                       \n";
        $stSql .= "         ON reajuste_registro_evento_decimo.cod_registro     = registro_evento_decimo.cod_registro                                                                                                               \n";
        $stSql .= "        AND reajuste_registro_evento_decimo.timestamp        = registro_evento_decimo.timestamp                                                                                                                  \n";
        $stSql .= "        AND reajuste_registro_evento_decimo.cod_evento       = registro_evento_decimo.cod_evento                                                                                                                 \n";
        $stSql .= " INNER JOIN folhapagamento.evento                                                                                                                                                       \n";
        $stSql .= "         ON registro_evento_decimo.cod_evento = evento.cod_evento                                                                                                                                                \n";
        ...
        $stSql .= "           AND registro_evento_decimo.cod_periodo_movimentacao = ".$this->getDado("inCodPeriodoMovimentacao")."  \n";
        $stSql .= "           AND reajuste.cod_reajuste = ".$this->getDado("inCodReajuste")."                                       \n";

        return $stSql;
    }

    public function montaRecuperaReajusteDecimo()
    {
        $stSql .= "        SELECT registro_evento_decimo.cod_contrato                                                                                                                                         \n";
        $stSql .= "             , registro_evento_decimo.cod_evento                                                                                                                                           \n";
        $stSql .= "             , registro_evento_decimo.timestamp                                                                                                                                            \n";
        ...
        $stSql .= "            ON registro_evento_decimo.cod_contrato = servidor_contrato_servidor.cod_contrato                                                                                               \n";
