...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.configuracao_empenho_evento_local
...
/**
  * Efetua conexão com a tabela  folhapagamento.configuracao_empenho_evento_local
  * Data de Criação: 10/07/2007
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoConfiguracaoEmpenhoLocal extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoConfiguracaoEmpenhoLocal()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.configuracao_empenho_local");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_configuracao,exercicio,cod_local,sequencia,timestamp');
