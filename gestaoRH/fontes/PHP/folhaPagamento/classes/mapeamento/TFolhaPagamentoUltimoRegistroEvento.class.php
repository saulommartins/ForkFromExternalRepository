...
<?php
/**
    * Classe de mapeamento da tabela FOLHAPAGAMENTO.ULTIMO_REGISTRO_EVENTO
...
/**
  * Efetua conexão com a tabela  FOLHAPAGAMENTO.ULTIMO_REGISTRO_EVENTO
  * Data de Criação: 04/11/2005
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoUltimoRegistroEvento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoUltimoRegistroEvento()
{
    parent::Persistente();
    $this->setTabela('folhapagamento.ultimo_registro_evento');
    ...
    $this->AddCampo( 'timestamp'   , 'timestamp', false,'', true, 'TFolhaPagamentoRegistroEvento' );
...
function montaRecuperaRelacionamento()
{
    ...
    $stSql .= " WHERE ultimo_registro_evento.cod_registro = registro_evento.cod_registro                    \n";
    $stSql .= "   AND ultimo_registro_evento.cod_evento   = registro_evento.cod_evento                      \n";
