...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.configuracao_empenho_lla_lotacao
...
/**
  * Efetua conexão com a tabela  folhapagamento.configuracao_empenho_lla_lotacao
  * Data de Criação: 10/07/2007
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoConfiguracaoEmpenhoLlaLotacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoConfiguracaoEmpenhoLlaLotacao()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.configuracao_empenho_lla_lotacao");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_orgao,exercicio,cod_configuracao_lla,timestamp');
