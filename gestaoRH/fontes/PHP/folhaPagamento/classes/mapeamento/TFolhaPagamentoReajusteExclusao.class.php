...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.reajuste_exclusao
...
class TFolhaPagamentoReajusteExclusao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoReajusteExclusao()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.reajuste_exclusao");
