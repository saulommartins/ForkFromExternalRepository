...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.configuracao_empenho_evento_atributo
...
/**
  * Efetua conexão com a tabela  folhapagamento.configuracao_empenho_evento_atributo
  * Data de Criação: 10/07/2007
  ...
  * @subpackage Mapeamento
*/
class TFolhaPagamentoConfiguracaoEmpenhoAtributo extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoConfiguracaoEmpenhoAtributo()
{
    parent::Persistente();
    $this->setTabela("folhapagamento.configuracao_empenho_atributo");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_configuracao,exercicio,cod_atributo,cod_modulo,cod_cadastro,sequencia,timestamp');
