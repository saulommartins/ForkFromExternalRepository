...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.configuracao_empenho_situacao
...
class TFolhaPagamentoConfiguracaoEmpenhoSituacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFolhaPagamentoConfiguracaoEmpenhoSituacao()
{
    parent::Persistente();
    $this->setTabela("folhapagamento".sessao::getentidade().".configuracao_empenho_situacao");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_configuracao,sequencia,exercicio,situacao,timestamp');
