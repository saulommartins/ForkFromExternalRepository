...
<?php
/**
    * Classe de mapeamento da tabela folhapagamento.reajuste_registro_evento_ferias
...
class TFolhaPagamentoReajusteRegistroEventoFerias extends Persistente
{
    /**
    * Método Construtor
    * @access Private
    */
    public function TFolhaPagamentoReajusteRegistroEventoFerias()
    {
        parent::Persistente();
        $this->setTabela("folhapagamento.reajuste_registro_evento_ferias");
        ...
        $this->AddCampo('timestamp'    ,'timestamp',true  ,''   ,true,'TFolhaPagamentoRegistroEventoFerias');
        $this->AddCampo('cod_evento'   ,'integer'  ,true  ,''   ,true,'TFolhaPagamentoRegistroEventoFerias');
        $this->AddCampo('desdobramento','char'     ,true  ,'1'  ,true,'TFolhaPagamentoRegistroEventoFerias');
    }

    public function recuperaReajusteFerias(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajusteFerias",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function recuperaReajustePensionistaFerias(&$rsRecordSet,$stFiltro="",$stOrder="",$boTransacao="")
    {
        return $this->executaRecupera("montaRecuperaReajustePensionistaFerias",$rsRecordSet,$stFiltro,$stOrder,$boTransacao);
    }

    public function montaRecuperaReajustePensionistaFerias()
    {
        ...
        $stSql .= "          , to_real(registro_evento_ferias.valor) as valor                                                                                                                                                       \n";
        ...
        $stSql .= " INNER JOIN folhapagamento.reajuste_registro_evento_ferias                                                                                                                              \n";
        $stSql .= "         ON reajuste.cod_reajuste = reajuste_registro_evento_ferias.cod_reajuste                                                                                                                                 \n";
        $stSql .= " INNER JOIN folhapagamento.registro_evento_ferias                                                                                                                                       \n";
        $stSql .= "         ON reajuste_registro_evento_ferias.cod_registro     = registro_evento_ferias.cod_registro                                                                                                               \n";
        $stSql .= "        AND reajuste_registro_evento_ferias.timestamp        = registro_evento_ferias.timestamp                                                                                                                  \n";
        $stSql .= "        AND reajuste_registro_evento_ferias.cod_evento       = registro_evento_ferias.cod_evento                                                                                                                 \n";
        $stSql .= " INNER JOIN folhapagamento.evento                                                                                                                                                       \n";
        $stSql .= "         ON registro_evento_ferias.cod_evento = evento.cod_evento                                                                                                                                                \n";
        ...
        $stSql .= "   AND registro_evento_ferias.cod_periodo_movimentacao = ".$this->getDado("inCodPeriodoMovimentacao")."  \n";
        $stSql .= "   AND reajuste.cod_reajuste = ".$this->getDado("inCodReajuste")."                                       \n";

        return $stSql;
    }

    public function montaRecuperaReajusteFerias()
    {
        $stSql  = "        SELECT registro_evento_ferias.cod_contrato                                                                                                                                                   \n";
        $stSql .= "             , registro_evento_ferias.cod_evento                                                                                                                                                     \n";
        $stSql .= "             , registro_evento_ferias.timestamp                                                                                                                                                      \n";
        ...
        $stSql .= "            ON registro_evento_ferias.cod_contrato = servidor_contrato_servidor.cod_contrato                                                                                                         \n";
