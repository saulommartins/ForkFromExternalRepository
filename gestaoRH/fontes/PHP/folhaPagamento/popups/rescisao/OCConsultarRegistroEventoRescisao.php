...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: tiago $
    $Date: 2007-05-23 10:06:37 -0300 (Qua, 23 Mai 2007) $
...
function gerarSpanEventosCadastrados()
{
    ...
    if ( $rsPeriodoMovimentacao->getNumLinhas() > 0 ) {
        ...
        $stOrdem = " codigo, desdobramento_texto";
...
function gerarSpanEventosBase($arEventos,$inCodContrato,$inCodPeriodoMovimentacao)
{
    ...
    if ($stCodEventos != "") {
        ...
        $stFiltro .= " AND registro_evento_rescisao.cod_periodo_movimentacao = $inCodPeriodoMovimentacao";
