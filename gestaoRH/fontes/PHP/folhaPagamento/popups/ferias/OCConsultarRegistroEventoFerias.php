...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: vandre $
    $Date: 2006-08-15 12:08:04 -0300 (Ter, 15 Ago 2006) $
...
function gerarSpanEventosBase($arEventos,$inCodContrato,$inCodPeriodoMovimentacao)
{
    ...
    if ($stCodEventos != "") {
        ...
        $stFiltro .= " AND registro_evento_ferias.cod_contrato = $inCodContrato";
        $stFiltro .= " AND registro_evento_ferias.cod_periodo_movimentacao = $inCodPeriodoMovimentacao";

        $obTFolhaPagamentoEventoBase = new TFolhaPagamentoEventoBase;
        $obTFolhaPagamentoEventoBase->recuperaEventoBaseDesdobramento($rsEventosBase,$stFiltro);
    }
