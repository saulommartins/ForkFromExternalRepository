...
$pgFilt = "FL".$stPrograma.".php?".Sessao::getId()."&nomForm=".$_REQUEST["nomForm"]."&campoNom=".$_REQUEST["campoNom"]."&campoNum=".$_REQUEST["campoNum"];
...
//$obLista->ultimaAcao->addCampo( "stTextoComplementar"   , "observacao");
//$obLista->ultimaAcao->addCampo( "stTipo"                , "tipo");
//$obLista->ultimaAcao->addCampo( "stFixado"              , "fixado");
//$obLista->ultimaAcao->addCampo( "nuValor"               , "valor_quantidade");
//$obLista->ultimaAcao->addCampo( "boLimiteCalculo"       , "limite_calculo");
//$obLista->ultimaAcao->addCampo( "stProventosDescontos"  , "proventos_descontos");
