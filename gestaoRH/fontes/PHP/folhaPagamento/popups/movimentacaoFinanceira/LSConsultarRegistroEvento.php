...
<?php
/**
* Página de Formulario de consulta dos registros dos eventos.
...
$inCodigoEvento = $_POST["inCodigoEvento"] ? $_POST["inCodigoEvento"] : $_GET["inCodigoEvento"];
...
//$obPeriodoMovimentacao->setDtFinal( $inCodMes."/".$inAno );
//
//$obPeriodoContratoServidor = new RFolhaPagamentoPeriodoContratoServidor( $obPeriodoMovimentacao );
//$obPeriodoContratoServidor->setRegistro( $inRegistro );
//
//$obRegistroEvento = new RFolhaPagamentoRegistroEvento;
//$obRegistroEvento->setRORFolhaPagamentoPeriodoContratoServidor( $obPeriodoContratoServidor );
//$obRegistroEvento->listarRegistroEvento( $rsRegistroEvento );

include_once(CAM_GRH_FOL_MAPEAMENTO."TFolhaPagamentoPeriodoMovimentacao.class.php");
$obTFolhaPagamentoPeriodoMovimentacao = new TFolhaPagamentoPeriodoMovimentacao();
$stFiltro = " WHERE to_char(dt_final,'mmyyyy') = '".$inCodMes.$inAno."'";
$obTFolhaPagamentoPeriodoMovimentacao->recuperaTodos($rsMovimentacao,$stFiltro);
...
if (trim($inCodigoEvento)!="") {
    $stFiltro .= " AND evento.codigo = '".$inCodigoEvento."'";
}
...
while ( !$rsRegistroEvento->eof() ) {
    ...
    if ($rsRegistroEvento->getCampo('parcela') != '') {
        $rsRegistroEvento->setCampo('quantidade', $rsRegistroEvento->getCampo('quantidade') . '/' . $rsRegistroEvento->getCampo('parcela'));
    }
...
Sessao::write('stTipoFolha',"Salario");
