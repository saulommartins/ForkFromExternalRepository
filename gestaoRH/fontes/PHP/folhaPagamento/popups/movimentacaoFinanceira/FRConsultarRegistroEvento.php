...
<frameset rows="*,0" border="0" noresize >
    <frame name="telaPrincipal" src="./<?=$_GET["sUrlConsulta"]."&inCodigoEvento=".$_GET["inCodigoEvento"]."&iURLRandomica=".$_GET["iURLRandomica"]."&inContrato=".$_GET["inContrato"]."&inCodMes=".$_GET["inCodMes"]."&inAno=".$_GET["inAno"]?>" marginwidth="0" marginheight="0" scrolling="yes" frameborder="0" noresize >
