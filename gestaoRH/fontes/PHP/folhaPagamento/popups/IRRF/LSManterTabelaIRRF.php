...
/**
    ...
    * @ignore
    ...
    $Name$
    $Author: souzadl $
    $Date: 2008-03-26 10:04:30 -0300 (Qua, 26 Mar 2008) $
...
$stFncJavaScript .= " d.".$_REQUEST["nomForm"].".Hdn".$_REQUEST["campoNum"].".value = cod_evento; \n";
...
$obRFolhaPagamentoPeriodoContratoServidor->roRFolhaPagamentoRegistroEvento->obRFolhaPagamentoEvento->setEventoSistema( $_REQUEST['boEventoSistema'] );
