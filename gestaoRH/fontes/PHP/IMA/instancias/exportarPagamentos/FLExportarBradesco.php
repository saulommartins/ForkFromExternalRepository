...
$obLblCodigoConvenio->setRotulo("Código da Empresa");
$obLblCodigoConvenio->setNull(false);
$obLblCodigoConvenio->setValue($rsConfiguracaoConvenio->getCampo("cod_empresa"));
...
$obTAdministracaoConfiguracao->pegaConfiguracao($stValor,"num_sequencial_arquivo_bradesco".Sessao::getEntidade());
