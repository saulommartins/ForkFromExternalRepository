...
<?php
/**
    * Página de Formulário do Exportação Remessa Banco do Brasil
    ...
    * @ignore
    ...
    $Name$
    $Author: rgarbin $
    $Date: 2008-04-09 09:56:26 -0300 (Qua, 09 Abr 2008) $
...
include_once ( CAM_GRH_FOL_NEGOCIO."RFolhaPagamentoPeriodoMovimentacao.class.php"                       );
 ...
 $arFiltro = Sessao::read('stFiltroLink');
...
$stTabela1 .= "<tr><td align=center colspan=2 width=100%><font size=3><b>Resumo Remessa Banco do Brasil</b></font></td></tr>";
...
if ($_GET['stSituacao'] == 'estagiarios') {
    ...
    $stCompetencia  = ( $arFiltro['inCodMes'] >= 10 )? $arFiltro['inCodMes'] : "0".$arFiltro['inCodMes'];
...
$stTabela1 .= "<td align=left width=50%><font size=-1>".$arFiltro['dtGeracaoArquivo']."</font></td></tr>";
$stTabela1 .= "<tr><td align=right width=50%><font size=-1>Data do Pagamento:</font></td>";
$stTabela1 .= "<td align=left width=50%><font size=-1>".$arFiltro['dtPagamento']."</font></td></tr>";
if ($_GET['nuValorLiquidoInicial'] and $arFiltro['nuValorLiquidoFinal']) {
    $stTabela1 .= "<tr><td align=right width=50%><font size=-1>Valores Líquidos de:</font></td>";
    $stTabela1 .= "<td align=left width=50%><font size=-1>".$arFiltro['nuValorLiquidoInicial']." até ".$arFiltro['nuValorLiquidoFinal']."</font></td></tr>";
}
if ($_GET['nuPercentualPagar']) {
    $stTabela1 .= "<tr><td align=right width=50%><font size=-1>Percentual à Pagar do Líquido:</font></td>";
    $stTabela1 .= "<td align=left width=50%><font size=-1>".$arFiltro['nuPercentualPagar']." %</font></td></tr>";
}
$stTabela1 .= "</table>";
