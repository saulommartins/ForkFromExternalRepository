...
/**
    ...
    * @ignore
    ...
    $Id: FMExportarRemessaCaixaEconomicaFederal.php 59612 2014-09-02 12:00:51Z gelson $
...
$stTabela1 .= "<tr><td align=center colspan=2 width=100%><font size=3><b>Resumo Remessa Caixa Econ&ocirc;mica Federal</b></font></td></tr>";
...
if ($_GET["inTipoMovimento"] != "") {
    switch ($_GET["inTipoMovimento"]) {
        case 0;
            $stTipoMovimento = "0 - Débito/Crédito  Normal";
            break;

        case 1;
            $stTipoMovimento = "1 - Cancelamento";
            break;

        case 5;
            $stTipoMovimento = "5 - Cadastro de Optantes";
            break;
    }
}
