...
/**
    ...
    * @ignore
    ...
    $Id: FMExportarRemessaBanrisul.php 59612 2014-09-02 12:00:51Z gelson $
...
if ($arFiltro['stSituacao'] == 'estagiarios') {
    ///////// COMPETENCIA ATUAL
    ...
    $stCompetencia  = ( $request->get('inCodMes') >= 10 ) ? $request->get('inCodMes') : "0".$request->get('inCodMes');
...
if ($arFiltro['nuValorLiquidoInicial'] and $arFiltro['nuValorLiquidoFinal']) {
