...
/**
    ...
    * @ignore
    ...
    $Id: OCExportacaoBancoBanrisul.php 65818 2016-06-21 12:13:54Z michel $
...
function montarListaConfBanrisul()
{
    ...
    $obLista->ultimaAcao->setLink( "JavaScript:JavaScript:BloqueiaFrames(true,false);executaFuncaoAjax('montaAlterarConfBanrisul');" );
