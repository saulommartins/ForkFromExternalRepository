...
<?php
/**
    * Página de Formulário do IMA Configuração - Banrisul
    ...
    * @ignore
    ...
    $Id: FMExportacaoBancoBanrisul.php 59612 2014-09-02 12:00:51Z gelson $
...
$obTIMAConfiguracaoConvenioBanrisul->recuperaTodos($rsConfiguracao);
...
$obIMontaAgenciaConta->obIMontaAgencia->obITextBoxSelectBanco->setTitle("Código do Banco Banrisul (041). Necessário que este banco esteja previamente cadastrado em Gestão Tributátia :: Cadastro Monetário :: Banco :: Incluir Banco.");
...
if ( $rsPeriodoMovimentacao->getNumLinhas()>0 ) {
    ...
    $obFormulario->addTitulo             ( "Banrisul"                     		                                            );
    ...
    $obFormulario->incluirAlterar("ConfBanrisul",$arComponentes,false,false,$stIds);
