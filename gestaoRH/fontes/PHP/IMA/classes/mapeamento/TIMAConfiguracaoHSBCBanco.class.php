...
class TIMAConfiguracaoHSBCBanco extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TIMAConfiguracaoHSBCBanco()
    {
        parent::Persistente();
        $this->setTabela("ima.configuracao_hsbc_bancos");

        $this->setCampoCod('');
        $this->setComplementoChave('cod_convenio, cod_banco, cod_agencia, cod_conta_corrente, timestamp, cod_banco_outros');
        ...
        $this->AddCampo('cod_banco_outros'  ,'integer'	     , true, '', true, 'TMONBanco');
    }
}
?>
