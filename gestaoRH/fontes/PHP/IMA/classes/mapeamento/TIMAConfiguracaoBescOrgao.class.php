...
<?php
/**
    * Classe de mapeamento da tabela ima.configuracao_besc_orgao
...
class TIMAConfiguracaoBescOrgao extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TIMAConfiguracaoBescOrgao()
    {
        parent::Persistente();
        $this->setTabela("ima.configuracao_besc_orgao");

        $this->setCampoCod('');
        $this->setComplementoChave('cod_convenio,cod_banco,cod_agencia,cod_conta_corrente,cod_orgao');
