...
<?php
/**
    * Classe de mapeamento da tabela ima.configuracao_bb_local
...
class TIMAConfiguracaoBbLocal extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TIMAConfiguracaoBbLocal()
{
    parent::Persistente();
    $this->setTabela("ima".sessao::getentidade().".configuracao_bb_local");
