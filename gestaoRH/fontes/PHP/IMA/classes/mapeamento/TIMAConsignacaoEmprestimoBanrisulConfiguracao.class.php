...
<?php
/**
* Classe de mapeamento da tabela ima.consignacao_emprestimo_banrisul_configuracao
...
class TIMAConsignacaoEmprestimoBanrisulConfiguracao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TIMAConsignacaoEmprestimoBanrisulConfiguracao()
{
    parent::Persistente();
    $this->setTabela('ima.consignacao_emprestimo_banrisul_configuracao');
    ...
    $this->AddCampo( 'cod_convenio', 'integer', false, '', false, '' );
    $this->AddCampo( 'nom_convenio', 'varchar', false, 50, false, '' );
    $this->AddCampo( 'ano_mes', 'varchar', false, 6, false, '' );
}
