...
class TIMAConfiguracaoDirfIrrfPlanoConta extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */    
    public function TIMAConfiguracaoDirfIrrfPlanoConta()
    {
        parent::Persistente();
        $this->setTabela("ima.configuracao_dirf_irrf_plano_conta");
