...
<?php
/**
    * Classe de mapeamento da tabela ima.configuracao_banrisul_orgao
...
class TIMAConfiguracaoBanrisulOrgao extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TIMAConfiguracaoBanrisulOrgao()
    {
        parent::Persistente();
        $this->setTabela("ima.configuracao_banrisul_orgao");
