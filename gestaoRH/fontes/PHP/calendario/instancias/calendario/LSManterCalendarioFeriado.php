...
$stCaminho   = "../modulos/calendario/calendario/";
...
$obRegra->setCodCalendar(Sessao::read('cod_calendar'));

$obRegra->addFeriadoVariavel();
$obRegra->ultimoFeriadoVariavel->setDtFeriado($_GET['dtData']);
$obRegra->commitFeriadoVariavel();
$obRegra->listarFeriados($rsLista,$stFiltro,$boTransacao);
...
if ($stAcao != 'consultar') {
    ...
    if ($stAcao == "excluir") {
        $obLista->ultimaAcao->setLink( $stCaminho.$pgProx."?" . Sessao::getId().$stLink . '&dtData='.$_GET['dtData'] . '&stAcao=excluir');
    } else {
