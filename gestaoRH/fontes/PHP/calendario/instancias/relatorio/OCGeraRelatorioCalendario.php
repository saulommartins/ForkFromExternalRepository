...
$obPDF->setTitulo            ( "Relação de Feriados por Calendário" );
$obPDF->setSubTitulo         ( Sessao::read('transf6') );
...
//$obPDF->addCampo("", -5 );
//
//$obPDF->addRecordSet( Sessao::read('transf50')) );
//$obPDF->setQuebraPaginaLista( false );
//
//$obPDF->setAlinhamento ( "L" );
//$obPDF->addCabecalho("DATA", 10, 10);
...
//$obPDF->addCampo("descricao", 8 );
//
//if (#sessao->transf5[1]['inNumLinhas'] != -1) {
//    $obPDF->addRecordSet( $rsVazio );
//    $obPDF->setQuebraPaginaLista( false );
//
//    $obPDF->setAlinhamento ( "L" );
...
//    $obPDF->addCampo("", -5 );
//
//    $obPDF->addRecordSet( Sessao::read('transf51') );
//    $obPDF->setQuebraPaginaLista( false );
//
//    $obPDF->setAlinhamento ( "L" );
//    $obPDF->addCabecalho("DATA", 10, 10);
