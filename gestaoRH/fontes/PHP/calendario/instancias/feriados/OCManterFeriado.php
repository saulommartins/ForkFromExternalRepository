...
$obLbAbrangencia = new Label;
$obLbAbrangencia->setRotulo        ( "Abrangência" );
$obLbAbrangencia->setName          ( "stAbrangencia" );
$obLbAbrangencia->setValue         ( $stAbrangencia );
...
$obFormulario->addComponente        ( $obLbAbrangencia );
$obFormulario->OK                   ();
$obFormulario->show                 ();
