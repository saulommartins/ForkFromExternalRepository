...
<?php
/**
    * Página de Formulário para Inclusão de ponto facultativo
...
$obLbDtData->setTitle     ( "Data do ponto facultativo" );

$obTxtDescricao = new TextBox;
$obTxtDescricao->setName      ( "stDescricao" );
$obTxtDescricao->setValue     ( $stDescricao );
$obTxtDescricao->setRotulo    ( "Descrição" );
$obTxtDescricao->setTitle     ( "Descrição do ponto facultativo" );
...
$obFormulario->addTitulo            ( "Dados do ponto facultativo" );
