...
$pgCons = "FMConsultarPontoFacultativo.php";

$stCaminho   = "../../../../../../gestaoRH/fontes/PHP/calendario/instancias/pontoFacultativo/";
...
if ($_REQUEST['dtData']) {
    $obRPontoFacultativo->setDtFeriado( $_REQUEST['dtData'] );
}

$stLink .= "&stAcao=".$stAcao;

$obRPontoFacultativo->listarPontoFacultativo($rsLista, $stOrdem,$boTransacao);
...
if ($stAcao != 'consultar') {
    ...
    if ($stAcao == "excluir") {
        $obLista->ultimaAcao->setLink( $stCaminho.$pgProx."?" . Sessao::getId().$stLink . '&dtData='. $_REQUEST['dtData'] . '&stAcao=excluir');
    } else {
