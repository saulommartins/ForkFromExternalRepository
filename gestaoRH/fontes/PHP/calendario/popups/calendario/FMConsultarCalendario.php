...
<?php
/*
    * Formulario para consulta de calendário
...
$obTCalendarioCalendarioCadastro->setDado("cod_calendar",$_GET["inCodCalendario"]);
$obTCalendarioCalendarioCadastro->setDado("ano",Sessao::getExercicio());
$obTCalendarioCalendarioCadastro->recuperaRelacionamento($rsFeriados);
