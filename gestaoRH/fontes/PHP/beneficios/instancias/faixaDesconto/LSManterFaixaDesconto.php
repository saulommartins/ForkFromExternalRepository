...
$stCaminho = CAM_GRH_BEN_INSTANCIAS."faixaDesconto/";
...
$obLista->setTitulo("Registro de Faixas de Desconto");
...
$obLista->ultimaAcao->addCampo( "&inCodVigencia" , "cod_vigencia" );
if ($stAcao == "excluir") {
    $obLista->ultimaAcao->addCampo("stDescQuestao"  ,"cod_vigencia");
