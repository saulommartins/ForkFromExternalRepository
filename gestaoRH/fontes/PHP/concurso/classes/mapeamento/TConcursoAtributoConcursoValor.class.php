...
<?php
/**
  * Classe de mapeamento da tabela CONCURSO.ATRIBUTO_CONCURSO_VALOR
...
/**
  * Efetua conexão com a tabela  CONCURSO.ATRIBUTO_CONCURSO_VALOR
  * Data de Criação: 29/03/2005
  ...
  * @subpackage Mapeamento
*/
class TConcursoAtributoConcursoValor extends PersistenteAtributosValores
{
/*
    * Método Construtor
    * @access Private
*/
function TConcursoAtributoConcursoValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('concurso.atributo_concurso_valor');
    //$this->setPersistenteAtributo( new TConcursoAtributoConcurso );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_atributo,cod_modulo,cod_cadastro,cod_edital');
