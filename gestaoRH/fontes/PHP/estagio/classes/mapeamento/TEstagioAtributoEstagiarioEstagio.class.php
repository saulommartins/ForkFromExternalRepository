...
<?php
/**
    * Classe de mapeamento da tabela estagio.atributo_estagiario_estagio
...
/**
  * Efetua conexão com a tabela  estagio.atributo_estagiario_estagio
  * Data de Criação: 05/10/2006
  ...
  * @subpackage Mapeamento
*/
class TEstagioAtributoEstagiarioEstagio extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TEstagioAtributoEstagiarioEstagio()
{
    parent::PersistenteAtributosValores();
    $this->setTabela("estagio.atributo_estagiario_estagio");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_cadastro,cod_modulo,cod_atributo,numcgm,cod_estagio,cod_curso,cgm_instituicao_ensino');
