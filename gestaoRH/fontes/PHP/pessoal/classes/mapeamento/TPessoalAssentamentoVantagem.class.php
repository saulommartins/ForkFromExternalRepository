...
<?php
/**
    * Classe de mapeamento da tabela PESSOAL.ASSENTAMENTO_VANTAGEM
...
/**
  * Efetua conexão com a tabela  PESSOAL.ASSENTAMENTO_VANTAGEM
  * Data de Criação: 10/08/2005
  ...
  * @subpackage Mapeamento
*/
class TPessoalAssentamentoVantagem extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPessoalAssentamentoVantagem()
{
    parent::Persistente();
    $this->setTabela('pessoal.assentamento_vantagem');
