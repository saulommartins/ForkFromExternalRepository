...
<?php
/**
    * Classe de mapeamento da tabela pessoal.contrato_pensionista_orgao
...
/**
  * Efetua conexão com a tabela  pessoal.contrato_pensionista_orgao
  * Data de Criação: 15/08/2006
  ...
  * @subpackage Mapeamento
*/
class TPessoalContratoPensionistaOrgao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPessoalContratoPensionistaOrgao()
{
    parent::Persistente();
    $this->setTabela("pessoal.contrato_pensionista_orgao");
...
{
    $stSql .= "SELECT contrato_pensionista_orgao.*                                                             \n";
