...
<?php
/**
  * Classe de mapeamento da tabela pessoal.assentamento_gerado_observacao
...
class TPessoalAssentamentoGeradoObservacao extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TPessoalAssentamentoGeradoObservacao()
    {
        parent::Persistente();
        $this->setTabela('pessoal.assentamento_gerado_observacao');
