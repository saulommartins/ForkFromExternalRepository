...
<?php
/**
    * Classe de mapeamento da tabela pessoal.pensao_funcao
...
/**
  * Efetua conexão com a tabela  pessoal.pensao_funcao
  * Data de Criação: 03/04/2006
  ...
  * @subpackage Mapeamento
*/
class TPessoalPensaoFuncao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPessoalPensaoFuncao()
{
    parent::Persistente();
    $this->setTabela("pessoal.pensao_funcao");
