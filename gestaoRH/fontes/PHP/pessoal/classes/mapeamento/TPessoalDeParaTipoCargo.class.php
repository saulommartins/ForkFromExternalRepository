...
<?php
/**
    * Classe de mapeamento da tabela tcepb.de_para_tipo_cargo
...
class TPessoalDeParaTipoCargo extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPessoalDeParaTipoCargo()
{
    parent::Persistente();
    $this->setTabela('pessoal.de_para_tipo_cargo');
