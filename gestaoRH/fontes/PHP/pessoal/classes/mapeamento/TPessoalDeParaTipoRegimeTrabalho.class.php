...
<?php
/**
    * Classe de mapeamento da tabela tcepb.de_para_tipo_regime_trabalho
...
class TPessoalDeParaTipoRegimeTrabalho extends Persistente
{
    ...
    */
    ...
    {
        parent::Persistente();
        $this->setTabela('pessoal.de_para_tipo_regime_trabalho');

        $this->setCampoCod('cod_sub_divisao');
        $this->setComplementoChave('cod_tipo_regime_trabalho_tce');

        $this->AddCampo('cod_sub_divisao'             , 'integer', true, '' , true, true);
        $this->AddCampo('cod_tipo_regime_trabalho_tce', 'integer', true, '' , true, true);
    }
