...
$Id: LSProcurarCgmDependente.php 59612 2014-09-02 12:00:51Z gelson $
...
$stPrograma = "ProcurarCgmDependente";
...
if ($_REQUEST["boFiltrarPensaoJudicial"]) {
    $stFiltroPensaoJudicial .= " AND cod_dependente IN (
