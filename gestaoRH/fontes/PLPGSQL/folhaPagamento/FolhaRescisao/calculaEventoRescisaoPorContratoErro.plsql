...
CREATE OR REPLACE FUNCTION calculaEventoRescisaoPorContratoErro() RETURNS BOOLEAN as $$
...
BEGIN
    ...
    END IF;
    stDadosRegistro             := buscaDadosRegistroEventoRescisaoDeDescontoIRRF(dtVigencia,inCodTipo,inCodContrato,inCodPeriodoMovimentacao);              
