...
*
* Objetivo: Recupera a quantidade de dependentes ativos para 
* para tratar a diferenca de salario familia de contrato com previdencia 
* inss porem que seja estaturario.
*/



CREATE OR REPLACE FUNCTION pega1QtdDependentesSalarioFamiliaEstatutario() RETURNS integer as '
...
--stDataFinalCompetencia :=''2006-04-30 23:59:59'';
  ...
  inIdadeLimite := pega1IdadeLimiteSalarioFamiliaEstatutario(); 
