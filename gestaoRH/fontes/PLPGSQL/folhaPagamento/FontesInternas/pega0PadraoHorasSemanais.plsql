...
--
-- Objetivo: Recebe o codigo do padrao e retorna o nr.de horas semanais para o referido padrao
--



CREATE OR REPLACE FUNCTION pega0PadraoHorasSemanais(integer) RETURNS Numeric as '
