...
--
-- Objetivo: verifica o codigo do padrao do contrato ( ultima posicao ) 
-- e retorna o nr. de horas semanais 
--



CREATE OR REPLACE FUNCTION pega1PadraoHorasSemanais() RETURNS Numeric as '
