...
* previdencia oficial obtem o codigo do vinculo desta ( ativo,inativo,pensionista)
*
...
CREATE OR REPLACE FUNCTION pega1VinculoPrevidenciaOficial() RETURNS integer as '

DECLARE
    inCodPrevidencia          INTEGER;
    inCodvinculo              INTEGER := 0;
stEntidade VARCHAR := recuperarBufferTexto(''stEntidade'');
 BEGIN
    ...
    inCodVinculo := selectIntoInteger(''
        SELECT cod_vinculo
