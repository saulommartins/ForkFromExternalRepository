...
* pega0TimestampTabelaIrrfNaData e o valor da base e retorna o percentual 
...
CREATE OR REPLACE FUNCTION pega0PercDescontoFaixaDescontoIrrfNoTimestampTabela(varchar,numeric) RETURNS numeric as '
