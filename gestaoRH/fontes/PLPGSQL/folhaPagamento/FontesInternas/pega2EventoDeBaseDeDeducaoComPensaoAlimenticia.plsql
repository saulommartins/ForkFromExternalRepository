...
*
* Objetivo: recupera o numero do evento configurado para a base de deducao com pensao alimenticia
*/




CREATE OR REPLACE FUNCTION pega2EventoDeBaseDeDeducaoComPensaoAlimenticia() RETURNS varchar as '
    ...
    inCodEvento := selectIntoInteger(''
           SELECT cod_evento
             ...
             WHERE cod_tipo = ''||inCodTipo||''
               AND cod_tabela = ''||inCodTabelaTabela||''
