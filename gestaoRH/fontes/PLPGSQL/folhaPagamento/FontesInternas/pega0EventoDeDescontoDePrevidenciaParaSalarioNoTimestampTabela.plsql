...
*/
--drop function pega0EventoDeDescontoDePrevidenciaParaSalarioNaData(integer,varchar);



CREATE OR REPLACE FUNCTION pega0EventoDeDescontoDePrevidenciaParaSalarioNoTimestampTabela(integer,varchar) RETURNS integer as '
