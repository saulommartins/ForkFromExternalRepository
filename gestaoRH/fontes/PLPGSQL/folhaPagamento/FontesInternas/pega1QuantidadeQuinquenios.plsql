...
-- $Name$
-- $Autor: Dagiane $
-- Date: 2011/10/31 10:50:00 $
--
--
-- Objetivo: Recebe a Data da Lei para avaliar vigencia da contagem 
-- do tempo para quinquenio, e retorna quantidade de quinquenios.
--/
--


CREATE OR REPLACE FUNCTION pega1QuantidadeQuinquenios(DATE) RETURNS integer as $$
