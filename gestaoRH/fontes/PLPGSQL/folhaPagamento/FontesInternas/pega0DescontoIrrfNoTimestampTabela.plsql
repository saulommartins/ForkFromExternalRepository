...
*
* Objetivo: recebe timestamp exato (retorno de funcao ). Recebe , tambem, 
* o valor da base liquida de ir , ou seja, 
...
CREATE OR REPLACE FUNCTION pega0DescontoIrrfNoTimestampTabela(varchar,numeric) RETURNS numeric as '
