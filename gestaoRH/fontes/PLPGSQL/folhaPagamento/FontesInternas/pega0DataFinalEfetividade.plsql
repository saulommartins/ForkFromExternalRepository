...
CREATE OR REPLACE FUNCTION pega0DataFinalEfetividade() RETURNS varchar as '

DECLARE
    stDataFinalEfetividade           VARCHAR :='''';
stEntidade VARCHAR := recuperarBufferTexto(''stEntidade'');
 BEGIN


   stDataFinalEfetividade := selectIntoVarchar('' SELECT                                        
     to_char(FPM.dt_final, ''''yyyy-mm-dd'''')||'''' 23:59:59''''  as dt_final                 
   FROM                                                               
