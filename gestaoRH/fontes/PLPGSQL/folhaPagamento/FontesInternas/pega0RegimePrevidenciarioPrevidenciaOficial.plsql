...
CREATE OR REPLACE FUNCTION pega0RegimePrevidenciarioPrevidenciaOficial(INTEGER,VARCHAR) RETURNS integer as '
...
stEntidade VARCHAR := recuperarBufferTexto(''stEntidade'');
 BEGIN
    ...
    inCodPrevidencia := pega0PrevidenciaOficialDoContratoNaData( inCodContrato, stDataFinalCompetencia  );
