...
* se FOR dependente para pensao alimenticia nao deve receber como salario familia.
*/



CREATE OR REPLACE FUNCTION pega0QtdDependentesSalarioFamilia(INTEGER,VARCHAR) RETURNS integer as '
...
stEntidade VARCHAR := recuperarBufferTexto(''stEntidade'');
 BEGIN
  ...
  inIdadeLimite := pega0IdadeLimiteSalarioFamilia(inCodContrato, stDataFinalCompetencia);
