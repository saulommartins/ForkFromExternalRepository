...
CREATE OR REPLACE FUNCTION pega0IdadeLimiteSalarioFamilia(integer,varchar) RETURNS integer as '
...
stEntidade VARCHAR := recuperarBufferTexto(''stEntidade'');
 BEGIN
    ...
    inCodRegimePrevidenciario := pega0RegimePrevidenciarioPrevidenciaOficial(inCodContrato, stDataFinalCompetencia );
