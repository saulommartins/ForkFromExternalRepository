...
CREATE OR REPLACE FUNCTION inserirValorQuantidadeEventoFeriasCalculado() RETURNS BOOLEAN AS $$
DECLARE
    inCodEvento                 INTEGER;
...
BEGIN
    ...
    stSql := 'INSERT INTO folhapagamento'|| stEntidade ||'.evento_ferias_calculado 
                (cod_evento,
                 cod_registro,
                 timestamp_registro,
                 desdobramento,
    ...
    IF inCodEvento = pega2CodEventoDescontoPensaoAlimenticia() THEN
        ...
        LOOP
            ...
            nuQuantidade := 1;
            stInsert := 'INSERT INTO folhapagamento'|| stEntidade ||'.evento_ferias_calculado_dependente
                        (cod_evento,
                         cod_registro,
                         cod_dependente,
                         timestamp_registro,
