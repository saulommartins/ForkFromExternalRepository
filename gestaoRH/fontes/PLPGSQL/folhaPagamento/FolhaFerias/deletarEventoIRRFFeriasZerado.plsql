...
CREATE OR REPLACE FUNCTION deletarEventoIRRFFeriasZerado(VARCHAR,INTEGER,INTEGER,INTEGER) RETURNS BOOLEAN as $$
DECLARE
...
BEGIN
    stSql := 'SELECT evento_ferias_calculado.cod_registro
