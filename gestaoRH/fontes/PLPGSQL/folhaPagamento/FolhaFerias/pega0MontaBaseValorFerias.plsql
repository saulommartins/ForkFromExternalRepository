...
CREATE OR REPLACE FUNCTION pega0MontaBaseValorFerias(varchar) RETURNS numeric as $$
...
BEGIN
    ...
    LOOP
        ...
        IF stNaturezaEvento = 'D' THEN
            ...
            ELSE
                nuValorBase := nuValorBase - pegaValorCalculadoFerias( stEventoFormatado, stDesdobramento, inCodConfiguracao  );
            END IF;
        ELSE
            IF (stDesdobramento = '') THEN
                --INSERT INTO tmp#inControle VALUES (1);
