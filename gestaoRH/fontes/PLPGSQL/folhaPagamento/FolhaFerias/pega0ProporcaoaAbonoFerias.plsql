...
*/
--/**
--    * Pl para retorno da informação de porporcionalização do evento de abono na aba férias
...
--
--    * $Id: pega0ProporcaoAdiantamentoDecimo.sql 29220 2008-04-15 18:46:02Z souzadl $
--*/
CREATE OR REPLACE FUNCTION pega0ProporcaoAbonoFerias() RETURNS BOOLEAN AS $$
DECLARE
    stSelect        VARCHAR:='';
    stEntidade   VARCHAR:='';
    inCodEvento     INTEGER;
...
stSelect := '    
SELECT configuracao_evento_caso.proporcao_abono
