...
CREATE OR REPLACE FUNCTION deletarRegistroEvento(INTEGER,INTEGER,VARCHAR,VARCHAR) RETURNS BOOLEAN as $$
DECLARE
...
BEGIN
    ...
    boRetorno       := deletarUltimoRegistroEvento(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
    boRetorno       := deletarReajusteRegistroEvento(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
