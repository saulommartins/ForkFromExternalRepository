...
CREATE OR REPLACE FUNCTION deletarUltimoRegistroEvento(INTEGER,INTEGER,VARCHAR,VARCHAR) RETURNS BOOLEAN as $$
DECLARE
...
BEGIN
    ...
    boRetorno       := deletarEventoCalculado(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
    boRetorno       := deletarRegistroEventoParcela(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
    boRetorno       := deletarLogErroCalculo(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
