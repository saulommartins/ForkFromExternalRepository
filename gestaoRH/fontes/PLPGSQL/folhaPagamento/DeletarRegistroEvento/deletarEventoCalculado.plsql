...
CREATE OR REPLACE FUNCTION deletarEventoCalculado(INTEGER,INTEGER,VARCHAR,VARCHAR) RETURNS BOOLEAN as $$
DECLARE
...
BEGIN
    ...
    boRetorno       := deletarEventoCalculadoDependente(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
    boRetorno       := deletarDeducaoDependente(inCodRegistro,inCodEvento,stDesdobramento,stTimestamp);
