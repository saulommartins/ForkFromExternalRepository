...
*/
/*
 * PL para retorno de número de vagas ocupadas para a especialidade
...
CREATE OR REPLACE FUNCTION getVagasOcupadasEspecialidade(INTEGER, INTEGER, INTEGER, INTEGER, BOOLEAN, VARCHAR) RETURNS INTEGER AS $$
DECLARE
...
BEGIN
    ...
    stSql := '    SELECT count(1) as contador 
              ...
              INNER JOIN pessoal'||stEntidade||'.contrato_servidor
                   ...
                   WHERE cod_especialidade = '||inCodEspecialidade||' 
    ...
    stSql := '     SELECT count(1) as contador
               ...
               INNER JOIN (  SELECT cod_contrato
                    ...
                    WHERE contrato_servidor_especialidade_funcao.cod_especialidade = '||inCodEspecialidade||'
