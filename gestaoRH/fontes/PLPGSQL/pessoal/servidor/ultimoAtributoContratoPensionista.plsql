...
*/
/*
* ultimo_atributo_contrato_pensionista
...
CREATE OR REPLACE FUNCTION ultimo_atributo_contrato_pensionista(VARCHAR, INTEGER) RETURNS SETOF colunasUltimoAtributoContratoPensionista AS $$
DECLARE
    stEntidade                      ALIAS FOR $1;
    inCodPeriodoMovimentacao        ALIAS FOR $2;
    stSql                           VARCHAR;
    rwAtributo                      colunasUltimoAtributoContratoPensionista%ROWTYPE;
...
BEGIN
    ...
    stSql := '      SELECT atributo_contrato_pensionista.cod_contrato
                         , atributo_contrato_pensionista.cod_cadastro
                         , atributo_contrato_pensionista.cod_atributo
                         , atributo_contrato_pensionista.cod_modulo
                         , atributo_contrato_pensionista.valor
                ...
                INNER JOIN (  SELECT cod_contrato
                        ...
                        ON atributo_contrato_pensionista.cod_contrato = max_atributo_contrato_pensionista.cod_contrato
