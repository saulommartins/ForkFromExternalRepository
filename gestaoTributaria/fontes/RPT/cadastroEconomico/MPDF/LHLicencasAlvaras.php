    ...
    <table class='border'>
        <thead>
            <tr class='border font_weight_bold text_align_center'>
                <th colspan=3>Relatório de Licenças e Alvarás</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
    ...
    <table class='border'>
        <thead>
            <tr>
                ...
                <td class="border text_align_center font_weight_bold" width="15%">Número da Inscrição Econômica</td>
                <td class="border text_align_center font_weight_bold" width="20%">Atividade</td>
        ...
        <tbody>
            <tr>
                    ...
                    foreach ($arLicencas as $key => $licenca) {
                        ...
                        echo "<td class=\"border text_align_justify\"> ".$licenca['atividade']     ."</td>";
