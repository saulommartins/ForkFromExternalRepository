...
*/
   ...
   BEGIN
    ...
    --Inclusão de função interna arrecadacao/fn_acrescimo_indice.plsql
      ...
      intCodFuncao   := public.manutencao_funcao   (  25, 1, 'fn_multa_2_porcento_mariana', 4);
      ...
      PERFORM           public.manutencao_parametro(  25, 1, intCodFuncao, intCodVariavel );
      intCodVariavel := public.manutencao_variavel (  25, 1, intCodFuncao, 'flCorrigido', 4 );
      PERFORM           public.manutencao_parametro(  25, 1, intCodFuncao, intCodVariavel );
...
CREATE TABLE arrecadacao.regra_desoneracao_grupo (
    cod_grupo      INTEGER NOT NULL, ano_exercicio CHAR(4)  NOT NULL,
    cod_modulo     INTEGER NOT NULL,
    cod_biblioteca INTEGER NOT NULL,
    cod_funcao     INTEGER NOT NULL,
 CONSTRAINT pk_regra_grupo PRIMARY KEY (cod_grupo,ano_exercicio),
 CONSTRAINT fk_regra_grupo_1 FOREIGN KEY (cod_grupo,ano_exercicio) REFERENCES arrecadacao.grupo_credito (cod_grupo,ano_exercicio),
 CONSTRAINT fk_regra_grupo_2 FOREIGN KEY (cod_modulo,cod_biblioteca,cod_funcao) REFERENCES administracao.funcao (cod_modulo,cod_biblioteca,cod_funcao)
);

GRANT ALL ON arrecadacao.regra_desoneracao_grupo TO GROUP urbem;
...
BEGIN
   ...
   IF FOUND THEN
      ...
      INSERT INTO arrecadacao.regra_desoneracao_grupo VALUES (169,'2008',25,2,98);
