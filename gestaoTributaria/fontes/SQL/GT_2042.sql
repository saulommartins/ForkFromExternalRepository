...
* Versao 2.04.2
*
* Fabio Bertoldi - 20150910
*
*/

----------------------------------------------------------------------------------------
-- Insercao da funcao fn_juros_simples_1_por_cento_ao_mes_033_ao_dia como funcao EXTERNA
----------------------------------------------------------------------------------------
   ...
   BEGIN
    ...
    --Inclusão de função interna arrecadacao/fn_acrescimo_indice.plsql
      ...
      intCodFuncao   := public.manutencao_funcao   (  28, 2, 'fn_juros_simples_1_por_cento_ao_mes_033_ao_dia', 4);
