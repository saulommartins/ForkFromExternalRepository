...
*
* $Id: atributoElementoCadastroEconomicoValorCREA.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
/*
$Log$
Revision 1.3  2006/11/13 12:55:23  gris
Ajuste Funcao atributoElementoCadastroEconomicoValorCREA.sql
...
*/
   ...
   CREATE OR REPLACE FUNCTION atributoElementoCadastroEconomicoValorCREA( intInscricaoEconomica INTEGER)
   RETURNS CHARACTER VARYING AS $$
   DECLARE
      varValor          VARCHAR := NULL;
      intCodModulo      INTEGER  := 14;
      intCodCadastro    INTEGER  := 5 ;
      intCodAtributo    INTEGER  := 7 ;
