...
*
* $Id: buscaInicioInscricaoMunicipalDia.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION buscaInicioInscricaoMunicipalDia( intInscricaoEconomica INTEGER
   ...
   BEGIN
      ...
      SELECT BTRIM(TO_CHAR(DATE_PART( 'DAY', atividade_cadastro_economico.dt_inicio),'99'))
        INTO varDiaAbertura
