...
*
* $Id: consultaCnae.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
--
CREATE OR REPLACE FUNCTION economico.fn_consulta_cnae(INTEGER,INTEGER)
RETURNS VARCHAR AS '
        ...
        stSql := ''
                  ...
                  FROM
                      ( SELECT
                           N.*
                       FROM
                           ECONOMICO.VIGENCIA_CNAE AS V,
                           ECONOMICO.NIVEL_CNAE AS N
                       WHERE
