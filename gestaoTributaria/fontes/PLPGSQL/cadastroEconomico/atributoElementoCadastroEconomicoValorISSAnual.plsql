...
*
* $Id: atributoElementoCadastroEconomicoValorISSAnual.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION atributoElementoCadastroEconomicoValorISSAnual( intInscricaoEconomica INTEGER)
   RETURNS CHARACTER VARYING AS $$
   DECLARE
      varValor          VARCHAR := NULL;
      intCodModulo      INTEGER  := 14;
      intCodCadastro    INTEGER  := 5 ;
      intCodAtributo    INTEGER  := 6 ;
