...
*
* $Id: buscaAberturaInscricaoMunicipalAno.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION buscaAberturaInscricaoMunicipalAno( intInscricaoEconomica INTEGER)
   RETURNS CHARACTER VARYING  AS $$
   DECLARE
      varDiaAbertura VARCHAR(04);
   BEGIN

      SELECT BTRIM(TO_CHAR(DATE_PART( 'YEAR', cadastro_economico.dt_abertura),'9999'))
        INTO varDiaAbertura
