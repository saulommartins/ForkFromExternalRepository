...
*
* $Id: buscaQtdTotalAtividadeDaInscricaoEconomica.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION buscaQtdTotalAtividadeDaInscricaoEconomica( intInscricaoEconomica INTEGER)
   RETURNS INTEGER AS $$
   DECLARE
      intValor             INTEGER := 0 ;
