...
*
* $Id: atributoElementoAtividadeGenerico.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION atributoElementoAtividade( intInscricaoEconomica  INTEGER
                                                       , intCodAtributo         INTEGER
                                                       , intCodAtividade        INTEGER
                                                       , intCodElemento         INTEGER)
   ...
   BEGIN
      ...
      IF FOUND AND booAtributoAtivo THEN
         ...
         WHERE atributo_elem_cad_economico_valor.cod_modulo          = intCodModulo
           ...
           AND atributo_elem_cad_economico_valor.cod_atividade       = intCodAtividade
           AND atributo_elem_cad_economico_valor.cod_elemento        = intCodElemento
