...
*
* $Id: buscaAberturaInscricaoMunicipalDia.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION buscaAberturaInscricaoMunicipalDia( intInscricaoEconomica INTEGER)
   RETURNS CHARACTER VARYING  AS $$
   DECLARE
      varDiaAbertura VARCHAR(02);
   BEGIN

      SELECT BTRIM(TO_CHAR(DATE_PART( 'DAY', cadastro_economico.dt_abertura),'99'))
        INTO varDiaAbertura
