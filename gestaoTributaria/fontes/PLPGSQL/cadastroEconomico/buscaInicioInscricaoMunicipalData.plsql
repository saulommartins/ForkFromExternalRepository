...
*
* $Id: buscaInicioInscricaoMunicipalData.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION buscaInicioInscricaoMunicipalData( intInscricaoEconomica INTEGER
   ...
   BEGIN
      ...
      SELECT atividade_cadastro_economico.dt_inicio
        INTO dDataInicio
