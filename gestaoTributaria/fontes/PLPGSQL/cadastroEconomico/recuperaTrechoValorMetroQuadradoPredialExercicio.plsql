...
*
* $Id: recuperaTrechoValorMetroQuadradoPredial.sql 29200 2008-04-15 13:48:27Z fabio $
*
...
--
CREATE OR REPLACE FUNCTION recuperaTrechoValorMetroQuadradoPredialExercicio( intInscricaoMunicipal INTEGER, intExercicio INTEGER )
...
BEGIN
        ...
        SELECT trecho_valor_m2.valor_m2_predial
          INTO varValor
