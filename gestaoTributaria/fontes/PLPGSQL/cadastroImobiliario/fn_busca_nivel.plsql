...
*
* $Id: fn_busca_nivel.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION imobiliario.fn_busca_nivel(INT,INT)  RETURNS VARCHAR AS '
DECLARE
