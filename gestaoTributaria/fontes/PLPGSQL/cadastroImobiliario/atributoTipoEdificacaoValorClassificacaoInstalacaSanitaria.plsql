...
*
* $Id: atributoTipoEdificacaoValorClassificacaoInstalacaSanitaria.sql 29199 2008-04-15 13:42:29Z fabio $
*
...
*/
   ...
   CREATE OR REPLACE FUNCTION atributoTipoEdificacaoValorClassificacaoInstalacaSanitaria( intInscricaoMunicipal INTEGER)
   RETURNS CHARACTER VARYING AS $$
   DECLARE
      varValor          VARCHAR := NULL;
      intCodModulo      INTEGER  := 12;
      intCodCadastro    INTEGER  := 5 ;
      intCodAtributo    INTEGER  := 8;
