...
*
* $Id: fn_lista_inscricao_por_num_parcelamento.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION lista_inscricao_por_num_parcelamento(integer) returns varchar as '
declare
