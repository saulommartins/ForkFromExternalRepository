...
*
* $Id: fn_acrescimo_infracao_tff.plsql 44137 2010-04-12 19:39:49Z cassiano $
*
* Caso de uso: uc-05.04.00
* Calculo Valor de Juros Especial (Mata)
*/

CREATE OR REPLACE FUNCTION fn_acrescimo_infracao_tff_composto ( date, date, numeric, integer, integer ) RETURNS numeric as '
    ...
    BEGIN
        ...
        nuRetorno := ( nuRetorno * 1 )::numeric(14,2);
