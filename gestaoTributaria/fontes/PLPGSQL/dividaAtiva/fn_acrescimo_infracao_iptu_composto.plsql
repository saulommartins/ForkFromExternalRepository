...
*
* $Id: fn_acrescimo_infracao_iptu.plsql 44119 2010-04-07 14:22:41Z cassiano $
*
* Caso de uso: uc-05.04.00
* Calculo Valor de Juros Especial (Mata)
*/

CREATE OR REPLACE FUNCTION fn_acrescimo_infracao_iptu_composto ( date, date, numeric, integer, integer ) RETURNS numeric as '
