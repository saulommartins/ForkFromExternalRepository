...
*
* $Id: fn_acrescimo_infracao_iss.plsql 44140 2010-04-13 12:19:52Z cassiano $
*
* Caso de uso: uc-05.04.00
* Calculo Valor de Juros Especial (Mata)
*/

CREATE OR REPLACE FUNCTION fn_acrescimo_infracao_iss_composto ( date, date, numeric, integer, integer ) RETURNS numeric as '
    ...
    BEGIN
        ...
        FROM fn_acrescimo_indice_mata_composto ( dtVencimento, dtDataCalculo, nuValor, 3, 1);
        nuRetorno := ( nuValor + nuCorrecao );
        IF TO_CHAR(dtDataCalculo,''YYYY'')::INT > 2006 THEN
            nuRetorno := ( nuRetorno * 0.6 )::numeric(14,2);
        END IF;
