...
*
*/
--lista todas inscricoes em divida do imovel que deveriam ser da mesma remissao
CREATE OR REPLACE FUNCTION fn_lista_numparcelamento_remissao(integer) RETURNS varchar as $$
DECLARE
...
BEGIN
    ...
    stSql := '
        ...
        WHERE
            divida_remissao.dt_remissao = '|| quote_literal(dtData) ||' AND ';
    ...
    FOR reRegistro IN EXECUTE stSql LOOP
        ...
        stRetorno := stRetorno||reRegistro.num_parcelamento;
    END LOOP;
