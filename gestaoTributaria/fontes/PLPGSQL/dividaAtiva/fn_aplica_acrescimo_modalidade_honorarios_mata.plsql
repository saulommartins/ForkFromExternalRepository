...
*
* $Id: fn_aplica_acrescimo_modalidade_honorarios_mata.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
/*
$Log$
Revision 1.1  2007/09/28 20:57:12  fabio
criada em funcao do calculo de honorarios


*/


CREATE OR REPLACE FUNCTION aplica_acrescimo_modalidade_honorarios_mata(integer,integer,integer,integer,integer,integer,numeric,date,date,text) returns varchar as '
declare
...
begin
    ...
    stSqlFuncoes := ''                                       
        ...
        ON
            ...
            AND divida.modalidade_acrescimo.cod_acrescimo <> 10
