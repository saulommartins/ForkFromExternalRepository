...
*
* $Id: fn_acrescimo_infracao_iss.plsql 59612 2014-09-02 12:00:51Z gelson $
*
* Caso de uso: uc-05.04.00
* Calculo Valor de Juros Especial (Mata)
*/

CREATE OR REPLACE FUNCTION fn_acrescimo_infracao_iss ( date, date, numeric, integer, integer ) RETURNS numeric as '
