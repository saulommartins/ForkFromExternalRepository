...
CREATE OR REPLACE FUNCTION divida.fn_busca_origem_num_parcelamento( integer ) RETURNS VARCHAR AS $$
declare
...
begin
        ...
        INNER JOIN
            (
                SELECT 
                    ...
                    MAX (lancamento_calculo.cod_calculo) as cod_calculo
                FROM
    ...
    FOR reRecordFuncoes IN EXECUTE stSqlFuncoes LOOP
        ...
        stOrigem := stOrigem||reRecordFuncoes.origem;
    END LOOP;
