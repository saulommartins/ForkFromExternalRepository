...
/*
$Log$
Revision 1.11  2007/07/10 20:20:56  dibueno
Melhoria referente ao esquema da funcao fn_imovel_lote
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_area_real(INTEGER)  RETURNS numeric(20,4) AS '
DECLARE
    inIM                        ALIAS FOR $1;
    inCodLote                   INTEGER;
    stSql                       VARCHAR   := '''';
...
BEGIN
    ...
    boLog := arrecadacao.salva_log(''arrecadacao.fn_area_real'',nuResultado::varchar);
    RETURN nuResultado;
END;
' LANGUAGE 'plpgsql';
