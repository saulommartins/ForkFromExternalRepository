...
*
* $Id: fn_rl_gc_valor_pago_parcelado.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_gc_valor_pago_parcelado ( integer, integer )  RETURNS NUMERIC(14,2) AS '
DECLARE
