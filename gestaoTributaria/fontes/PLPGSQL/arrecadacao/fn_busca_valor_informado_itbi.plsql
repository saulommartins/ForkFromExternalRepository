...
*
* $Id: fn_busca_valor_informado_itbi.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_busca_valor_informado_itbi( INTEGER ) returns numeric AS '
DECLARE
