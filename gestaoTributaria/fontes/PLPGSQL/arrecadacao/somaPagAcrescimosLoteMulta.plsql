...
*
* $Id: somaPagAcrescimosLoteMulta.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
/*
$Log$
Revision 1.4  2007/07/10 20:15:52  dibueno
*** empty log message ***

Revision 1.3  2007/04/17 15:57:12  dibueno
Bug #9034#
...
CREATE OR REPLACE FUNCTION arrecadacao.somaPagAcrescimosLoteMulta(integer,integer,integer,integer,integer,integer, varchar ) returns numeric as '
declare
