...
*
* $Id: fn_calcula_juros_lancamento.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.calcula_juros_lancamento( VARCHAR, DATE ) RETURNS VARCHAR AS '
DECLARE
...
SELECT 
    ...
    FROM
        (
         select 
            (
                case when ( aplica_juro (acar.numeracao, acar.exercicio::int, apar.cod_parcela, dtDataBase )) > 0 then
                    ((                                                                                                                              
                    alc.valor                                                                                                                   
                    ...
                    *  
                    aplica_juro (acar.numeracao, acar.exercicio::int, apar.cod_parcela, dtDataBase )
                    * arrecadacao.calculaProporcaoParcela(apar.cod_parcela)  
                    /100
                else
                    0.00
