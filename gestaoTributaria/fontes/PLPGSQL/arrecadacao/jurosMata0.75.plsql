...
*
* $Id: jurosMata0.75.plsql 59612 2014-09-02 12:00:51Z gelson $
*
* Caso de uso: uc-05.03.00
* Calculo Valor de Juros para Mariana
*/ 
CREATE OR REPLACE FUNCTION fn_juros_0pt75_porcento(date,date,numeric,integer,integer) RETURNS numeric as '
    ...
    DECLARE
        ...
        i               INTEGER = 0;
        nuTaxaFracao    NUMERIC = 0.025/100;
        nuTaxa          NUMERIC = 0.75/100;
