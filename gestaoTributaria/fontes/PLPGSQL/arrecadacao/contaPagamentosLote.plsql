...
*
* $Id: contaPagamentosLote.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.contaPagamentosLote(integer,integer) returns integer as $$
declare
