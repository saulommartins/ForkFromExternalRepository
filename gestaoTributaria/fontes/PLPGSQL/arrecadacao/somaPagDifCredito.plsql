...
*
* $Id: somaPagDifCredito.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.somaPagDifCredito(integer,integer,integer,integer,integer,integer, varchar) returns numeric as '
declare
...
begin
    ...
    stSql := ''
            ...
            from arrecadacao.calculo c
                , arrecadacao.pagamento_diferenca paga
