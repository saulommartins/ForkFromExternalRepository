...
*
* $Id: fn_aplica_multa_credito_parcela.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
/*
$Log$
Revision 1.8  2006/09/19 14:35:34  domluc
Adicionada chave completa de funcao

Revision 1.7  2006/09/19 09:40:03  domluc
...
CREATE OR REPLACE FUNCTION aplica_multa_credito_parcela(varchar,integer,integer,date,integer,integer,integer,integer) returns numeric as $$
declare
