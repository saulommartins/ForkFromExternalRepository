...
*
* $Id: fn_calculo_lancamento.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_calculo_lancamento( INTEGER )  RETURNS SETOF RECORD AS '
DECLARE
