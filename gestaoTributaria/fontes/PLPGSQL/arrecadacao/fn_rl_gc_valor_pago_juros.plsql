...
*
* $Id: fn_rl_gc_valor_pago_juros.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_gc_valor_pago_juros ( integer, integer, date )  RETURNS NUMERIC(14,2) AS '
DECLARE
