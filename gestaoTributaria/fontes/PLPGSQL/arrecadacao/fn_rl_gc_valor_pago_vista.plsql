...
*
* $Id: fn_rl_gc_valor_pago_vista.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_gc_valor_pago_vista ( integer, integer )  RETURNS NUMERIC(14,2) AS '
DECLARE
...
BEGIN
        ...
        select 
            coalesce (sum(APAR.valor), 0.00) as soma
        INTO
            nuResultado
        FROM
