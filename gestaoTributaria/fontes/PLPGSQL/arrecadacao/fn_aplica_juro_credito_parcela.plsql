...
*
* $Id: fn_aplica_juro_credito_parcela.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION aplica_juro_credito_parcela(varchar,integer,integer,date,integer,integer,integer,integer) returns numeric as $$
declare
