...
*
* $Id: fn_resultado_varchar.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_resultado_var(stValorRetorno VARCHAR) RETURNS varchar AS $$
DECLARE
    stRetorno                   VARCHAR;
    stTipo                      VARCHAR;
BEGIN
...
if stTipo = 's' then
    stRetorno   := substring(stValorRetorno from 3);
else
    stRetorno   := '';
end if;
