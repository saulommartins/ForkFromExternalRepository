...
*/
/*
* Busca o valor total do lançamento a partir da soma dos valores da tabela lancamento_calculo
*
* URBEM Soluções de Gestão Pública Ltda
* www.urbem.cnm.org.br
*
* $Id: buscaValorLancadoLancamento.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.buscaValorLancadoLancamento (integer, varchar) returns numeric as '
declare
