...
*
* $Id: buscaNumeracaoMigrada.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.buscaNumeracaoMigracao( varchar , integer ) RETURNS varchar AS '
DECLARE
