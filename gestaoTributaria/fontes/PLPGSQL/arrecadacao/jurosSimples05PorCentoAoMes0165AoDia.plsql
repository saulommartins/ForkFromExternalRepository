...
*
* $Id: jurosSimples05PorCentoAoMes0165AoDia.plsql 65272 2016-05-09 18:22:16Z fabio $
*
* Caso de uso: uc-05.03.00
*/
CREATE OR REPLACE FUNCTION fn_juros_simples_05_por_cento_ao_mes_0165_ao_dia( dtVencimento      DATE
                                                                           , dtCalculo         DATE
                                                                           , nuValor           NUMERIC
...
DECLARE
    ...
    nuTaxaFracao        NUMERIC := 0.0165/100;
    nuTaxa              NUMERIC := 0.005;
