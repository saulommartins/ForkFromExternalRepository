...
*
* $Id: fn_rl_cr_valor_pago_juros.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
/*
$Log$
Revision 1.6  2007/03/21 12:49:02  fabio
comentado raise
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_cr_valor_pago_juros ( integer, integer, integer, integer, integer, varchar ) RETURNS NUMERIC(14,2) AS '
DECLARE
