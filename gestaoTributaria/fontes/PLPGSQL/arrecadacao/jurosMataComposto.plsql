...
*
* $Id: jurosMata.plsql 44108 2010-04-06 13:47:39Z cassiano $
*
* Caso de uso: uc-05.03.00
* Calculo Valor de Juros para Mariana
*/ 
CREATE OR REPLACE FUNCTION fn_juros_1_porcento_composto(date,date,numeric,integer,integer) RETURNS numeric as '
