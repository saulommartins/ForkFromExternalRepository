...
*
* $Id: multaSimplesDezPorCento.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION fn_multa_simples_dez_por_cento(date,date,numeric,integer,integer) RETURNS numeric as '
    ...
    BEGIN
        ...
        IF dtVencimento <= dtDataCalculo  THEN
            IF ( inDiff > 0 ) THEN
                flMulta := ( flCorrigido * 10 ) / 100;  -- 1 até 30 dias, aplica 10%
            END IF;
        END IF;
