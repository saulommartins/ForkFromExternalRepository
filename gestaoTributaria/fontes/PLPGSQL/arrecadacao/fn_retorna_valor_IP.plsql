...
*
* $Id: fn_retorna_valor_IP.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_return_valor_IP() returns numeric AS '
DECLARE
    nuResultado     NUMERIC;
BEGIN
