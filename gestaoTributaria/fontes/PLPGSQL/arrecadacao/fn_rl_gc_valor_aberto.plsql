...
*
* $Id: fn_rl_gc_valor_aberto.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_gc_valor_aberto ( integer , numeric )  RETURNS NUMERIC(14,2) AS '
DECLARE
