...
*
* $Id: somaPagAcrescimosLote.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.somaPagAcrescimosLote(integer,integer,integer,integer,integer,integer) returns numeric as '
declare
