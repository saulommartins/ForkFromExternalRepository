...
*
* $Id: fn_acrescimo_indice.plsql 59612 2014-09-02 12:00:51Z gelson $
*
* Caso de uso: uc-05.03.00
* Calculo Valor de Juros Especial (Mata)
*/

CREATE OR REPLACE FUNCTION fn_acrescimo_indice (date,date,numeric,integer,integer) RETURNS numeric as '
...
--                inMesInicio := inMesInicio + 1;
            ...
            nuRetorno      := nuValor * ( nuJuroTotal / 100 ); 
