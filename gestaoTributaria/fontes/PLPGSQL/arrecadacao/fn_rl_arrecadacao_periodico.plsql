...
*
* $Id: fn_rl_arrecadacao_periodico.plsql 59612 2014-09-02 12:00:51Z gelson $
*
* Caso de uso: uc-05.03.13
*/


CREATE OR REPLACE FUNCTION arrecadacao.fn_rl_arrecadacao_periodico (
...
--    stFiltro :=
    ...
    FROM
        (
            ...
            GROUP BY    cod_lancamento, descricao
        ) as al
