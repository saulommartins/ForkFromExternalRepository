...
*
* $Id: fn_aplica_correcao.plsql 61622 2015-02-18 15:50:46Z evandro $
*
...
/*
$Log$
Revision 1.4  2007/09/21 18:46:30  fabio
Ticket#10227#

Revision 1.3  2007/03/19 20:26:03  dibueno
Bug #8416#
...
CREATE OR REPLACE FUNCTION aplica_correcao(varchar,integer,integer,date) returns numeric as $$
DECLARE
   ...
   stSqlCreditos := '
    ...
    FOR reRecord IN EXECUTE stSqlCreditos LOOP
        stSqlFuncoes := '
             ...
             AND    ACRE.cod_tipo = 1
             ORDER BY FORM.timestamp desc limit 1
        ';
