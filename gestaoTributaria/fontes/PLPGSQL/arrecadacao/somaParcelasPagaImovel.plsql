...
*
* $Id: somaParcelasPagaImovel.plsql 59612 2014-09-02 12:00:51Z gelson $
*
...
CREATE OR REPLACE FUNCTION arrecadacao.somaParcelasPagasImovel(integer , char(4)) returns numeric as '
declare
