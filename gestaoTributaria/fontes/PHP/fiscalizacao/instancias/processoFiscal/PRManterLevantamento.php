...
<?php
/**
    * Página de processo para filtro dos processos fiscais
...
$controller = new RFISManterLevantamento;
$visao = new VFISManterLevantamentol($controller);

$resposta = $visao->$funcao($_REQUEST);
