...
<?php
/**
    * Página que Processa o servico de levantamento fiscal por nota
...
require_once( CAM_GT_FIS_VISAO."VFISManterNota.class.php" );

//Instanciando a Classe de Controle e de Visao
$obController = new RFISManterNota;
$obVisao = new VFISManterNota( $obController );
