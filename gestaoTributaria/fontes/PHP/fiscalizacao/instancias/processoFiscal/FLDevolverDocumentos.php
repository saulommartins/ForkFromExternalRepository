...
<?php
/**
    * Página que Filtra os Processos Iniciados para Devolver Documentos
...
$stPrograma = "DevolverDocumentos"; // DINÂMICO
...
$obHdnNumCgm->setValue(Sessao::read('numCgm'));

$obHdnBoSituacao =  new Hidden;
$obHdnBoSituacao->setName ( "boSituacao" );
$obHdnBoSituacao->setValue( true );
