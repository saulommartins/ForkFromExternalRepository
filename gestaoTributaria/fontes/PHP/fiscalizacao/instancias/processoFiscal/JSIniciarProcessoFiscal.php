...
<script type="text/javascript">
    ...
    buscarDocumentosVinculados = function (valor) {
        setTimeout("montaParametrosGET('montaListaDocumentosVinculados', '', true)",valor);
    }
    ...
    function limparGeral(tipoBusca)
    {
        limpaFormulario();
    ...
    {
        buscarDocumentosVinculados(1000);
        Limpar();
    }
