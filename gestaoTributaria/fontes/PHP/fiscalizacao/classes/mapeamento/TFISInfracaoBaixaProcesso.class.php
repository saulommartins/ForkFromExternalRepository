...
<?php
/**
 * Classe de mapeamento para fiscalizacao.infracao_baixa_processo
 ...
 */
class TFISInfracaoBaixaProcesso extends Persistente
{
    /**
     * Método construtor
     * @access public
    ...
    public function __construct()
    {
        ...
        $this->setTabela( 'fiscalizacao.infracao_baixa_processo' );
        ...
        $this->addCampo( 'ano_exercicio', 'character', true, '', false, true );
    }
}
