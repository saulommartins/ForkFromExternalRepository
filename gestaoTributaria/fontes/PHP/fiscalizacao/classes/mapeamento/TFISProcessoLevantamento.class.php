...
<?php
/**
    * Classe de mapeamento para FISCALIZACAO.PROCESSO_LEVANTAMENTO
...
class TFISProcessoLevantamento extends Persistente
{
    /**
        * Metodo Construtor
        * @access Private
    */
    ...
    public function __construct()
    {
            ...
            $this->setTabela( 'fiscalizacao.processo_levantamento' );
