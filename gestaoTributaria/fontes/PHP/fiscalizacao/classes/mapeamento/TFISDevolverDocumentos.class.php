...
<?php
/**
    * Classe de mapeamento para FISCALIZACAO.PRORROGACAO_ENTREGA
...
class TFISDevolverDocumentos extends Persistente
{
    /**
        * Metodo Construtor
        * @access Private
    */
    public function __construct()
    {
        ...
        //$this->AddCampo( 'dt_entrega','date',true,'',false,false );
