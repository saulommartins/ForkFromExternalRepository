...
<?php
/**
    * Classe de mapeamento para FISCALIZACAO.RETENCAO_FONTE
...
class TFISRetencaoFonte extends Persistente
{
    /**
        * Metodo Construtor
        * @access Private
    */
    ...
    {
        parent::Persistente();
        $this->setTabela( 'fiscalizacao.retencao_fonte' );
        $this->setCampoCod( 'competencia');
        ...
        $this->AddCampo( 'valor_retencao','numeric',true,'14.2',false,true );
