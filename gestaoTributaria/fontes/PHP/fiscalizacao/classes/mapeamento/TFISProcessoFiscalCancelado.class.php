...
<?php
/**
    * Classe de mapeamento para FISCALIZACAO.PROCESSO_FISCAL_CANCELADO
...
class TFISProcessoFiscalCancelado extends Persistente
{
    /**
        * Metodo Construtor
        * @access Private
    */
    ...
    {
            parent::Persistente();
            $this->setTabela( 'fiscalizacao.processo_fiscal_cancelado' );
