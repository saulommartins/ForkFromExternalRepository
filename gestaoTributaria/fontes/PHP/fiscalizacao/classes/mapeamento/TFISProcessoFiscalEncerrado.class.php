...
class TFISProcessoFiscalEncerrado extends Persistente
{
    public function __construct()
    {
        parent::Persistente();
        $this->setTabela('fiscalizacao.termino_fiscalizacao');

        $this->setCampoCod('');
        $this->setComplementoChave('cod_processo, cod_documento, cod_tipo_documento, cod_fiscal');
