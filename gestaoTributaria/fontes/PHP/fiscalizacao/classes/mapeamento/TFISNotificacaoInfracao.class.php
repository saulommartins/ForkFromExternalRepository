 ...
 * @subpackage Mapeamento
 ...
 $Id: TFISNotificacaoInfracao.class.php 59612 2014-09-02 12:00:51Z gelson $
 ...
 */
class TFISNotificacaoInfracao extends Persistente
{
    /**
     * Método construtor
     * @access public
    ...
    public function __construct()
    {
        ...
        $this->setTabela( 'fiscalizacao.notificacao_infracao' );

        $this->setCampoCod( 'cod_processo, cod_infracao' );
