...
<?php
/** Página de Formulario de Inclusao/Alteracao Modalidade
...
/*
$Log$
Revision 1.4  2007/07/27 14:49:45  cercato
Bug#9766#

Revision 1.3  2007/04/24 15:18:05  cercato
alteracao em funcao da mudanca da reducao.

Revision 1.2  2007/02/28 17:07:07  cercato
Bug #8534#
...
function excluirReducaoCredito( inIndice1 ) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    document.frm.stCtrl.value = 'ExcluirReducaoCredito';
    document.frm.target = "oculto";
...
function excluirAcrescimo( inIndice1, inIndice2 ) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
...
function alterarReducao( inIndice1, inIndice2, inIndice3) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    document.frm.stCtrl.value = 'AlterarReducao';
    document.frm.target = "oculto";
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>&inIndice1='+inIndice1+'&inIndice2='+inIndice2+'&inIndice3='+inIndice3;
    document.frm.submit();
    document.frm.target = stTarget;
    document.frm.action = stAction;
}

function excluirReducao( inIndice1, inIndice2, inIndice3) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    document.frm.stCtrl.value = 'ExcluirReducao';
    document.frm.target = "oculto";
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>&inIndice1='+inIndice1+'&inIndice2='+inIndice2+'&inIndice3='+inIndice3;
    document.frm.submit();
    document.frm.target = stTarget;
...
function excluirParcela( inIndice1, inIndice2, inIndice3, inIndice4 ) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    document.frm.stCtrl.value = 'ExcluirParcela';
    document.frm.target = "oculto";
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>&inIndice1='+inIndice1+'&inIndice2='+inIndice2+'&inIndice3='+inIndice3+'&inIndice4='+inIndice4;
    document.frm.submit();
    document.frm.target = stTarget;
    document.frm.action = stAction;
}

function excluirDocumento( inIndice1 ) {
    var stTarget = document.frm.target;
    var stAction = document.frm.action;
    document.frm.stCtrl.value = 'ExcluirDocumento';
    document.frm.target = "oculto";
    document.frm.action = '<?=$pgOcul;?>?<?=Sessao::getId();?>&inIndice1='+inIndice1;
    document.frm.submit();
    document.frm.target = stTarget;
...
function Limpar(){
   ...
   if ( document.frm.inCodigo )
        document.frm.inCodigo.focus();
   else
