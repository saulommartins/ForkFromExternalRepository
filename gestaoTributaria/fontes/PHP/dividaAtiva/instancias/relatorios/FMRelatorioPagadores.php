...
<?php
/**
  * Página de Filtro para o Relatorio Pagadores
...
$obCmbLimite->setRotulo    ( "N° de registros pagadores" );
...
//DEFINICAO DO FORM
$obForm = new Form;
$obForm->setAction( "PRRelatorioPagadores.php" );
...
if($_REQUEST['stFiltro'] == 'credito') {
    ...
    $obFormulario->addTitulo("Limite de registros Pagadores");
