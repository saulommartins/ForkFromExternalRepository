...
/**
    ...
    * $Id: FMConcederRemissaoRelatorio.php 59612 2014-09-02 12:00:51Z gelson $
...
$arDadosSessao = Sessao::read( "dadosRemissao" );
...
if ($inTotalNaListaGrupoCreditoSessao > 0) {
    ...
    for ($inX=0; $inX<$inTotalNaListaGrupoCreditoSessao; $inX++) {
        ...
        $stFiltro2 .= $arDados[1].(int) $arDados[0].',';
    }
    $stFiltro2 = SUBSTR($stFiltro2,0,-1).'\'';
}

$stFiltro = "(".$stFiltro2.", true";
