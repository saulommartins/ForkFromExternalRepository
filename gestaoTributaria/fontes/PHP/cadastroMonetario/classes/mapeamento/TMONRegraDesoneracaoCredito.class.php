...
<?php
/**
    * Classe de regra de negócio para MONETARIO.REGRA_DESONERACAO_CREDITO
...
class TMONRegraDesoneracaoCredito extends Persistente
{
    /**
        * Método Construtor
        * @access Public
    */
    public function TMONRegraDesoneracaoCredito()
    {
        parent::Persistente();
        $this->setTabela("monetario.regra_desoneracao_credito");

        $this->setCampoCod('');
        $this->setComplementoChave('cod_natureza,cod_genero,cod_especie,cod_credito');
