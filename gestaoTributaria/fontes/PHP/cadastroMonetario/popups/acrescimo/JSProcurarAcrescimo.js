...
/**
  ...
  * Data de criação : 01/06/2005
    ...
    * $Id: JSProcurarAcrescimo.js 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
function Insere( stR1, stR2, stR3  ){
    ...
    window.opener.parent.frames['telaPrincipal'].document.getElementById('<?=$_REQUEST["campoNom"];?>').innerHTML = stR3;
