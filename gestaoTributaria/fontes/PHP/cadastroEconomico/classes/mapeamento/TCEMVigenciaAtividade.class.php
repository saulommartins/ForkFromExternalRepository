...
<?php
/**
  * Classe de mapeamento da tabela ECONOMICO.VIGENCIA_ATIVIDADE
  ...
  * @subpackage Mapeamento
    ...
    * $Id: TCEMVigenciaAtividade.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ECONOMICO.VIGENCIA_ATIVIDADE
  * Data de Criação: 17/11/2004
  ...
  * @subpackage Mapeamento
*/
class TCEMVigenciaAtividade extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCEMVigenciaAtividade()
{
    parent::Persistente();
    $this->setTabela('economico.vigencia_atividade');
...
function montaRecuperaVigenciaAtual()
{
    ...
    $stSQL .= " WHERE                                               \n";
    $stSQL .= "     dt_inicio::varchar <= TO_CHAR( NOW(), 'yyyy-mm-dd' ) AND \n";
...
function montaRecuperaVigenciasValidas()
{
    ...
    $stSQL .= "     ".$this->getTabela()."                                          \n";
    $stSQL .= " WHERE                                                               \n";
    $stSQL .= "     to_char(dt_inicio,'dd/mm/yyyy') >= (                            \n";
    $stSQL .= "         select max(to_char(dt_inicio,'dd/mm/yyyy')) as dt_inicio    \n";
    $stSQL .= "         from economico.vigencia_atividade                           \n";
    $stSQL .= "         WHERE                                                       \n";
    $stSQL .= "             dt_inicio <= TO_CHAR( NOW(), 'yyyy-mm-dd' ) AND         \n";
    $stSQL .= "          cod_vigencia > 0                                           \n";
    $stSQL .= "     )                                                               \n";
