...
<?php
/**
  * Classe de mapeamento da tabela ECONOMICO.ATRIBUTO_EMPRESA_FATO_VALOR
  ...
  * @subpackage Mapeamento
    ...
    * $Id: TCEMAtributoEmpresaFatoValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ECONOMICO.ATRIBUTO_EMPRESA_FATO_VALOR
  * Data de Criação: 17/11/2004
  ...
  * @subpackage Mapeamento
*/
class TCEMAtributoEmpresaFatoValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCEMAtributoEmpresaFatoValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('economico.atributo_empresa_fato_valor');
...
function RemoveAtributoEmpresaFato($boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
    $stSql = $this->montaRemoveAtributoEmpresaFato();
    $this->stDebug = $stSql;
...
function montaRemoveAtributoEmpresaFato()
{
    $stSql  = "  DELETE FROM  economico.atributo_empresa_fato_valor \n";
