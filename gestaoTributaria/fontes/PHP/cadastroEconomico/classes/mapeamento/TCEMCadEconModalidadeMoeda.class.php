...
<?php
/**
  * Classe de mapeamento da tabela ECONOMICO.CAD_ECON_MODALIDADE_MOEDA
  ...
  * @subpackage Mapeamento
    ...
    * $Id: TCEMCadEconModalidadeMoeda.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TCEMCadEconModalidadeMoeda extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCEMCadEconModalidadeMoeda()
{
    parent::Persistente();
    $this->setTabela('economico.cad_econ_modalidade_moeda');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_modalidade,cod_atividade,inscricao_economica,ocorrencia_atividade,dt_inicio,cod_moeda');
