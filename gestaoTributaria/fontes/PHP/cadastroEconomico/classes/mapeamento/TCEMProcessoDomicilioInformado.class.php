...
<?php
/**
  * Classe de mapeamento da tabela ECONOMICO.PROCESSO_DOMICILIO_INFORMADO
  ...
  * @subpackage Mapeamento
    ...
    * $Id: TCEMProcessoDomicilioInformado.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ECONOMICO.PROCESSO_DOMICILIO_INFORMADO
  * Data de Criação: 13/03/2006
  ...
  * @subpackage Mapeamento
*/
class TCEMProcessoDomicilioInformado extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCEMProcessoDomicilioInformado()
{
    parent::Persistente();
    $this->setTabela('economico.processo_domicilio_informado');
