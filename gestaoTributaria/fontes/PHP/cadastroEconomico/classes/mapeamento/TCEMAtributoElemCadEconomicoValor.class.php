...
<?php
/**
  * Classe de mapeamento da tabela ECONOMICO.ATRIBUTO_ELEM_CAD_ECONOMICO_VALOR
  ...
  * @subpackage Mapeamento
    ...
    * $Id: TCEMAtributoElemCadEconomicoValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ECONOMICO.ATRIBUTO_ELEM_CAD_ECONOMICO_VALOR
  * Data de Criação: 17/11/2004
  ...
  * @subpackage Mapeamento
*/
class TCEMAtributoElemCadEconomicoValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCEMAtributoElemCadEconomicoValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('economico.atributo_elem_cad_economico_valor');
    $this->setPersistenteAtributo( new TCEMAtributoElemento );

    $this->setCampoCod('');
    $this->setComplementoChave('inscricao_economica,cod_atividade,cod_elemento,ocorrencia_elemento,ocorrencia_atividade,cod_atributo,cod_cadastro','timestamp');
