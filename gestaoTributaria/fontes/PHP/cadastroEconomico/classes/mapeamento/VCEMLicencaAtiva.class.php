...
<?php
/**
     * Classe de mapeamento para a tabela ECONOMICO.VW_LICENCA_ATIVA
    ...
    * $Id: VCEMLicencaAtiva.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a view ECONOMICO.VW_LICENCA_ATIVA
  * Data de Criação: 01/12/2004
  ...
  * @subpackage Mapeamento
*/
class VCEMLicencaAtiva extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function VCEMLicencaAtiva()
{
    parent::Persistente();
    $this->setTabela('ECONOMICO.VW_LICENCA_ATIVA');
