...
* $Id: MontaServico.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/*
$Log$
Revision 1.10  2007/03/12 18:54:07  rodrigo
Bug #8597#

Revision 1.9  2006/11/03 11:07:44  cercato
bug #7314#

Revision 1.8  2006/10/30 19:05:12  cercato
adicionada funcao para setar rotulo.

Revision 1.7  2006/10/30 11:19:08  cercato
adicionada funcao para setar rotulo.

Revision 1.6  2006/10/26 15:23:03  cercato
adicionado include para funcionar o componente.
...
/**
    ...
    * @param Integer $valor
*/
function setCodigoAtividade($valor)
{
    $this->obRCEMServico->setCodigoAtividade( $valor );
}
...
//  $this->boCadastroServico = true;
    $this->stRotulo = "Serviço";
    $this->stTitle = "Informe o serviço";
}
...
function geraFormulario(&$obFormulario)
{
    ...
    while ( !$rsListaNivelServico->eof() ) {
        ...
        $obCmbServico->setRotulo    ( $this->stRotulo );
    ...
    if ( count( $arCombosServico ) ) {
        ...
        $obTxtChaveServico->setTitle     ( $this->stTitle );
        $obTxtChaveServico->setRotulo    ( $this->stRotulo );
         ...
         if ($boMontaCombosServico) {
             ...
             while ( !$rsListaServico->eof() ) {
                 ...
                 if ( $rsListaServico->getCampo( "valor_reduzido") == $stValorReduzidoServico ) {
                     $stSelected = "selected";
                     $stChaveServicoSelecionado = $stChaveServico;
                 } else {
                     $stSelected = "";
                 }
             ...
             $js .= "f.".$stNomeCombo.".value = '".$stChaveServicoSelecionado."';";
         }
         $rsListaNivelServico->proximo();
    }
