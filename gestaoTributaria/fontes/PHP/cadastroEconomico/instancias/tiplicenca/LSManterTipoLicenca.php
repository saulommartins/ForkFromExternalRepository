...
$stCaminho = CAM_GT_CEM_INSTANCIAS."tiplicenca/";
...
//MONTA O FILTRO
if ($_REQUEST["inCodigoTipoLicencaDiversa"]) {
...
if ($_REQUEST["stNomeTipoLicenca"]) {
    //RETIRA O PONTO FINAL DO VALOR COMPOSTO CASO EXISTA
    $obRCEMTipoLicencaDiversa->setNomeTipoLicencaDiversa( $_REQUEST["stNomeTipoLicenca"] );
}

$stLink .= "&stAcao=".$stAcao;
$obRCEMTipoLicencaDiversa->listarTipoLicencaDiversa($rsLista);

$obLista = new Lista;
$obLista->setRecordSet( $rsLista );
$obLista->setTitulo("Registros de Tipo de Licença");
...
$obLista->ultimaAcao->addCampo("&stNomeTipoLicencaDiversa",       "nom_tipo"        );
$obLista->ultimaAcao->addCampo("&inCodigoTipoLicencaDiversa",       "cod_tipo"        );
