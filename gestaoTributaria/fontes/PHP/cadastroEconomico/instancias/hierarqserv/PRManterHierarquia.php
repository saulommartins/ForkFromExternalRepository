...
switch ($stAcao) {
    case "incluir":
        ...
        $obRCEMNivelServico->setMascara        ( $_REQUEST["stMascaraNivel"]   );
        $obErro = $obRCEMNivelServico->incluirNivel();
    ...
    break;
    case "excluir":
        $obRCEMNivelServico->setCodigoNivel    ( $_REQUEST["inCodigoNivel"]    );
        $obRCEMNivelServico->setCodigoVigencia ( $_REQUEST["inCodigoVigencia"] );
        $obErro = $obRCEMNivelServico->excluirNivel();
    ...
    case "alterar":
        ...
        $obRCEMNivelServico->setNomeNivel      ( $_REQUEST["stNomeNivel"]      );
        $obRCEMNivelServico->setMascara        ( $_REQUEST["stMascaraNivel"]   );
        $obErro = $obRCEMNivelServico->alterarNivel();
