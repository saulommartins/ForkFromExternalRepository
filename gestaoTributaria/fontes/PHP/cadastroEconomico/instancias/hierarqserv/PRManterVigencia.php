...
/*
$Log$
Revision 1.5  2006/09/15 14:32:55  fabio
...
include(CAM_GT_CEM_NEGOCIO."RCEMNivelServico.class.php");
...
switch ($stAcao) {
    ...
    case "incluir":
        ...
        if ($stDataInicioA>$stUltDataVigenciaA) {
            ...
            sistemaLegado::exibeAviso("Data deve ser maior que a ultima cadastrada: Data:".$stDataInicio,"n_incluir","aviso");
    ...
    case "excluir":
       ...
       /* COnsultar se a niveis para vigencia */
        ...
        $obErro = $obRegra->excluirVigencia();
            ...
            sistemaLegado::alertaAviso($pgList,"Vigência possui niveis atrelados a ela! (Vigência: ".$obRegra->getCodigoVigencia().'-'.$obRegra->getInicioVigencia().")","erro","erro", Sessao::getId(), "../");
        }
    break;
    case "alterar":
        $obRegra->setCodigoVigencia( $_REQUEST['inCodigoVigencia'] );
