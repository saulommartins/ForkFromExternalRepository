...
/**
    ...
    * $Id: JSBuscaLote.js 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
function Insere( inNumLote, inCodLote ){
    window.opener.parent.frames['telaPrincipal'].document.frm.<?=$_REQUEST["campoNum"];?>.value = inNumLote;
    window.opener.parent.frames['telaPrincipal'].document.frm.<?=$_REQUEST["campoNom"];?>.value = inCodLote;
