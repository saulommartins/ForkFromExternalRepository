...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.ATRIBUTO_TRECHO_VALOR
    ...
    * $Id: TCIMAtributoTrechoValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.ATRIBUTO_TRECHO_VALOR
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoTrechoValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoTrechoValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('imobiliario.atributo_trecho_valor');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_trecho,cod_logradouro,cod_atributo,cod_cadastro,timestamp,cod_modulo');
