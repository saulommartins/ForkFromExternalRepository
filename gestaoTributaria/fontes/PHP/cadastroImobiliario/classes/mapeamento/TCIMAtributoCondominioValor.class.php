...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.ATRIBUTO_CONDOMINIO_VALOR
    ...
    * $Id: TCIMAtributoCondominioValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.ATRIBUTO_CONDOMINIO_VALOR
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoCondominioValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoCondominioValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('imobiliario.atributo_condominio_valor');
//    $this->setPersistenteAtributo( new TCIMAtributoCadastroImobiliario );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_condominio,cod_atributo,cod_cadastro,timestamp');
