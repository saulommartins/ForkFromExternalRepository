...
/*
    ...
    * $Id: TCIMLicencaBaixa.class.php 59762 2014-09-09 21:02:35Z carolina $
...
class TCIMLicencaBaixa extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TCIMLicencaBaixa()
    {
        parent::Persistente();
        $this->setTabela('imobiliario.licenca_baixa');
        ...
        $this->AddCampo( 'dt_inicio', 'date', false, '', true, false );
