...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_LOTE
    ...
    * $Id: TCIMBaixaLote.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_LOTE
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaLote extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaLote()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_lote');
