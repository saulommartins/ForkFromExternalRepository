...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_UNIDADE_DEPENDENTE
    ...
    * $Id: TCIMBaixaUnidadeDependente.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_UNIDADE_DEPENDENTE
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaUnidadeDependente extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaUnidadeDependente()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_unidade_dependente');

    $this->setCampoCod('');
    $this->setComplementoChave('inscricao_municipal,cod_construcao_dependente,cod_construcao,cod_tipo,timestamp');
