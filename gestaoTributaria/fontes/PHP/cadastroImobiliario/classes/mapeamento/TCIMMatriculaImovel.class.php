...
/**
    ...
    * $Id: TCIMMatriculaImovel.class.php 66542 2016-09-16 13:32:13Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class TCIMMatriculaImovel extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMMatriculaImovel()
{
    parent::Persistente();
    $this->setTabela('imobiliario.matricula_imovel');
    ...
    $this->AddCampo('mat_registro_imovel','varchar',20,'',true,false);
    $this->AddCampo('zona','varchar',10,'',false,false);
