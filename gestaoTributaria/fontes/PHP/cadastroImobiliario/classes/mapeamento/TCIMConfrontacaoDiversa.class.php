...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.CONFRONTACAO_DIVERSA
    ...
    * $Id: TCIMConfrontacaoDiversa.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.CONFRONTACAO_DIVERSA
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMConfrontacaoDiversa extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMConfrontacaoDiversa()
{
    parent::Persistente();
    $this->setTabela('imobiliario.confrontacao_diversa');
