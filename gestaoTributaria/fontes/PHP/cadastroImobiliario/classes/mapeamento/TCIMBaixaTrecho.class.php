...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_TRECHO
    ...
    * $Id: TCIMBaixaTrecho.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_TRECHO
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaTrecho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaTrecho()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_trecho');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_trecho,cod_logradouro,timestamp');
