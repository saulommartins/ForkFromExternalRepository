...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_CONSTRUCAO
    ...
    * $Id: TCIMBaixaConstrucao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_CONSTRUCAO
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaConstrucao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaConstrucao()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_construcao');
