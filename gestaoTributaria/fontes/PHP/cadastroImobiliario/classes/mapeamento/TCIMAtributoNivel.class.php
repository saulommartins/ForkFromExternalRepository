...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.ATRIBUTO_NIVEL
    ...
    * $Id: TCIMAtributoNivel.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.ATRIBUTO_NIVEL
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoNivel extends PersistenteAtributos
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoNivel()
{
    parent::Persistente();
    $this->setTabela('imobiliario.atributo_nivel');
    $this->setPersistenteAtributoModulo( new TCIMAtributoCadastroImobiliario );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_nivel,cod_vigencia,cod_atributo,cod_cadastro,cod_modulo');
