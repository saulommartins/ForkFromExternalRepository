...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.vw_confrontacao_extensao_atual
    ...
    * $Id: VCIMConfrontacaoExtensaoAtual.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a view  IMOBILIARIO.vw_confrontacao_extensao_atual
  * Data de Criação: 20/11/2004
  ...
  * @subpackage Mapeamento
*/
class VCIMConfrontacaoExtensaoAtual extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function VCIMConfrontacaoExtensaoAtual()
{
    parent::Persistente();
    $this->setTabela('imobiliario.vw_confrontacao_extensao_atual');
