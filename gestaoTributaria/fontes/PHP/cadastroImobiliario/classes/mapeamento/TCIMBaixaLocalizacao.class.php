...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_LOCALIZACAO
    ...
    * $Id: TCIMBaixaLocalizacao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_LOCALIZACAO
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaLocalizacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaLocalizacao()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_localizacao');
