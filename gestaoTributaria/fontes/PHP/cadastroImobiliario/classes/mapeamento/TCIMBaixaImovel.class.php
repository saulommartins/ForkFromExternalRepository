...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_IMOVEL
    ...
    * $Id: TCIMBaixaImovel.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_IMOVEL
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaImovel extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaImovel()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_imovel');
