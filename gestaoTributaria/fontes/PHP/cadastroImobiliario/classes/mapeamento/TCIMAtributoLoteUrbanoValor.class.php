...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.ATRIBUTO_LOTE_URBANO_VALOR
    ...
    * $Id: TCIMAtributoLoteUrbanoValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.ATRIBUTO_LOTE_URBANO_VALOR
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoLoteUrbanoValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoLoteUrbanoValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('imobiliario.atributo_lote_urbano_valor');
//    $this->setPersistenteAtributo( new TCIMAtributoCadastroImobiliario );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_atributo,cod_cadastro,timestamp,cod_lote','cod_modulo');
