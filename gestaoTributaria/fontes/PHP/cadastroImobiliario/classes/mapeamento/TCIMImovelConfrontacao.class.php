...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.IMOVEL_CONFRONTACAO
    ...
    * $Id: TCIMImovelConfrontacao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.IMOVEL_CONFRONTACAO
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMImovelConfrontacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMImovelConfrontacao()
{
    parent::Persistente();
    $this->setTabela('imobiliario.imovel_confrontacao');
