...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.LOTE_RURAL
    ...
    * $Id: TCIMLoteRural.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.LOTE_RURAL
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMLoteRural extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMLoteRural()
{
    parent::Persistente();
    $this->setTabela('imobiliario.lote_rural');
...
function montaRecuperaRelacionamento()
{
    ...
    $stSQL .= "    imobiliario.lote_rural                  AS LU,              \n";
...
/*
    ...
    $stSQL .= "    LP.cod_processo,                                         \n";
    $stSQL .= "    LP.ano_exercicio,                                        \n";
    ...
    $stSQL .= "     WHERE                                                   \n";
    $stSQL .= "         LP.cod_lote = L.cod_lote                            \n";
    $stSQL .= "     ORDER BY                                                \n";
    $stSQL .= "         LP.timestamp DESC                                      \n";
    $stSQL .= "     LIMIT 1                                                 \n";
    $stSQL .= "     ) as LP ON                                              \n";
    $stSQL .= "     LP.cod_lote = L.cod_lote,                                \n";
