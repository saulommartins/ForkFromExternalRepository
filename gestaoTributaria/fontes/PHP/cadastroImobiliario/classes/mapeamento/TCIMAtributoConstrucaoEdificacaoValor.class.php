...
/**
    ...
    * $Id: TCIMAtributoConstrucaoEdificacaoValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoConstrucaoEdificacaoValor extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoConstrucaoEdificacaoValor()
{
    parent::Persistente();
    $this->setTabela('imobiliario.atributo_tipo_edificacao_valor');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_tipo,cod_construcao,cod_atributo,cod_cadastro,timestamp');
