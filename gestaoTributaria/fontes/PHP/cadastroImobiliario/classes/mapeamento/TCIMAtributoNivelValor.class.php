...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.ATRIBUTO_NIVEL_VALOR
    ...
    * $Id: TCIMAtributoNivelValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.ATRIBUTO_NIVEL_VALOR
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMAtributoNivelValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMAtributoNivelValor()
{
    parent::Persistente();
    $this->setTabela('imobiliario.atributo_nivel_valor');
    $this->setPersistenteAtributo( new TCIMAtributoNivel );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_nivel,cod_vigencia,cod_localizacao,cod_atributo,cod_cadastro,cod_modulo');
