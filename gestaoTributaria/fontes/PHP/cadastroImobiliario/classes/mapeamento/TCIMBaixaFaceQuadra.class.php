...
<?php
/**
     * Classe de mapeamento para a tabela IMOBILIARIO.BAIXA_FACE_QUADRA
    ...
    * $Id: TCIMBaixaFaceQuadra.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  IMOBILIARIO.BAIXA_FACE_QUADRA
  * Data de Criação: 07/09/2004
  ...
  * @subpackage Mapeamento
*/
class TCIMBaixaFaceQuadra extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TCIMBaixaFaceQuadra()
{
    parent::Persistente();
    $this->setTabela('imobiliario.baixa_face_quadra');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_face,cod_localizacao,timestamp');
