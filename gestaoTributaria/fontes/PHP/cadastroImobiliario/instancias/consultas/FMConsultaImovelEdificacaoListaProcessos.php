...
<?php
/**
    * Página para lista de Processos da Edificacao
    ...
    * $Id: FMConsultaImovelEdificacaoListaProcessos.php 59612 2014-09-02 12:00:51Z gelson $
...
$obLista->ultimaAcao->setLink( "JavaScript:visualizarProcessoConstrucao( 'visualizarProcessoEdificacao' );" );
...
$obSpnProcessoEdificacao = new Span;
$obSpnProcessoEdificacao->setId    ( "spnProcessoEdificacao"       );
$obSpnProcessoEdificacao->setValue ( $obLista->getHTML() );

$obSpnAtributosProcessoEdificacao = new Span;
$obSpnAtributosProcessoEdificacao->setId ( "spnAtributosProcessoEdificacao" );
