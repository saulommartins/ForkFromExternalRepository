...
<?php
/**
    * Página para lista de Processos do Condomínio
    ...
    * $Id: FMConsultaImovelCondominioListaProcessos.php 59612 2014-09-02 12:00:51Z gelson $
...
$rsListaProcesso->addFormatacao( "area_total_comum", "NUMERIC_BR" );
...
$obLista->ultimaAcao->setLink( "JavaScript:visualizarProcessoCondominio('visualizarProcessoCondominio');" );
...
$obLista->ultimaAcao->addCampo("5","area_total_comum");
$obLista->commitAcao();

$obLista->montaHTML();

$obSpnProcessoCondominio = new Span;
$obSpnProcessoCondominio->setId ( "spnProcessoCondominio" );
$obSpnProcessoCondominio->setValue ($obLista->getHTML());

$obSpnAtributosProcessoCondominio = new Span;
$obSpnAtributosProcessoCondominio->setId ( "spnAtributosProcessoCondominio" );
