...
/**
    ...
    * $Id: FfnImpostoPredialSw.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FfnImpostoPredialSw extends Persistente
{
/**
    * M̩todo Construtor
    * @access Private
*/
function FfnImpostoPredialSw()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT fnImpostoPredialSw(".$stParametros.") as valor \r\n";
