...
/**
    ...
    * $Id: Fcalculataxalimpeza.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class Fcalculataxalimpeza extends Persistente
{
/**
    * M̩todo Construtor
    * @access Private
...
{
    $stSql  = " SELECT calculataxalimpeza(".$stParametros.") as valor \r\n";
