...
<?php
/**
    * Classe de mapeamento da função VenalEdificacao()
    ...
    * $Id: FValorLogTemp.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/*
$Log$
Revision 1.4  2006/09/15 11:49:45  fabio
corrigidas tags de caso de uso

Revision 1.3  2006/09/15 10:28:15  fabio
...
/**
  ...
  * @subpackage Mapeamento
*/
class FValorLogTemp extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FValorLogTemp()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT  arrecadacao.fn_valor_log_temp(".$stParametros.") as valor \r\n";
