...
/**
    ...
    * $Id: Fcalculaimpostoterritorial.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class Fcalculaimpostoterritorial extends Persistente
{
/**
    * M̩todo Construtor
    * @access Private
*/
function Fcalculaimpostoterritorial()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT calculaimpostoterritorial(".$stParametros.") as valor \r\n";
