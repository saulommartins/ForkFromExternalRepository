...
<?php
/**
  * Classe da Função NumeracaoConsolidacao
  ...
  * @subpackage Funcao
    ...
    * $Id: FNumeracaoConsolidacao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class FNumeracaoConsolidacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FNumeracaoConsolidacao()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT  numeracaoconsolidacao(".$stParametros.") as valor \r\n";
