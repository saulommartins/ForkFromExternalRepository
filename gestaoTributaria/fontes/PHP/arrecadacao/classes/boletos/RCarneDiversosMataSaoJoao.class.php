...
//67.5, 60.5, 53.5
        ...
        $this->Text   ( $x+2, $y+(81*$this->tamY), 'Data de emissão: '.date("d/m/Y h:i:s"));
...
class RCarneDiversosMataSaoJoao
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneDiversosMataSaoJoao($arEmissao, $horizontal = 7, $vertical = 95)
{
