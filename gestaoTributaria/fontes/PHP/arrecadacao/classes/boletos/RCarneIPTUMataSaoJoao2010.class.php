...
/**
  ...
  * @package URBEM
    ...
    * $Id: RCarneIPTUMataSaoJoao2010.class.php 36715 2008-12-24 10:48:57Z cercato $
...
class RCarneDadosCadastraisMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->Text( $x+62, $y+(10*$inTamY), 'IPTU/TLP/CIP 2010' );
...
*/
        ...
        $this->Text( $x+8, $y+(159*$inTamY), 'pagamento, após o dia 31 de dezembro de 2010.' );
        ...
        $this->Text( $x+9, $y+(30*$inTamY), '(estes  valores   estão  definidos   na  Planta Genérica de Valores do Município, Lei nº248/2005 alterada pela Lei nº 375/2008).' );
        ...
        $this->Text( $x+9, $y+(63*$inTamY), 'Fiscal/2010)' );
...
//fim do novo texto
        ...
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO DE 2010');
...
class RCarneIPTUMataSaoJoao2010
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao2010($arEmissao, $horizontal = 7, $vertical = 95)
{
            ...
            foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
                ...
                if ($diffBaixa) {
                    ...
                    if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                        ...
                        $this->obRCarnePetropolis->stObsVencimento = "Receber até 31/12/2010.";
