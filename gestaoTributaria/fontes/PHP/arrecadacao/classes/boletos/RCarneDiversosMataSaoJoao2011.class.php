...
class RCarneDiversosMataSaoJoao2011
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneDiversosMataSaoJoao2011($arEmissao, $horizontal = 7, $vertical = 95)
{
    ...
    if ( $this->getConsolidacao() ) {
        ...
        #echo '<h2>CONSOLIDACAO </h2>'; #exit;
            ...
            foreach ($chave as $parcela) {
                ...
                $this->arBarra['nosso_numero'] = (string) $parcela['numeracao'];
                $this->obRCarneMata->stNumeracao = $parcela['numeracao'];
