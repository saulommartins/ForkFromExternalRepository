...
//        $this->Text   ( $x+2, $y+191, $this->flValorTotal ); //valor do documento lado B //item novo/alterado 11_03_2008
        ...
        $stObs = str_replace( "\n\r", " ", $this->stObservacao );
        $this->Text   ( $x+40, $y+218, substr( $stObs, 0, 90 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+40, $y+221, substr( $stObs, 90, 90 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+40, $y+224, substr( $stObs, 180, 90 ) ); //item novo/alterado 11_03_2008
    ...
    public function posicionaVariaveisCapa($x, $y)
    {
        ...
        $this->Text   ( $x+2, $y+148, "Obs: ".substr( $stObs, 0, 140 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+2, $y+151, substr( $stObs, 140, 140 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+2, $y+154, substr( $stObs, 280, 140 ) ); //item novo/alterado 11_03_2008
...
/*
    ...
    * @access Private
*/
function RCarneDiversosCanaa($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    //    while ( !$rsGeraCarneCabecalho->eof() ) {
        ...
        if ( $rsGeraCarneCabecalho->getCampo( 'natureza' ) == "Econômica" ) {
