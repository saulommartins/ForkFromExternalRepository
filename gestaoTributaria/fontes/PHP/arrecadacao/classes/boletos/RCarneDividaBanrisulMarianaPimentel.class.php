...
/**
  ...
  * @package URBEM
    ...
    * $Id: RCarneDividaBanrisulMarianaPimentel.class.php 56606 2013-12-10 16:27:15Z diogo.zarpelon $
...
class RCarneDividaBanrisulMarianaPimentel
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneDividaBanrisulMarianaPimentel($arEmissao, $horizontal = 7, $vertical = 95)
{
