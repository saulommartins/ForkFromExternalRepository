...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Image( $stBB, $x+28+$inAlteracaoMata, $y+(4*$this->tamY)+0.5, 35, 4, $stExt );

        if ($this->ImagemCarne) {
            $stExt = substr( $this->ImagemCarne, strlen($this->ImagemCarne)-3, strlen($this->ImagemCarne) );
            $this->Image( $this->ImagemCarne, $x, $y+4, 16, 9, $stExt );
        }
        $this->setFillColor( 240 );
        $this->Rect( $x, $y+(37*$this->tamY), 48, 6*$this->tamY, 'DF' );
        // linhas horizontais
        $this->Line( $x+27+$inAlteracaoMata, ($y+(9*$this->tamY)), (197+$x), ($y+(10*$this->tamY)) );

        $this->Line( $x, ($y+(14*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(14*$this->tamY)) );
        $this->Line( $x+27+$inAlteracaoMata, ($y+(14*$this->tamY)), (197+$x), ($y+(14*$this->tamY)) );

        $this->Line( $x, ($y+(20*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(20*$this->tamY)) );
        $this->Line( $x+27+$inAlteracaoMata, ($y+(20*$this->tamY)), (197+$x), ($y+(20*$this->tamY)) );

        $this->Line( $x, ($y+(26*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(26*$this->tamY)) );
        $this->Line( $x+27+$inAlteracaoMata, ($y+(26*$this->tamY)), (197+$x), ($y+(26*$this->tamY)) );

        $this->Line( $x+48, ($y+(31*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(31*$this->tamY)) );
        $this->Line( $x+27+$inAlteracaoMata, ($y+(31*$this->tamY)), (197+$x), ($y+(31*$this->tamY)) );

        $this->Line( $x, ($y+(37*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(37*$this->tamY)) );
        $this->Line( $x+158, ($y+(36*$this->tamY)), (197+$x), ($y+(36*$this->tamY)) );

        $this->Line( $x, ($y+(43*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(43*$this->tamY)) );
        $this->Line( $x+158, ($y+(41*$this->tamY)), (197+$x), ($y+(41*$this->tamY)) );

        $this->Line( $x, ($y+(48*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(48*$this->tamY)) );
        $this->Line( $x+158, ($y+(46*$this->tamY)), (197+$x), ($y+(46*$this->tamY)) );

        $this->Line( $x, ($y+(53*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(53*$this->tamY)) );
        $this->Line( $x+158, ($y+(51*$this->tamY)), (197+$x), ($y+(51*$this->tamY)) );

        $this->Line( $x, ($y+(58*$this->tamY)), (25+$x)+$inAlteracaoMata, ($y+(58*$this->tamY)) );
        $this->Line( $x+27+$inAlteracaoMata, ($y+(56*$this->tamY)), (197+$x), ($y+(56*$this->tamY)) );

        $this->Line( $x+27+$inAlteracaoMata, ($y+(66*$this->tamY)), (197+$x), ($y+(66*$this->tamY)) );

        // linhas verticais
        $this->Line( $x+48, $y+(16*$this->tamY), $x+48, $y+(45*$this->tamY) ); //nova do canhotinho

        $this->Line( $x+66+$inAlteracaoMata, $y+(5*$this->tamY), 66+$x+$inAlteracaoMata, $y+(10*$this->tamY) );

        $this->Line( $x+42+$inAlteracaoMata, $y+(21*$this->tamY), 42+$x+$inAlteracaoMata, $y+(32*$this->tamY) );
        $this->Line( $x+65+$inAlteracaoMata, $y+(21*$this->tamY), 65+$x+$inAlteracaoMata, $y+(32*$this->tamY) );
        $this->Line( $x+80+$inAlteracaoMata, $y+(21*$this->tamY), 80+$x+$inAlteracaoMata, $y+(32*$this->tamY) );
        $this->Line( $x+94+$inAlteracaoMata, $y+(21*$this->tamY), 94+$x+$inAlteracaoMata, $y+(32*$this->tamY) );

        $this->Line( $x+20, $y+(21*$this->tamY), 20+$x, $y+(27*$this->tamY) );

        $this->Line( $x+158, $y+(10*$this->tamY), 158+$x, $y+(58*$this->tamY) );

        $this->setFont ( 'Arial', 'B', 7 );
        $this->Text ( $x+38, $y+(8*$this->tamY), "MATA DE SÃO JOÃO" );
        $this->Text ( $x+38, $y+(10*$this->tamY)+0.5, "Sec. de Adm. e Fin." );
        $this->Text ( $x+38, $y+(13*$this->tamY), "EXERCÍCIO 2014" );

        $this->setFont ( 'Arial', '', 6 );
        $this->Text ( $x+20.5, $y+(22*$this->tamY), "Inscrição" );
        $this->Text ( $x+20.5, $y+(25*$this->tamY), $this->inInscricao );

        $this->Text ( $x, $y+(16*$this->tamY), "Nosso Número" );
        $this->Text ( $x, $y+(19*$this->tamY), $this->stNumeracao );

        $this->Text ( $x, $y+(22*$this->tamY), "Parcela" );
        $this->Text ( $x, $y+(25*$this->tamY), $this->stParcela );

        $this->Text ( $x, $y+(39*$this->tamY), "Vencimento" );
        $this->Text ( $x+30, $y+(39*$this->tamY), $this->dtVencimento );

        $this->setFont ( 'Arial', '', 5 );
        $this->Text ( $x, $y+(45*$this->tamY), "MULTA 5% ATÉ 30 DIAS. 10% DE 30 A 60 DIAS E 15% SUPERIOR A 60 DIAS." );
        $this->Text ( $x, $y+(47*$this->tamY), "JUROS DE 1% AO MÊS = 0,003%" );

        $this->setFont ( 'Arial', '', 6 );
        $this->Text ( $x, $y+(28*$this->tamY), "Tributo" );
        $this->Text ( $x, $y+(30*$this->tamY), $this->stTributo );

        $this->Text ( $x+48.5, $y+(16*$this->tamY), "(=) Valor Principal" );
        $this->Text ( $x+48.5, $y+(19*$this->tamY), $this->flValor );

        $this->Text ( $x+48.5, $y+(22*$this->tamY), "(+) Multa de Mora" );
        $this->Text ( $x+48.5, $y+(25*$this->tamY), $this->flValorMulta );

        $this->Text ( $x+48.5, $y+(28*$this->tamY), "(+) Juros de Mora" );
        $this->Text ( $x+48.5, $y+(30*$this->tamY), $this->flValorJuros );

        $this->Text ( $x+48.5, $y+(33*$this->tamY), "(+) At. Monet." );
        $this->Text ( $x+48.5, $y+(36*$this->tamY), $this->flValorOutros );

        $this->Text ( $x+48.5, $y+(39*$this->tamY), "(=) Total" );
        $this->Text ( $x+48.5, $y+(41*$this->tamY)+0.5, $this->flValorTotal );

        if ($this->stParcela == 'ÚNICA') {
            $this->Text ( $x, $y+(60*$this->tamY), "Observação");
            $this->Text ( $x, $y+(63*$this->tamY), "NÃO RECEBER APÓS VENCIMENTO." );
        //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
        } else {
            $this->Text ( $x, $y+(60*$this->tamY), "Observação:" );
            $this->Text ( $x, $y+(63*$this->tamY), "RECEBER ATÉ 31/12/2014." );
            //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
        }
        $this->Text ( $x+38, $y+(60*$this->tamY), "Via Contribuinte" );

        $stObs = str_replace( "\n\r", " ", $this->stObservacao );
        $this->Text ( $x, $y+(62*$this->tamY), substr( $stObs, 0, 70 ) );
        $this->Text ( $x, $y+(64*$this->tamY), substr( $stObs, 70, 70 ) );
        $this->Text ( $x, $y+(66*$this->tamY), substr( $stObs, 140, 70 ) );
        $this->Text ( $x, $y+(68*$this->tamY), substr( $stObs, 210, 70 ) );
        $this->Text ( $x, $y+(70*$this->tamY), substr( $stObs, 280, 70 ) );
        $this->Text ( $x, $y+(72*$this->tamY), substr( $stObs, 350, 70 ) );
        $this->Text ( $x, $y+(74*$this->tamY), substr( $stObs, 420, 70 ) );
        $this->Text ( $x, $y+(76*$this->tamY), substr( $stObs, 490, 70 ) );

        $this->Text ( $x, $y+(50*$this->tamY), "Contribuinte" );
        $this->Text ( $x, $y+(52*$this->tamY), substr( $this->getNomCgm(), 0, 70 ) );

        $this->Text ( $x, $y+(55*$this->tamY), "Endereço" );
        $this->Text ( $x, $y+(57*$this->tamY), substr( $this->getRua(), 0, 70 ) );

        $this->setFont ( 'Arial', '', 6 );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(11*$this->tamY), "Local de Pagamento" );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(13*$this->tamY), $this->stLocalPagamento );

        $this->Text ( $x+27+$inAlteracaoMata, $y+(17*$this->tamY), "Cedente" );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(19*$this->tamY), $this->stCedente );

        $this->Text ( $x+27+$inAlteracaoMata, $y+(23*$this->tamY), "Data do Doc." );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(25*$this->tamY), date('d/m/Y') );

        $this->Text ( $x+27+$inAlteracaoMata, $y+(28*$this->tamY), "Uso do Banco" );

        if ($this->stParcela == 'ÚNICA') {
            $this->Text ( $x+27+$inAlteracaoMata, $y+(34*$this->tamY), "Instruções" );
            $this->Text ( $x+27+$inAlteracaoMata, $y+(36.5*$this->tamY), "NÃO RECEBER APÓS VENCIMENTO." );
       //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
        } else {
            $this->Text ( $x+27+$inAlteracaoMata, $y+(34*$this->tamY), "Instruções" );
            $this->Text ( $x+27+$inAlteracaoMata, $y+(36.5*$this->tamY), "RECEBER ATÉ 31/12/2014." );
            //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
        }
        $this->Text ( $x+27+$inAlteracaoMata, $y+(38*$this->tamY), substr( $stObs, 0, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(40*$this->tamY), substr( $stObs, 150, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(42*$this->tamY), substr( $stObs, 225, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(44*$this->tamY), substr( $stObs, 300, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(46*$this->tamY), substr( $stObs, 375, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(48*$this->tamY), substr( $stObs, 450, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(50*$this->tamY), substr( $stObs, 525, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(52*$this->tamY), substr( $stObs, 600, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(54*$this->tamY), substr( $stObs, 675, 75 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(56*$this->tamY), substr( $stObs, 750, 75 ) );

        $this->Text ( $x+27+$inAlteracaoMata, $y+(58*$this->tamY), "Sacado" );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(60*$this->tamY), substr( $this->getNomCgm(), 0, 120 ) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(62*$this->tamY), substr($this->getRua(), 0, 120) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(64*$this->tamY), substr($this->getRua(), 120, 120) );
        $this->Text ( $x+27+$inAlteracaoMata, $y+(66*$this->tamY), substr($this->getRua(), 240, 120) );

        $this->Text ( $x+27+$inAlteracaoMata, $y+(65*$this->tamY)+0.5, "Sacador/Avalista" );

        $this->Text ( $x+42.5+$inAlteracaoMata, $y+(23*$this->tamY), "Nosso Número" );
        $this->Text ( $x+42.5+$inAlteracaoMata, $y+(25*$this->tamY), $this->stNumeracao );

        $this->Text ( $x+42.5+$inAlteracaoMata, $y+(28*$this->tamY), "Carteira" );
        $this->Text ( $x+42.5+$inAlteracaoMata, $y+(30*$this->tamY), $this->stCarteira );

        $this->Text ( $x+65.5+$inAlteracaoMata, $y+(23*$this->tamY), "Espécie DOC" );
        $this->Text ( $x+65.5+$inAlteracaoMata, $y+(25*$this->tamY), $this->stEspecieDoc );

        $this->Text ( $x+65.5+$inAlteracaoMata, $y+(28*$this->tamY), "Espécie" );
        $this->Text ( $x+65.5+$inAlteracaoMata, $y+(30*$this->tamY), $this->stEspecie );

        $this->Text ( $x+80.5+$inAlteracaoMata, $y+(23*$this->tamY), "Aceite" );
        $this->Text ( $x+80.5+$inAlteracaoMata, $y+(25*$this->tamY), $this->stAceite );

        $this->Text ( $x+80.5+$inAlteracaoMata, $y+(28*$this->tamY), "Quantidade" );
        $this->Text ( $x+80.5+$inAlteracaoMata, $y+(30*$this->tamY), $this->stQuantidade );

        $this->Text ( $x+94.5+$inAlteracaoMata, $y+(23*$this->tamY), "Data de Proc." );
        $this->Text ( $x+94.5+$inAlteracaoMata, $y+(25*$this->tamY), date('d/m/Y') );

        $this->Text ( $x+94.5+$inAlteracaoMata, $y+(28*$this->tamY), "Valor" );

        $this->Text ( $x+158.5, $y+(11*$this->tamY), "Vencimento" );
        $this->Text ( $x+158.5, $y+(13*$this->tamY), $this->dtVencimento );

        $this->Text ( $x+158.5, $y+(17*$this->tamY), "Agência/Código do Cedente" );
        $this->Text ( $x+158.5, $y+(19*$this->tamY), $this->stAgenciaCodCedente );

        $this->Text ( $x+158.5, $y+(23*$this->tamY), "Nosso Número" );
        $this->Text ( $x+158.5, $y+(25*$this->tamY), $this->stNumeracao );

        $this->Text ( $x+158.5, $y+(28*$this->tamY), "(=) Valor do Documento" );
        $this->Text ( $x+158.5, $y+(30*$this->tamY), $this->flValor );

        $this->Text ( $x+158.5, $y+(33*$this->tamY), "(-) Desconto" );
        $this->Text ( $x+158.5, $y+(38*$this->tamY), "(-) Outras Deduções/Abatimento" );

        $this->Text ( $x+158.5, $y+(43*$this->tamY), "(+) Mora/Multa/Juros" );
        $this->Text ( $x+158.5, $y+(45*$this->tamY)+0.5, $this->flValorMultaJuros );

        $this->Text ( $x+158.5, $y+(48*$this->tamY), "(+) Outros Acréscimos" );
        $this->Text ( $x+158.5, $y+(50*$this->tamY), $this->flValorOutros );

        $this->Text ( $x+158.5, $y+(53*$this->tamY), "(=) Valor Cobrado" );
        $this->Text ( $x+158.5, $y+(56*$this->tamY), $this->flValorTotal );

        $this->Text ( $x+85.5+$inAlteracaoMata, $y+(69*$this->tamY), "Autenticação Mecânica - Ficha de Compensação . . . . . . . . . . . . . . ." );

        $this->setFont ( 'Arial', 'B', 6 );
        $this->Text ( $x+68+$inAlteracaoMata, $y+(8*$this->tamY), "|001-9|" );

        $this->Text ( $x+78+$inAlteracaoMata, $y+(8*$this->tamY), $this->stLinhaCode );
        $this->defineCodigoBarras( $x+31+$inAlteracaoMata, $y+(71*$this->tamY), $this->stBarCode, 0.7, 8 );
    }
    ...
    {
        for ($i=0;$i<=196;($i+=2)) {
           $this->Line( ($x+$i), ($y+(85*$this->tamY)), ($x+$i+1), ($y+(85*$this->tamY)) );
        }
...
O contribuinte que não efetuar o recolhimento da taxa em quota única poderá fazê-lo em até 03 (três) parcelas mensais, na forma e prazos estabelecidos por Ato do Poder Executivo, fixado o vencimento da primeira parcela em 15 de janeiro de 2014.\n
...
Emails: atendimento.tributacao@pmsj.ba.gov.br / arrecadacao.iss@pmsj.ba.gov.br\n";
        ...
        $this->Rect( $x, $y + (78*$inTamY) , 189, 75*$inTamY );
        ...
        $this->setFont( 'Arial','B',10 );
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO 2014');
        ...
        $this->setFont( 'Arial','B',5 );
        $this->Text( $x+   22 , $y+(128*$inTamY) , 'Valor total:' ); //130
        ...
        $this->Text( $x+   22 , $y+(136*$inTamY) , 'Parcela única com desconto:' );
        ...
        $this->setFont( 'Arial','',5 );
        $this->Text( $x+3 , $y+(144*$inTamY) , 'Necessitando alterar os dados cadastrais compareça, munido de documentos comprobatórios, à Coordenadoria Fazendária do Município, situado na Rua Luiz Antônio Garcez, nº 140 - Centro Administrativo - Centro' );
    ...
    $valor_1 = str_replace('.', '', $this->stValorParcelaUnica);
    $valor_2 = str_replace(',', '.', $valor_1);

        /* Valor calculado com desconte */
        //$parcelaUnica = number_format($this->stValorParcelaUnica, 2, '.', '');
        //$percentualDesconto = number_format($this->stDescontoParcelaUnica, 2, '.', '');

        $valorDesconto 		= $valor_2-($valor_2*($this->stDescontoParcelaUnica/100));
    $valorDescontoFormatado = number_format($valorDesconto, 2, ',', '.');

        $this->Text( $x+55 , $y+(136*$inTamY) , $valorDescontoFormatado );
    ...
    public function show($stNome = "Carne.pdf", $stOpcao="")
    {
        $this->Output2File();
    }
}

class RCarneTFFMataSaoJoao2014
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneTFFMataSaoJoao2014($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        $rsListaCarne->setCampo('observacao', $rsListaCarne->getCampo('observacao'));
        ...
        $this->obRCarnePetropolis->stValorParcelaUnica = $arDadosParcelas[0]["valor"];
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            if ($diffBaixa) {
                ...
                if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                    ...
                    $this->obRCarnePetropolis->setObservacaoL3 ( 'Receber até 31/12/2014.' );
                    $this->obRCarnePetropolis->setParcela ( 'ÚNICA' );
                    $this->obRCarnePetropolis->stObsVencimento = "Receber até 31/12/2014.";
