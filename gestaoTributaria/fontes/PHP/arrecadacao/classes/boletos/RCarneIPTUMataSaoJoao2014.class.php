...
<?php
/**
  * Carnê IPTU 2014 para Mata de Sao Joao
  * Data de criação : 21/10/2013
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(16*$this->tamY), "EXERCÍCIO 2014" );
...
class RCarneDadosCadastraisMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->Text( $x+62, $y+(10*$inTamY), 'IPTU/TLP/CIP 2014' );
...
*/
        ...
        $this->setFont( 'Arial', '', 12 );
        $this->Text( $x+22, $y+(18*$inTamY), 'Prefeitura de Mata de São João: (71) 3635-1669/1310 Fax: (71) 3635-1293' );
        ...
        $this->Text( $x+8, $y+(154*$inTamY), 'pagamento, após o dia 31 de dezembro de 2014.' );
        ...
        $this->Text( $x+8, $y+(181*$inTamY), '140 - Centro - CEP: 48.280-000 - Mata de São João/BA. Tel/Fax: (71) 3635-1293 / (71) 3635-1310 / (71) 9957-6813.' );
    $this->addPage();
        ...
        $this->Text( $x+9, $y+(30*$inTamY), '(estes  valores   estão  definidos   na  Planta Genérica de Valores do Município, Lei nº 514/2012 alterada pela Lei nº 538/2013.' );
        ...
        $this->Text( $x+9, $y+(63*$inTamY), 'Fiscal/2014)' );
        ...
        $this->Text( $x+9, $y+(75*$inTamY), 'situado  no  Shopping  Armazém  da  Vila,  1º andar,  sala  41  -  Praia  do  Forte  -  Mata  de    São  João/BA. ' );
        $this->Text( $x+9, $y+(78*$inTamY), 'Telefones:  (71) 3635-1669/3009  /  (71)  9617-7254   /   (71)  9957-6798   /   (71)  9630-1106.' );
    $this->setFont( 'Arial','BU', 8);
    $this->Text( $x+9, $y+(81*$inTamY), 'Horário  para  atendimento: de 08h às 11:30 min - de 13h às 15h. ');
    $this->Text( $x+9, $y+(84*$inTamY), 'E-mails:  atendimento.tributacao@pmsj.ba.gov.br  /  cadastro.imobiliario@pmsj.ba.gov.br.' );
...
//fim do novo texto
        ...
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO DE 2014');
     ...
     //carne 2014
        ...
        $this->Text( $x+6 , $y+(163*$inTamY) , 'Tel/Fax: (71) 3635-1669 / (71) 3635-3009 / (71) 9957-6813.' );
...
class RCarneIPTUMataSaoJoao2014
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao2014($arEmissao, $horizontal = 7, $vertical = 95)
{
