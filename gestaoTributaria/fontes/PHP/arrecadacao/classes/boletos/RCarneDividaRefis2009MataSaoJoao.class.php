...
//67.5, 60.5, 53.5
        ...
        $this->setFont( 'Arial','', 5 );
        $stObs = $this->stObservacao." Multa de Mora 10% após o vencimento e Juros de Mora 1% = 0,033% ao dia.";
        $stObs = str_replace("\n\r", " ", $stObs);
...
class RCarneDividaRefis2009MataSaoJoao
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneDividaRefis2009MataSaoJoao($arEmissao, $horizontal = 7, $vertical = 95)
{
