...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(13*$this->tamY), "EXERCÍCIO 2013" );
        ...
        //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x, $y+(60*$this->tamY), "Observação:" );
            $this->Text ( $x, $y+(63*$this->tamY), "RECEBER ATÉ 31/12/2013." );
            //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
        }
        ...
        $this->Text ( $x+27+$inAlteracaoMata, $y+(25*$this->tamY), $this->stDataDocumento );
       ...
       //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x+27+$inAlteracaoMata, $y+(34*$this->tamY), "Instruções" );
            $this->Text ( $x+27+$inAlteracaoMata, $y+(36.5*$this->tamY), "RECEBER ATÉ 31/12/2013." );
            //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
        }
        ...
        $this->Text ( $x+94.5+$inAlteracaoMata, $y+(25*$this->tamY), $this->stDataProcessamento );
...
O contribuinte que não efetuar o recolhimento da taxa em quota única poderá fazê-lo em até 03 (três) parcelas mensais, na forma e prazos estabelecidos por Ato do Poder Executivo, fixado o vencimento da primeira parcela em 14 de janeiro de 2013.\n
...
Necessitando alterar os dados cadastrais compareça, munido de documentos comprobatórios, à Coordenadoria Fazendária do Município, órgão da Secretaria Municipal de Administração e Finanças, sito na Rua Luiz Antônio Garcez, s/nº - Centro Administrativo - Centro - CEP: 48.280-000 - Mata de São João/BA.\n";
        ...
        $this->setFont( 'Arial','B',10 );
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO 2013');
        ...
        $this->setFont( 'Arial','',5 );
        $this->Text( $x+3 , $y+(144*$inTamY) , 'Necessitando alterar os dados cadastrais compareça, munido de documentos comprobatórios, à Coordenadoria Fazendária do Município, sito na Rua Luiz Antônio Garcez, s/nº - Centro Administrativo - Centro' );
...
class RCarneTFFMataSaoJoao2013
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneTFFMataSaoJoao2013($arEmissao, $horizontal = 7, $vertical = 95)
{
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            if ($diffBaixa) {
                ...
                if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                    ...
                    $this->obRCarnePetropolis->setObservacaoL3 ( 'Receber até 31/12/2013.' );
