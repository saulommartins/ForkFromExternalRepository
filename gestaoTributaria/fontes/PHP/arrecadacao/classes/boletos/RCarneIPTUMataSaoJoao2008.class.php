...
/**
  ...
  * @package URBEM
    ...
    * $Id: RCarneIPTUMataSaoJoao2008.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        //if ( !$this->getObsVencimento() ) {
            $this->setObsVencimento ( 'Receber até 31/12/'.$this->stExercicio.'.' );
        }
        //}
...
class RCarneDadosCadastraisMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->Text( $x+62, $y+(10*$inTamY), 'IPTU/TLP/CIP 2009' );
        ...
        $this->setFont( 'Arial', '', 12 );
        $this->Text( $x+22, $y+(18*$inTamY), 'Prefeitura de Mata de São João: (71)3635-1992/1310 Fax: (71) 3635-1392' );
        ...
        $this->Text( $x+8, $y+(159*$inTamY), 'pagamento, após o dia 31 de dezembro de 2009.' );
        ...
        $this->Text( $x+8, $y+(186*$inTamY), 's/nº - Centro - CEP: 48.280-000 - Mata de São João/Ba. Tel/Fax: (71) 3635-1992 / (71) 3635-1310 / (71) 9617-7231 / (71) 9957-6813.' );
        ...
        $this->setFont( 'Arial', '', 8 );
        $this->Text( $x+9, $y+(12*$inTamY), 'Valor Venal do Imóvel = Valor Venal do Terreno (VUPt x área m2) + Valor Venal da Edificação (VUPC x área m2).' );
        $this->setFont( 'Arial', 'B', 8 );
        $this->Text( $x+5, $y+(16*$inTamY), 'II - Taxa de Limpeza Pública => Valor da Taxa = Área (do terreno, caso não haja edificação; havendo usar área da construção) x valor/m2' );
        ...
        $this->Text( $x+9, $y+(30*$inTamY), '(estes  valores   estão  definidos   na  Legislação   em  vigor  do  Município).' );
        ...
        $this->setFont( 'Arial', '', 8 );
        $this->Text( $x+142, $y+(59*$inTamY), '(Fundamentação   Legal:  Art.2,º   do' );
        $this->Text( $x+6, $y+(62*$inTamY), 'Decreto   nº   393/2008);' );
        ...
        $this->Text( $x+5, $y+(75*$inTamY), 'sito  no  Shopping  Armazém  da  Vila,  1º andar,  sala  41  -  Praia  do  Forte  -  Mata  de    São  João/Ba.  Telefones:  (71)  3635-1992/1310' );
        $this->Text( $x+5, $y+(78*$inTamY), '(Sede)  /  (71)  3676-1569   (Praia do Forte)   /   (71)  9617-7231   /   (71)9957-6813' );
...
//fim do novo texto
        ...
        $this->Text( $x+6 , $y+(164*$inTamY) , 'São João/Ba. Tel/Fax: (71) 3635-1992 / (71) 3635-1310 / (71) 9617-7231 / (71) 9957-6813.' );
        /* mostrar dados */
...
class RCarneIPTUMataSaoJoao2008
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao2008($arEmissao, $horizontal = 7, $vertical = 95)
{
