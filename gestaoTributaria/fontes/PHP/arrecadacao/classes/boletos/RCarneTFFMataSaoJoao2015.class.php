...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(13*$this->tamY), "EXERCÍCIO 2015" );
        ...
        //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x, $y+(60*$this->tamY), "Observação:" );
            $this->Text ( $x, $y+(63*$this->tamY), "RECEBER ATÉ 31/12/2015." );
            //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
        }
       ...
       //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x+27+$inAlteracaoMata, $y+(34*$this->tamY), "Instruções" );
            $this->Text ( $x+27+$inAlteracaoMata, $y+(36.5*$this->tamY), "RECEBER ATÉ 31/12/2015." );
            //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
        }
...
class RCarneDadosTFFMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->setFont( 'Arial','B',10 );
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO 2015');
...
class RCarneTFFMataSaoJoao2015
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneTFFMataSaoJoao2015($arEmissao, $horizontal = 7, $vertical = 95)
{
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            if ($diffBaixa) {
                ...
                if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                    ...
                    $this->obRCarnePetropolis->setObservacaoL3 ( 'Receber até 31/12/2015.' );
                    $this->obRCarnePetropolis->setParcela ( 'ÚNICA' );
                    $this->obRCarnePetropolis->stObsVencimento = "Receber até 31/12/2015.";
