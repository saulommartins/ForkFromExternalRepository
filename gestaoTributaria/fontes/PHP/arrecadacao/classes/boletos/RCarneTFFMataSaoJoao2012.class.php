...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(13*$this->tamY), "EXERCÍCIO 2012" );
        ...
        //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x, $y+(60*$this->tamY), "Observação:" );
            $this->Text ( $x, $y+(63*$this->tamY), "RECEBER ATÉ 31/12/2012." );
            //$this->Text ( $x, $y+(66*$this->tamY), "TFF - proporcional a quatro meses." );
        }
       ...
       //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
            ...
            $this->Text ( $x+27+$inAlteracaoMata, $y+(34*$this->tamY), "Instruções" );
            $this->Text ( $x+27+$inAlteracaoMata, $y+(36.5*$this->tamY), "RECEBER ATÉ 31/12/2012." );
            //$this->Text ( $x+27+$inAlteracaoMata, $y+(39*$this->tamY), "TFF - proporcional a quatro meses." );
        }
...
O contribuinte que não efetuar o recolhimento da taxa em quota única poderá fazê-lo em até 03 (três) parcelas mensais, na forma e prazos estabelecidos por Ato do Poder Executivo, fixado o vencimento da primeira parcela em 16 de janeiro de 2012.\n
...
Necessitando alterar os dados cadastrais compareça, munido de documentos comprobatórios, à Coordenadoria Fazendária do Município, órgão da Secretaria Municipal de Administração e Finanças, sito na Rua Antônio Luiz Garcez, s/nº - Centro Administrativo - Centro - CEP: 48.280-000 - Mata de São João/BA.\n";
        ...
        $this->setFont( 'Arial','B',10 );
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO 2012');
...
class RCarneTFFMataSaoJoao2012
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneTFFMataSaoJoao2012($arEmissao, $horizontal = 7, $vertical = 95)
{
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            if ($diffBaixa) {
                ...
                if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                    ...
                    $this->obRCarnePetropolis->setObservacaoL3 ( 'Receber até 31/12/2012.' );
                    $this->obRCarnePetropolis->setParcela ( 'ÚNICA' );
                    $this->obRCarnePetropolis->stObsVencimento = "Receber até 31/12/2012.";
