...
<?php
/**
    * Classe de Regra para geração do código de barra e linha digitável padrão febraban Compensacao BB - anexo 5
...
class RCodigoBarraFebrabanCompensacaoBB_Anexo5
{
    /*
    ...
    */
    public function geraFebraban($info)
    {
        ...
        */
        ...
        $stDVModOnze = $this->_modulo11( '001'.$tipoMoeda.$stFator.$valor.$stConvenio.$nNumero."21" );
        ...
        $barraFebraban = '001'.$tipoMoeda.$stDVModOnze.$stFator.$valor.$stConvenio.$nNumero."21";

        $campo1 = '001'.$tipoMoeda.$barraFebraban[20-1].".".$barraFebraban[21-1].$barraFebraban[22-1].$barraFebraban[23-1].$barraFebraban[24-1];
        $stDV = $this->_modulo10( '001'.$tipoMoeda.$barraFebraban[20-1].$barraFebraban[21-1].$barraFebraban[22-1].$barraFebraban[23-1].$barraFebraban[24-1] );
        $campo1 .= $stDV;
