...
<?php
/**
  * Carnê Divida Refis para Mata de Sao Joao 2015
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->setFont ( 'Arial', 'B', 6 );
        $this->Text ( $x+38, $y+(16*$this->tamY), "DÍVIDA ATIVA REFIS " . Sessao::getExercicio() );
...
class RCarneDividaRefis2015MataSaoJoao
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneDividaRefis2015MataSaoJoao($arEmissao, $horizontal = 7, $vertical = 95)
{
            ...
            foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
                ...
                if ($diffBaixa) {
                    ...
                    if ( $rsParcela->getCampo( 'nr_parcela' ) == 0 ) {
                        ...
                        $this->obRCarnePetropolis->stObsVencimento = "REFIS 2015- Não receber após o vencimento.";
