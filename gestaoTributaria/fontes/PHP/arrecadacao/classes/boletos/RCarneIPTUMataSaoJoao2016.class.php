...
<?php
/**
  * Carnê IPTU 2015 para Mata de Sao Joao
  * Data de criação : 04/12/2014

  * @author Analista: Fábio Bertoldi
  * @author Programador: Luciana Dellay
...
//            $this->Text   ( 70    , 73   , $stObsL7 );
    ...
    */
    public function drawComplemento($x,$y)
    {
        ...
        $this->Text   ( ($x+40)  , ($y+7)   , strtoupper('IPTU-2016') );
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(16*$this->tamY), "EXERCÍCIO 2016" );
...
class RCarneDadosCadastraisMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->Text( $x+62, $y+(10*$inTamY), 'IPTU/TLP/CIP 2016' );
        ...
        $this->Text( $x+36, $y+(42*$inTamY), $arEnd[0].', nº '.$arEnd[1].' '.$arEnd[2]);
        $this->Text( $x+36, $y+(46*$inTamY), $arEnd[3].' - '.sistemaLegado::strtoupper_ptBR($arEnd[6]).' / '.sistemaLegado::strtoupper_ptBR($arEnd[5]));
        $this->Text( $x+36, $y+(50*$inTamY), 'CEP: '.$arEnd[4] );
        ...
        $this->Text( $x+22, $y+(18*$inTamY), 'Prefeitura de Mata de São João: (71) 3635-1669/1310' );
        ...
        $this->Text( $x+64, $y+(62*$inTamY), '(71) 3635-1310' );
        ...
        $this->Text( $x+64, $y+(73*$inTamY), '(71) 3635-1310' );

        $this->Text( $x+3, $y+(73*$inTamY), '(Coordenadoria Fazendária do Município)' );
        
        $this->Line( $x+2, $y+(74*$inTamY), $x+92, $y+(74*$inTamY) );
        
        $this->Text( $x+3, $y+(77*$inTamY), 'Posto Tributário Imbassaí  (71) 99617-7254' );
        $this->Text( $x+64, $y+(77*$inTamY), '(71) 99951-0463' );
        
        $this->Line( $x+62, $y+(29*$inTamY), $x+62, $y+(77*$inTamY) );

        $this->setFont( 'Arial', '', 8 );
        $this->Rect( $x+2, $y+(78*$inTamY), 90, 4*$inTamY, '');
        $this->Text( $x+3, $y+(81*$inTamY), 'Hospital Municipal Dr. Eurico Goulart de Freitas (71) 3635-1005' );
        
        //$this->Text( $x+20, $y+(85*$inTamY), '(71) 3635-1005' );
        //$this->Text( $x+45, $y+(85*$inTamY), '(71) 3635-3850' );
        ...
        $this->Text( $x+156, $y+(32*$inTamY), '(71) 3635-1247' );
        ...
        $this->Text( $x+156, $y+(46*$inTamY), '(71) 99617-7232' );
        ...
        $this->Text( $x+156, $y+(68*$inTamY), '(71) 3635-1605' );
        ...
        $this->Text( $x+8, $y+(117*$inTamY), '"Pague o seu IPTU em dia e ajude a Prefeitura a promover mais educação, ');
        $this->Text( $x+8, $y+(123*$inTamY), 'mais saúde e outras  ações, visando  ao desenvolvimento  do  município".' );

        $this->setFont( 'Arial', '', 10 );
        $this->Text( $x+8, $y+(132*$inTamY), 'Prezado(a) Contribuinte,' );
        $this->Text( $x+8, $y+(136*$inTamY), 'O pagamento deste  carnê não  quita  débitos  anteriores. As  parcelas  vencidas  estão  sujeitas a multa e juros' );
        $this->Text( $x+8, $y+(139*$inTamY), 'moratórios. O prazo para  reclamação do lançamento será de até 30  (trinta)  dias,  contados a partir  da data  de' );
        $this->Text( $x+8, $y+(142*$inTamY), 'entrega do carnê. Os valores  do  demonstrativo estão expressos em  Reais  (R$).  Caso  o  vencimento  ocorra' );
        $this->Text( $x+8, $y+(145*$inTamY), 'em dia não útil, o pagamento deverá ser realizado no primeiro dia útil imediato. O  IPTU  não  implica  em  reco-' );
        $this->Text( $x+8, $y+(148*$inTamY), 'nhecimento de  direitos sobre o  imóvel  ou  na  sua  regularização.  Este carnê não poderá  ser  utilizado,  para' );
        $this->Text( $x+8, $y+(151*$inTamY), 'pagamento, após o dia 31 de dezembro de 2016.' );

        $this->Rect( $x+8, $y+(158*$inTamY), 171, 10*$inTamY ); //lado b

        $this->setFont( 'Arial', 'B', 8 );
        $this->Text( $x+12, $y+(162*$inTamY), 'A legislação municipal pertinente aos tributos pode ser encontrada no site da Prefeitura Municipal de Mata de São João,' );
        $this->Text( $x+22, $y+(165*$inTamY), 'no endereço www.pmsj.ba.gov.br .' );

        $this->setFont( 'Arial', 'B', 10 );
        $this->Text( $x+26, $y+(171*$inTamY), 'PAGÁVEL EM QUALQUER AGÊNCIA BANCÁRIA ATÉ O VENCIMENTO.' );

        $this->setFont( 'Arial', 'B', 8 );
        $this->Text( $x+8, $y+(175*$inTamY), 'Qualquer dúvida, consulte o Setor de Tributos e Fiscalização, no Centro Administrativo situado à Rua Luiz Antônio Garcez,' );
        $this->Text( $x+8, $y+(178*$inTamY), '140 - Centro - CEP: 48.280-000 - Mata de São João/BA. Tel: (71) 3635-1669 / (71) 3635-1310 / (71) 9957-6813.' );
        $this->Text( $x+8, $y+(181*$inTamY), 'Postos de Apoio Tributário no Litoral: Praia do Forte (Av. do Farol, Shopping Armazém da Vila, sala 44 - Praia do Forte) ');
        $this->Text( $x+8, $y+(184*$inTamY), 'ou Imbassaí (Alameda das Amendoeiras, s/n, Posto de Atendimento - Imbassaí)');
        ...
        $this->Text( $x+9, $y+(30*$inTamY), '(estes valores estão definidos  na Planta Genérica de Valores do Município, Lei nº 564/2014, alterada pela Lei nº 599/2015' );
        ...
        $this->Text( $x+9, $y+(63*$inTamY), 'Fiscal/2016)' );
        $this->Text( $x+5, $y+(66*$inTamY), '4)' );
        $this->setFont( 'Arial', 'B', 8 );
        $this->Text( $x+9, $y+(66*$inTamY), 'Necessitando   alterar   os    dados  cadastrais,  compareça,   munido  de   documentos  comprobatórios, à Coordenadoria Fazendária, ' );
        $this->Text( $x+9, $y+(69*$inTamY), 'órgão  da  Secretaria   Municipal  de  Administração e  Finanças,   situada   no  Centro  Administrativo, Rua Luiz Antônio' );
        ...
        $this->Text( $x+9, $y+(84*$inTamY), 'E-mails:  atendimento.tributacao@pmsj.ba.gov.br  /  arrecadacao.tributacao@pmsj.ba.gov.br.' );
...
//fim do novo texto
        ...
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO DE 2016');
     ...
     //carne 2015
        ...
        $this->Text( $x+6 , $y+(157*$inTamY) , 'consulte o Setor de Tributos e Fiscalização, no Centro Administrativo, situado à Rua Luiz Antônio Garcez,'  );
        $this->Text( $x+6 , $y+(160*$inTamY) , '140, Centro - CEP: 48.280-000 - Mata de São João/BA.' );
        $this->Text( $x+6 , $y+(163*$inTamY) , 'Tel/Fax: (71) 3635-1669 / (71) 3635-1310 / (71) 9957-6813.' );
...
class RCarneIPTUMataSaoJoao2016
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao2016($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        $this->obRCarnePetropolis->stEnderecoEntrega = str_replace ( "'", " ",$rsListaCarne->getCampo("endereco_entrega") );
...
//        $this->obRARRCarne->inCodContribuinteInicial = $chave[0]["numcgm"];
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            $this->obRCarnePetropolis->stObsVencimento = '[ Isento conforme Lei Municipal '.$stNorma.' ]' ;
            $this->obRCarnePetropolis->setParcela ( 'ÚNICA' );
