...
/*
    ...
    * @access Private
*/
function RCarneIptuUrbem($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        if ( count( $chave ) > 1 ) {
            ...
            $obTARRCarne->ListaDadosPorGrupoParaCarneIPTU( $rsListaDetalheCreditos, " WHERE al.cod_lancamento = ".$valor.$stFiltro1.$stFiltro2." order by ap.nr_parcela " );
        } else {
            unset( $rsListaDetalheCreditos );
        ...
        unset( $this->obRCarneMata->arDados );
