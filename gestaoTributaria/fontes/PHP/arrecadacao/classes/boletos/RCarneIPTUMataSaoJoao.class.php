...
<?php
/**
  * Carnê IPTU para Mata de Sao Joao
  ...
  * @package URBEM
    ...
    * $Id: RCarneIPTUMataSaoJoao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
\n";
        ...
        $this->Line( $x + 136 , $y + (102*$inTamY) , $x + 136 , $y  + (107*$inTamY));
        ...
        $this->Text( $x+138 , $y+(144*$inTamY) , '06) ' . $this->arVencimentosDemonstrativos[6] . ' ' . $this->arDemonstrativoParcelas[6] );

        $this->Text( $x+165 , $y+(129*$inTamY) , '07) ' . $this->arVencimentosDemonstrativos[7] . ' ' . $this->arDemonstrativoParcelas[7] );
        $this->Text( $x+165 , $y+(132*$inTamY) , '08) ' . $this->arVencimentosDemonstrativos[8] . ' ' . $this->arDemonstrativoParcelas[8] );
        $this->Text( $x+165 , $y+(135*$inTamY) , '09) ' . $this->arVencimentosDemonstrativos[9] . ' ' . $this->arDemonstrativoParcelas[9] );
        $this->Text( $x+165 , $y+(138*$inTamY) , '10) ' . $this->arVencimentosDemonstrativos[10] . ' ' . $this->arDemonstrativoParcelas[10] );

        $this->Text( $x+165 , $y+(141*$inTamY) , '11) ' . $this->arVencimentosDemonstrativos[11] . ' ' . $this->arDemonstrativoParcelas[11] );

        $this->Text( $x+165 , $y+(144*$inTamY) , '12) ' . $this->arVencimentosDemonstrativos[12] . ' ' . $this->arDemonstrativoParcelas[12] );

        $this->setFont( 'Arial','B',6 );
        $this->Text( $x+96 , $y+(143*$inTamY) , 'VALOR TOTAL DOS TRIBUTOS (R$):' );

        $this->setFont( 'Arial','',6 );
        $this->Text( $x+3 , $y+(143*$inTamY) , 'Quaisquer dúvidas, consulte o Setor de Tributos,
na Rua Santos Dummont, 86,' );
        $this->Text( $x+6 , $y+(146*$inTamY) , 'Centro, CEP: 48280-000, Tel/Fax: (71) 3635-1669.' );
        /* mostrar dados */
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao($arEmissao, $horizontal = 7, $vertical = 95)
{
