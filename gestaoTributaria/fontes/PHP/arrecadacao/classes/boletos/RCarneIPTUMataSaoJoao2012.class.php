...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        $this->Text ( $x+38, $y+(16*$this->tamY), "EXERCÍCIO 2012" );
...
class RCarneDadosCadastraisMataSaoJoao extends RCarneDiversosPetropolis
{
    ...
    public function desenhaCarne($x , $y)
    {
        ...
        $this->Text( $x+62, $y+(10*$inTamY), 'IPTU/TLP/CIP 2012' );
        ...
        $this->Text( $x+14, $y+(46*$inTamY), $arEnd[0].' '.$arEnd[2]);
...
*/
        ...
        $this->Text( $x+8, $y+(159*$inTamY), 'pagamento, após o dia 31 de dezembro de 2012.' );
        ...
        $this->Text( $x+9, $y+(30*$inTamY), '(estes  valores   estão  definidos   na  Planta Genérica de Valores do Município, Lei nº 404/2009 alterada pela Lei nº 476/2011).' );
        ...
        $this->Text( $x+9, $y+(63*$inTamY), 'Fiscal/2012)' );
...
//fim do novo texto
        ...
        $this->Text( $x+122 , $y+(88*$inTamY) , 'EXERCÍCIO DE 2012');
...
class RCarneIPTUMataSaoJoao2012
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUMataSaoJoao2012($arEmissao, $horizontal = 7, $vertical = 95)
{
...
//        $this->obRARRCarne->inCodContribuinteInicial = $chave[0]["numcgm"];
        ...
        foreach ($chave as $parcela) { // impressao das parcelas selecionadas para cada codigo de lancamento
            ...
            $this->obRCarnePetropolis->stObsVencimento = "[ Isento conforme a Lei Municipal n° 477/2011 ]";
            $this->obRCarnePetropolis->setParcela ( 'ÚNICA' );
