...
/**
  ...
  * @package URBEM
    ...
    * $Id: RCarneDiversosMarianaPimentel.class.php 46946 2012-06-29 16:30:55Z tonismar $
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public function drawCarne($x, $y)
    {
        ...
        /* returna retangulo */
        //$this->Rect( $x, $y, 92, 75 );
        $this->Rect( $x, $y+1, 92-20, 80*$this->tamY );
        ...
        $this->Text   ( ($x+108), ($y+(4*$this->tamY)), substr( $rsListaCarnePrefeitura->getCampo( "nom_prefeitura" ), 0, 60 ) );
        $this->Text   ( ($x+108), ($y+(7*$this->tamY)), substr( $rsListaCarnePrefeitura->getCampo( "carne_secretaria" ), 0, 60 ) );

        $this->Text   ( ($x+16) , ($y+(10*$this->tamY)), $this->lblExercicio );
        $this->Text   ( ($x+108), ($y+(10*$this->tamY)), $this->lblExercicio );
...
//67.5, 60.5, 53.5
    ...
    public function posicionaVariaveis($x, $y)
    {
        ...
        $this->Text   ( ($x+127), ($y+(10*$this->tamY))  ,$this->stExercicio ); // ok
...
class RCarneIPTUBanrisulMarianaPimentel
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RCarneIPTUBanrisulMarianaPimentel($arEmissao, $horizontal = 7, $vertical = 95)
{
...
/*        $this->obRCarneMarianaPimentel->drawProtocolo();
        $this->obRCarneMarianaPimentel->posicionaVariaveisProtocolo();
*/
        $inParcela = $inCount = 0;
