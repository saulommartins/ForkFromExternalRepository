...
//            $this->Text   ( 70    , 73   , $stObsL7 );
            ...
            $this->MultiCell(120, 3, $stObs, 0, 'J', 0);

            $this->SetXY($xAnt,$yAnt);
            //$this->Text   ( 8     , 76.5+$this->inTamY , substr($stObs,0   ,90 ));
            //$this->Text   ( 8     , 79+$this->inTamY   , substr($stObs,90  ,90 ));
            //$this->Text   ( 8     , 81.5+$this->inTamY , substr($stObs,180 ,90 ));
            //$this->Text   ( 8     , 84+$this->inTamY   , substr($stObs,270 ,90 ));
            //$this->Text   ( 8     , 86.5+$this->inTamY , substr($stObs,360 ,90 ));
        }
...
//        $stObs = "Intruções: Após Vencimento Cobrar: Multa de Mora 10% e Juros de 1% A.M.";
        ...
        //$this->Text   ( $x+40, $y+227, substr( $stObs, 270, 90 ) ); //item novo/alterado 11_03_2008
        //$this->Text   ( $x+40, $y+230, substr( $stObs, 360, 90 ) ); //item novo/alterado 11_03_2008
...
/*
    ...
    * @access Private
*/
function RCarneIssUrbem($arEmissao, $horizontal = 7, $vertical = 95)
{
