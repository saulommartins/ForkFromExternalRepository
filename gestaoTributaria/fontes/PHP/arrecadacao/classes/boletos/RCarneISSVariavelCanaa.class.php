...
//eh aakiiiiii o carnets
        ...
        //oitava linha
        $this->Line( $x+148, $y+120, (148+$x), $y+127 );
        ...
        $this->setFont('Arial','',8);
        $this->Text   ( $x+2, $y+23, "Insc. Econômica" );
        $this->Text   ( $x+32, $y+23, "Empresa" );
        ...
        $this->Text   ( $x+2, $y+156, "Observação:" );
...
//esta linha vai subir um pouco
        ...
        $this->Text   ( $x+150, $y+123, "Valor Declarado:" );

        $this->Text   ( $x+2, $y+123, "Prestador:" );
        $this->Text   ( $x+2, $y+130, "Notas Declaradas:" );
    ...
    public function posicionaVariaveisCapa($x, $y)
    {
        ...
        $this->Text   ( $x+2, $y+126, $this->stPrestador );

        $this->Text   ( $x+2 , $y+133 , substr( $this->stNumeroNota, 0, 180) );
        $this->Text   ( $x+2 , $y+137 , substr( $this->stNumeroNota, 180, 180) );
        $this->Text   ( $x+2 , $y+141 , substr( $this->stNumeroNota, 360, 180) );
        $this->Text   ( $x+2 , $y+145 , substr( $this->stNumeroNota, 540, 180) );
        ...
        $this->Text   ( $x+150, $y+126, $this->stValorDeclarado );

        $stObs = str_replace( "\n\r", " ", $this->stObservacao );
        $this->Text   ( $x+2, $y+160, substr( $stObs, 0, 120 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+2, $y+163, substr( $stObs, 120, 120 ) ); //item novo/alterado 11_03_2008
...
/*
    ...
    * @access Private
*/
function RCarneISSVariavelCanaa($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        //dados notas
        $stFiltro  = " acef.inscricao_economica = ".$chave[0]["inscricao"]." and ";
        ...
        $this->obRCarneMata->stNomeZoneamento = "CPF/CNPJ";

        $this->obRCarneMata->stNumeroNota = $stNumeracaoCarne;
        $this->obRCarneMata->stPrestador = $stPrestador;
        ...
        $this->obRCarneMata->stValorDeclarado = number_format( $flValorDeclarado, 2, ',', '.' );
        ...
        $this->obRCarneMata->stZoneamento = $rsListaCPForCNPJ->getCampo( 'cpf' );
