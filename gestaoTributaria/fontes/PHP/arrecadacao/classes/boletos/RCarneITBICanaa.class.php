...
class RProtocolo extends fpdf
{
    ...
    public function posicionaVariaveisProtocolo()
    {
        ...
        if ( !Sessao::read( 'itbi_observacao' ) ) {
            ...
            $this->arAdquirente = $rsItbi->getCampo('adquirinte');

            $this->Text   ( 8     , 34+$this->inTamY   , strtoupper($this->arAdquirente) );
        }
...
class RCarneDiversosPetropolis extends RProtocolo
{
    ...
    public $tamY = 0.93;
    public $stVVenalTerreno;
    public $stVVenalConstrucao;
    public $stVVenalImovel;
    public $stVAliquota;
    public $stNomeZoneamento;

    public $stAreaLote;
    public $stLote;
    public $stAreaEdificacao;
    public $stAreaLoteRural;
...
//eh aakiiiiii o carnets
        $this->Rect( $x, $y+20, 196, 158*$this->tamY );

        /* linha horizontais */
        //bloco a
        $this->Line( $x, $y+27, (196+$x), $y+27 );
        $this->Line( $x, $y+38, (196+$x), $y+38 );
        $this->Line( $x, $y+45, (196+$x), $y+45 );
        $this->Line( $x, $y+52, (196+$x), $y+52 );
        $this->Line( $x, $y+56, (196+$x), $y+56 );

        $this->Line( $x, $y+113, (196+$x), $y+113 );
        $this->Line( $x, $y+120, (196+$x), $y+120 );
        $this->Line( $x, $y+127, (196+$x), $y+127 );
        $this->Line( $x, $y+134, (196+$x), $y+134 );

        /* linha vertical*/
        //primeira linha
        $this->Line( $x+30, $y+20, (30+$x), $y+27 );
        $this->Line( $x+98, $y+20, (98+$x), $y+27 );
        $this->Line( $x+130, $y+20, (130+$x), $y+27 );
        $this->Line( $x+160, $y+20, (160+$x), $y+27 );

        //segunda linha
        $this->Line( $x+160, $y+27, (160+$x), $y+38 ); //novo 03_04_08
        ...
        $this->Line( $x+50, $y+120, (50+$x), $y+127 );
        $this->Line( $x+100, $y+120, (100+$x), $y+127 );
        $this->Line( $x+150, $y+120, (150+$x), $y+127 ); //era127 ate 134

        $this->Line( $x+47, $y+127, (47+$x), $y+134 );
        $this->Line( $x+95, $y+127, (95+$x), $y+134 );
        ...
        $this->setFont('Arial','',8);
        $this->Text   ( $x+2, $y+23, "Insc. Imobiliaria" );
        $this->Text   ( $x+32, $y+23, "Proprietário(a)" );
        $this->Text   ( $x+100, $y+23, "Quadra - Lote" );
        $this->Text   ( $x+132, $y+23, "Natureza" );

        $this->Text   ( $x+162, $y+30, "Lote" ); //novo 03_04_08
        $this->Text   ( $x+162, $y+34, $this->stLotePadrao ); //novo 03_04_08
...
//esta linha vai subir um pouco
        ...
        $this->Text   ( $x+2, $y+123, "Valor Venal do Terreno (R$):" );
        $this->Text   ( $x+52, $y+123, "Valor Venal da Construção (R$):" );
        $this->Text   ( $x+102, $y+123, "Valor Venal do Imóvel (R$):" );
        $this->Text   ( $x+152, $y+123, "Aliquota:" );

        $this->Text   ( $x+2, $y+130, "Área Lote:" );
        $this->Text   ( $x+49, $y+130, "Área Edificação:" );
        $this->Text   ( $x+97, $y+130, "Área Lote Rural:" );

        $this->Text   ( $x+2, $y+137, "Adquirentes:" );
        $this->Text   ( $x+120, $y+137, "Quota:" );
        for ( $inX=0; $inX<count( $this->arAdquirente ); $inX++) {
            $this->Text   ( $x+2, $y+141+($inX*3), $this->arAdquirente[$inX] );
            $this->Text   ( $x+120, $y+141+($inX*3), $this->arAdquirenteQuota[$inX] );
        }
    ...
    public function drawCarne($x, $y)
    {
        ...
        /* returna retangulo */
        $this->Rect( $x, $y+173, 196, 84*$this->tamY );
        ...
        $this->Line( $x+37, $y+180, (196+$x), $y+180 ); //item novo/alterado 12_03_2008
        $this->Line( $x+37, $y+185, (196+$x), $y+185 ); //item novo/alterado 12_03_2008
        $this->Line( $x+37, $y+192, (196+$x), $y+192 ); //item novo/alterado 12_03_2008
        $this->Line( $x+37, $y+199, (196+$x), $y+199 ); //item novo/alterado 12_03_2008
        $this->Line( $x+37, $y+206, (196+$x), $y+206 ); //item novo/alterado 12_03_2008

        $this->Line( $x+160, $y+213, (196+$x), $y+213 );
        $this->Line( $x+160, $y+220, (196+$x), $y+220 );
        $this->Line( $x+160, $y+227, (196+$x), $y+227 );

        $this->Line( $x+37, $y+220, (167+$x), $y+220 ); //04/04/2008
        $this->Line( $x+37, $y+227, (167+$x), $y+227 ); //04/04/2008
        ...
        $this->Line( $x+37, $y+234, (196+$x), $y+234 ); //item novo/alterado 12_03_2008
        ...
        $this->Line( $x+72, $y+220, 72+$x, $y+227 ); //04/04/2008
        $this->Line( $x+102, $y+220, 102+$x, $y+227 ); //04/04/2008
        $this->Line( $x+132, $y+220, 132+$x, $y+227 ); //04/04/2008
        ...
        $this->Text   ( $x+39, $y+223, "VV Terreno (R$):" ); //04/04/2008
        $this->Text   ( $x+74, $y+223, "VV Construção (R$):" ); //04/04/2008
        $this->Text   ( $x+104, $y+223, "VV Imóvel (R$):" ); //04/04/2008
        $this->Text   ( $x+134, $y+223, "Aliquota:" ); //04/04/2008
        $this->Text   ( $x+39, $y+230, "Adquirentes/Quotas" ); //04/04/2008
    ...
    public function posicionaVariaveis($x, $y)
    {
        ...
        $this->Text   ( $x+39, $y+226, $this->stVVenalTerreno ); //04/04/2008
        $this->Text   ( $x+74, $y+226, $this->stVVenalConstrucao ); //04/04/2008
        $this->Text   ( $x+104, $y+226, $this->stVVenalImovel ); //04/04/2008
        $this->Text   ( $x+134, $y+226, $this->stVAliquota ); //04/04/2008
        $stDadosAdquirente = "";
        for ( $inX=0; $inX<count( $this->arAdquirente ); $inX++) {
            if ( $inX > 0 )
                $stDadosAdquirente .= ", ";

            $stDadosAdquirente .= $this->arAdquirente[$inX]."(".$this->arAdquirenteQuota[$inX].")";
        }

        $this->Text   ( $x+39, $y+233, $stDadosAdquirente ); //04/04/2008
        $this->Text   ( $x+162, $y+191, $this->flValor ); //valor do documento lado B
        $this->Text   ( $x+2, $y+191, $this->flValor ); //valor do documento lado B //item novo/alterado 11_03_2008
        ...
        $stObs = str_replace( "\n\r", " ", $this->stObservacao );
        $this->Text   ( $x+40, $y+215, substr( $stObs, 0, 120 ) ); //item novo/alterado 11_03_2008
        $this->Text   ( $x+40, $y+218, substr( $stObs, 120, 120 ) ); //item novo/alterado 11_03_2008
        ...
        $this->setFont('Arial', '', 8 );
        $this->Text   ( ($x+85), ($y+(278*$this->tamY)), $this->stLinhaCode );
        $this->defineCodigoBarras( ($x+75), ($y+(280*$this->tamY)), $this->stBarCode );
    }
    ...
    public function posicionaVariaveisCapa($x, $y)
    {
        ...
        $this->Text   ( $x+100, $y+26, $this->stLote );
        //falta aki 22_08
        $this->Text   ( $x+32, $y+26, $this->getNomCgm() ); // proprietario lado A
        $this->Text   ( $x+2, $y+26, $this->inInscricao ); // id fisico lado A

        $this->Text   ( $x+2, $y+30, substr( $this->getRua(), 0, 100 ) ) ; // end . do imovel lado A
        $this->Text   ( $x+18, $y+32, substr( $this->getRua(), 100, 120 ) ) ; // end . do imovel lado A
        ...
        $this->Text   ( $x+2, $y+126, $this->stVVenalTerreno );
        $this->Text   ( $x+52, $y+126, $this->stVVenalConstrucao );
        $this->Text   ( $x+102, $y+126, $this->stVVenalImovel );
        $this->Text   ( $x+152, $y+126, $this->stVAliquota );

        $this->Text   ( $x+2, $y+133, $this->stAreaLote );
        $this->Text   ( $x+49, $y+133, $this->stAreaEdificacao );
        $this->Text   ( $x+97, $y+133, $this->stAreaLoteRural );
...
class RCarneMata extends RProtocolo
{
    ...
    public function posicionaVariaveis($x, $y)
    {
        ...
        if ( Sessao::read('itbi_observacao') == 'sim') {
            $this->Text   ( ($x+1)  , ($y+(64*$inTamY))  , $this->arAdquirente );
            $this->Text   ( ($x+96-20) , ($y+(64*$inTamY))  , $this->arAdquirente );
        } else {
...
/*
    ...
    * @access Private
*/
function RCarneITBICanaa($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        require_once(CAM_GT_ARR_MAPEAMENTO."TARRImovelVVenal.class.php");
        $obImovelVVenal = new TARRImovelVVenal;
        $filtro = "and inscricao_municipal = ".$chave[0]['inscricao'];
        $obImovelVVenal->recuperaMensagemItbi( $rsItbi, $filtro, "", "", $valor );

        $rsItbi->addFormatacao ( 'cota', 'NUMERIC_BR' );
        $this->obRCarneMata->arAdquirente = array();
        $this->obRCarneMata->arAdquirenteQuota = array();
        while ( !$rsItbi->Eof() ) {
            $this->obRCarneMata->arAdquirente[] = str_replace( "E OUTROS", "", $rsItbi->getCampo('adquirinte') );
            $this->obRCarneMata->arAdquirenteQuota[] = $rsItbi->getCampo('cota')."%";
            $rsItbi->proximo();
        }
        ...
        $this->obRCarneMata->stLote = $rsListaCarne->getCampo( "lote_quadra" )." - ".$rsListaCarne->getCampo( "lote_urb" );
        ...
        $this->obRCarneMata->stAreaLoteRural = $rsListaCarne->getCampo("area_lote_rural");
...
//$obTARRCarne->debug();exit;
        ...
        if ( count( $chave ) > 1 ) {
            ...
            while ( !$rsListaDetalheCreditos->Eof() ) {
                ...
                $stNomeCredito = $rsListaDetalheCreditos->getCampo("credito");
                $this->obRCarneMata->arDados[$inDados]["tributo"] = "    ".substr( $stNomeCredito, 0, 40 );
                $this->obRCarneMata->arDados[$inDados]["valor_lanc"] = number_format( $rsListaDetalheCreditos->getCampo("valor_credito"), 2, ',', '.' );
                $this->obRCarneMata->arDados[$inDados]["correcao"] = number_format( $rsListaDetalheCreditos->getCampo("credito_correcao_pagar"), 2, ',', '.' );
                $this->obRCarneMata->arDados[$inDados]["juros"] = number_format( $rsListaDetalheCreditos->getCampo("credito_juros_pagar"), 2, ',', '.' );
                $this->obRCarneMata->arDados[$inDados]["multa"] = number_format( $rsListaDetalheCreditos->getCampo("credito_multa_pagar"), 2, ',', '.' );
                ...
                $this->obRCarneMata->arDados[$inDados]["parcela"] = $rsListaDetalheCreditos->getCampo("nr_parcela");
                $this->obRCarneMata->arDados[$inDados]["vencimento"] = $rsListaDetalheCreditos->getCampo( 'vencimento' );
                $inTamanhoNomeCredito = strlen( $stNomeCredito );
                $inPosicao = 0;
                while ($inTamanhoNomeCredito > 40) {
                    $inDados++;
                    $inPosicao++;
                    $this->obRCarneMata->arDados[$inDados]["tributo"] = "      ".substr( $stNomeCredito, 40*$inPosicao, (40*$inPosicao)+40 );

                    $inTamanhoNomeCredito -= 40;
                }
...
*/
    ...
    //                $this->obRCarneMata->setParcela( $rsParcela->getCampo( 'info' ));
            ...
            if (!$inParcela) {
                ...
                $this->obRCarneMata->setPicote( $this->inHorizontal, $this->inVertical-152 );
            }
