...
<?php
/**
  * Regra ISS para Carne Mata de Sao Joao
  ...
  * @package URBEM
    ...
    * $Id: RISSEstimadoMataSaoJoao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
include_once ( CAM_GT_ARR_CLASSES."boletos/RCarneDadosISSEstimadoMataSaoJoao.class.php" );
include_once ( CAM_GT_ARR_NEGOCIO."RARRCarne.class.php" );
include_once ( CAM_GT_ARR_NEGOCIO."RARRConfiguracao.class.php" );
include_once ( CAM_GA_ADM_MAPEAMENTO."TAdministracaoConfiguracao.class.php" );

class RISSEstimadoMataSaoJoao
{
/*
    * @var Integer
    * @access Private
...
/*
    ...
    * @access Private
*/
function RISSEstimadoMataSaoJoao($arEmissao, $horizontal = 7, $vertical = 95)
{
...
function imprimirCarne($diffBaixa = FALSE)
{
    ...
    foreach ($this->arEmissao as $valor => $chave) {
        ...
        $this->obRCarnePetropolis->stExercicio  = '2007';
