...
<?php
/**
    * Classe de mapeamento da funçao AplicaMultaReemissao
    * Data de Criação:
...
class Faplica_multa_reemissao extends Persistente
{
    public function Faplica_multa_reemissao()
    {
        parent::Persistente();
    ...
    {
        $stSql  = " SELECT aplica_multa_reemissao(".$stParametros.") as valor \r\n";
