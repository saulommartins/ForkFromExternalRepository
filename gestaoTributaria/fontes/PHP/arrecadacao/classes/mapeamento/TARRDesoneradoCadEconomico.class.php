...
/**
    ...
    * $Id: TARRDesoneradoCadEconomico.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ARRECADACAO.DESONERADO_CAD_ECONOMICO
  ...
  * @subpackage Mapeamento
*/
class TARRDesoneradoCadEconomico extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TARRDesoneradoCadEconomico()
{
    parent::Persistente();
    $this->setTabela('arrecadacao.desonerado_cad_economico');

    $this->setCampoCod('');
    $this->setComplementoChave('numcgm,cod_desoneracao,inscricao_economica');
