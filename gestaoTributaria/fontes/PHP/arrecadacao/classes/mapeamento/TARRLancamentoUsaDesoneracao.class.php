...
<?php
/**
    * Classe de mapeamento da tabela ARRECADACAO.LANCAMENTO_USA_DESONERACAO
    ...
    * $Id: TARRLancamentoUsaDesoneracao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TARRLancamentoUsaDesoneracao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
    public function TARRLancamentoUsaDesoneracao()
    {
        parent::Persistente();
        $this->setTabela("arrecadacao.lancamento_usa_desoneracao");
