...
<?php
/**
    * Classe de mapeamento da tabela ARRECADACAO.SUSPENSAO_TERMINO
    ...
    * $Id: TARRSuspensaoTermino.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ARRECADACAO.SUSPENSAO_TERMINO
  ...
  * @subpackage Mapeamento
*/
class TARRSuspensaoTermino extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TARRSuspensaoTermino()
{
    parent::Persistente();
    $this->setTabela('arrecadacao.suspensao_termino');
