...
/**
    ...
    * $Id: FARRParcentualDescontoParcela.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRParcentualDescontoParcela extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRParcentualDescontoParcela()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                              \r\n";
    $stSql .= "     arrecadacao.fn_percentual_desconto_parcela(".$stParametros.") as valor  \r\n";
