...
/**
    ...
    * $Id: Ftotal_parcelas.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class Ftotal_parcelas extends Persistente
{
function Ftotal_parcelas()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT arrecadacao.fn_total_parcelas(".$stParametros.") as valor \r\n";
