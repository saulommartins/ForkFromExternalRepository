...
/**
    ...
    * $Id: Faplica_multa.class.php 65763 2016-06-16 17:31:43Z evandro $
...
class Faplica_multa extends Persistente
{
function Faplica_multa()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT aplica_multa(".$stParametros.") as valor \r\n";
