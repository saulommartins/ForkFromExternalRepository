...
/**
    ...
    * $Id: FARRUltimoValorVenalLanc.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRUltimoValorVenalLanc extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRUltimoValorVenalLanc()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                              \r\n";
    $stSql .= "     arrecadacao.fn_ultimo_venal_por_im_lanc(".$stParametros.") as valor  \r\n";
