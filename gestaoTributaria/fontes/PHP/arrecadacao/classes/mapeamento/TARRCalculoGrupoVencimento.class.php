...
/**
    ...
    * $Id: TARRCalculoGrupoVencimento.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class TARRCalculoGrupoVencimento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TARRCalculoGrupoVencimento()
{
    parent::Persistente();
    $this->setTabela("arrecadacao.calculo_grupo_vencimento");
    ...
    $this->AddCampo('cod_vencimento','integer'  ,true       ,''     ,false  ,true );
