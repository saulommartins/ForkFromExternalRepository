...
/**
    ...
    * $Id: FARRVenaisAtributos.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRVenaisAtributos extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRVenaisAtributos()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                              \r\n";
    $stSql .= " arrecadacao.fn_busca_venais_atributos(".$stParametros.") as valor  \r\n";
