...
<?php
/**
    * Classe de mapeamento da função ARRECADACAO.FECHA_CALCULO()
    ...
    * $Id: FARRFechaCalculo.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRFechaCalculo extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRFechaCalculo()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                          \r\n";
    $stSql .= "     arrecadacao.fecha_calculo() as valor         \r\n";
