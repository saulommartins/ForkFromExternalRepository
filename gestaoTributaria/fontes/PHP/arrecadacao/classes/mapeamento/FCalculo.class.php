...
<?php
/**
    * Classe de mapeamento generico paras funções do gerador de calculo
    ...
    * $Id: FCalculo.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FCalculo extends Persistente
{
    public $stFuncao;
/**
    * MÃ©todo Construtor
...
{
    $stSql  = " SELECT ".$this->stFuncao."(".$stParametros.") as valor \r\n";
