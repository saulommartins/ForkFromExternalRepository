...
/**
    ...
    * $Id: FARRProporcaoParcela.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRProporcaoParcela extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRProporcaoParcela()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                              \r\n";
    $stSql .= "     arrecadacao.calculaProporcaoParcela(".$stParametros.") as valor  \r\n";
