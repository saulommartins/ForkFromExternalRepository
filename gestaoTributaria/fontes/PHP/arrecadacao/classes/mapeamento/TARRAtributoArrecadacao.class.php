...
<?php
/**
  * Classe de mapeamento da tabela ARRECADACAO.ATRIBUTO_ARRECADACAO
    ...
    * $Id: TARRAtributoArrecadacao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  arrecadacao.atributo_arrecadacao
  ...
  * @subpackage Mapeamento
*/
class TARRAtributoArrecadacao extends PersistenteAtributos
{
/**
    * Método Construtor
    * @access Private
*/
function TARRAtributoArrecadacao()
{
    parent::Persistente();
    $this->setTabela('arrecadacao.atributo_arrecadacao');
