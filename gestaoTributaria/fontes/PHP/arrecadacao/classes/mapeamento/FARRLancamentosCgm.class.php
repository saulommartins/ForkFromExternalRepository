...
/**
    ...
    * $Id: FARRLancamentosCgm.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRLancamentosCgm extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRLancamentosCgm()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                                  \r\n";
    $stSql .= "     arrecadacao.buscaLancamentosCgm(".$stParametros.") as valor    \r\n";
