...
/**
    ...
    * $Id: FARRCalculaJuroOrMultaParcelasReemissao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRCalculaJuroOrMultaParcelasReemissao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRCalculaJuroOrMultaParcelasReemissao()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                                          \r\n";
    $stSql .= "     arrecadacao.calculaJuroOrMultaParcelasReemissao(".$stParametros.") as valor \r\n";
