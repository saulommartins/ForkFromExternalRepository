...
/**
    ...
    * $Id: Ffn_situacao_carne.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class Ffn_situacao_carne extends Persistente
{
function Ffn_situacao_carne()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT arrecadacao.fn_situacao_carne(".$stParametros.") as valor \r\n";
