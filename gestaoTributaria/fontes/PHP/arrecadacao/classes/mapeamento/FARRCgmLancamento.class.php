...
/**
    ...
    * $Id: FARRCgmLancamento.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRCgmLancamento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRCgmLancamento()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                                  \r\n";
    $stSql .= "     arrecadacao.buscaCgmLancamento(".$stParametros.") as valor    \r\n";
