...
<?php
/**
    * Classe de mapeamento da função ARRECADACAO.buscaLancamentosIM()
    ...
    * $Id: FARRLancamentosIM.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRLancamentosIM extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRLancamentosIM()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                                  \r\n";
    $stSql .= "     arrecadacao.buscaLancamentosIM(".$stParametros.") as valor    \r\n";
