...
<?php
/**
  * Classe de mapeamento da tabela ARRECADACAO.ATRIBUTO_GRUPO
    ...
    * $Id: TARRAtributoGrupo.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ARRECADACAO.ATRIBUTO_GRUPO
  ...
  * @subpackage Mapeamento
*/
class TARRAtributoGrupo extends PersistenteAtributos
{
/**
    * Método Construtor
    * @access Private
*/
function TARRAtributoGrupo()
{
    parent::PersistenteAtributos();
    $this->setTabela('arrecadacao.atributo_grupo');
//  $this->setPersistenteAtributoModulo( new TARRAtributoArrecadacao);

    $this->setCampoCod('');
    $this->setComplementoChave('cod_modulo,cod_grupo,cod_cadastro,cod_atributo');
