...
<?php
/**
    * Classe de mapeamento da tabela ARRECADACAO.SERVICO_COM_RETENCAO
    ...
    * $Id: TARRServicoComRetencao.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TARRServicoComRetencao extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TARRServicoComRetencao()
    {
        parent::Persistente();
        $this->setTabela('arrecadacao.servico_com_retencao');

        $this->setCampoCod('');
        $this->setComplementoChave('cod_atividade,cod_servico,cod_municipio,cod_uf,numcgm,inscricao_economica,ocorrencia,timestamp');
        ...
        $this->AddCampo('valor_retido', 'numeric', true, '14,2', false, false );
    }
