...
<?php
/**
    * Classe de mapeamento da tabela ARRECADACAO.CADASTRO_ATRIBUTO
    ...
    * $Id: TARRCadastroAtributo.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ARRECADACAO.CADASTRO_ATRIBUTO
  ...
  * @subpackage Mapeamento
*/
class TARRCadastroAtributo extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TARRCadastroAtributo()
{
    parent::Persistente();
    $this->setTabela('arrecadacao.cadastro_atributo');
