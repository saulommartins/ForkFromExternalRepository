...
/**
    ...
    * $Id: FARRValoresItbi.class.php 65763 2016-06-16 17:31:43Z evandro $
...
/**
  ...
  * @subpackage Mapeamento
*/
class FARRValoresItbi extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function FARRValoresItbi()
{
    parent::Persistente();
...
{
    $stSql  = " SELECT                                                              \r\n";
    $stSql .= "     arrecadacao.fn_busca_valores_itbi(".$stParametros.") as valor  \r\n";
