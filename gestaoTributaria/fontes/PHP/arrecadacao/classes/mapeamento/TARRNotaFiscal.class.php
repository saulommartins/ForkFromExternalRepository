...
<?php
/**
    * Classe de mapeamento da tabela ARRECADACAO.NOTA_FISCAL
...
class TARRNotaFiscal extends Persistente
{
    /**
        * Método Construtor
        * @access Private
    */
    public function TARRNotaFiscal()
    {
        parent::Persistente();
        $this->setTabela('arrecadacao.nota_fiscal');
