...
<?php
/**
  * Classe de mapeamento da tabela ARRECADACAO.ATRIBUTO_CALENDARIO_VALOR
    ...
    * $Id: TARRAtributoCalendarioValor.class.php 59612 2014-09-02 12:00:51Z gelson $
...
/**
  * Efetua conexão com a tabela  ARRECADACAO.ATRIBUTO_CALENDARIO_VALOR
  ...
  * @subpackage Mapeamento
*/
class TARRAtributoCalendarioValor extends PersistenteAtributosValores
{
/**
    * Método Construtor
    * @access Private
*/
function TARRAtributoCalendarioValor()
{
    parent::PersistenteAtributosValores();
    $this->setTabela('arrecadacao.atributo_calendario_valor');
//    $this->setPersistenteAtributo( new TARRAtributoArrecadacao );

    $this->setCampoCod('');
    $this->setComplementoChave('cod_cadastro,cod_atributo,cod_grupo');
