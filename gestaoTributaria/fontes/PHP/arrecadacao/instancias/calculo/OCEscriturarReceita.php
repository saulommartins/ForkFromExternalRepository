...
<?php
/**
    * Página de Frame Oculto do Calculo ISS
    ...
    * $Id: OCEscriturarReceita.php 59612 2014-09-02 12:00:51Z gelson $
...
function montaListaNotas($rsLista)
{
    if ( $rsLista->getNumLinhas() > 0 ) {
        ...
        $obLista->setTotaliza                  ( "flValorLancadoSemAliquota,Valor em Serviço,right,8" );
        ...
        $obLista->addDado                      (                        );
        $obLista->ultimoDado->setCampo         ( "flValorLancadoSemAliquota"  );
        $obLista->commitDado                   (                        );
...
function montaListaServicos($rsLista)
{
    if ( $rsLista->getNumLinhas() > 0 ) {
        ...
        $obLista->setTotaliza                  ( "flValorLancadoSemAliquota,Valor Total,right,8" );
...
switch ($_REQUEST['stCtrl']) {
    ...
    case "montaRetencao":
        ...
        if ( $boTemValores || (count( Sessao::read( 'servicos_retencao_semrt' ) ) > 0 ) || (count( Sessao::read( 'notas_retencao_semrt' ) ) > 0 ) ) {
            ...
            $obFormulario2->addComponente ( $obTxtObservacao );
            ...
            $obFormulario2->addComponente ( $obChkEmissaoCarne );
            ...
            $obFormulario2->addComponente ( $obCmbModelo );

            $obFormulario2->montaInnerHTML();
            $stJs .= "d.getElementById('spnCarne').innerHTML = '". $obFormulario2->getHTML(). "';\n";
        } else {
            $stJs .= "d.getElementById('spnCarne').innerHTML = '&nbsp;';\n";
        }
    ...
    case "alterarServico":
        ...
        for ($inCount = 0; $inCount < $nregistros; $inCount++) {
            if (
                ( $arServicoRetencao[$inCount]["stServico"] == $stServico ) &&
                ( $arServicoRetencao[$inCount]["flAliquota"] == $flAliquota ) &&
                ( $arServicoRetencao[$inCount]["flValorDeclarado"] == $flValorDeclarado ) &&
                ( $arServicoRetencao[$inCount]["flValorLancado"] == $flValorLancado ) &&
                ( $arServicoRetencao[$inCount]["flDeducao"] == $flDeducao ) &&
                ( $arServicoRetencao[$inCount]["flDeducaoLegal"] == $flDeducaoLegal )
            ) {
                $obTCGM = new TCGM;
                ...
                if ($arServicoRetencao[$inCount]["flValorDeclarado"]) {
                    ...
                    $stJs .= 'f.flDeducaoLegal.value = "'.$arServicoRetencao[$inCount]["flDeducaoLegal"].'";';
                } else {
        ...
        if ($boIncluir) {
            ...
            for ($inX=0; $inX<$nregistros; $inX++) {
                if ($_REQUEST["boReterFonte"]) { //com retencao
                    ...
                    $flTotalLancadoSemAliquota += str_replace ( ',', '.', str_replace ( '.', '', $arServicoRetencaoComRT[$inX]["flValorLancadoSemAliquota"] ) );
                    ...
                    $flTotalLancadoSemAliquota += str_replace ( ',', '.', str_replace ( '.', '', $arServicoRetencaoSemRT[$inX]["flValorLancadoSemAliquota"] ) );
            ...
            if ($_REQUEST["boReterFonte"]) { //com retencao
                ...
                $arNotasRetencaoComRT[$nroNotas]["flValorLancadoSemAliquota"] = number_format( $flTotalLancadoSemAliquota, 2, ',', '.' );
                ...
                $arNotasRetencaoSemRT[$nroNotas]["flValorLancadoSemAliquota"] = number_format( $flTotalLancadoSemAliquota, 2, ',', '.' );
    ...
    case "incluirServico":
        if ($_REQUEST["boReterFonte"]) {
            ...
            if (!$_REQUEST["flDeducaoLegal"]) {
                $stJs = "alertaAviso('@Campo Valor Dedução Legal inválido.','form','erro','".Sessao::getId()."');";
                sistemaLegado::executaFrameOculto( $stJs );
                exit;
            }
        ...
        if ($_REQUEST["stEscrituracao"] == "nota") {
            if ($_REQUEST["boReterFonte"]) { //com retencao
                ...
                if ( Sessao::read( 'servicos_retencao_alterando_comrt' ) ) {
                    ...
                    unset( $arServicoRetencaoComRT[$inTotalElementos]["flDeducaoLegal"]);
                ...
                if ( Sessao::read( 'servicos_retencao_alterando_semrt' ) ) {
                    ...
                    unset( $arServicoRetencaoSemRT[$inTotalElementos]["flDeducaoLegal"]);
            ...
            if ( Sessao::read( 'servicos_retencao_alterando' ) ) {
                ...
                unset( $arServicoRetencao[$inTotalElementos]["flDeducaoLegal"]);
        ...
        if ($_REQUEST["boReterFonte"]) {
            ...
            if ($_REQUEST["stEscrituracao"] == "nota") {
                ...
                $arServicoRetencaoSemRT[$inTotalElementos]["flDeducaoLegal"] = $_REQUEST["flDeducaoLegal"];
                ...
                $arServicoRetencaoSemRT[$inTotalElementos]["flValorLancado"] = (( $flValorDeclarado - $flDeducao - $flDeducaoLegal ) * $flAliquota ) / 100;
                ...
                $arServicoRetencaoSemRT[$inTotalElementos]["flValorLancadoSemAliquota"] = $flValorDeclarado - $flDeducao - $flDeducaoLegal;
                $arServicoRetencaoSemRT[$inTotalElementos]["flValorLancadoSemAliquota"] = number_format( $arServicoRetencaoSemRT[$inTotalElementos]["flValorLancadoSemAliquota"], 2, ',', '.' );
                ...
                $arServicoRetencao[$inTotalElementos]["flDeducaoLegal"] = $_REQUEST["flDeducaoLegal"];
                ...
                $flAliquota = str_replace ( ',', '.', str_replace ( '.', '', $_REQUEST["flAliquota"] ) );
                $flDeducaoLegal = str_replace ( ',', '.', str_replace ( '.', '', $_REQUEST["flDeducaoLegal"] ) );
                $arServicoRetencao[$inTotalElementos]["flValorLancado"] = (( $flValorDeclarado - $flDeducao - $flDeducaoLegal ) * $flAliquota ) / 100;
                $arServicoRetencao[$inTotalElementos]["flValorLancado"] = number_format( $arServicoRetencao[$inTotalElementos]["flValorLancado"], 2, ',', '.' );

                $arServicoRetencao[$inTotalElementos]["flValorLancadoSemAliquota"] = $flValorDeclarado - $flDeducao - $flDeducaoLegal;
