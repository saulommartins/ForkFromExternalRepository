...
<?php
  ...
  * $Id: JSEmitirCarne.js 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
function EnviaFormulario(){
   ...
   var campoTipoEmissao;
    ...
    if (Valida()) {
	    if (jQuery("#emissao_carnes:checked").val() == 'local'){
		    campoTipoEmissao = 'Local';
	    } else if (jQuery("#emissao_carnes:checked").val() == 'grafica') {
            ...
            if (jQuery("#vinculo:checked").val() == 'imobiliario') {
            ...
            } else if (jQuery("#vinculo:checked").val() == 'economico') {
