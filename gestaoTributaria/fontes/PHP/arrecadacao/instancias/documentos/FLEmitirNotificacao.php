...
<?php
/**
  * Página de Filtro de Emissão de Notificação
  * Data de criação : 16/11/2005

  * @author Analista: Fábio Bertoldi
  * @author Programador: Tonismar R. Bernardo

    * $Id: FLEmitirNotificacao.php 59612 2014-09-02 12:00:51Z gelson $
...
$obTxtNotificacao = new Textbox;
$obTxtNotificacao->setName   ( "inCodDocumento" );
$obTxtNotificacao->setRotulo ( "Notificação"    );
$obTxtNotificacao->setValue  ( $_REQUEST["inCodDocumento"]  );
