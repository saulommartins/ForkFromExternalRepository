...
/**
  ...
  * $Id: OCEmitirCarne.php 45571 2011-06-22 19:05:35Z davi.aroldi $
...
switch ($_REQUEST['stCtrl']) {
    ...
    case "montaOpcoesGrafica":
        ...
        if ($_REQUEST["emissao_carnes"] == "local") {
            ...
            $obRadioTipoCarneImobiliario->obEvento->setOnClick("montaParametrosGET('montaFiltroCarneImobiliario');");
