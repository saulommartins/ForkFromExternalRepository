...
<?php
/**
  * Página Oculto de Emitir Notificação
  * Data de criação : 16/11/2005

  * @author Analista: Fábio Bertoldi
  * @author Programador: Tonismar R. Bernardo

    * $Id: OCEmitirNotificacao.php 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
function montaBuscaOrdem($stTipo)
{
    ...
    $rsRecordSet = $rsRecordSetS = new RecordSet;
...
function montaBuscaInscricaoImobiliariaIndividual()
{
    ...
    //$obBscInscricaoMunicipal->setTitle                 ( "Informar Inscrição Imobiliária Municipal para o calculo ");
