...
/*
$Log$
Revision 1.86  2007/06/12 20:42:41  dibueno
Bug #9386#

Revision 1.85  2007/06/07 15:19:51  dibueno
Bug #9372#

Revision 1.84  2007/05/31 19:37:58  dibueno
Bug #9341#

Revision 1.83  2007/02/07 12:51:48  dibueno
Melhorias da consulta da arrecadacao

Revision 1.82  2007/02/07 11:13:20  dibueno
Melhorias da consulta da arrecadacao

Revision 1.81  2007/02/05 11:07:30  dibueno
Melhorias da consulta da arrecadacao

Revision 1.80  2006/12/15 19:00:52  dibueno
Modificações na consulta da arrecadacao, em relacao ao calculo de juros/multa

Revision 1.79  2006/11/29 11:47:38  dibueno
Bug #7667#

Revision 1.78  2006/11/02 18:55:27  dibueno
Bug #7325#

Revision 1.77  2006/10/25 11:25:21  dibueno
Exibição de dados da consolidação caso seja parcela consolidada

Revision 1.76  2006/09/15 11:04:44  fabio
...
include_once '../../classes/negocio/RARRCarne.class.php';
...
//$dtDataBase = "2008-04-30";
//$dtDataUS = "2008=04-30";
// corrige formato da data
/*if ($stTipoData) {
    $arData = explode("/",$dtDataBase);
    $dtDataUS = $arData[2]."-".$arData[1]."-".$arData[0];
} else {
#echo 'CA';
    $arData = explode( "-", $dtDataBase);
...
$obLblVencimento->setValue  ( $rsDetalheParcela->getCampo("vencimento_original") );
