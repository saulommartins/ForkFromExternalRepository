...
/**
  ...
  * @ignore
    ...
    * $Id: JSRelatorioFichaCadastral.js 62838 2015-06-26 13:02:49Z diogo.zarpelon $
...
if(!document.frm.inCodContribuinteInicial.value && !document.frm.inCodGrupoInicio.value && !document.frm.inCodCreditoInicio.value)  {
            mensagem = "Contribuinte, Grupo ou Crédito deve(m) ser informado(s)!";
            alertaAviso(mensagem,'form','erro','<?=Sessao::getId();?>', '../');
}else if(document.frm.inCodGrupoInicio.value && document.frm.inCodCreditoInicio.value ){
            mensagem = "Deve ser selecionado apenas Grupo ou Apenas Crédito!";
            alertaAviso(mensagem,'form','erro','<?=Sessao::getId();?>', '../');
    }else{
    document.frm.submit();
    }
