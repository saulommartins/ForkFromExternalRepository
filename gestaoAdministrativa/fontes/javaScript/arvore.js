...
$Name$
$Author: pablo $
$Date: 2005-11-24 16:48:51 -0200 (Qui, 24 Nov 2005) $
...
function setStateFolder(isOpen){ 
    ...
    this.isOpen = isOpen;
    if (this.getID()!=foldersTree.getID() && PRESERVESTATE && !this.isOpen){
...
function generateCheckBox(parentfolderObject, itemLabel, objCheck, funcChange){
    ...
    sStr = "<td valign=middle><input type=checkbox value='"+objCheck.value+"' name='"+objCheck.name+"' id='"+objCheck.id+"' onpropertychange='"+funcChange+"'></td>";
