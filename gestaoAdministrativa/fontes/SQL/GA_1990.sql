...
---------------------------------------------------------------------------------
-- ALTERANDO QUANTIDADE DE CARACTERES NAS COLUNAS logradouro E logradouro_corresp
---------------------------------------------------------------------------------

DROP VIEW economico.vw_responsavel_tecnico;
ALTER TABLE sw_cgm ALTER column logradouro TYPE varchar(100);
ALTER TABLE sw_cgm ALTER column logradouro_corresp TYPE varchar(100);
...
ALTER TABLE sw_cga ALTER column logradouro TYPE varchar(100);
ALTER TABLE sw_cga ALTER column logradouro_corresp TYPE varchar(100);
