...
$Id: tbsooo_class.php 59612 2014-09-02 12:00:51Z gelson $

Caso de Uso: uc-01.00.00
*/
...
class clsTinyButStrongOOo extends clsTinyButStrong
{
  ...
  public $_process_path = 'tmp/';
  public $_zip_bin = '';
  public $_unzip_bin = '';
  public $_charset = '';
  public $_ooo_basename = '';
  public $_ooo_file_ext = '';
  public $_xml_filename = '';

  // public method

  public function SetZipBinary($path_binary, $test=false)
  {
  ...
  public function SetUnzipBinary($path_binary, $test=false)
  {
  ...
  public function SetProcessDir($process_path)
  {
    clearstatcache();
  ...
  public function NewDocFromTpl($ooo_template_filename)
  {
  ...
  public function LoadXmlFromDoc($xml_file)
  {
  ...
  public function AddFileToDoc($filename)
  {
  ...
  public function ReplaceTagImage()
  {
    /*
  ...
  public function GetPathnameDoc()
  {
    // remove tmp dir
  ...
  public function GetMimetypeDoc()
  {
  ...
  public function ClearProcessDir($hour = '2', $minut = '0')
  {
    clearstatcache();
  ...
  public function _PathQuote($path_quote)
  {
  ...
  public function _CharsetEncode($string_encode)
  {
  ...
  public function _RemoveTmpBasenameDir()
  {
    clearstatcache();
