...
<?php
/**
 * Classe de Mapeamento para a tabela sw_processo_matricula
...
class TProtocoloProcessoMatricula extends Persistente
{

    public function TProtocoloProcessoMatricula()
    {
        parent::Persistente();
        $this->setTabela('sw_processo_matricula');
