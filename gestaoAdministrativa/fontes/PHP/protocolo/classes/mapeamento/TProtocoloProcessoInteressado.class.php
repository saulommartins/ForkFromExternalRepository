...
<?php
/**
 * Classe de Mapeamento para a tabela sw_processo_interessado
...
class TProtocoloProcessoInteressado extends Persistente
{

    public function TProtocoloProcessoInteressado()
    {
        parent::Persistente();
        $this->setTabela('sw_processo_interessado');
