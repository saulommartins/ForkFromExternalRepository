...
/**
    ...
    * @author Desenvolvedor: Cassiano
    ...
    $Id: FMPopupLaco.php 59612 2014-09-02 12:00:51Z gelson $
...
$arParametros = Sessao::read('ParametrosTipo');
for ($inCount=0; $inCount<count($arParametros); $inCount++) {
    $arVariaveisTmp['stNomeVariavel'] = $arParametros[$inCount]['stNomeParametro'];
    $arVariaveisTmp['stTipoVariavel'] = $arParametros[$inCount]['stTipoParametro'];
...
if ( empty($stAcao)||$stAcao=="incluir" ) {
    ...
    $stHtml = substr($stConteudo,8, strlen($stConteudo)-12 );
...
$obFormulario->addTitulo            ( "Dados para laço" );
...
$obTabela->ultimaLinha->ultimaCelula->addConteudo( "ENQUANTO&nbsp;" );
...
$obTabela->ultimaLinha->ultimaCelula->setWidth ( 20 );
$obTabela->ultimaLinha->ultimaCelula->addConteudo( "&nbsp;FACA" );
$obTabela->ultimaLinha->commitCelula();
...
$obTabela->ultimaLinha->addCelula();
$obTabela->ultimaLinha->ultimaCelula->setClass ( "label" );
$obTabela->ultimaLinha->ultimaCelula->addConteudo( "FIMENQUANTO" );
$obTabela->ultimaLinha->commitCelula();
$obTabela->ultimaLinha->addCelula();
$obTabela->ultimaLinha->ultimaCelula->setClass ( "label" );
$obTabela->ultimaLinha->ultimaCelula->addConteudo( "&nbsp;" );
...
//$obFormulario->obIFrame->setHeight("80");
$obFormulario->show                 ();
