...
switch ($stCtrl) {
    case "ComboCadastro":
        ...
        $obRRegra->recuperaAtributosSelecionados($rsAtributosSelecionados);
        $obRRegra->recuperaAtributosDisponiveis ($rsAtributosDisponiveis);
        ...
        while (!$rsAtributosDisponiveis->eof()) {
            $inCodigo   = $rsAtributosDisponiveis->getCampo("cod_atributo");
            $stNome     = $rsAtributosDisponiveis->getCampo("nom_atributo");
        ...
        while (!$rsAtributosSelecionados->eof()) {
            $inCodigo   = $rsAtributosSelecionados->getCampo("cod_atributo");
            $stNome     = $rsAtributosSelecionados->getCampo("nom_atributo");
            $js .= "f.$stCombo.options[$inCount] = new Option('".$stNome."','".$inCodigo."'); \n";
