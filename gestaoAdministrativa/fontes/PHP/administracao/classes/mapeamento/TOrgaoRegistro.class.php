...
*/
class TOrgaoRegistro extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TOrgaoRegistro()
{
    parent::Persistente();
    $this->setTabela('administracao.orgao_registro');
    $this->setCampoCod('codigo');

    $this->AddCampo('codigo',    'integer', true, '', true,  false );
    $this->AddCampo('descricao', 'varchar', false, 60, false, false );
}
}
