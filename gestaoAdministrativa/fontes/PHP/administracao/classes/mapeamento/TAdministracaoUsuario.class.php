...
<?php
  ...
  /**
    ...
    * @author Desenvolvedor: Cassiano
    ...
    $Id: TAdministracaoUsuario.class.php 59612 2014-09-02 12:00:51Z gelson $
...
function buscaUsuarioBancoDados(&$rsRecordSet, $stCondicao = "" , $stOrdem = "" , $boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
    ...
    $stSql = $this->montaBuscaUsuarioBancoDados().$stCondicao.$stOrdem;
    $this->setDebug( $stSql );
    $obErro = $obConexao->executaSQL( $rsRecordSet, $stSql, $boTransacao );
...
function montaBuscaUsuarioBancoDados()
{
    $stSQL = " SELECT * from pg_user where usename = '".$this->getDado('username')."'";
