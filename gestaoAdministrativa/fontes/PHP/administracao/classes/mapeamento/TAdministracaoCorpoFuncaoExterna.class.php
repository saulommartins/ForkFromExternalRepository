...
<?php
/**
* Classe de mapeamento para administracao.corpo_funcao_externa
...
/**
  * Efetua conexão com a tabela  ADMINISTRACAO.CORPO_FUNCAO_EXTERNA
...
*/
class TAdministracaoCorpoFuncaoExterna extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TAdministracaoCorpoFuncaoExterna()
{
    parent::Persistente();
    $this->setTabela('administracao.corpo_funcao_externa');
    ...
    $this->AddCampo('nivel','integer',true,'',false,false);
    $this->AddCampo('linha','varchar',true,'400',false,false);
