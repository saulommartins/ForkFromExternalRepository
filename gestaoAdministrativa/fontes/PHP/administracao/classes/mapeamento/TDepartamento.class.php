...
<?php
/**
* Classe de mapeamento para administracao.departamento
...
/**
    * Efetua conexão com tabela de Departamento
    * Data de Criação   : 24/03/2004
    * @author Alessandro La-Rocca Silveira
*/
class TDepartamento extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TDepartamento()
{
    parent::Persistente();
    $this->setTabela('administracao.departamento');
    $this->setComplementoChave('cod_orgao, cod_unidade, cod_departamento');
    ...
    $this->AddCampo('nom_departamento',    'varchar',   true,  60, false, false );
