...
<?php
/**
* Classe de mapeamento para administracao.atributo_funcao
...
/**
  * Efetua conexão com a tabela  ADMINISTRACAO.ATRIBUTO_FUNCAO
...
*/
class TAdministracaoAtributoFuncao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TAdministracaoAtributoFuncao()
{
    parent::Persistente();
    $this->setTabela('administracao.atributo_funcao');

    $this->setCampoCod('');
    $this->setComplementoChave('cod_modulo,cod_biblioteca,cod_funcao,cod_cadastro,cod_atributo');
