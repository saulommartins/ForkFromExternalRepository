...
<?php
/**
* Classe de mapeamento para administracao.parametro
...
/**
  * Efetua conexão com a tabela  ADMINISTRACAO.PARAMETRO
...
*/
class TAdministracaoParametro extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TAdministracaoParametro()
{
    parent::Persistente();
    $this->setTabela('administracao.parametro');

    $this->setCampoCod('ordem');
    $this->setComplementoChave('cod_modulo,cod_biblioteca,cod_funcao,cod_variavel');
    ...
    $this->AddCampo('cod_variavel','integer',true,'',true,true);
    $this->AddCampo('ordem','integer',true,'',true,false);
...
function montaRecuperaRelacionamento()
{
    ...
    $stSql .= " where                                           \n";
    $stSql .= "     pri.cod_tipo       = var.cod_tipo       AND \n";
