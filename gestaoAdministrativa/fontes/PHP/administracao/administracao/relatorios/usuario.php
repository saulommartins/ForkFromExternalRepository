...
<?php
  /**
    ...
    * Casos de uso: uc-01.03.94
    ...
    $Id: usuario.php 59612 2014-09-02 12:00:51Z gelson $
...
$preview = new PreviewBirt(1,2,5);
$preview->setVersaoBirt('2.5.0');

$preview->addParametro('pExercicioSessao' , Sessao::getExercicio());

if (!empty($_REQUEST['inCodOrgao']))
    $preview->addParametro('pCodOrgao', $_REQUEST['inCodOrgao']);
else
    $preview->addParametro('pCodOrgao', '');

if (!empty($_REQUEST['orderby']))
    $preview->addParametro('pOrderBy', ' ORDER BY '.$_REQUEST['orderby']);
else
    $preview->addParametro('pOrderBy', '');
