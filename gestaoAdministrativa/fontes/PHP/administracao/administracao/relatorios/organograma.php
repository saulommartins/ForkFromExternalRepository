...
/**
    ...
    * Casos de uso: uc-01.03.94
    ...
    $Id: organograma.php 59612 2014-09-02 12:00:51Z gelson $
...
#
# $preview = new PreviewBirt(1,2,1);
# $preview->setVersaoBirt( '2.2.1' );
#
# $preview->addParametro ( 'inCodOrganograma' , Sessao::read('inCodOrganogramaTEMP') );
# Sessao::remove('inCodOrganogramaTEMP');
#
# $preview->preview();
