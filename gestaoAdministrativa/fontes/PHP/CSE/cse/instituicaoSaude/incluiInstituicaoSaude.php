...
<table width='100%'>
    ...
    <tr>
        ...
        <td class='field' width='80%'>
            <input type='text' name='nomInstituicao' value='' size='40' maxlength='80' onKeyUp="return autoTab(this, 80, event);" >
        </td>
    </tr>
    <tr>
...
case 1:
    ...
    if (!comparaValor("nom_instituicao", $nomInstituicao, "cse.instituicao_saude","",1)) {
...
/*** Se não houver restrições faz a inclusão dos dados ***/
    if ($ok) {
        ...
        $objeto = $nomInstituicao;
        if ($obj->incluirInstituicaoSaude($nomInstituicao) ) {
            //Insere auditoria
