                ...
                <tr>
                    <td height=20 bgcolor=b6bab6>
                        ...
                        <font FACE="sans-serif, Arial, Helvetica, Geneva" color=000000 size=2>
                            O Sistema URBEM está homologado para funcionar corretamente a partir da versão 4.2.2 do PHP.<BR><BR>

                            Sua versão atual é <?=phpversion();?><BR><BR>
                        </font>
                    </td>
                </tr>
            </table>
