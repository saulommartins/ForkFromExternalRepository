...
class Sessao extends SessaoLegada
{
    ...
    {
        return Sessao::write('stPassword', $valor, true);
    ...
    public static function getCodEntidade()
    {
        if (Sessao::read('stEntidade')== "") {
            return SistemaLegado::pegaConfiguracao("cod_entidade_prefeitura", 8, Sessao::read('exercicio'));
