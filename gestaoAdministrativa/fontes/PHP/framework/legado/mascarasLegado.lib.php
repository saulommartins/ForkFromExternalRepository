...
function validaMascara($mascara,$digitos)
{
    $mascaraFinal = "";
    $erros = 0;
...
function validaMascaraDinamica($mascara,$digitos)
{
    $mascaraFinal = "";
    $erros = 0;
...
function geraMascara($mascara,$valor)
{
$mascaraFinal = "";
$erros = 0;
...
$aMascara = validaMascara($mascara,$res);
