...
<tr>
    ...
    <tr>
        <td class=field>
        <select name=codOrgao onChange="javascript: preencheCA_ano('codOrgao', this.value);" style="width:400px">
    ...
    $chave = $codOrgaof;
    $dbEmp->vaiProximo();
    $comboCodOrgao .= "         <option value='".$chave.$anoE."'";
    if (isset($codOrgao)) {
        if ($chave == $codOrgao) {
            if ($anoOrgao) {
                if($anoOrgao==$anoE)
    ...
    <tr>
        <td class=field>
            <select name=codUnidade onChange="javascript: preencheCA_ano('codUnidade', this.value);" style="width:400px">
    ...
    <tr>
        <td class=field>
            <select name=codDepartamento onChange="javascript: preencheCA_ano('codDepartamento', this.value);" style="width:400px">
    ...
    <tr>
        <td class=field>
            <select name=codSetor onChange="javascript: preencheCA_ano('codSetor', this.value);" style="width:400px">
