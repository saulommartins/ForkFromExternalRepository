...
include_once( CAM_REGRA."REmpenhoNotaLiquidacao.class.php" );
include_once( CAM_REGRA."REmpenhoEmpenho.class.php" );

//Define o nome dos arquivos PHP
$stPrograma = "ConsultaEmpenhoLiquidado";
...
$obRegra->listarLiquidados( $rsLista );
...
$obLista->addDado();
$obLista->ultimoDado->setCampo( "[cod_nota] / [exercicio]" );
