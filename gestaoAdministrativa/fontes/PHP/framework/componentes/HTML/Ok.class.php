...
function Ok($boBlock=false)
{
    ...
    $this->setDefinicao ( "OK" );
    $this->obEvento->setOnClick("Salvar();");
    if($boBlock)
        $this->obEvento->setOnClick($this->obEvento->getOnClick().'if ( Valida() ) {BloqueiaFrames(true,false);}');
}
