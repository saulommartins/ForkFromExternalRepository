...
<?php
/**
* Gerar o componente tipo submit de acordo com os valores setados pelo usuário.
...
/**
    * Classe que gera o HTML do submit
*/
class Submit extends Componente
{
/**
    * Método construtor
    * @access Public
