...
class TableHeader extends TableElement
{
    ...
    */
    ...
    public function TableHeader(&$Linha)
    {
        parent::TableElement();
        $this->setTag ( "th" );
        $this->Linha = &$Linha;

        $this->setId     ( $this->Linha->getId() . '_header_' . count( $this->Linha->arCabecalhos ) ) ;
        $this->setName   ( $this->Linha->getId() . '_header_' . count( $this->Linha->arCabecalhos) ) ;
    }
