...
*/
class ListaPDFRH extends ListaPDF
{
/**
    * Método Construtor
    * @access Private
*/
function ListaPDFRH($orientation='P',$unit='mm',$format='A4')
{
    ...
    if ( is_array($this->arLarguraColuna[$inIndiceLista]) ) {
        ...
        if ($boVazio == false) {
            ...
            foreach ($this->arCabecalho[$inIndiceLista] as $arCabecalho) {
                ...
                $this->MultiCell( $arLarguraColuna["value"] ,($this->inAlturaCabecalho[$inIndiceLista]?$this->inAlturaCabecalho[$inIndiceLista]:5), $arCabecalho["rotulo"].$in, 0,$arCabecalho["alinhamento"],0 );
