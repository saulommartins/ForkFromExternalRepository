...
/*
#########################################################################
## Atualização da ação do sistema para a emissão dos novos relatórios  ##
#########################################################################
*/
 -- Relatório de Apólice de Seguro.
UPDATE administracao.acao SET nom_arquivo = 'FLApoliceSeguros.php' WHERE cod_acao = 111 AND cod_funcionalidade = 28;

-- Relatório de Apólice de Seguros a Vencer.
UPDATE administracao.acao SET nom_arquivo = 'FLApoliceSegurosVencer.php' WHERE cod_acao = 112 AND cod_funcionalidade = 28;

-- Relatório de Manutenção.
UPDATE administracao.acao SET nom_arquivo = 'FLRelatorioManutencao.php' WHERE cod_acao = 113 AND cod_funcionalidade = 28;

-- Relatório de Classificação.
UPDATE administracao.acao SET nom_arquivo = 'FLRelatorioClassificacao.php' WHERE cod_acao = 125 AND cod_funcionalidade = 28;

/*
#########################################################################
## Inserção dos novos relatórios do módulo Patrimonio.                 ##
#########################################################################
*/
...
VALUES
    (3, 6, 3, 'Relatório de Apólice de Seguro', 'apoliceSeguros.rptdesign');

-- Apólice de Seguro a Vencer.
INSERT INTO administracao.relatorio 
    (cod_gestao, cod_modulo, cod_relatorio, nom_relatorio, arquivo)
VALUES
    (3, 6, 4, 'Relatório de Apólice de Seguro a Vencer', 'apoliceSegurosVencer.rptdesign');

-- Relatório de Manutenção.
INSERT INTO administracao.relatorio 
    (cod_gestao, cod_modulo, cod_relatorio, nom_relatorio, arquivo)
VALUES
    (3, 6, 5, 'Relatório de Manutenção', 'manutencao.rptdesign');

-- Relatório de Classificação.
INSERT INTO administracao.relatorio 
    (cod_gestao, cod_modulo, cod_relatorio, nom_relatorio, arquivo)
VALUES
    (3, 6, 6, 'Relatório de Classificação', 'classificacao.rptdesign');
