...
$obBirtPreview = new PreviewBirt( 3, 29, 13);

// Versão NOVA
$obBirtPreview->setVersaoBirt( '2.5.0' );

$obBirtPreview->setTitulo     ( 'Relatório de Saída por Estorno de Entrada' );
...
$obBirtPreview->addParametro( 'prCodLancamentoEntrada', $_REQUEST['inCodLancamentoEntrada'] );
