...
<?php
/**
    * Classe de mapeamento da tabela ALMOXARIFADO.TIPO_ITEM
...
/**
  * Efetua conexão com a tabela  ALMOXARIFADO.TIPO_ITEM
  * Data de Criação: 26/10/2005
  ...
  * @subpackage Mapeamento
*/
class TAlmoxarifadoTipoItem extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TAlmoxarifadoTipoItem()
{
    parent::Persistente();
    $this->setTabela('almoxarifado.tipo_item');
