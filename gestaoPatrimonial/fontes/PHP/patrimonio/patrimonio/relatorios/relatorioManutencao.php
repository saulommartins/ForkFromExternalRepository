...
<script>
    ...
    <form action="relatorioManutencao.php?<?=Sessao::getId()?>&ctrl=1" method="POST" name="frm" onsubmit="return Valida();" >
        <table width="100%">
        <tr>
            <td class="alt_dados" colspan="2">Informe os Dados para Consulta</td>
<?php
   geraCampoData2("*Data Inicial", "dataInicial", "01/03/2003", false, "onKeyPress=\"return(isValido(this, event, '0123456789'));\"onKeyUp=\"mascaraData(this, event);\" onBlur=\"JavaScript: if (!verificaData(this)) {alertaAviso('@Data inválida!('+this.value+')','form','erro','Sessao::getId()');this.value=''};\"","Informe a data inicial","Buscar data inicial" );
