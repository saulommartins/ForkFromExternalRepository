...
if (!isset($filtroA)) {
    ...
    $filtro   = $relatorio->montaFiltro( $natureza, $grupo, $especie, $orgao, $unidade, $departamento, $setor, $local, $exercicioLocal,"","h");
}
...
$sXML       = '../../../../../../gestaoPatrimonial/fontes/PHP/patrimonio/patrimonio/relatorios/cargaPatrimonialTotalizador.xml';
