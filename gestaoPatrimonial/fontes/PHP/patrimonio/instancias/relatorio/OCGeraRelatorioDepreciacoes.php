...
$preview = new PreviewBirt(3,6,16);
...
$preview->addParametro('stExercicio'     , $request->get('stExercicio') );
$preview->addParametro('stTipoRelatorio' , $request->get('stTipoRelatorio') );
$preview->addParametro('inCompetencia'   , $request->get('inCompetenciaDepreciacao') );
