...
$entidade = $request->get('inCodEntidade');
$entidade = "&inCodEntidade=$entidade";
...
switch ($stAcao) {
    ...
    case 'inventario':
        ...
        $obLista->ultimaAcao->setLink( $stCaminho.$pgGeraRelatorioInventario."?".Sessao::getId().$stLink.$entidade   );
    break;
