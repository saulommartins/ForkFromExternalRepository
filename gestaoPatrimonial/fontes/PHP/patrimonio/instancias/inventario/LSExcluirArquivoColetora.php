...
$obArquivos = new TPatrimonioArquivoColetora;
$filtro = 	 "WHERE timestamp between to_date('".$stDataInicial."', 'yyyy-mm-dd') and to_date('".$stDataFinal ."', 'yyyy-mm-dd')";
$obArquivos->recuperaListaArquivo( $rsArquivo, $filtro );

$obLista = new Lista;
$obLista->setTitulo("Lista de Arquivos");
$obLista->setMostraPaginacao(true);
$obLista->obPaginacao->setFiltro("&stLink=".$stLink );
$obLista->setRecordSet( $rsArquivo );
...
$obLista->ultimaAcao->addCampo("&nome" , "nome");
$obLista->commitAcao();
