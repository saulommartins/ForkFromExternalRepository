...
/**
    ...
    *
    $Id: TPatrimonioGrupoPlanoReavaliacao.class.php 65901 2016-06-28 14:22:28Z michel $
*/

include_once '../../../../../../gestaoAdministrativa/fontes/PHP/framework/include/valida.inc.php';
include_once CLA_PERSISTENTE;

class TPatrimonioGrupoPlanoReavaliacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
...
{
    parent::__construct();
    $this->setTabela('patrimonio.grupo_plano_reavaliacao');
...
public function recuperaPlanoReavaliacao(&$rsRecordSet, $stFiltro = "", $stOrdem = "", $boTransacao = "")
{
    $obErro      = new Erro;
    $obConexao   = new Conexao;
    $rsRecordSet = new RecordSet;
    $stSql = $this->montaRecuperaPlanoReavaliacao().$stFiltro.$stOrdem;
    $this->stDebug = $stSql;
...
public function montaRecuperaPlanoReavaliacao()
{
    $stSql = "      SELECT grupo_plano_reavaliacao.cod_plano,
