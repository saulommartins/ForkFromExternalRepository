...
/*
$Log$
Revision 1.1  2007/10/17 13:26:55  hboaventura
...
class TPatrimonioManutencaoPaga extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TPatrimonioManutencaoPaga()
{
    parent::Persistente();
    $this->setTabela('patrimonio.manutencao_paga');
    $this->setCampoCod('');
