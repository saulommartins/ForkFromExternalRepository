...
/**
    ...
    * $Id: TPatrimonioVeiculoUniorcam.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TPatrimonioVeiculoUniorcam extends Persistente
{
/**
    * Método Construtor
    * @access Private
...
function TPatrimonioVeiculoUniorcam()
{
    parent::Persistente();
    $this->setTabela('patrimonio.veiculo_uniorcam');
