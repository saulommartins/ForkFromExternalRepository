...
$obSelectOrdenacao->addOption( 'codigo', 'Veiculo, Data' );
$obSelectOrdenacao->addOption( 'dataAscendente' , 'Data Ascendente, Veiculo' );
$obSelectOrdenacao->addOption( 'dataDescendente' , 'Data Descendente, Veiculo' );
$obSelectOrdenacao->addOption( 'horaAscendente' , 'Data Ascendente, Hora' );
$obSelectOrdenacao->addOption( 'horaDescendente' , 'Data Descendente, Hora' );
