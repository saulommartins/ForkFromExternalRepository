...
/**
    ...
    * @author Programador: Fernando Zank Correa Evangelista
    ...
    $Id: OCControleIndividual.php 59612 2014-09-02 12:00:51Z gelson $
...
//        $arDadosVeiculo[$inCount]['titulo2'] = "";
        ...
        #sessao->transf5 = $rsDados;
        #sessao->transf6 = $rsDadosVeiculo;
        #sessao->transf7 = $rsTotalItem;
