...
/**
    ...
    * $Id: FLRelatorioAbastecimento.php 59612 2014-09-02 12:00:51Z gelson $
...
//select para o tipo do relatorio
$obCmbTipoRelatorio = new Select();
$obCmbTipoRelatorio->setName( 'slTipoRelatorio' );
$obCmbTipoRelatorio->setRotulo( 'Tipo de Relatório' );
$obCmbTipoRelatorio->setTitle( 'Selecione o tipo do relatório.' );
$obCmbTipoRelatorio->addOption( '','Selecione' );
$obCmbTipoRelatorio->addOption( 1, 'Controle Consolidado de Combustível' );
$obCmbTipoRelatorio->addOption( 2, 'Controle de Combustível Por Veículo' );
$obCmbTipoRelatorio->addOption( 3, 'Controle de Combustível Por Mês' );
$obCmbTipoRelatorio->setNull( false );
$obCmbTipoRelatorio->obEvento->setOnChange("montaParametrosGET('montaPeriodo','slTipoRelatorio')");

//span para a periodicidade
