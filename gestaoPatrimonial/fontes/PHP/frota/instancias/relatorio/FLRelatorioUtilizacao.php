...
/**
    ...
    * $Id: FLRelatorioUtilizacao.php 59612 2014-09-02 12:00:51Z gelson $
...
$stPrograma = "RelatorioUtilizacao";
...
$obPeriodicidade->obPeriodoFinal->obEvento->setOnBlur( "verificaPeriodo();" );
$obPeriodicidade->obPeriodoFinal->setId     ( 'stPeriodoFinal'              );
$obPeriodicidade->obPeriodoInicial->setId   ( 'stPeriodoInicial'            );
