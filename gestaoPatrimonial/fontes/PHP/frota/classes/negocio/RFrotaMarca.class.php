...
function setTFrotaMarca($valor) { $this->obTFrotaMarca = $valor; }
...
/**
    ...
    * @return Object
*/
function getTFrotaMarca() { return $this->obTFrotaMarca; }
...
function listar(&$rsLista, $stOrder = "nom_marca", $boTransacao = "")
{
    $obErro = new Erro;
    if ($this->inCodMarca)
        $this->obTFrotaMarca->setDado('inCodMarca',$this->inCodMarca);
    $obErro = $this->obTFrotaMarca->recuperaMarca( $rsLista, $stFiltro, $stOrder, $boTransacao );
