...
/**
    ...
    * @author Desenvolvedor: Henrique Boaventura
    ...
    $Id: TFrotaVeiculoDocumentoEmpenho.class.php 59612 2014-09-02 12:00:51Z gelson $
...
class TFrotaVeiculoDocumentoEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TFrotaVeiculoDocumentoEmpenho()
{
    parent::Persistente();
    $this->setTabela('frota.veiculo_documento_empenho');
