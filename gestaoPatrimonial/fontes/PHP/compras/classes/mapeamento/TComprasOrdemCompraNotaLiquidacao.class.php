...
<?php
/**
    * Classe de mapeamento da tabela compras.ordem_compra_nota_liquidacao
...
/**
  * Efetua conexão com a tabela  compras.ordem_compra_nota_liquidacao
  * Data de Criação: 30/06/2006
  ...
  * @subpackage Mapeamento
*/
class TComprasOrdemCompraNotaLiquidacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasOrdemCompraNotaLiquidacao()
{
    parent::Persistente();
    $this->setTabela("compras.ordem_compra_nota_liquidacao");
    ...
    $this->AddCampo('exercicio_liquidacao','CHAR(4)',true,'',false,true);
