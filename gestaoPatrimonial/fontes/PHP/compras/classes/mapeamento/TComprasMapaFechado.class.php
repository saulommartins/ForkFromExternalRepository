...
<?php
/**
    * Classe de mapeamento da tabela compras.mapa_fechado
...
/**
  * Efetua conexão com a tabela  compras.mapa_fechado
  * Data de Criação: 30/06/2006
  ...
  * @subpackage Mapeamento
*/
class TComprasMapaFechado extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasMapaFechado()
{
    parent::Persistente();
    $this->setTabela("compras.mapa_fechado");

    $this->setCampoCod('');
    $this->setComplementoChave('exercicio,cod_mapa');
