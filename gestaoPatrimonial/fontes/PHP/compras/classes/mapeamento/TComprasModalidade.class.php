...
<?php
/**
    * Classe de mapeamento da tabela compras.modalidade
...
/**
  * Efetua conexão com a tabela  compras.modalidade
  * Data de Criação: 30/06/2006
  ...
  * @subpackage Mapeamento
*/
class TComprasModalidade extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasModalidade()
{
    parent::Persistente();
    $this->setTabela("compras.modalidade");

    $this->setCampoCod('cod_modalidade');
    $this->setComplementoChave('');

    $this->AddCampo('cod_modalidade','INTEGER',true,'',true,false);
    $this->AddCampo('descricao','VARCHAR(50)',true,'',false,false);
