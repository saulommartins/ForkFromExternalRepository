...
/**
  ...
  * @subpackage Mapeamento
*/
class TComprasOrdemCompraAnulacao extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasOrdemCompraAnulacao()
{
    parent::Persistente();
    $this->setTabela("compras.ordem_anulacao");

    $this->setCampoCod('');
    $this->setComplementoChave('exercicio,cod_entidade,cod_ordem,timestamp');
    ...
    $this->AddCampo('motivo','VARCHAR(200)',true,'',false,false);
