...
<?php
/**
    * Classe de mapeamento da tabela compras.mapa_solicitacao_item_pre_empenho
...
/**
  * Efetua conexão com a tabela  compras.mapa_solicitacao_item_pre_empenho
  * Data de Criação: 30/06/2006
  ...
  * @subpackage Mapeamento
*/
class TComprasMapaSolicitacaoItemPreEmpenho extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasMapaSolicitacaoItemPreEmpenho()
{
    parent::Persistente();
    $this->setTabela("compras.mapa_solicitacao_item_pre_empenho");

    $this->setCampoCod('');
    $this->setComplementoChave('exercicio_mapa,cod_mapa,exercicio_solicitacao,cod_entidade,cod_solicitacao,exercicio,cod_pre_empenho,cod_centro,cod_item,num_item');
