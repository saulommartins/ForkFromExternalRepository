...
<?php
/**
    * Classe de mapeamento da tabela compras.ordem_compra_nota_item
...
/**
  * Efetua conexão com a tabela  compras.ordem_compra_nota_item
  * Data de Criação: 30/06/2006
  ...
  * @subpackage Mapeamento
*/
class TComprasOrdemCompraNotaItem extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TComprasOrdemCompraNotaItem()
{
    parent::Persistente();
    $this->setTabela("compras.ordem_compra_nota_item");
    ...
    $this->AddCampo('vl_desconto','NUMERIC(14,2)',true,'',false,false);
