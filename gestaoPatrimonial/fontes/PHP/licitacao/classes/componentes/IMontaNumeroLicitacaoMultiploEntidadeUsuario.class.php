...
class IMontaNumeroLicitacaoMultiploEntidadeUsuario extends Objeto
{
    public $obForm;
    public $obExercicio;
    ...
    public function IMontaNumeroLicitacaoMultiploEntidadeUsuario(&$obForm)
    {
        parent::Objeto();
        ...
        $this->obISelectModalidade->setNull( true );
