...
/**
  ...
  * @subpackage Mapeamento
*/
class TLicitacaoParticipantePenalidade extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TLicitacaoParticipantePenalidade()
{
    parent::Persistente();
    $this->setTabela("licitacao.participante_penalidade");

    $this->setCampoCod('');
    $this->setComplementoChave('cod_penalidade');

    $this->AddCampo('cod_penalidade','integer',false ,''      ,true,'TLicitacaoPenalidades');
    $this->AddCampo('cgm_fornecedor','integer',false ,''      ,false,'TComprasFornecedor');
    $this->AddCampo('valor'         ,'numeric',false ,'14,2'  ,false,false);
    $this->AddCampo('num_processo'  ,'integer',false ,''      ,false,false);
