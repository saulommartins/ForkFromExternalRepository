...
<?php
/**
    * Classe de mapeamento da tabela licitacao.edital_anulado
...
/**
  * Efetua conexão com a tabela  licitacao.edital_anulado
  * Data de Criação: 15/09/2006
  ...
  * @subpackage Mapeamento
*/
class TLicitacaoEditalAnulado extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TLicitacaoEditalAnulado()
{
    parent::Persistente();
    $this->setTabela("licitacao.edital_anulado");
