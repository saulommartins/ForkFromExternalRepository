...
<?php
/**
    * Classe de mapeamento da tabela licitacao.convenio_anulado
...
/**
  * Efetua conexão com a tabela  licitacao.convenio_anulado
  * Data de Criação: 15/09/2006
  ...
  * @subpackage Mapeamento
*/
class TLicitacaoConvenioAnulado extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TLicitacaoConvenioAnulado()
{
    parent::Persistente();
    $this->setTabela("licitacao.convenio_anulado");

    $this->setCampoCod('');
    $this->setComplementoChave('exercicio,num_convenio');
    ...
    $this->AddCampo('dt_anulacao'  ,'date'   ,false ,''   ,false,false);
