...
<?php
/**
    * Classe de mapeamento da tabela licitacao.penalidade
...
/**
  * Efetua conexão com a tabela  licitacao.penalidade
  * Data de Criação: 15/09/2006
  ...
  * @subpackage Mapeamento
*/
class TLicitacaoPenalidade extends Persistente
{
/**
    * Método Construtor
    * @access Private
*/
function TLicitacaoPenalidade()
{
    parent::Persistente();
    $this->setTabela("licitacao.penalidade");
