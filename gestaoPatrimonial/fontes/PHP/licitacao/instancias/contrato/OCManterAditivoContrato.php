...
/*
    ...
    * Casos de uso :
    ...
    $Id: OCManterAditivoContrato.php 66086 2016-07-18 20:07:47Z michel $
*/
...
//Inclui itens na listagem de veiculos de publicacao utilizados
    ...
    //Carrega campo Descricao
    case 'montaDescricao' :
        $stDescricao = $request->get('stDescricao');
        $stDescricao = stripslashes($stDescricao);

        $inCodTermoAditivo = $request->get('inCodTipoTermoAditivo');
        if($inCodTermoAditivo == 6 OR $inCodTermoAditivo == 9 OR $inCodTermoAditivo == 10 OR $inCodTermoAditivo == 11 OR $inCodTermoAditivo == 14 ) {
            $js.= montaDescricao($stDescricao);
        } else {
            $js.="d.getElementById('spanDescricao').innerHTML = '';";
        }
        echo $js;
    break;
}

function montaDescricao($stDescricao = "")
{
    $obTxtDescricao = new TextArea;
    $obTxtDescricao->setName('stDescricao');
    $obTxtDescricao->setId('stDescricao');
    $obTxtDescricao->setRotulo('Descrição');
    $obTxtDescricao->setTitle('Informe a descrição do aditivo.');
    ...
    $js.="d.getElementById('spanDescricao').innerHTML = '".$stHtml."';";
   return $js;
}
