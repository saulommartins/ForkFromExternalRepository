...
/*
    ...
    * $Id: OCManterContrato.php 66518 2016-09-09 19:31:46Z michel $
...
switch ($_REQUEST['stCtrl']) {
    ...
    case "addArquivo":
        ...
        if(empty($stErro)){
            ...
            $arArquivosUpload['num_contrato'] = $request->get('inNumeroContrato');
            $arArquivosUpload['cod_entidade'] = $request->get('inCodEntidade');
            $arArquivosUpload['exercicio']    = $request->get('stExercicioContrato');
        ...
        if(!empty($stErro)){
            ...
            $stJs  = montaListaArquivos($arArquivos, true, $request->get('consultar'));
    ...
    case 'excluirListaArquivo':
        ...
        if(empty($stErro)){
            ...
            $stJs = montaListaArquivos($arTemp, true, $request->get('consultar'));
        }else{
            $stJs = "alertaAviso('".urlencode("Erro ao Incluir Arquivo Digital: ".$stErro)."','unica','erro','".Sessao::getId()."');";
        }
